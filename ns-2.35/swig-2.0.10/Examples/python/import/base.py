...
class Base(_object):
    ...
    def A(self): return _base.Base_A(self)
    def B(self): return _base.Base_B(self)
    def toBase(self): return _base.Base_toBase(self)
Base_swigregister = _base.Base_swigregister
