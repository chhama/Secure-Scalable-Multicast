...
SWIGINTERN PyObject *_wrap_gcdmain(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  int arg1 ;
  char **arg2 ;
  PyObject * obj0 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:gcdmain",&obj0)) SWIG_fail;
  {
    int i;
...
SWIGINTERN PyObject *_wrap_count(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:count",&obj0,&obj1)) SWIG_fail;
  {
    ...
    utf8str = PyUnicode_AsUTF8String(obj0);
    PyBytes_AsStringAndSize(utf8str, &cstr, &len);
    arg1 = strndup(cstr, (size_t)len);
    arg2 = (int)len;
    Py_DECREF(utf8str);
#else
...
SWIGINTERN PyObject *_wrap_capitalize(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  char *arg1 = (char *) 0 ;
  int arg2 ;
  PyObject * obj0 = 0 ;
  
  if (!PyArg_ParseTuple(args,(char *)"O:capitalize",&obj0)) SWIG_fail;
  {
#if PY_VERSION_HEX >= 0x03000000
    char *cstr;
    Py_ssize_t len;
    PyObject *utf8str = PyUnicode_AsUTF8String(obj0);
    PyBytes_AsStringAndSize(utf8str, &cstr, &len);
    arg1 = strndup(cstr, (size_t)len);
    arg2 = (int)len;
    Py_DECREF(utf8str);
    ...
    memmove(arg1,PyString_AsString(obj0),arg2);
#endif
  }
  ...
  resultobj = SWIG_Py_Void();
  {
    PyObject *o;
#if PY_VERSION_HEX >= 0x03000000
    o = PyUnicode_FromStringAndSize(arg1,arg2);
#else
...
SWIGINTERN PyObject *_wrap_circle(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:circle",&obj0,&obj1)) SWIG_fail;
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"gcdmain", _wrap_gcdmain, METH_VARARGS, NULL},
	 { (char *)"count", _wrap_count, METH_VARARGS, NULL},
	 { (char *)"capitalize", _wrap_capitalize, METH_VARARGS, NULL},
