...
public:
    SwigDirector_Employee(PyObject *self, char const *n);
...
/* VTable implementation */
    PyObject *swig_get_method(size_t method_index, const char *method_name) const {
      ...
      if (!method) {
        ...
        if (!method) {
          std::string msg = "Method in class Employee doesn't exist, undefined ";
          msg += method_name;
...
public:
    SwigDirector_Manager(PyObject *self, char const *n);
    virtual std::string getTitle();
    virtual std::string getName();
    virtual std::string getPosition() const;
...
/* VTable implementation */
    PyObject *swig_get_method(size_t method_index, const char *method_name) const {
      ...
      if (!method) {
        ...
        method = PyObject_GetAttr(swig_get_self(), name);
        if (!method) {
          std::string msg = "Method in class Manager doesn't exist, undefined ";
          msg += method_name;
          Swig::DirectorMethodException::raise(msg.c_str());
        }
        vtable[method_index] = method;
