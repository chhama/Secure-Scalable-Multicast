...
def copy_intp(*args):
  return _example.copy_intp(*args)
copy_intp = _example.copy_intp

def delete_intp(*args):
  return _example.delete_intp(*args)
delete_intp = _example.delete_intp

def intp_assign(*args):
  return _example.intp_assign(*args)
intp_assign = _example.intp_assign

def intp_value(*args):
  return _example.intp_value(*args)
intp_value = _example.intp_value

def sub(*args):
  return _example.sub(*args)
sub = _example.sub

def divide(*args):
  return _example.divide(*args)
