...
#define SWIG_init    Base_Init
#define SWIG_name    "base"
#define SWIG_prefix  ""
...
SWIGINTERN int
_wrap_Base_A(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Base *arg1 = (Base *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:Base_A self ",(void *)0) == TCL_ERROR) SWIG_fail;
...
SWIGINTERN int
_wrap_Base_B(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Base *arg1 = (Base *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:Base_B self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Base, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN int
_wrap_Base_toBase(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Base *arg1 = (Base *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  Base *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:Base_toBase self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Base, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
static swig_command_info swig_commands[] = {
    ...
    { SWIG_prefix "Base_A", (swig_wrapper_func) _wrap_Base_A, NULL},
    { SWIG_prefix "Base_B", (swig_wrapper_func) _wrap_Base_B, NULL},
    { SWIG_prefix "Base_toBase", (swig_wrapper_func) _wrap_Base_toBase, NULL},
...
SWIGEXPORT int Base_SafeInit(Tcl_Interp *interp) {
