...
SWIGINTERN int
_wrap_Foo_A(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Foo *arg1 = (Foo *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:Foo_A self ",(void *)0) == TCL_ERROR) SWIG_fail;
...
SWIGINTERN int
_wrap_Foo_B(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Foo *arg1 = (Foo *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:Foo_B self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Foo, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN int
_wrap_Foo_toBase(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Foo *arg1 = (Foo *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  Base *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:Foo_toBase self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Foo, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN int
_wrap_Foo_fromBase(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Base *arg1 = (Base *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  Foo *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:Foo_fromBase b ",(void *)0) == TCL_ERROR) SWIG_fail;
...
static swig_method swig_Foo_methods[] = {
    {"A", _wrap_Foo_A}, 
    {"B", _wrap_Foo_B}, 
    {"toBase", _wrap_Foo_toBase}, 
    {0,0}
};
static swig_attribute swig_Foo_attributes[] = {
    {0,0,0}
};
static swig_class *swig_Foo_bases[] = {0,0};
static const char * swig_Foo_base_names[] = {"Base *",0};
...
static swig_command_info swig_commands[] = {
    ...
    { SWIG_prefix "Foo_A", (swig_wrapper_func) _wrap_Foo_A, NULL},
    { SWIG_prefix "Foo_B", (swig_wrapper_func) _wrap_Foo_B, NULL},
    { SWIG_prefix "Foo_toBase", (swig_wrapper_func) _wrap_Foo_toBase, NULL},
    { SWIG_prefix "Foo_fromBase", (swig_wrapper_func) _wrap_Foo_fromBase, NULL},
...
SWIGEXPORT int Foo_SafeInit(Tcl_Interp *interp) {
