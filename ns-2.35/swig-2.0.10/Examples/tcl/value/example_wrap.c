...
_wrap_vector_add(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  Tcl_SetObjResult(interp,SWIG_NewInstanceObj((Vector *)memcpy((Vector *)malloc(sizeof(Vector)),&result,sizeof(Vector)), SWIGTYPE_p_Vector, SWIG_POINTER_OWN | 0 ));
  return TCL_OK;
fail:
  return TCL_ERROR;
}
...
SWIGINTERN int
_wrap_free(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  void *arg1 = (void *) 0 ;
  int res1 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:free void * ",(void *)0) == TCL_ERROR) SWIG_fail;
...
_wrap_vector_print(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (SWIG_GetArgs(interp, objc, objv,"o:vector_print v ",(void *)0) == TCL_ERROR) SWIG_fail;
...
static swig_command_info swig_commands[] = {
    ...
    { SWIG_prefix "free", (swig_wrapper_func) _wrap_free, NULL},
