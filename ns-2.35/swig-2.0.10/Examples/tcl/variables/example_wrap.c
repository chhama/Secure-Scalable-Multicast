...
extern "C" {
#endif
SWIGINTERN const char *_wrap_ivar_get(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2, int flags) {
  Tcl_Obj *value = 0;
  
  value = SWIG_From_int((int)(ivar));
  if (value) {
...
SWIGINTERN const char *_wrap_ivar_set(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2 SWIGUNUSED, int flags) {
  Tcl_Obj *value = 0;
  Tcl_Obj *name1o = 0;
...
SWIGINTERN const char *_wrap_svar_get(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2, int flags) {
  Tcl_Obj *value = 0;
  
  value = SWIG_From_short((short)(svar));
  if (value) {
    Tcl_SetVar2(interp,name1,name2,Tcl_GetStringFromObj(value,NULL), flags);
    Tcl_DecrRefCount(value);
  }
...
SWIGINTERN const char *_wrap_svar_set(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2 SWIGUNUSED, int flags) {
  Tcl_Obj *value = 0;
  Tcl_Obj *name1o = 0;
...
SWIGINTERN const char *_wrap_lvar_get(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2, int flags) {
  Tcl_Obj *value = 0;
  
  value = SWIG_From_long((long)(lvar));
  if (value) {
    Tcl_SetVar2(interp,name1,name2,Tcl_GetStringFromObj(value,NULL), flags);
    Tcl_DecrRefCount(value);
  }
...
SWIGINTERN const char *_wrap_lvar_set(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2 SWIGUNUSED, int flags) {
  Tcl_Obj *value = 0;
  Tcl_Obj *name1o = 0;
...
SWIGINTERN const char *_wrap_uivar_get(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2, int flags) {
  Tcl_Obj *value = 0;
  
  value = SWIG_From_unsigned_SS_int((unsigned int)(uivar));
  if (value) {
    Tcl_SetVar2(interp,name1,name2,Tcl_GetStringFromObj(value,NULL), flags);
    Tcl_DecrRefCount(value);
  }
...
SWIGINTERN const char *_wrap_uivar_set(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2 SWIGUNUSED, int flags) {
  Tcl_Obj *value = 0;
  Tcl_Obj *name1o = 0;
...
SWIGINTERN const char *_wrap_usvar_get(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2, int flags) {
  Tcl_Obj *value = 0;
  
  value = SWIG_From_unsigned_SS_short((unsigned short)(usvar));
  if (value) {
    Tcl_SetVar2(interp,name1,name2,Tcl_GetStringFromObj(value,NULL), flags);
    Tcl_DecrRefCount(value);
  }
...
SWIGINTERN const char *_wrap_usvar_set(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2 SWIGUNUSED, int flags) {
  Tcl_Obj *value = 0;
  Tcl_Obj *name1o = 0;
...
SWIGINTERN const char *_wrap_ulvar_get(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2, int flags) {
  Tcl_Obj *value = 0;
  
  value = SWIG_From_unsigned_SS_long((unsigned long)(ulvar));
  if (value) {
    Tcl_SetVar2(interp,name1,name2,Tcl_GetStringFromObj(value,NULL), flags);
    Tcl_DecrRefCount(value);
  }
...
SWIGINTERN const char *_wrap_ulvar_set(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2 SWIGUNUSED, int flags) {
  Tcl_Obj *value = 0;
  Tcl_Obj *name1o = 0;
...
SWIGINTERN const char *_wrap_scvar_get(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2, int flags) {
  Tcl_Obj *value = 0;
  
  value = SWIG_From_signed_SS_char((signed char)(scvar));
  if (value) {
    Tcl_SetVar2(interp,name1,name2,Tcl_GetStringFromObj(value,NULL), flags);
    Tcl_DecrRefCount(value);
  }
...
SWIGINTERN const char *_wrap_scvar_set(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2 SWIGUNUSED, int flags) {
  Tcl_Obj *value = 0;
  Tcl_Obj *name1o = 0;
...
SWIGINTERN const char *_wrap_ucvar_get(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2, int flags) {
  Tcl_Obj *value = 0;
  
  value = SWIG_From_unsigned_SS_char((unsigned char)(ucvar));
  if (value) {
    Tcl_SetVar2(interp,name1,name2,Tcl_GetStringFromObj(value,NULL), flags);
    Tcl_DecrRefCount(value);
  }
...
SWIGINTERN const char *_wrap_ucvar_set(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2 SWIGUNUSED, int flags) {
  Tcl_Obj *value = 0;
  Tcl_Obj *name1o = 0;
...
SWIGINTERN const char *_wrap_cvar_get(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2, int flags) {
  Tcl_Obj *value = 0;
  
  value = SWIG_From_char((char)(cvar));
  if (value) {
    Tcl_SetVar2(interp,name1,name2,Tcl_GetStringFromObj(value,NULL), flags);
    Tcl_DecrRefCount(value);
  }
...
SWIGINTERN const char *_wrap_cvar_set(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2 SWIGUNUSED, int flags) {
  Tcl_Obj *value = 0;
  Tcl_Obj *name1o = 0;
...
SWIGINTERN const char *_wrap_fvar_get(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2, int flags) {
  Tcl_Obj *value = 0;
  
  value = SWIG_From_float((float)(fvar));
  if (value) {
    Tcl_SetVar2(interp,name1,name2,Tcl_GetStringFromObj(value,NULL), flags);
    Tcl_DecrRefCount(value);
  }
...
SWIGINTERN const char *_wrap_fvar_set(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2 SWIGUNUSED, int flags) {
  Tcl_Obj *value = 0;
  Tcl_Obj *name1o = 0;
...
SWIGINTERN const char *_wrap_dvar_get(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2, int flags) {
  Tcl_Obj *value = 0;
  
  value = SWIG_From_double((double)(dvar));
  if (value) {
    Tcl_SetVar2(interp,name1,name2,Tcl_GetStringFromObj(value,NULL), flags);
    Tcl_DecrRefCount(value);
  }
...
SWIGINTERN const char *_wrap_dvar_set(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2 SWIGUNUSED, int flags) {
  Tcl_Obj *value = 0;
  Tcl_Obj *name1o = 0;
...
SWIGINTERN const char *_wrap_strvar_get(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2, int flags) {
  Tcl_Obj *value = 0;
  
  value = SWIG_FromCharPtr(strvar);
  if (value) {
    Tcl_SetVar2(interp,name1,name2,Tcl_GetStringFromObj(value,NULL), flags);
    Tcl_DecrRefCount(value);
  }
...
SWIGINTERN const char *_wrap_strvar_set(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2 SWIGUNUSED, int flags) {
  Tcl_Obj *value = 0;
  Tcl_Obj *name1o = 0;
...
SWIGINTERN const char *_wrap_cstrvar_get(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2, int flags) {
  Tcl_Obj *value = 0;
  
  value = SWIG_FromCharPtr(cstrvar);
  if (value) {
    Tcl_SetVar2(interp,name1,name2,Tcl_GetStringFromObj(value,NULL), flags);
    Tcl_DecrRefCount(value);
  }
...
SWIGINTERN const char *_wrap_iptrvar_get(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2, int flags) {
  Tcl_Obj *value = 0;
  
  value = SWIG_NewPointerObj(SWIG_as_voidptr(iptrvar), SWIGTYPE_p_int,  0 );
  if (value) {
    Tcl_SetVar2(interp,name1,name2,Tcl_GetStringFromObj(value,NULL), flags);
    Tcl_DecrRefCount(value);
  }
...
SWIGINTERN const char *_wrap_iptrvar_set(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2 SWIGUNUSED, int flags) {
  Tcl_Obj *value = 0;
  Tcl_Obj *name1o = 0;
...
SWIGINTERN const char *_wrap_name_get(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2, int flags) {
  Tcl_Obj *value = 0;
  ...
  value = SWIG_FromCharPtrAndSize(name, size);
  if (value) {
    Tcl_SetVar2(interp,name1,name2,Tcl_GetStringFromObj(value,NULL), flags);
    Tcl_DecrRefCount(value);
  }
...
SWIGINTERN const char *_wrap_name_set(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2 SWIGUNUSED, int flags) {
  Tcl_Obj *value = 0;
  Tcl_Obj *name1o = 0;
  ...
  if (!value) SWIG_fail;
  {
    int res = SWIG_AsCharArray(value, name, 256);
    if (!SWIG_IsOK(res)) {
...
SWIGINTERN const char *_wrap_ptptr_get(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2, int flags) {
  Tcl_Obj *value = 0;
  
  value = SWIG_NewPointerObj(SWIG_as_voidptr(ptptr), SWIGTYPE_p_Point,  0 );
  if (value) {
    Tcl_SetVar2(interp,name1,name2,Tcl_GetStringFromObj(value,NULL), flags);
    Tcl_DecrRefCount(value);
  }
...
SWIGINTERN const char *_wrap_ptptr_set(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2 SWIGUNUSED, int flags) {
  Tcl_Obj *value = 0;
  Tcl_Obj *name1o = 0;
  ...
  {
    void *argp = 0;
    int res = SWIG_ConvertPtr(value, &argp, SWIGTYPE_p_Point,  0 );  
    if (!SWIG_IsOK(res)) {
...
SWIGINTERN const char *_wrap_pt_get(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2, int flags) {
  Tcl_Obj *value = 0;
  
  value = SWIG_NewInstanceObj(SWIG_as_voidptr(&pt), SWIGTYPE_p_Point, 0 );
  if (value) {
    Tcl_SetVar2(interp,name1,name2,Tcl_GetStringFromObj(value,NULL), flags);
    Tcl_DecrRefCount(value);
  }
...
SWIGINTERN const char *_wrap_pt_set(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2 SWIGUNUSED, int flags) {
  Tcl_Obj *value = 0;
  Tcl_Obj *name1o = 0;
...
SWIGINTERN const char *_wrap_status_get(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2, int flags) {
  Tcl_Obj *value = 0;
  
  value = SWIG_From_int((int)(status));
  if (value) {
    Tcl_SetVar2(interp,name1,name2,Tcl_GetStringFromObj(value,NULL), flags);
    Tcl_DecrRefCount(value);
  }
...
SWIGINTERN const char *_wrap_path_get(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2, int flags) {
  Tcl_Obj *value = 0;
  ...
  value = SWIG_FromCharPtrAndSize(path, size);
  if (value) {
    Tcl_SetVar2(interp,name1,name2,Tcl_GetStringFromObj(value,NULL), flags);
    Tcl_DecrRefCount(value);
  }
...
SWIGINTERN int
_wrap_print_vars(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  if (SWIG_GetArgs(interp, objc, objv,":print_vars ") == TCL_ERROR) SWIG_fail;
  print_vars();
...
_wrap_new_int(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (SWIG_GetArgs(interp, objc, objv,"o:new_int value ",(void *)0) == TCL_ERROR) SWIG_fail;
...
SWIGINTERN int
_wrap_new_Point(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  int arg1 ;
  int arg2 ;
  int val1 ;
  int ecode1 = 0 ;
  ...
  if (SWIG_GetArgs(interp, objc, objv,"oo:new_Point x y ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  ecode1 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[1], &val1);
  if (!SWIG_IsOK(ecode1)) {
  ...
  Tcl_SetObjResult(interp, SWIG_NewInstanceObj( SWIG_as_voidptr(result), SWIGTYPE_p_Point,0));
  return TCL_OK;
fail:
  return TCL_ERROR;
}
...
SWIGINTERN int
_wrap_Point_print(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Point *arg1 = (Point *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  char *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:Point_print p ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Point, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN int
_wrap_pt_print(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  if (SWIG_GetArgs(interp, objc, objv,":pt_print ") == TCL_ERROR) SWIG_fail;
  pt_print();
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "print_vars", (swig_wrapper_func) _wrap_print_vars, NULL},
    { SWIG_prefix "new_int", (swig_wrapper_func) _wrap_new_int, NULL},
    { SWIG_prefix "new_Point", (swig_wrapper_func) _wrap_new_Point, NULL},
    { SWIG_prefix "Point_print", (swig_wrapper_func) _wrap_Point_print, NULL},
    { SWIG_prefix "pt_print", (swig_wrapper_func) _wrap_pt_print, NULL},
    {0, 0, 0}
};

static swig_var_info swig_variables[] = {
    { SWIG_prefix "ivar", 0, (swig_variable_func) _wrap_ivar_get,(swig_variable_func) _wrap_ivar_set},
    { SWIG_prefix "svar", 0, (swig_variable_func) _wrap_svar_get,(swig_variable_func) _wrap_svar_set},
    { SWIG_prefix "lvar", 0, (swig_variable_func) _wrap_lvar_get,(swig_variable_func) _wrap_lvar_set},
    { SWIG_prefix "uivar", 0, (swig_variable_func) _wrap_uivar_get,(swig_variable_func) _wrap_uivar_set},
    { SWIG_prefix "usvar", 0, (swig_variable_func) _wrap_usvar_get,(swig_variable_func) _wrap_usvar_set},
    { SWIG_prefix "ulvar", 0, (swig_variable_func) _wrap_ulvar_get,(swig_variable_func) _wrap_ulvar_set},
    { SWIG_prefix "scvar", 0, (swig_variable_func) _wrap_scvar_get,(swig_variable_func) _wrap_scvar_set},
    { SWIG_prefix "ucvar", 0, (swig_variable_func) _wrap_ucvar_get,(swig_variable_func) _wrap_ucvar_set},
    { SWIG_prefix "cvar", 0, (swig_variable_func) _wrap_cvar_get,(swig_variable_func) _wrap_cvar_set},
    { SWIG_prefix "fvar", 0, (swig_variable_func) _wrap_fvar_get,(swig_variable_func) _wrap_fvar_set},
    { SWIG_prefix "dvar", 0, (swig_variable_func) _wrap_dvar_get,(swig_variable_func) _wrap_dvar_set},
    { SWIG_prefix "strvar", 0, (swig_variable_func) _wrap_strvar_get,(swig_variable_func) _wrap_strvar_set},
    { SWIG_prefix "cstrvar", 0, (swig_variable_func) _wrap_cstrvar_get,(swig_variable_func) swig_readonly},
    { SWIG_prefix "iptrvar", 0, (swig_variable_func) _wrap_iptrvar_get,(swig_variable_func) _wrap_iptrvar_set},
    { SWIG_prefix "name", 0, (swig_variable_func) _wrap_name_get,(swig_variable_func) _wrap_name_set},
    { SWIG_prefix "ptptr", 0, (swig_variable_func) _wrap_ptptr_get,(swig_variable_func) _wrap_ptptr_set},
    { SWIG_prefix "pt", 0, (swig_variable_func) _wrap_pt_get,(swig_variable_func) _wrap_pt_set},
    { SWIG_prefix "status", 0, (swig_variable_func) _wrap_status_get,(swig_variable_func) swig_readonly},
    { SWIG_prefix "path", 0, (swig_variable_func) _wrap_path_get,(swig_variable_func) swig_readonly},
    {0,0,0,0}
};
