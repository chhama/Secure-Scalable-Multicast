...
#endif
SWIGINTERN int
_wrap_gcd(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  int arg1 ;
  int arg2 ;
  int val1 ;
  int ecode1 = 0 ;
  ...
  if (SWIG_GetArgs(interp, objc, objv,"oo:gcd x y ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
...
SWIGINTERN int
_wrap_gcdmain(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  int arg1 ;
  char **arg2 ;
  int result;
  
  arg2 = 0;
  if (SWIG_GetArgs(interp, objc, objv,"o:gcdmain argc ?argv? ",(void *)0) == TCL_ERROR) SWIG_fail;
  {
    Tcl_Obj **listobjv = 0;
    int i;
    if (Tcl_ListObjGetElements(interp,objv[1], &arg1, &listobjv) == TCL_ERROR) {
      SWIG_exception(SWIG_ValueError,"Expected a list");
      return TCL_ERROR;
    }
    arg2 = (char **) malloc((arg1+1)*sizeof(char *));
    for (i = 0; i < arg1; i++) {
      arg2[i] = Tcl_GetStringFromObj(listobjv[i],0);
    }
    arg2[i] = 0;
  }
...
_wrap_count(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (SWIG_GetArgs(interp, objc, objv,"oo:count bytes len ?c? ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  {
    arg1 = Tcl_GetStringFromObj(objv[1],&arg2);
  }
...
SWIGINTERN int
_wrap_capitalize(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  char *arg1 = (char *) 0 ;
  int arg2 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:capitalize str ?len? ",(void *)0) == TCL_ERROR) SWIG_fail;
  {
    char *temp;
    temp = Tcl_GetStringFromObj(objv[1],&arg2);
    arg1 = (char *) malloc(arg2+1);
    memmove(arg1,temp,arg2);
  }
  capitalize(arg1,arg2);
  
  {
    Tcl_Obj *o;
    o = Tcl_NewStringObj(arg1,arg2);
...
SWIGINTERN int
_wrap_circle(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  double arg1 ;
  double arg2 ;
  double val1 ;
  int ecode1 = 0 ;
  ...
  if (SWIG_GetArgs(interp, objc, objv,"oo:circle cx cy ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "gcd", (swig_wrapper_func) _wrap_gcd, NULL},
    { SWIG_prefix "gcdmain", (swig_wrapper_func) _wrap_gcdmain, NULL},
    { SWIG_prefix "count", (swig_wrapper_func) _wrap_count, NULL},
    { SWIG_prefix "capitalize", (swig_wrapper_func) _wrap_capitalize, NULL},
    { SWIG_prefix "circle", (swig_wrapper_func) _wrap_circle, NULL},
    {0, 0, 0}
};
