...
_wrap_add(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (SWIG_GetArgs(interp, objc, objv,"ooo:add x y result ",(void *)0,(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
...
SWIGINTERN int
_wrap_sub(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  int *arg1 = (int *) 0 ;
  int *arg2 = (int *) 0 ;
  int *arg3 = (int *) 0 ;
  int temp1 ;
  ...
  arg3 = &temp3;
  if (SWIG_GetArgs(interp, objc, objv,"oo:sub INPUT INPUT ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
...
_wrap_divide(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  arg3 = &temp3;
  if (SWIG_GetArgs(interp, objc, objv,"oo:divide n d ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  ecode1 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[1], &val1);
  if (!SWIG_IsOK(ecode1)) {
...
static swig_command_info swig_commands[] = {
    ...
    { SWIG_prefix "sub", (swig_wrapper_func) _wrap_sub, NULL},
