...
SWIGEXPORT int SWIG_init(Tcl_Interp *interp) {
  ...
  SWIG_Tcl_SetConstantObj(interp, "ICONST", SWIG_From_int((int)(42)));
  SWIG_Tcl_SetConstantObj(interp, "FCONST", SWIG_From_double((double)(2.1828)));
  SWIG_Tcl_SetConstantObj(interp, "CCONST", SWIG_From_char((char)('x')));
  SWIG_Tcl_SetConstantObj(interp, "CCONST2", SWIG_From_char((char)('\n')));
  SWIG_Tcl_SetConstantObj(interp, "SCONST", SWIG_FromCharPtr("Hello World"));
  SWIG_Tcl_SetConstantObj(interp, "SCONST2", SWIG_FromCharPtr("\"Hello World\""));
  SWIG_Tcl_SetConstantObj(interp, "EXPR", SWIG_From_double((double)(42+3*(2.1828))));
  SWIG_Tcl_SetConstantObj(interp, "iconst", SWIG_From_int((int)(37)));
  SWIG_Tcl_SetConstantObj(interp, "fconst", SWIG_From_double((double)(3.14)));
  return TCL_OK;
}
