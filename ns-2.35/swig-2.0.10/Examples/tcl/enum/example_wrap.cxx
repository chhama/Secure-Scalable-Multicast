...
SWIGINTERN int
_wrap_Foo_enum_test(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Foo *arg1 = (Foo *) 0 ;
  Foo::speed arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (SWIG_GetArgs(interp, objc, objv,"oo:Foo_enum_test self s ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Foo, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Foo_enum_test" "', argument " "1"" of type '" "Foo *""'"); 
  }
  arg1 = reinterpret_cast< Foo * >(argp1);
  ecode2 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[2], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "Foo_enum_test" "', argument " "2"" of type '" "Foo::speed""'");
  } 
  arg2 = static_cast< Foo::speed >(val2);
  (arg1)->enum_test(arg2);
...
SWIGINTERN int
_wrap_enum_test(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  color arg1 ;
  Foo::speed arg2 ;
  int val1 ;
  int ecode1 = 0 ;
  ...
  if (SWIG_GetArgs(interp, objc, objv,"oo:enum_test c s ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  ecode1 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[1], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "enum_test" "', argument " "1"" of type '" "color""'");
  } 
  arg1 = static_cast< color >(val1);
  ecode2 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[2], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "enum_test" "', argument " "2"" of type '" "Foo::speed""'");
  } 
  arg2 = static_cast< Foo::speed >(val2);
  enum_test(arg1,arg2);
...
static swig_command_info swig_commands[] = {
    ...
    { SWIG_prefix "Foo_enum_test", (swig_wrapper_func) _wrap_Foo_enum_test, NULL},
    ...
    { SWIG_prefix "enum_test", (swig_wrapper_func) _wrap_enum_test, NULL},
    {0, 0, 0}
};
...
SWIGEXPORT int SWIG_init(Tcl_Interp *interp) {
  ...
  SWIG_Tcl_SetConstantObj(interp, "Foo_IMPULSE", SWIG_From_int(static_cast< int >(Foo::IMPULSE)));
  SWIG_Tcl_SetConstantObj(interp, "Foo_WARP", SWIG_From_int(static_cast< int >(Foo::WARP)));
  SWIG_Tcl_SetConstantObj(interp, "Foo_LUDICROUS", SWIG_From_int(static_cast< int >(Foo::LUDICROUS)));
  return TCL_OK;
}
