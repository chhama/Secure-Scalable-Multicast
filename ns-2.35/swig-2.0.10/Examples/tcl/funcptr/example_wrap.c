...
SWIGEXPORT int SWIG_init(Tcl_Interp *interp) {
  ...
  SWIG_Tcl_SetConstantObj(interp, "ADD", SWIG_NewFunctionPtrObj((void *)add, SWIGTYPE_p_f_int_int__int));
  SWIG_Tcl_SetConstantObj(interp, "SUB", SWIG_NewFunctionPtrObj((void *)sub, SWIGTYPE_p_f_int_int__int));
  SWIG_Tcl_SetConstantObj(interp, "MUL", SWIG_NewFunctionPtrObj((void *)mul, SWIGTYPE_p_f_int_int__int));
  return TCL_OK;
}
