...
/* cinit subsection */
SWIG_LONG_CONSTANT(ICONST, 42);
SWIG_DOUBLE_CONSTANT(FCONST, 2.1828);
SWIG_CHAR_CONSTANT(CCONST, 'x');
SWIG_CHAR_CONSTANT(CCONST2, '\n');
SWIG_STRING_CONSTANT(SCONST, "Hello World");
SWIG_STRING_CONSTANT(SCONST2, "\"Hello World\"");
SWIG_DOUBLE_CONSTANT(EXPR, 42+3*(2.1828));
SWIG_LONG_CONSTANT(iconst, 37);
SWIG_DOUBLE_CONSTANT(fconst, 3.14);
