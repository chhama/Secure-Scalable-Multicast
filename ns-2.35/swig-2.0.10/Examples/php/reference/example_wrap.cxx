...
/* end header section */
/* vdecl subsection */
static int le_swig__p_Vector=0; /* handle for Vector */
static int le_swig__p_VectorArray=0; /* handle for VectorArray */
...
ZEND_NAMED_FUNCTION(_wrap_new_Vector) {
  ...
  SWIG_SetPointerZval(return_value, (void *)result, SWIGTYPE_p_Vector, 1);
...
static void __wrap_delete_Vector(zend_rsrc_list_entry *rsrc, const char *type_name TSRMLS_DC) {
  ...
  arg1 = (Vector *)SWIG_ZTS_ConvertResourceData(ptr,type_name,SWIGTYPE_p_Vector TSRMLS_CC);
  if (! arg1) zend_error(E_ERROR, "Vector resource already free'd");
  delete arg1;
  return;
fail:
  SWIG_FAIL();
...
ZEND_NAMED_FUNCTION(_wrap_Vector_as_string) {
  Vector *arg1 = (Vector *) 0 ;
  zval **args[1];
  char *result = 0 ;
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_Vector, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of Vector_as_string. Expected SWIGTYPE_p_Vector");
    }
  }
...
ZEND_NAMED_FUNCTION(_wrap_addv) {
  Vector *arg1 = 0 ;
  Vector *arg2 = 0 ;
  zval **args[2];
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_Vector, 0) < 0 || arg1 == NULL) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of addv. Expected SWIGTYPE_p_Vector");
    }
  }
  {
    if(SWIG_ConvertPtr(*args[1], (void **) &arg2, SWIGTYPE_p_Vector, 0) < 0 || arg2 == NULL) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 2 of addv. Expected SWIGTYPE_p_Vector");
    }
  }
  result = addv(*arg1,*arg2);
  {
    Vector * resultobj = new Vector((const Vector &) result);
    SWIG_SetPointerZval(return_value, (void *)resultobj, SWIGTYPE_p_Vector, 1);
  }
  return;
fail:
  SWIG_FAIL();
...
ZEND_NAMED_FUNCTION(_wrap_new_VectorArray) {
  int arg1 ;
  zval **args[1];
  ...
  SWIG_SetPointerZval(return_value, (void *)result, SWIGTYPE_p_VectorArray, 1);
...
/* This function is designed to be called by the zend list destructors */
/* to typecast and do the actual destruction */
static void __wrap_delete_VectorArray(zend_rsrc_list_entry *rsrc, const char *type_name TSRMLS_DC) {
  swig_object_wrapper *value=(swig_object_wrapper *) rsrc->ptr ;
  void *ptr=value->ptr ;
  int newobject=value->newobject ;
  ...
  efree(value);
  if (! newobject) return; /* can't delete it! */
  arg1 = (VectorArray *)SWIG_ZTS_ConvertResourceData(ptr,type_name,SWIGTYPE_p_VectorArray TSRMLS_CC);
  if (! arg1) zend_error(E_ERROR, "VectorArray resource already free'd");
  delete arg1;
  return;
fail:
  SWIG_FAIL();
...
ZEND_NAMED_FUNCTION(_wrap_VectorArray_size) {
  VectorArray *arg1 = (VectorArray *) 0 ;
  zval **args[1];
  int result;
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_VectorArray, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of VectorArray_size. Expected SWIGTYPE_p_VectorArray");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
...
ZEND_NAMED_FUNCTION(_wrap_VectorArray_get) {
  VectorArray *arg1 = (VectorArray *) 0 ;
  int arg2 ;
  zval **args[2];
  Vector *result = 0 ;
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_VectorArray, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of VectorArray_get. Expected SWIGTYPE_p_VectorArray");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
  ...
  SWIG_SetPointerZval(return_value, (void *)result, SWIGTYPE_p_Vector, 0);
...
ZEND_NAMED_FUNCTION(_wrap_VectorArray_set) {
  VectorArray *arg1 = (VectorArray *) 0 ;
  int arg2 ;
  Vector *arg3 = 0 ;
  zval **args[3];
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_VectorArray, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of VectorArray_set. Expected SWIGTYPE_p_VectorArray");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
  ...
  {
    if(SWIG_ConvertPtr(*args[2], (void **) &arg3, SWIGTYPE_p_Vector, 0) < 0 || arg3 == NULL) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 3 of VectorArray_set. Expected SWIGTYPE_p_Vector");
    }
  }
...
static ZEND_RSRC_DTOR_FUNC(_wrap_destroy_p_Vector) {
  __wrap_delete_Vector(rsrc, SWIGTYPE_p_Vector->name TSRMLS_CC);
}
static ZEND_RSRC_DTOR_FUNC(_wrap_destroy_p_VectorArray) {
  __wrap_delete_VectorArray(rsrc, SWIGTYPE_p_VectorArray->name TSRMLS_CC);
}
/* end wrapper section */
...
static zend_function_entry example_functions[] = {
 SWIG_ZEND_NAMED_FE(new_vector,_wrap_new_Vector,NULL)
 SWIG_ZEND_NAMED_FE(vector_as_string,_wrap_Vector_as_string,NULL)
 SWIG_ZEND_NAMED_FE(addv,_wrap_addv,NULL)
 SWIG_ZEND_NAMED_FE(new_vectorarray,_wrap_new_VectorArray,NULL)
 SWIG_ZEND_NAMED_FE(vectorarray_size,_wrap_VectorArray_size,NULL)
 SWIG_ZEND_NAMED_FE(vectorarray_get,_wrap_VectorArray_get,NULL)
 SWIG_ZEND_NAMED_FE(vectorarray_set,_wrap_VectorArray_set,NULL)
...
le_swig__p_Vector=zend_register_list_destructors_ex(_wrap_destroy_p_Vector,NULL,(char *)(SWIGTYPE_p_Vector->name),module_number);
SWIG_TypeClientData(SWIGTYPE_p_Vector,&le_swig__p_Vector);
le_swig__p_VectorArray=zend_register_list_destructors_ex(_wrap_destroy_p_VectorArray,NULL,(char *)(SWIGTYPE_p_VectorArray->name),module_number);
SWIG_TypeClientData(SWIGTYPE_p_VectorArray,&le_swig__p_VectorArray);
