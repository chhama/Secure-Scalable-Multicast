...
#define SWIGTYPE_p_Sync swig_types[0]
...
static swig_type_info _swigt__p_Sync = {"_p_Sync", "Sync *", 0, 0, (void*)0, 0};
...
/* end header section */
/* vdecl subsection */
static int le_swig__p_Sync=0; /* handle for Sync */
...
ZEND_NAMED_FUNCTION(_wrap_s_set) {
  ...
  
  {
    delete [] s;
    if (arg1) {
      s = (char *) (new char[strlen((const char *)arg1)+1]);
      strcpy((char *)s, (const char *)arg1);
    } else {
      s = 0;
    }
  }
...
ZEND_NAMED_FUNCTION(_wrap_Sync_x_set) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_Sync, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of Sync_x_set. Expected SWIGTYPE_p_Sync");
    }
  }
...
ZEND_NAMED_FUNCTION(_wrap_Sync_x_get) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_Sync, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of Sync_x_get. Expected SWIGTYPE_p_Sync");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
  result = (int) ((arg1)->x);
...
ZEND_NAMED_FUNCTION(_wrap_Sync_s_set) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_Sync, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of Sync_s_set. Expected SWIGTYPE_p_Sync");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
  ...
  
  {
    delete [] arg1->s;
    if (arg2) {
      arg1->s = (char *) (new char[strlen((const char *)arg2)+1]);
...
ZEND_NAMED_FUNCTION(_wrap_Sync_s_get) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_Sync, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of Sync_s_get. Expected SWIGTYPE_p_Sync");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
  result = (char *) ((arg1)->s);
...
ZEND_NAMED_FUNCTION(_wrap_Sync_printer) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_Sync, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of Sync_printer. Expected SWIGTYPE_p_Sync");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
  (arg1)->printer();
...
ZEND_NAMED_FUNCTION(_wrap_new_Sync) {
  ...
  result = (Sync *)new Sync();
  
  SWIG_SetPointerZval(return_value, (void *)result, SWIGTYPE_p_Sync, 1);
...
static void __wrap_delete_Sync(zend_rsrc_list_entry *rsrc, const char *type_name TSRMLS_DC) {
  ...
  arg1 = (Sync *)SWIG_ZTS_ConvertResourceData(ptr,type_name,SWIGTYPE_p_Sync TSRMLS_CC);
  if (! arg1) zend_error(E_ERROR, "Sync resource already free'd");
  delete arg1;
  return;
fail:
  SWIG_FAIL();
...
static ZEND_RSRC_DTOR_FUNC(_wrap_destroy_p_Sync) {
  __wrap_delete_Sync(rsrc, SWIGTYPE_p_Sync->name TSRMLS_CC);
}
/* end wrapper section */
...
static zend_function_entry example_functions[] = {
 ...
 SWIG_ZEND_NAMED_FE(sync_x_set,_wrap_Sync_x_set,NULL)
 SWIG_ZEND_NAMED_FE(sync_x_get,_wrap_Sync_x_get,NULL)
 SWIG_ZEND_NAMED_FE(sync_s_set,_wrap_Sync_s_set,NULL)
 SWIG_ZEND_NAMED_FE(sync_s_get,_wrap_Sync_s_get,NULL)
 SWIG_ZEND_NAMED_FE(sync_printer,_wrap_Sync_printer,NULL)
 SWIG_ZEND_NAMED_FE(new_sync,_wrap_new_Sync,NULL)
...
le_swig__p_Sync=zend_register_list_destructors_ex(_wrap_destroy_p_Sync,NULL,(char *)(SWIGTYPE_p_Sync->name),module_number);
SWIG_TypeClientData(SWIGTYPE_p_Sync,&le_swig__p_Sync);
...
/* vinit subsection */
{
  ...
  if(s) {
      ...
      z_var->value.str.len = strlen(s);
  } else {
      z_var->value.str.val = 0;
      z_var->value.str.len = 0;
  }
  zend_hash_add(&EG(symbol_table), (char*)"s", sizeof("s"), (void *)&z_var, sizeof(zval *), NULL);
}
{
  zval *z_var;
  MAKE_STD_ZVAL(z_var);
