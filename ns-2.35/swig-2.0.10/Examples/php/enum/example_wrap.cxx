...
ZEND_NAMED_FUNCTION(_wrap_Foo_enum_test) {
  Foo *arg1 = (Foo *) 0 ;
  Foo::speed arg2 ;
  zval **args[2];
  ...
  
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_Foo, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of Foo_enum_test. Expected SWIGTYPE_p_Foo");
    }
  }
  ...
  arg2 = (Foo::speed) Z_LVAL_PP(args[1]);
  /*@SWIG@*/;
...
ZEND_NAMED_FUNCTION(_wrap_enum_test) {
  color arg1 ;
  Foo::speed arg2 ;
  zval **args[2];
...
static zend_function_entry example_functions[] = {
 ...
 SWIG_ZEND_NAMED_FE(foo_enum_test,_wrap_Foo_enum_test,NULL)
 SWIG_ZEND_NAMED_FE(enum_test,_wrap_enum_test,NULL)
...
SWIG_LONG_CONSTANT(Foo_IMPULSE, Foo::IMPULSE);
SWIG_LONG_CONSTANT(Foo_WARP, Foo::WARP);
SWIG_LONG_CONSTANT(Foo_LUDICROUS, Foo::LUDICROUS);
