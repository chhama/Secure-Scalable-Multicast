...
public class Sin extends ArithUnaryFunction_double_double {
  ...
  protected Sin(long cPtr, boolean cMemoryOwn) {
    super(template_typedef_importJNI.Sin_SWIGUpcast(cPtr), cMemoryOwn);
    swigCPtr = cPtr;
  }
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        template_typedef_importJNI.delete_Sin(swigCPtr);
      }
      swigCPtr = 0;
    }
    super.delete();
  ...
  public Sin() {
    this(template_typedef_importJNI.new_Sin(), true);
  }
