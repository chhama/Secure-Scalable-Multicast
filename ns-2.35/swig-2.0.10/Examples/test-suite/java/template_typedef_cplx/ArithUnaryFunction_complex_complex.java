...
public class ArithUnaryFunction_complex_complex extends UnaryFunction_complex_complex {
  ...
  protected ArithUnaryFunction_complex_complex(long cPtr, boolean cMemoryOwn) {
    super(template_typedef_cplxJNI.ArithUnaryFunction_complex_complex_SWIGUpcast(cPtr), cMemoryOwn);
    swigCPtr = cPtr;
  }
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        template_typedef_cplxJNI.delete_ArithUnaryFunction_complex_complex(swigCPtr);
      }
      swigCPtr = 0;
    }
    super.delete();
  ...
  public ArithUnaryFunction_complex_complex() {
    this(template_typedef_cplxJNI.new_ArithUnaryFunction_complex_complex(), true);
  }
