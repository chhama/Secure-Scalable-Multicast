...
/*-----------------------------------------------
              @(target):= _typemap_delete.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__typemap_delete

#else
#  define SWIG_init    init_typemap_delete

#endif
#define SWIG_name    "_typemap_delete"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_Rect_val_set(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:Rect_val_set",&obj0,&obj1)) SWIG_fail;
...
SWIGINTERN PyObject *_wrap_Rect_val_get(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  Rect *arg1 = (Rect *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:Rect_val_get",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_Rect, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"Rect_val_set", _wrap_Rect_val_set, METH_VARARGS, NULL},
	 { (char *)"Rect_val_get", _wrap_Rect_val_get, METH_VARARGS, NULL},
