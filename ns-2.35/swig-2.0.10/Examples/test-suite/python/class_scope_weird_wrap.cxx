...
/*-----------------------------------------------
              @(target):= _class_scope_weird.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__class_scope_weird

#else
#  define SWIG_init    init_class_scope_weird

#endif
#define SWIG_name    "_class_scope_weird"
...
SWIGINTERN PyObject *_wrap_new_Quat__SWIG_2(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  res1 = SWIG_ConvertPtr(obj0, &argp1, SWIGTYPE_p_tacka3,  0  | 0);
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_new_Quat(PyObject *self, PyObject *args) {
  ...
  if (argc == 1) {
    int _v;
    int res = SWIG_ConvertPtr(argv[0], 0, SWIGTYPE_p_matrix4, 0);
    _v = SWIG_CheckState(res);
    if (_v) {
  ...
  if (argc == 2) {
    int _v;
    int res = SWIG_ConvertPtr(argv[0], 0, SWIGTYPE_p_tacka3, 0);
    _v = SWIG_CheckState(res);
    if (_v) {
      {
...
fail:
  SWIG_SetErrorMsg(PyExc_NotImplementedError,"Wrong number or type of arguments for overloaded function 'new_Quat'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    Quat::Quat()\n"
