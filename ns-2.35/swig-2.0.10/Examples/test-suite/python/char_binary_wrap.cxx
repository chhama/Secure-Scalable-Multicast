...
/*-----------------------------------------------
              @(target):= _char_binary.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__char_binary

#else
#  define SWIG_init    init_char_binary

#endif
#define SWIG_name    "_char_binary"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_Test_strlen(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:Test_strlen",&obj0,&obj1)) SWIG_fail;
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"Test_strlen", _wrap_Test_strlen, METH_VARARGS, NULL},
