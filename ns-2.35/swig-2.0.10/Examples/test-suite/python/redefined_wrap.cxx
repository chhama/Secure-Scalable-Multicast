...
/*-----------------------------------------------
              @(target):= _redefined.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__redefined

#else
#  define SWIG_init    init_redefined

#endif
#define SWIG_name    "_redefined"
...
# endif
  ...
  SWIG_Python_SetConstant(d, "agua",SWIG_From_int(static_cast< int >(0)));
  SWIG_Python_SetConstant(d, "REDUNDANT",SWIG_From_int(static_cast< int >(1)));
#if PY_VERSION_HEX >= 0x03000000
  return m;
#else
  return;
