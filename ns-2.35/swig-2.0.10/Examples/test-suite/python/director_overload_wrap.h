...
public:
    SwigDirector_OverloadedClass(PyObject *self);
...
/* VTable implementation */
    PyObject *swig_get_method(size_t method_index, const char *method_name) const {
      ...
      if (!method) {
        ...
        if (!method) {
          std::string msg = "Method in class OverloadedClass doesn't exist, undefined ";
          msg += method_name;
...
public:
    SwigDirector_OverloadedPointers(PyObject *self);
...
/* VTable implementation */
    PyObject *swig_get_method(size_t method_index, const char *method_name) const {
      ...
      if (!method) {
        ...
        method = PyObject_GetAttr(swig_get_self(), name);
        if (!method) {
          std::string msg = "Method in class OverloadedPointers doesn't exist, undefined ";
          msg += method_name;
          Swig::DirectorMethodException::raise(msg.c_str());
        }
        vtable[method_index] = method;
