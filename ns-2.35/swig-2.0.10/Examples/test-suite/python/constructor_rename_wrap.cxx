...
/*-----------------------------------------------
              @(target):= _constructor_rename.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__constructor_rename

#else
#  define SWIG_init    init_constructor_rename

#endif
#define SWIG_name    "_constructor_rename"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_new_RenamedConstructor(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  Foo *result = 0 ;
  
  if (!PyArg_ParseTuple(args,(char *)":new_RenamedConstructor")) SWIG_fail;
  result = (Foo *)new Foo();
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"new_RenamedConstructor", _wrap_new_RenamedConstructor, METH_VARARGS, NULL},
