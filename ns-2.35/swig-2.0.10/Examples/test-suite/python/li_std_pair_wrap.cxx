...
#define SWIGTYPE_p_std__pairT_int_int_t swig_types[3]
...
/*-----------------------------------------------
              @(target):= _li_std_pair.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__li_std_pair

#else
#  define SWIG_init    init_li_std_pair

#endif
#define SWIG_name    "_li_std_pair"
...
SWIGINTERN PyObject *_wrap_product3(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::pair< int,int > *arg1 = (std::pair< int,int > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:product3",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_std__pairT_int_int_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"product3", _wrap_product3, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
