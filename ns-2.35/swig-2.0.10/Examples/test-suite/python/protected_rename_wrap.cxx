...
/*-----------------------------------------------
              @(target):= _protected_rename.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__protected_rename

#else
#  define SWIG_init    init_protected_rename

#endif
#define SWIG_name    "_protected_rename"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_Foo_x(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:Foo_x",&obj0)) SWIG_fail;
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"Foo_x", _wrap_Foo_x, METH_VARARGS, NULL},
