...
/*-----------------------------------------------
              @(target):= _director_keywords.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__director_keywords

#else
#  define SWIG_init    init_director_keywords

#endif
#define SWIG_name    "_director_keywords"
...
void SwigDirector_Foo::bar(int abstract) {
  ...
  obj0 = SWIG_From_int(static_cast< int >(abstract));
  if (!swig_get_self()) {
