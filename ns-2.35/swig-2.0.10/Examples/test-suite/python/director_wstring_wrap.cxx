...
#define SWIGTYPE_p_std__allocatorT_std__wstring_t swig_types[6]
#define SWIGTYPE_p_std__invalid_argument swig_types[7]
#define SWIGTYPE_p_std__vectorT__Tp__Alloc_t swig_types[8]
#define SWIGTYPE_p_std__vectorT_std__wstring_std__allocatorT_std__wstring_t_t swig_types[9]
...
/*-----------------------------------------------
              @(target):= _director_wstring.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__director_wstring

#else
#  define SWIG_init    init_director_wstring

#endif
#define SWIG_name    "_director_wstring"
...
SWIGINTERN void std_vector_Sl_std_wstring_Sg____setslice____SWIG_0(std::vector< std::wstring > *self,std::vector< std::wstring >::difference_type i,std::vector< std::wstring >::difference_type j,std::vector< std::wstring,std::allocator< std::wstring > > const &v=std::vector< std::wstring,std::allocator< std::wstring > >()){
...
#include "director_wstring_wrap.h"

SwigDirector_A::SwigDirector_A(PyObject *self, std::wstring const &first): A(first), Swig::Director(self) {
...
std::wstring const &SwigDirector_A::get_first() const {
  ...
  const char * const swig_method_name = "get_first";
  PyObject* method = swig_get_method(swig_method_index, swig_method_name);
  swig::SwigVar_PyObject result = PyObject_CallFunction(method, NULL, NULL);
#else
  swig::SwigVar_PyObject result = PyObject_CallMethod(swig_get_self(), (char *) "get_first", NULL);
#endif
  if (!result) {
    PyObject *error = PyErr_Occurred();
    if (error) {
      Swig::DirectorMethodException::raise("Error detected when calling 'A.get_first'");
    }
  }
  std::wstring *swig_optr = 0;
  int swig_ores = SWIG_AsPtr_std_wstring(result, &swig_optr);
  if (!SWIG_IsOK(swig_ores)) {
    Swig::DirectorTypeMismatchException::raise(SWIG_ErrorType(SWIG_ArgError(swig_ores)), "in output value of type '""std::wstring const &""'");
  } else {
    if (!swig_optr) {
      Swig::DirectorTypeMismatchException::raise(SWIG_ErrorType(SWIG_ValueError), "invalid null reference " "in output value of type '""std::wstring const &""'");
    } 
  }    
  c_result = swig_optr;
  ...
  return (std::wstring const &) *c_result;
}


std::wstring const &SwigDirector_A::get(int n) const {
  std::wstring *c_result;
...
#else
  swig::SwigVar_PyObject result = PyObject_CallMethod(swig_get_self(), (char *)"get", (char *)"(O)" ,(PyObject *)obj0);
#endif
  if (!result) {
    PyObject *error = PyErr_Occurred();
    if (error) {
      Swig::DirectorMethodException::raise("Error detected when calling 'A.get'");
    }
  }
  std::wstring *swig_optr = 0;
  int swig_ores = SWIG_AsPtr_std_wstring(result, &swig_optr);
...
std::wstring const &SwigDirector_A::call_get_first() const {
  std::wstring *c_result;
  if (!swig_get_self()) {
    Swig::DirectorException::raise("'self' uninitialized, maybe you forgot to call A.__init__.");
  }
  ...
  const char * const swig_method_name = "call_get_first";
  PyObject* method = swig_get_method(swig_method_index, swig_method_name);
  swig::SwigVar_PyObject result = PyObject_CallFunction(method, NULL, NULL);
#else
  swig::SwigVar_PyObject result = PyObject_CallMethod(swig_get_self(), (char *) "call_get_first", NULL);
#endif
  if (!result) {
    PyObject *error = PyErr_Occurred();
    if (error) {
      Swig::DirectorMethodException::raise("Error detected when calling 'A.call_get_first'");
    }
  }
  std::wstring *swig_optr = 0;
  int swig_ores = SWIG_AsPtr_std_wstring(result, &swig_optr);
...
std::wstring const &SwigDirector_A::call_get(int n) const {
  std::wstring *c_result;
  swig::SwigVar_PyObject obj0;
  obj0 = SWIG_From_int(static_cast< int >(n));
  if (!swig_get_self()) {
  ...
  const char * const swig_method_name = "call_get";
  PyObject* method = swig_get_method(swig_method_index, swig_method_name);
  swig::SwigVar_PyObject result = PyObject_CallFunction(method, (char *)"(O)" ,(PyObject *)obj0);
#else
  swig::SwigVar_PyObject result = PyObject_CallMethod(swig_get_self(), (char *)"call_get", (char *)"(O)" ,(PyObject *)obj0);
#endif
  if (!result) {
    PyObject *error = PyErr_Occurred();
    if (error) {
      Swig::DirectorMethodException::raise("Error detected when calling 'A.call_get'");
    }
  }
  std::wstring *swig_optr = 0;
  int swig_ores = SWIG_AsPtr_std_wstring(result, &swig_optr);
...
void SwigDirector_A::process_text(wchar_t const *text) {
  swig::SwigVar_PyObject obj0;
  obj0 = SWIG_FromWCharPtr((const wchar_t *)text);
  if (!swig_get_self()) {
    Swig::DirectorException::raise("'self' uninitialized, maybe you forgot to call A.__init__.");
  }
#if defined(SWIG_PYTHON_DIRECTOR_VTABLE)
  const size_t swig_method_index = 4;
  const char * const swig_method_name = "process_text";
  PyObject* method = swig_get_method(swig_method_index, swig_method_name);
  swig::SwigVar_PyObject result = PyObject_CallFunction(method, (char *)"(O)" ,(PyObject *)obj0);
#else
  swig::SwigVar_PyObject result = PyObject_CallMethod(swig_get_self(), (char *)"process_text", (char *)"(O)" ,(PyObject *)obj0);
#endif
  if (!result) {
    PyObject *error = PyErr_Occurred();
    if (error) {
      Swig::DirectorMethodException::raise("Error detected when calling 'A.process_text'");
    }
  }
}


std::wstring SwigDirector_A::multiple_params_val(std::wstring const &p1, std::wstring const &p2, std::wstring p3, std::wstring p4) const {
  std::wstring c_result;
  swig::SwigVar_PyObject obj0;
  obj0 = SWIG_From_std_wstring(static_cast< std::wstring >(p1));
  swig::SwigVar_PyObject obj1;
  obj1 = SWIG_From_std_wstring(static_cast< std::wstring >(p2));
  swig::SwigVar_PyObject obj2;
  obj2 = SWIG_From_std_wstring(static_cast< std::wstring >(p3));
  swig::SwigVar_PyObject obj3;
  obj3 = SWIG_From_std_wstring(static_cast< std::wstring >(p4));
  if (!swig_get_self()) {
    Swig::DirectorException::raise("'self' uninitialized, maybe you forgot to call A.__init__.");
  }
#if defined(SWIG_PYTHON_DIRECTOR_VTABLE)
  const size_t swig_method_index = 5;
  const char * const swig_method_name = "multiple_params_val";
  PyObject* method = swig_get_method(swig_method_index, swig_method_name);
...
#else
  swig::SwigVar_PyObject result = PyObject_CallMethod(swig_get_self(), (char *)"multiple_params_val", (char *)"(OOOO)" ,(PyObject *)obj0,(PyObject *)obj1,(PyObject *)obj2,(PyObject *)obj3);
#endif
  if (!result) {
    PyObject *error = PyErr_Occurred();
    if (error) {
      Swig::DirectorMethodException::raise("Error detected when calling 'A.multiple_params_val'");
    }
  }
  std::wstring *swig_optr = 0;
  int swig_ores = SWIG_AsPtr_std_wstring(result, &swig_optr);
  if (!SWIG_IsOK(swig_ores) || !swig_optr) {
    Swig::DirectorTypeMismatchException::raise(SWIG_ErrorType(SWIG_ArgError((swig_optr ? swig_ores : SWIG_TypeError))), "in output value of type '""std::wstring""'");
  }
  c_result = *swig_optr;
...
std::wstring const &SwigDirector_A::multiple_params_ref(std::wstring const &p1, std::wstring const &p2, std::wstring p3, std::wstring p4) const {
  std::wstring *c_result;
  swig::SwigVar_PyObject obj0;
  obj0 = SWIG_From_std_wstring(static_cast< std::wstring >(p1));
  swig::SwigVar_PyObject obj1;
  ...
  const char * const swig_method_name = "multiple_params_ref";
  PyObject* method = swig_get_method(swig_method_index, swig_method_name);
  swig::SwigVar_PyObject result = PyObject_CallFunction(method, (char *)"(OOOO)" ,(PyObject *)obj0,(PyObject *)obj1,(PyObject *)obj2,(PyObject *)obj3);
#else
  swig::SwigVar_PyObject result = PyObject_CallMethod(swig_get_self(), (char *)"multiple_params_ref", (char *)"(OOOO)" ,(PyObject *)obj0,(PyObject *)obj1,(PyObject *)obj2,(PyObject *)obj3);
#endif
  if (!result) {
    PyObject *error = PyErr_Occurred();
    if (error) {
      Swig::DirectorMethodException::raise("Error detected when calling 'A.multiple_params_ref'");
    }
  }
  std::wstring *swig_optr = 0;
  int swig_ores = SWIG_AsPtr_std_wstring(result, &swig_optr);
...
SWIGINTERN PyObject *_wrap_new_A(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  arg1 = obj0;
  {
    ...
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "new_A" "', argument " "2"" of type '" "std::wstring const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "new_A" "', argument " "2"" of type '" "std::wstring const &""'"); 
    }
    arg2 = ptr;
  }
  if ( arg1 != Py_None ) {
    /* subclassed */
    result = (A *)new SwigDirector_A(arg1,(std::wstring const &)*arg2); 
  } else {
    result = (A *)new A((std::wstring const &)*arg2); 
  }
...
SWIGINTERN PyObject *_wrap_A_get_first(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  A *arg1 = (A *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:A_get_first",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_A, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "A_get_first" "', argument " "1"" of type '" "A const *""'"); 
  }
  arg1 = reinterpret_cast< A * >(argp1);
  ...
  try {
    if (upcall) {
      result = (std::wstring *) &((A const *)arg1)->A::get_first();
    } else {
      result = (std::wstring *) &((A const *)arg1)->get_first();
    }
...
SWIGINTERN PyObject *_wrap_A_get(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:A_get",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_A, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
  ...
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "A_get" "', argument " "2"" of type '" "int""'");
  } 
  ...
  try {
    if (upcall) {
      result = (std::wstring *) &((A const *)arg1)->A::get(arg2);
    } else {
      result = (std::wstring *) &((A const *)arg1)->get(arg2);
    }
  } catch (Swig::DirectorException&) {
    SWIG_fail;
  }
...
SWIGINTERN PyObject *_wrap_A_call_get_first(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  A *arg1 = (A *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:A_call_get_first",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_A, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "A_call_get_first" "', argument " "1"" of type '" "A const *""'"); 
  }
  arg1 = reinterpret_cast< A * >(argp1);
  director = SWIG_DIRECTOR_CAST(arg1);
  upcall = (director && (director->swig_get_self()==obj0));
  try {
    if (upcall) {
      result = (std::wstring *) &((A const *)arg1)->A::call_get_first();
    } else {
      result = (std::wstring *) &((A const *)arg1)->call_get_first();
    }
  } catch (Swig::DirectorException&) {
    SWIG_fail;
  }
...
SWIGINTERN PyObject *_wrap_A_call_get(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  A *arg1 = (A *) 0 ;
  int arg2 ;
  void *argp1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:A_call_get",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_A, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "A_call_get" "', argument " "1"" of type '" "A const *""'"); 
  }
  arg1 = reinterpret_cast< A * >(argp1);
  ecode2 = SWIG_AsVal_int(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "A_call_get" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = static_cast< int >(val2);
  director = SWIG_DIRECTOR_CAST(arg1);
  upcall = (director && (director->swig_get_self()==obj0));
  try {
    if (upcall) {
      result = (std::wstring *) &((A const *)arg1)->A::call_get(arg2);
    } else {
      result = (std::wstring *) &((A const *)arg1)->call_get(arg2);
    }
  } catch (Swig::DirectorException&) {
    SWIG_fail;
  }
...
SWIGINTERN PyObject *_wrap_A_m_strings_set(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  A *arg1 = (A *) 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:A_m_strings_set",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_A, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "A_m_strings_set" "', argument " "1"" of type '" "A *""'"); 
  }
  arg1 = reinterpret_cast< A * >(argp1);
  res2 = SWIG_ConvertPtr(obj1, &argp2,SWIGTYPE_p_std__vectorT_std__wstring_std__allocatorT_std__wstring_t_t, 0 |  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "A_m_strings_set" "', argument " "2"" of type '" "std::vector< std::wstring,std::allocator< std::wstring > > *""'"); 
  }
...
SWIGINTERN PyObject *_wrap_A_m_strings_get(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  A *arg1 = (A *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:A_m_strings_get",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_A, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "A_m_strings_get" "', argument " "1"" of type '" "A *""'"); 
  }
  arg1 = reinterpret_cast< A * >(argp1);
  result = (std::vector< std::wstring,std::allocator< std::wstring > > *)& ((arg1)->m_strings);
...
SWIGINTERN PyObject *_wrap_A_process_text(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  A *arg1 = (A *) 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:A_process_text",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_A, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "A_process_text" "', argument " "1"" of type '" "A *""'"); 
  }
  arg1 = reinterpret_cast< A * >(argp1);
  res2 = SWIG_AsWCharPtrAndSize(obj1, &buf2, NULL, &alloc2);
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "A_process_text" "', argument " "2"" of type '" "wchar_t const *""'");
  }
  ...
  try {
    if (upcall) {
      (arg1)->A::process_text((wchar_t const *)arg2);
    } else {
      (arg1)->process_text((wchar_t const *)arg2);
    }
  } catch (Swig::DirectorException&) {
    SWIG_fail;
  }
...
SWIGINTERN PyObject *_wrap_A_multiple_params_val(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  A *arg1 = (A *) 0 ;
  std::wstring *arg2 = 0 ;
  std::wstring *arg3 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOOOO:A_multiple_params_val",&obj0,&obj1,&obj2,&obj3,&obj4)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_A, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "A_multiple_params_val" "', argument " "1"" of type '" "A const *""'"); 
  }
  arg1 = reinterpret_cast< A * >(argp1);
  {
    std::wstring *ptr = (std::wstring *)0;
    res2 = SWIG_AsPtr_std_wstring(obj1, &ptr);
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "A_multiple_params_val" "', argument " "2"" of type '" "std::wstring const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "A_multiple_params_val" "', argument " "2"" of type '" "std::wstring const &""'"); 
    }
    arg2 = ptr;
  }
  {
    ...
    if (!SWIG_IsOK(res3)) {
      SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "A_multiple_params_val" "', argument " "3"" of type '" "std::wstring const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "A_multiple_params_val" "', argument " "3"" of type '" "std::wstring const &""'"); 
    }
    arg3 = ptr;
  }
  {
    std::wstring *ptr = (std::wstring *)0;
    int res = SWIG_AsPtr_std_wstring(obj3, &ptr);
    if (!SWIG_IsOK(res) || !ptr) {
      SWIG_exception_fail(SWIG_ArgError((ptr ? res : SWIG_TypeError)), "in method '" "A_multiple_params_val" "', argument " "4"" of type '" "std::wstring""'"); 
    }
    arg4 = *ptr;
  ...
  {
    std::wstring *ptr = (std::wstring *)0;
    int res = SWIG_AsPtr_std_wstring(obj4, &ptr);
    if (!SWIG_IsOK(res) || !ptr) {
      SWIG_exception_fail(SWIG_ArgError((ptr ? res : SWIG_TypeError)), "in method '" "A_multiple_params_val" "', argument " "5"" of type '" "std::wstring""'"); 
    }
    arg5 = *ptr;
    if (SWIG_IsNewObj(res)) delete ptr;
  }
  ...
  try {
    if (upcall) {
      result = ((A const *)arg1)->A::multiple_params_val((std::wstring const &)*arg2,(std::wstring const &)*arg3,arg4,arg5);
    } else {
      result = ((A const *)arg1)->multiple_params_val((std::wstring const &)*arg2,(std::wstring const &)*arg3,arg4,arg5);
    }
  } catch (Swig::DirectorException&) {
    SWIG_fail;
  }
...
SWIGINTERN PyObject *_wrap_A_multiple_params_ref(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  A *arg1 = (A *) 0 ;
  std::wstring *arg2 = 0 ;
  std::wstring *arg3 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOOOO:A_multiple_params_ref",&obj0,&obj1,&obj2,&obj3,&obj4)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_A, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "A_multiple_params_ref" "', argument " "1"" of type '" "A const *""'"); 
  }
  arg1 = reinterpret_cast< A * >(argp1);
  {
    std::wstring *ptr = (std::wstring *)0;
    res2 = SWIG_AsPtr_std_wstring(obj1, &ptr);
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "A_multiple_params_ref" "', argument " "2"" of type '" "std::wstring const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "A_multiple_params_ref" "', argument " "2"" of type '" "std::wstring const &""'"); 
    }
    arg2 = ptr;
  }
  {
    ...
    res3 = SWIG_AsPtr_std_wstring(obj2, &ptr);
    if (!SWIG_IsOK(res3)) {
      SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "A_multiple_params_ref" "', argument " "3"" of type '" "std::wstring const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "A_multiple_params_ref" "', argument " "3"" of type '" "std::wstring const &""'"); 
    }
    arg3 = ptr;
  }
  {
    ...
    int res = SWIG_AsPtr_std_wstring(obj3, &ptr);
    if (!SWIG_IsOK(res) || !ptr) {
      SWIG_exception_fail(SWIG_ArgError((ptr ? res : SWIG_TypeError)), "in method '" "A_multiple_params_ref" "', argument " "4"" of type '" "std::wstring""'"); 
    }
    arg4 = *ptr;
    if (SWIG_IsNewObj(res)) delete ptr;
  }
  {
    ...
    int res = SWIG_AsPtr_std_wstring(obj4, &ptr);
    if (!SWIG_IsOK(res) || !ptr) {
      SWIG_exception_fail(SWIG_ArgError((ptr ? res : SWIG_TypeError)), "in method '" "A_multiple_params_ref" "', argument " "5"" of type '" "std::wstring""'"); 
    }
    arg5 = *ptr;
    if (SWIG_IsNewObj(res)) delete ptr;
  }
  ...
  try {
    if (upcall) {
      result = (std::wstring *) &((A const *)arg1)->A::multiple_params_ref((std::wstring const &)*arg2,(std::wstring const &)*arg3,arg4,arg5);
    } else {
      result = (std::wstring *) &((A const *)arg1)->multiple_params_ref((std::wstring const &)*arg2,(std::wstring const &)*arg3,arg4,arg5);
    }
  } catch (Swig::DirectorException&) {
    SWIG_fail;
  }
...
SWIGINTERN PyObject *_wrap_A_call_process_func(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  A *arg1 = (A *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:A_call_process_func",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_A, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "A_call_process_func" "', argument " "1"" of type '" "A *""'"); 
  }
  arg1 = reinterpret_cast< A * >(argp1);
...
SWIGINTERN PyObject *_wrap_StringVector___setslice____SWIG_0(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  try {
    std_vector_Sl_std_wstring_Sg____setslice____SWIG_0(arg1,arg2,arg3,(std::vector< std::wstring,std::allocator< std::wstring > > const &)*arg4);
  }
  catch(std::out_of_range &_e) {
    SWIG_exception_fail(SWIG_IndexError, (&_e)->what());
  }
...
SWIGINTERN PyObject *_wrap_StringVector_insert__SWIG_0(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  result = (arg1)->insert(arg2,(std::vector< std::wstring >::value_type const &)*arg3);
  resultobj = SWIG_NewPointerObj(swig::make_output_iterator(static_cast< const std::vector< std::wstring >::iterator & >(result)),
    swig::SwigPyIterator::descriptor(),SWIG_POINTER_OWN);
  if (SWIG_IsNewObj(res3)) delete arg3;
  return resultobj;
...
SWIGINTERN PyObject *_wrap_StringVector_insert__SWIG_1(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  (arg1)->insert(arg2,arg3,(std::vector< std::wstring >::value_type const &)*arg4);
  resultobj = SWIG_Py_Void();
  if (SWIG_IsNewObj(res4)) delete arg4;
  return resultobj;
fail:
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"A_get_first", _wrap_A_get_first, METH_VARARGS, NULL},
	 { (char *)"A_get", _wrap_A_get, METH_VARARGS, NULL},
	 { (char *)"A_call_get_first", _wrap_A_call_get_first, METH_VARARGS, NULL},
	 { (char *)"A_call_get", _wrap_A_call_get, METH_VARARGS, NULL},
	 { (char *)"A_m_strings_set", _wrap_A_m_strings_set, METH_VARARGS, NULL},
	 { (char *)"A_m_strings_get", _wrap_A_m_strings_get, METH_VARARGS, NULL},
	 { (char *)"A_process_text", _wrap_A_process_text, METH_VARARGS, NULL},
	 { (char *)"A_multiple_params_val", _wrap_A_multiple_params_val, METH_VARARGS, NULL},
	 { (char *)"A_multiple_params_ref", _wrap_A_multiple_params_ref, METH_VARARGS, NULL},
	 { (char *)"A_call_process_func", _wrap_A_call_process_func, METH_VARARGS, NULL},
