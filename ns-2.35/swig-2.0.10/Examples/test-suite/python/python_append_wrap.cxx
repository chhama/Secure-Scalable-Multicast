...
/*-----------------------------------------------
              @(target):= _python_append.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__python_append

#else
#  define SWIG_init    init_python_append

#endif
#define SWIG_name    "_python_append"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_Test_static_func(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  
  if (!PyArg_ParseTuple(args,(char *)":Test_static_func")) SWIG_fail;
  Test::static_func();
...
SWIGINTERN PyObject *_wrap_Test_func(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:Test_func",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_Test, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Test_func" "', argument " "1"" of type '" "Test *""'"); 
  }
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"Test_static_func", _wrap_Test_static_func, METH_VARARGS, NULL},
