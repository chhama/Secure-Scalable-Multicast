...
/*-----------------------------------------------
              @(target):= _template_typedef_cplx5.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__template_typedef_cplx5

#else
#  define SWIG_init    init_template_typedef_cplx5

#endif
#define SWIG_name    "_template_typedef_cplx5"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_A_test1(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:A_test1",&obj0)) SWIG_fail;
  ...
  result = (arg1)->test1();
  resultobj = SWIG_NewPointerObj((new complex(static_cast< const complex& >(result))), SWIGTYPE_p_std__complexT_double_t, SWIG_POINTER_OWN |  0 );
  return resultobj;
fail:
  return NULL;
}
...
SWIGINTERN PyObject *_wrap_A_test2(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  A *arg1 = (A *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:A_test2",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_A, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"A_test1", _wrap_A_test1, METH_VARARGS, NULL},
	 { (char *)"A_test2", _wrap_A_test2, METH_VARARGS, NULL},
