...
/*-----------------------------------------------
              @(target):= _null_pointer.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__null_pointer

#else
#  define SWIG_init    init_null_pointer

#endif
#define SWIG_name    "_null_pointer"
...
SWIGINTERN PyObject *_wrap_getnull(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  A *result = 0 ;
  
  if (!PyArg_ParseTuple(args,(char *)":getnull")) SWIG_fail;
  result = (A *)getnull();
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"getnull", _wrap_getnull, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
