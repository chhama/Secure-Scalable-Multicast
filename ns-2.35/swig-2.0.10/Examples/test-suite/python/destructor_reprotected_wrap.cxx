...
/*-----------------------------------------------
              @(target):= _destructor_reprotected.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__destructor_reprotected

#else
#  define SWIG_init    init_destructor_reprotected

#endif
#define SWIG_name    "_destructor_reprotected"
