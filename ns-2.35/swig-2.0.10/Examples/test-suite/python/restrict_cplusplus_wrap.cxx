...
/*-----------------------------------------------
              @(target):= _restrict_cplusplus.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__restrict_cplusplus

#else
#  define SWIG_init    init_restrict_cplusplus

#endif
#define SWIG_name    "_restrict_cplusplus"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_Foo_restrict_set(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:Foo_restrict_set",&obj0,&obj1)) SWIG_fail;
...
SWIGINTERN PyObject *_wrap_Foo_restrict_get(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  Foo *arg1 = (Foo *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:Foo_restrict_get",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_Foo, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"Foo_restrict_set", _wrap_Foo_restrict_set, METH_VARARGS, NULL},
	 { (char *)"Foo_restrict_get", _wrap_Foo_restrict_get, METH_VARARGS, NULL},
