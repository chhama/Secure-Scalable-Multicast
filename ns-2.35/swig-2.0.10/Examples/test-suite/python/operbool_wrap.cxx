...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__operbool

#else
#  define SWIG_init    init_operbool

#endif
#define SWIG_name    "_operbool"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_Test___nonzero__(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:Test___nonzero__",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_Test, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Test___nonzero__" "', argument " "1"" of type '" "Test *""'"); 
  }
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"Test___nonzero__", _wrap_Test___nonzero__, METH_VARARGS, NULL},
