...
/*-----------------------------------------------
              @(target):= _typedef_reference.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__typedef_reference

#else
#  define SWIG_init    init_typedef_reference

#endif
#define SWIG_name    "_typedef_reference"
...
SWIGINTERN PyObject *_wrap_somefunc(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  int *arg1 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:somefunc",&obj0)) SWIG_fail;
...
SWIGINTERN PyObject *_wrap_otherfunc(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  int *arg1 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:otherfunc",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1, SWIGTYPE_p_int,  0 );
  if (!SWIG_IsOK(res1)) {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"somefunc", _wrap_somefunc, METH_VARARGS, NULL},
	 { (char *)"otherfunc", _wrap_otherfunc, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
