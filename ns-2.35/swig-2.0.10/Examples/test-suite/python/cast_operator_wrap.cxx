...
/*-----------------------------------------------
              @(target):= _cast_operator.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__cast_operator

#else
#  define SWIG_init    init_cast_operator

#endif
#define SWIG_name    "_cast_operator"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_A_tochar(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:A_tochar",&obj0)) SWIG_fail;
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"A_tochar", _wrap_A_tochar, METH_VARARGS, NULL},
