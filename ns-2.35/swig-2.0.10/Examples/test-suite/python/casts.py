...
if version_info >= (2,6,0):
    def swig_import_helper():
        ...
        fp = None
        try:
            fp, pathname, description = imp.find_module('_casts', [dirname(__file__)])
        except ImportError:
            import _casts
            return _casts
        if fp is not None:
            try:
                _mod = imp.load_module('_casts', fp, pathname, description)
            finally:
                fp.close()
            return _mod
    _casts = swig_import_helper()
...
class A(_object):
    ...
    def hello(self): return _casts.A_hello(self)
    __swig_destroy__ = _casts.delete_A
    __del__ = lambda self : None;
A_swigregister = _casts.A_swigregister
A_swigregister(A)
...
class B(A):
    ...
    __swig_destroy__ = _casts.delete_B
    __del__ = lambda self : None;
B_swigregister = _casts.B_swigregister
B_swigregister(B)
