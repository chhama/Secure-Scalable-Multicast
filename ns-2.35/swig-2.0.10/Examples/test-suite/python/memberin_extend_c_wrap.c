...
/*-----------------------------------------------
              @(target):= _memberin_extend_c.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__memberin_extend_c

#else
#  define SWIG_init    init_memberin_extend_c

#endif
#define SWIG_name    "_memberin_extend_c"
...
SWIGINTERN PyObject *_wrap_Person_name_set(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:Person_name_set",&obj0,&obj1)) SWIG_fail;
...
SWIGINTERN PyObject *_wrap_Person_name_get(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:Person_name_get",&obj0)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_Person, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN PyObject *_wrap_new_Person(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)":new_Person")) SWIG_fail;
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"Person_name_set", _wrap_Person_name_set, METH_VARARGS, NULL},
	 { (char *)"Person_name_get", _wrap_Person_name_get, METH_VARARGS, NULL},
