...
/*-----------------------------------------------
              @(target):= _constructor_explicit.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__constructor_explicit

#else
#  define SWIG_init    init_constructor_explicit

#endif
#define SWIG_name    "_constructor_explicit"
