...
/*-----------------------------------------------
              @(target):= _constructor_exception.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__constructor_exception

#else
#  define SWIG_init    init_constructor_exception

#endif
#define SWIG_name    "_constructor_exception"
...
SWIGINTERN PyObject *_wrap_new_SomeClass(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:new_SomeClass",&obj0)) SWIG_fail;
