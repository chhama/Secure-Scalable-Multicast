...
if version_info >= (2,6,0):
    def swig_import_helper():
        ...
        fp = None
        try:
            fp, pathname, description = imp.find_module('_abstract_access', [dirname(__file__)])
        except ImportError:
            import _abstract_access
            return _abstract_access
        if fp is not None:
            try:
                _mod = imp.load_module('_abstract_access', fp, pathname, description)
            finally:
                fp.close()
            return _mod
    _abstract_access = swig_import_helper()
...
class A(_object):
    ...
    __repr__ = _swig_repr
    __swig_destroy__ = _abstract_access.delete_A
    __del__ = lambda self : None;
    def z(self): return _abstract_access.A_z(self)
    def do_x(self): return _abstract_access.A_do_x(self)
A_swigregister = _abstract_access.A_swigregister
A_swigregister(A)
...
class B(A):
    ...
    def __init__(self, *args, **kwargs): raise AttributeError("No constructor defined - class is abstract")
    __repr__ = _swig_repr
    __swig_destroy__ = _abstract_access.delete_B
    __del__ = lambda self : None;
B_swigregister = _abstract_access.B_swigregister
B_swigregister(B)
...
class C(B):
    ...
    def __init__(self, *args, **kwargs): raise AttributeError("No constructor defined - class is abstract")
    __repr__ = _swig_repr
    __swig_destroy__ = _abstract_access.delete_C
    __del__ = lambda self : None;
C_swigregister = _abstract_access.C_swigregister
C_swigregister(C)
...
class D(C):
    ...
    __repr__ = _swig_repr
    def __init__(self): 
        this = _abstract_access.new_D()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _abstract_access.delete_D
    __del__ = lambda self : None;
D_swigregister = _abstract_access.D_swigregister
D_swigregister(D)
