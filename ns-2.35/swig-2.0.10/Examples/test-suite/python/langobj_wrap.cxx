...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__langobj

#else
#  define SWIG_init    init_langobj

#endif
#define SWIG_name    "_langobj"
...
SWIGINTERN PyObject *_wrap_identity(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:identity",&obj0)) SWIG_fail;
  arg1 = obj0;
  result = (PyObject *)identity(arg1);
  resultobj = result;
  return resultobj;
fail:
  return NULL;
