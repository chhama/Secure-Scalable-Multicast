...
/*-----------------------------------------------
              @(target):= _director_string.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__director_string

#else
#  define SWIG_init    init_director_string

#endif
#define SWIG_name    "_director_string"
...
SwigDirector_A::SwigDirector_A(PyObject *self, std::string const &first): A(first), Swig::Director(self) {
...
int SwigDirector_A::string_length(std::string const &s) const {
  ...
  const char * const swig_method_name = "string_length";
  PyObject* method = swig_get_method(swig_method_index, swig_method_name);
  swig::SwigVar_PyObject result = PyObject_CallFunction(method, (char *)"(O)" ,(PyObject *)obj0);
#else
  swig::SwigVar_PyObject result = PyObject_CallMethod(swig_get_self(), (char *)"string_length", (char *)"(O)" ,(PyObject *)obj0);
#endif
  if (!result) {
    PyObject *error = PyErr_Occurred();
    if (error) {
      Swig::DirectorMethodException::raise("Error detected when calling 'A.string_length'");
    }
  }
  int swig_val;
...
SWIGINTERN PyObject *_wrap_new_A(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  arg1 = obj0;
  {
    ...
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "new_A" "', argument " "2"" of type '" "std::string const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "new_A" "', argument " "2"" of type '" "std::string const &""'"); 
    }
    arg2 = ptr;
  }
  if ( arg1 != Py_None ) {
    /* subclassed */
    result = (A *)new SwigDirector_A(arg1,(std::string const &)*arg2); 
  } else {
    result = (A *)new A((std::string const &)*arg2); 
  }
...
SWIGINTERN PyObject *_wrap_A_string_length(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  A *arg1 = (A *) 0 ;
  std::string *arg2 = 0 ;
  void *argp1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:A_string_length",&obj0,&obj1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_A, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "A_string_length" "', argument " "1"" of type '" "A const *""'"); 
  }
  arg1 = reinterpret_cast< A * >(argp1);
  {
    std::string *ptr = (std::string *)0;
    res2 = SWIG_AsPtr_std_string(obj1, &ptr);
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "A_string_length" "', argument " "2"" of type '" "std::string const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "A_string_length" "', argument " "2"" of type '" "std::string const &""'"); 
    }
    arg2 = ptr;
  }
  director = SWIG_DIRECTOR_CAST(arg1);
...
SWIGINTERN PyObject *_wrap_A_m_strings_set(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "A_m_strings_set" "', argument " "2"" of type '" "std::vector< std::string,std::allocator< std::string > > *""'"); 
  }
...
SWIGINTERN PyObject *_wrap_A_m_strings_get(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  arg1 = reinterpret_cast< A * >(argp1);
  result = (std::vector< std::string,std::allocator< std::string > > *)& ((arg1)->m_strings);
...
SWIGINTERN PyObject *_wrap_A_process_text(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "A_process_text" "', argument " "2"" of type '" "char const *""'");
  }
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"A_string_length", _wrap_A_string_length, METH_VARARGS, NULL},
