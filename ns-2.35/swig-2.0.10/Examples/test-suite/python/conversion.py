...
class Foo(_object):
    ...
    __repr__ = _swig_repr
    def __init__(self): 
        this = _conversion.new_Foo()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _conversion.delete_Foo
    __del__ = lambda self : None;
Foo_swigregister = _conversion.Foo_swigregister
...
class Bar(_object):
    ...
    __repr__ = _swig_repr
    def toFoo(self): return _conversion.Bar_toFoo(self)
    def __init__(self): 
        this = _conversion.new_Bar()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _conversion.delete_Bar
    __del__ = lambda self : None;
Bar_swigregister = _conversion.Bar_swigregister
