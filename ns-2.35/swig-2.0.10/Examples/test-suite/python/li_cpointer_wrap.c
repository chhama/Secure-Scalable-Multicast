...
/*-----------------------------------------------
              @(target):= _li_cpointer.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__li_cpointer

#else
#  define SWIG_init    init_li_cpointer

#endif
#define SWIG_name    "_li_cpointer"
...
SWIGINTERN PyObject *_wrap_int_to_uint(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  int arg1 ;
  int val1 ;
  int ecode1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:int_to_uint",&obj0)) SWIG_fail;
  ecode1 = SWIG_AsVal_int(obj0, &val1);
  if (!SWIG_IsOK(ecode1)) {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"int_to_uint", _wrap_int_to_uint, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
