...
#define SWIG_init    boot_arrayref

#define SWIG_name   "arrayrefc::boot_arrayref"
#define SWIG_prefix "arrayrefc::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_arrayref_var::
class _wrap_arrayref_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
XS(_wrap_foo) {
  {
    ...
    res1 = SWIG_ConvertPtr(ST(0), &argp1, SWIGTYPE_p_a_10__int,  0 );
    if (!SWIG_IsOK(res1)) {
...
{"arrayrefc::foo", _wrap_foo},
{"arrayrefc::bar", _wrap_bar},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
