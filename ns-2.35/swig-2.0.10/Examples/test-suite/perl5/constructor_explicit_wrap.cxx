...
#define SWIG_init    boot_constructor_explicit

#define SWIG_name   "constructor_explicitc::boot_constructor_explicit"
#define SWIG_prefix "constructor_explicitc::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_constructor_explicit_var::
class _wrap_constructor_explicit_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
XS(_wrap_test) {
  {
    ...
    }
    {
      ...
      if (!argp1) {
        SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "test" "', argument " "1"" of type '" "Foo""'");
      } else {
        arg1 = *(reinterpret_cast< Foo * >(argp1));
      }
    }
...
static swig_type_info _swigt__p_Foo = {"_p_Foo", "Foo *", 0, 0, (void*)"constructor_explicit::Foo", 0};
...
{"constructor_explicitc::new_Foo", _wrap_new_Foo},
{"constructor_explicitc::delete_Foo", _wrap_delete_Foo},
{"constructor_explicitc::test", _wrap_test},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
...
XS(SWIG_init) {
  ...
  SWIG_TypeClientData(SWIGTYPE_p_Foo, (void*) "constructor_explicit::Foo");
  ST(0) = &PL_sv_yes;
  XSRETURN(1);
}
