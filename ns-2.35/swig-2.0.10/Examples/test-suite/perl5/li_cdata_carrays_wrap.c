...
#define SWIG_init    boot_li_cdata_carrays

#define SWIG_name   "li_cdata_carraysc::boot_li_cdata_carrays"
#define SWIG_prefix "li_cdata_carraysc::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_li_cdata_carrays_var::
class _wrap_li_cdata_carrays_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
XS(_wrap_cdata_int) {
  {
    ...
    if ((items < 1) || (items > 2)) {
      SWIG_croak("Usage: cdata_int(ptr,nelements);");
    }
    res1 = SWIG_ConvertPtr(ST(0), &argp1,SWIGTYPE_p_int, 0 |  0 );
    if (!SWIG_IsOK(res1)) {
...
static swig_type_info _swigt__p_intArray = {"_p_intArray", "intArray *", 0, 0, (void*)"li_cdata_carrays::intArray", 0};
...
{"li_cdata_carraysc::new_intArray", _wrap_new_intArray},
{"li_cdata_carraysc::delete_intArray", _wrap_delete_intArray},
{"li_cdata_carraysc::intArray_getitem", _wrap_intArray_getitem},
{"li_cdata_carraysc::intArray_setitem", _wrap_intArray_setitem},
{"li_cdata_carraysc::intArray_cast", _wrap_intArray_cast},
{"li_cdata_carraysc::intArray_frompointer", _wrap_intArray_frompointer},
{"li_cdata_carraysc::cdata", _wrap_cdata},
{"li_cdata_carraysc::memmove", _wrap_memmove},
{"li_cdata_carraysc::cdata_int", _wrap_cdata_int},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
...
XS(SWIG_init) {
  ...
  SWIG_TypeClientData(SWIGTYPE_p_intArray, (void*) "li_cdata_carrays::intArray");
  ST(0) = &PL_sv_yes;
  XSRETURN(1);
}
