...
#define SWIG_init    boot_extern_throws

#define SWIG_name   "extern_throwsc::boot_extern_throws"
#define SWIG_prefix "extern_throwsc::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_extern_throws_var::
class _wrap_extern_throws_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
XS(_wrap_get) {
  {
    ...
    try {
      ...
      sv_setsv(get_sv("@", GV_ADD), SWIG_NewPointerObj((new std::exception(static_cast< const std::exception& >(_e))),SWIGTYPE_p_std__exception,SWIG_POINTER_OWN)); SWIG_fail ;
    }
