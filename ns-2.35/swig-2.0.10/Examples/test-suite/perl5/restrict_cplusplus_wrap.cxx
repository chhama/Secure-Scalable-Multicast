...
#define SWIG_init    boot_restrict_cplusplus

#define SWIG_name   "restrict_cplusplusc::boot_restrict_cplusplus"
#define SWIG_prefix "restrict_cplusplusc::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_restrict_cplusplus_var::
class _wrap_restrict_cplusplus_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
XS(_wrap_Foo_restrict_set) {
  {
    ...
    if ((items < 2) || (items > 2)) {
      SWIG_croak("Usage: Foo_restrict_set(self,restrict);");
    }
...
XS(_wrap_Foo_restrict_get) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: Foo_restrict_get(self);");
    }
    res1 = SWIG_ConvertPtr(ST(0), &argp1,SWIGTYPE_p_Foo, 0 |  0 );
    if (!SWIG_IsOK(res1)) {
...
static swig_type_info _swigt__p_Foo = {"_p_Foo", "Foo *", 0, 0, (void*)"restrict_cplusplus::Foo", 0};
...
{"restrict_cplusplusc::Foo_restrict_set", _wrap_Foo_restrict_set},
{"restrict_cplusplusc::Foo_restrict_get", _wrap_Foo_restrict_get},
{"restrict_cplusplusc::new_Foo", _wrap_new_Foo},
{"restrict_cplusplusc::delete_Foo", _wrap_delete_Foo},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
...
XS(SWIG_init) {
  ...
  SWIG_TypeClientData(SWIGTYPE_p_Foo, (void*) "restrict_cplusplus::Foo");
  ST(0) = &PL_sv_yes;
  XSRETURN(1);
}
