...
#define SWIG_init    boot_char_binary

#define SWIG_name   "char_binaryc::boot_char_binary"
#define SWIG_prefix "char_binaryc::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_char_binary_var::
class _wrap_char_binary_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
XS(_wrap_Test_strlen) {
  {
    ...
    if ((items < 2) || (items > 2)) {
      SWIG_croak("Usage: Test_strlen(self,str,len);");
    }
    res1 = SWIG_ConvertPtr(ST(0), &argp1,SWIGTYPE_p_Test, 0 |  0 );
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Test_strlen" "', argument " "1"" of type '" "Test *""'"); 
    }
    arg1 = reinterpret_cast< Test * >(argp1);
    res2 = SWIG_AsCharPtrAndSize(ST(1), &buf2, &size2, &alloc2);
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "Test_strlen" "', argument " "2"" of type '" "char const *""'");
    }  
...
static swig_type_info _swigt__p_Test = {"_p_Test", "Test *", 0, 0, (void*)"char_binary::Test", 0};
...
static swig_variable_info swig_variables[] = {
    { "char_binaryc::var_namet", MAGIC_CLASS _wrap_var_namet_set, MAGIC_CLASS _wrap_var_namet_get,0 },
    { "char_binaryc::var_pchar", MAGIC_CLASS _wrap_var_pchar_set, MAGIC_CLASS _wrap_var_pchar_get,0 },
{0,0,0,0}
};
static swig_command_info swig_commands[] = {
{"char_binaryc::Test_strlen", _wrap_Test_strlen},
{"char_binaryc::new_Test", _wrap_new_Test},
{"char_binaryc::delete_Test", _wrap_delete_Test},
{"char_binaryc::new_pchar", _wrap_new_pchar},
{"char_binaryc::delete_pchar", _wrap_delete_pchar},
{"char_binaryc::pchar_getitem", _wrap_pchar_getitem},
{"char_binaryc::pchar_setitem", _wrap_pchar_setitem},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
...
XS(SWIG_init) {
  ...
  SWIG_TypeClientData(SWIGTYPE_p_Test, (void*) "char_binary::Test");
  ST(0) = &PL_sv_yes;
  XSRETURN(1);
}
