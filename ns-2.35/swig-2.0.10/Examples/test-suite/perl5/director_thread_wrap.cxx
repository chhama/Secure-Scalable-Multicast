...
#define SWIG_init    boot_director_thread

#define SWIG_name   "director_threadc::boot_director_thread"
#define SWIG_prefix "director_threadc::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_director_thread_var::
class _wrap_director_thread_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
XS(_wrap_MilliSecondSleep) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: MilliSecondSleep(milliseconds);");
    }
...
XS(_wrap_Foo_stop) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: Foo_stop(self);");
    }
    res1 = SWIG_ConvertPtr(ST(0), &argp1,SWIGTYPE_p_Foo, 0 |  0 );
    if (!SWIG_IsOK(res1)) {
...
XS(_wrap_Foo_do_foo) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: Foo_do_foo(self);");
    }
    res1 = SWIG_ConvertPtr(ST(0), &argp1,SWIGTYPE_p_Foo, 0 |  0 );
    if (!SWIG_IsOK(res1)) {
...
static swig_type_info _swigt__p_Foo = {"_p_Foo", "Foo *", 0, 0, (void*)"director_thread::Foo", 0};
...
{"director_threadc::MilliSecondSleep", _wrap_MilliSecondSleep},
{"director_threadc::Foo_val_set", _wrap_Foo_val_set},
{"director_threadc::Foo_val_get", _wrap_Foo_val_get},
{"director_threadc::new_Foo", _wrap_new_Foo},
{"director_threadc::delete_Foo", _wrap_delete_Foo},
{"director_threadc::Foo_stop", _wrap_Foo_stop},
{"director_threadc::Foo_run", _wrap_Foo_run},
{"director_threadc::Foo_do_foo", _wrap_Foo_do_foo},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
...
XS(SWIG_init) {
  ...
  SWIG_TypeClientData(SWIGTYPE_p_Foo, (void*) "director_thread::Foo");
  ST(0) = &PL_sv_yes;
  XSRETURN(1);
}
