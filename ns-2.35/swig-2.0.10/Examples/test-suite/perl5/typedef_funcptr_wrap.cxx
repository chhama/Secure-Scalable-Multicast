...
#define SWIG_init    boot_typedef_funcptr

#define SWIG_name   "typedef_funcptrc::boot_typedef_funcptr"
#define SWIG_prefix "typedef_funcptrc::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_typedef_funcptr_var::
class _wrap_typedef_funcptr_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
{"typedef_funcptrc::do_op", _wrap_do_op},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
...
XS(SWIG_init) {
  ...
  /*@SWIG:/home/chhama/Dropbox/mtp/o-ns-allinone-2.35.1/ns-2.35/swig-2.0.10/Lib/perl5/perltypemaps.swg,65,%set_constant@*/ do {
    SV *sv = get_sv((char*) SWIG_prefix "addf", TRUE | 0x2 | GV_ADDMULTI);
    sv_setsv(sv, SWIG_NewFunctionPtrObj((void *)addf, SWIGTYPE_p_f_int_int__int));
    SvREADONLY_on(sv);
  } while(0) /*@SWIG@*/;
  /*@SWIG:/home/chhama/Dropbox/mtp/o-ns-allinone-2.35.1/ns-2.35/swig-2.0.10/Lib/perl5/perltypemaps.swg,65,%set_constant@*/ do {
    SV *sv = get_sv((char*) SWIG_prefix "subf", TRUE | 0x2 | GV_ADDMULTI);
    sv_setsv(sv, SWIG_NewFunctionPtrObj((void *)subf, SWIGTYPE_p_f_int_int__int));
    SvREADONLY_on(sv);
  } while(0) /*@SWIG@*/;
  ST(0) = &PL_sv_yes;
  XSRETURN(1);
