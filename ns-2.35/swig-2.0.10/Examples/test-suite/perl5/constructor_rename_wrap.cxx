...
#define SWIG_init    boot_constructor_rename

#define SWIG_name   "constructor_renamec::boot_constructor_rename"
#define SWIG_prefix "constructor_renamec::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_constructor_rename_var::
class _wrap_constructor_rename_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
extern "C" {
#endif
XS(_wrap_new_RenamedConstructor) {
  {
    int argvi = 0;
    Foo *result = 0 ;
    dXSARGS;
    ...
    if ((items < 0) || (items > 0)) {
      SWIG_croak("Usage: new_RenamedConstructor();");
    }
    result = (Foo *)new Foo();
...
static swig_type_info _swigt__p_Foo = {"_p_Foo", "Foo *", 0, 0, (void*)"constructor_rename::Foo", 0};
...
{"constructor_renamec::new_RenamedConstructor", _wrap_new_RenamedConstructor},
{"constructor_renamec::delete_Foo", _wrap_delete_Foo},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
...
XS(SWIG_init) {
  ...
  SWIG_TypeClientData(SWIGTYPE_p_Foo, (void*) "constructor_rename::Foo");
  ST(0) = &PL_sv_yes;
  XSRETURN(1);
}
