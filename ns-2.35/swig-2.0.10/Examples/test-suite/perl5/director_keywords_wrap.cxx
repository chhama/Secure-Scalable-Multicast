...
#define SWIG_init    boot_director_keywords

#define SWIG_name   "director_keywordsc::boot_director_keywords"
#define SWIG_prefix "director_keywordsc::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_director_keywords_var::
class _wrap_director_keywords_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
XS(_wrap_Foo_bar) {
  {
    ...
    if ((items < 2) || (items > 2)) {
      SWIG_croak("Usage: Foo_bar(self,abstract);");
    }
...
static swig_type_info _swigt__p_Foo = {"_p_Foo", "Foo *", 0, 0, (void*)"director_keywords::Foo", 0};
...
{"director_keywordsc::delete_Foo", _wrap_delete_Foo},
{"director_keywordsc::Foo_bar", _wrap_Foo_bar},
{"director_keywordsc::new_Foo", _wrap_new_Foo},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
...
XS(SWIG_init) {
  ...
  SWIG_TypeClientData(SWIGTYPE_p_Foo, (void*) "director_keywords::Foo");
  ST(0) = &PL_sv_yes;
  XSRETURN(1);
}
