...
#define SWIG_init    boot_nested_comment

#define SWIG_name   "nested_commentc::boot_nested_comment"
#define SWIG_prefix "nested_commentc::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_nested_comment_var::
class _wrap_nested_comment_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
XS(_wrap_new_s2) {
  {
    ...
    result = (s1 *)new s1();
    ST(argvi) = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_s1, SWIG_OWNER | SWIG_SHADOW); argvi++ ;
    XSRETURN(argvi);
  fail:
    SWIG_croak_null();
  }
...
XS(_wrap_delete_s2) {
  {
    ...
    res1 = SWIG_ConvertPtr(ST(0), &argp1,SWIGTYPE_p_s1, SWIG_POINTER_DISOWN |  0 );
    if (!SWIG_IsOK(res1)) {
...
static swig_type_info _swigt__p_a = {"_p_a", "a *", 0, 0, (void*)"nested_comment::a", 0};
static swig_type_info _swigt__p_char = {"_p_char", "char *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_s1 = {"_p_s1", "s2 *|s1 *", 0, 0, (void*)"nested_comment::s2", 0};
...
{"nested_commentc::new_s2", _wrap_new_s2},
{"nested_commentc::delete_s2", _wrap_delete_s2},
{"nested_commentc::new_a", _wrap_new_a},
{"nested_commentc::delete_a", _wrap_delete_a},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
...
XS(SWIG_init) {
  ...
  SWIG_TypeClientData(SWIGTYPE_p_s1, (void*) "nested_comment::s2");
  SWIG_TypeClientData(SWIGTYPE_p_a, (void*) "nested_comment::a");
  ST(0) = &PL_sv_yes;
  XSRETURN(1);
}
