...
#define SWIG_init    boot_struct_rename

#define SWIG_name   "struct_renamec::boot_struct_rename"
#define SWIG_prefix "struct_renamec::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_struct_rename_var::
class _wrap_struct_rename_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
static swig_type_info _swigt__p_Foo = {"_p_Foo", "Foo *", 0, 0, (void*)"struct_rename::Bar", 0};
...
{"struct_renamec::Bar_x_set", _wrap_Bar_x_set},
{"struct_renamec::Bar_x_get", _wrap_Bar_x_get},
{"struct_renamec::new_Bar", _wrap_new_Bar},
{"struct_renamec::delete_Bar", _wrap_delete_Bar},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
...
XS(SWIG_init) {
  ...
  SWIG_TypeClientData(SWIGTYPE_p_Foo, (void*) "struct_rename::Bar");
  ST(0) = &PL_sv_yes;
  XSRETURN(1);
}
