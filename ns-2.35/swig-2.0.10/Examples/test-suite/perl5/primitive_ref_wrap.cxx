...
#define SWIG_init    boot_primitive_ref

#define SWIG_name   "primitive_refc::boot_primitive_ref"
#define SWIG_prefix "primitive_refc::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_primitive_ref_var::
class _wrap_primitive_ref_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
XS(_wrap_ref_longlong) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: ref_longlong(x);");
    }
...
XS(_wrap_ref_ulonglong) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: ref_ulonglong(x);");
    }
...
XS(_wrap_A_v_set) {
  {
    ...
    if ((items < 2) || (items > 2)) {
      SWIG_croak("Usage: A_v_set(self,v);");
    }
...
XS(_wrap_ref_over) {
  ...
  dispatch:
    switch(_index) {
    case 1:
      PUSHMARK(MARK); SWIG_CALLXS(_wrap_ref_over__SWIG_1); return;
    case 2:
      PUSHMARK(MARK); SWIG_CALLXS(_wrap_ref_over__SWIG_0); return;
    }
  }
  
  croak("No matching function for overloaded 'ref_over'");
  XSRETURN(0);
}
...
static swig_type_info _swigt__p_A = {"_p_A", "A *", 0, 0, (void*)"primitive_ref::A", 0};
...
{"primitive_refc::ref_int", _wrap_ref_int},
{"primitive_refc::ref_uint", _wrap_ref_uint},
{"primitive_refc::ref_short", _wrap_ref_short},
{"primitive_refc::ref_ushort", _wrap_ref_ushort},
{"primitive_refc::ref_long", _wrap_ref_long},
{"primitive_refc::ref_ulong", _wrap_ref_ulong},
{"primitive_refc::ref_schar", _wrap_ref_schar},
{"primitive_refc::ref_uchar", _wrap_ref_uchar},
{"primitive_refc::ref_char", _wrap_ref_char},
{"primitive_refc::ref_float", _wrap_ref_float},
{"primitive_refc::ref_double", _wrap_ref_double},
{"primitive_refc::ref_bool", _wrap_ref_bool},
{"primitive_refc::ref_longlong", _wrap_ref_longlong},
{"primitive_refc::ref_ulonglong", _wrap_ref_ulonglong},
{"primitive_refc::A_v_set", _wrap_A_v_set},
{"primitive_refc::A_v_get", _wrap_A_v_get},
{"primitive_refc::new_A", _wrap_new_A},
{"primitive_refc::delete_A", _wrap_delete_A},
{"primitive_refc::ref_over", _wrap_ref_over},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
...
XS(SWIG_init) {
  ...
  SWIG_TypeClientData(SWIGTYPE_p_A, (void*) "primitive_ref::A");
  ST(0) = &PL_sv_yes;
  XSRETURN(1);
}
