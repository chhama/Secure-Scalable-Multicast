...
#define SWIG_init    boot_overload_rename

#define SWIG_name   "overload_renamec::boot_overload_rename"
#define SWIG_prefix "overload_renamec::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_overload_rename_var::
class _wrap_overload_rename_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
XS(_wrap_new_Foo_int__SWIG_0) {
  {
    ...
    if ((items < 3) || (items > 3)) {
      SWIG_croak("Usage: new_Foo_int(a,c,b);");
    }
    ecode1 = SWIG_AsVal_float SWIG_PERL_CALL_ARGS_2(ST(0), &val1);
    if (!SWIG_IsOK(ecode1)) {
...
XS(_wrap_new_Foo_int__SWIG_1) {
  {
    ...
    if ((items < 2) || (items > 2)) {
      SWIG_croak("Usage: new_Foo_int(a,c);");
    }
    ecode1 = SWIG_AsVal_float SWIG_PERL_CALL_ARGS_2(ST(0), &val1);
    if (!SWIG_IsOK(ecode1)) {
      SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "new_Foo_int" "', argument " "1"" of type '" "float""'");
...
static swig_type_info _swigt__p_Foo = {"_p_Foo", "Foo *", 0, 0, (void*)"overload_rename::Foo", 0};
...
{"overload_renamec::new_Foo", _wrap_new_Foo},
{"overload_renamec::new_Foo_int", _wrap_new_Foo_int},
{"overload_renamec::delete_Foo", _wrap_delete_Foo},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
...
XS(SWIG_init) {
  ...
  SWIG_TypeClientData(SWIGTYPE_p_Foo, (void*) "overload_rename::Foo");
  ST(0) = &PL_sv_yes;
  XSRETURN(1);
}
