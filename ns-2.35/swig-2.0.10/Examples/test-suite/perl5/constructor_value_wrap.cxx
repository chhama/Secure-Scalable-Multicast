...
#define SWIG_init    boot_constructor_value

#define SWIG_name   "constructor_valuec::boot_constructor_value"
#define SWIG_prefix "constructor_valuec::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_constructor_value_var::
class _wrap_constructor_value_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
static swig_type_info _swigt__p_Bar = {"_p_Bar", "Bar *", 0, 0, (void*)"constructor_value::Bar", 0};
static swig_type_info _swigt__p_Foo = {"_p_Foo", "Foo *", 0, 0, (void*)"constructor_value::Foo", 0};
...
{"constructor_valuec::new_Foo", _wrap_new_Foo},
{"constructor_valuec::delete_Foo", _wrap_delete_Foo},
{"constructor_valuec::new_Bar", _wrap_new_Bar},
{"constructor_valuec::delete_Bar", _wrap_delete_Bar},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
...
XS(SWIG_init) {
  ...
  SWIG_TypeClientData(SWIGTYPE_p_Foo, (void*) "constructor_value::Foo");
  SWIG_TypeClientData(SWIGTYPE_p_Bar, (void*) "constructor_value::Bar");
  ST(0) = &PL_sv_yes;
  XSRETURN(1);
}
