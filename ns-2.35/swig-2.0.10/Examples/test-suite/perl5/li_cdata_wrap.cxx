...
#define SWIG_init    boot_li_cdata

#define SWIG_name   "li_cdatac::boot_li_cdata"
#define SWIG_prefix "li_cdatac::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_li_cdata_var::
class _wrap_li_cdata_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
XS(_wrap_cdata_double) {
  {
    ...
    if ((items < 1) || (items > 2)) {
      SWIG_croak("Usage: cdata_double(ptr,nelements);");
    }
...
{"li_cdatac::cdata", _wrap_cdata},
{"li_cdatac::memmove", _wrap_memmove},
{"li_cdatac::cdata_int", _wrap_cdata_int},
{"li_cdatac::cdata_double", _wrap_cdata_double},
{"li_cdatac::malloc", _wrap_malloc},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
