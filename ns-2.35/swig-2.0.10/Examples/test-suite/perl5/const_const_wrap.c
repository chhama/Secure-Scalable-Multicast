...
#define SWIG_init    boot_const_const

#define SWIG_name   "const_constc::boot_const_const"
#define SWIG_prefix "const_constc::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_const_const_var::
class _wrap_const_const_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
