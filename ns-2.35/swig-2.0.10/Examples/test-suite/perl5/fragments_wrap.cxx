...
#define SWIG_init    boot_fragments

#define SWIG_name   "fragmentsc::boot_fragments"
#define SWIG_prefix "fragmentsc::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_fragments_var::
class _wrap_fragments_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
{"fragmentsc::bar", _wrap_bar},
{"fragmentsc::foo", _wrap_foo},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
