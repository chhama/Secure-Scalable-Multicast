...
#define SWIG_init    boot_template_typedef_cplx5

#define SWIG_name   "template_typedef_cplx5c::boot_template_typedef_cplx5"
#define SWIG_prefix "template_typedef_cplx5c::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_template_typedef_cplx5_var::
class _wrap_template_typedef_cplx5_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
XS(_wrap_A_test1) {
  {
    ...
    result = (arg1)->test1();
    ST(argvi) = SWIG_NewPointerObj((new complex(static_cast< const complex& >(result))), SWIGTYPE_p_std__complexT_double_t, SWIG_POINTER_OWN | 0); argvi++ ;
...
XS(_wrap_A_test2) {
  {
    ...
    arg1 = reinterpret_cast< A * >(argp1);
    result = (arg1)->test2();
    ST(argvi) = SWIG_NewPointerObj((new std::complex< double >(static_cast< const std::complex< double >& >(result))), SWIGTYPE_p_std__complexT_double_t, SWIG_POINTER_OWN | 0); argvi++ ;
...
static swig_type_info _swigt__p_A = {"_p_A", "A *", 0, 0, (void*)"template_typedef_cplx5::A", 0};
...
{"template_typedef_cplx5c::A_test1", _wrap_A_test1},
{"template_typedef_cplx5c::A_test2", _wrap_A_test2},
{"template_typedef_cplx5c::new_A", _wrap_new_A},
{"template_typedef_cplx5c::delete_A", _wrap_delete_A},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
...
XS(SWIG_init) {
  ...
  SWIG_TypeClientData(SWIGTYPE_p_A, (void*) "template_typedef_cplx5::A");
  ST(0) = &PL_sv_yes;
  XSRETURN(1);
}
