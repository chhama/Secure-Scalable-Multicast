...
#define SWIG_init    boot_li_constraints

#define SWIG_name   "li_constraintsc::boot_li_constraints"
#define SWIG_prefix "li_constraintsc::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_li_constraints_var::
class _wrap_li_constraints_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
XS(_wrap_test_nonnegative) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: test_nonnegative(NONNEGATIVE);");
    }
...
XS(_wrap_test_nonpositive) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: test_nonpositive(NONPOSITIVE);");
    }
    ecode1 = SWIG_AsVal_double SWIG_PERL_CALL_ARGS_2(ST(0), &val1);
    if (!SWIG_IsOK(ecode1)) {
...
XS(_wrap_test_positive) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: test_positive(POSITIVE);");
    }
    ecode1 = SWIG_AsVal_double SWIG_PERL_CALL_ARGS_2(ST(0), &val1);
    if (!SWIG_IsOK(ecode1)) {
...
XS(_wrap_test_negative) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: test_negative(POSITIVE);");
    }
    ecode1 = SWIG_AsVal_double SWIG_PERL_CALL_ARGS_2(ST(0), &val1);
    if (!SWIG_IsOK(ecode1)) {
...
XS(_wrap_test_nonzero) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: test_nonzero(NONZERO);");
    }
    ecode1 = SWIG_AsVal_double SWIG_PERL_CALL_ARGS_2(ST(0), &val1);
    if (!SWIG_IsOK(ecode1)) {
...
XS(_wrap_test_nonnull) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: test_nonnull(NONNULL);");
    }
...
{"li_constraintsc::test_nonnegative", _wrap_test_nonnegative},
{"li_constraintsc::test_nonpositive", _wrap_test_nonpositive},
{"li_constraintsc::test_positive", _wrap_test_positive},
{"li_constraintsc::test_negative", _wrap_test_negative},
{"li_constraintsc::test_nonzero", _wrap_test_nonzero},
{"li_constraintsc::test_nonnull", _wrap_test_nonnull},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
