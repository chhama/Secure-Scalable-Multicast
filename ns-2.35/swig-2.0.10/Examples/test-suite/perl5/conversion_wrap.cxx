...
#define SWIG_init    boot_conversion

#define SWIG_name   "conversionc::boot_conversion"
#define SWIG_prefix "conversionc::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_conversion_var::
class _wrap_conversion_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
static swig_type_info _swigt__p_Bar = {"_p_Bar", "Bar *", 0, 0, (void*)"conversion::Bar", 0};
static swig_type_info _swigt__p_Foo = {"_p_Foo", "Foo *", 0, 0, (void*)"conversion::Foo", 0};
...
{"conversionc::new_Foo", _wrap_new_Foo},
{"conversionc::delete_Foo", _wrap_delete_Foo},
{"conversionc::Bar_toFoo", _wrap_Bar_toFoo},
{"conversionc::new_Bar", _wrap_new_Bar},
{"conversionc::delete_Bar", _wrap_delete_Bar},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
...
XS(SWIG_init) {
  ...
  SWIG_TypeClientData(SWIGTYPE_p_Foo, (void*) "conversion::Foo");
  SWIG_TypeClientData(SWIGTYPE_p_Bar, (void*) "conversion::Bar");
  ST(0) = &PL_sv_yes;
  XSRETURN(1);
}
