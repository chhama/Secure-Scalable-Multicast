...
#define SWIG_init    boot_voidtest

#define SWIG_name   "voidtestc::boot_voidtest"
#define SWIG_prefix "voidtestc::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_voidtest_var::
class _wrap_voidtest_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
XS(_wrap_Foo_memberfunc) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: Foo_memberfunc(self);");
    }
...
XS(_wrap_Foo_staticmemberfunc) {
  {
    int argvi = 0;
    dXSARGS;
    
    if ((items < 0) || (items > 0)) {
      SWIG_croak("Usage: Foo_staticmemberfunc();");
    }
...
static swig_type_info _swigt__p_Foo = {"_p_Foo", "Foo *", 0, 0, (void*)"voidtest::Foo", 0};
...
{"voidtestc::globalfunc", _wrap_globalfunc},
{"voidtestc::new_Foo", _wrap_new_Foo},
{"voidtestc::Foo_memberfunc", _wrap_Foo_memberfunc},
{"voidtestc::Foo_staticmemberfunc", _wrap_Foo_staticmemberfunc},
{"voidtestc::delete_Foo", _wrap_delete_Foo},
{"voidtestc::vfunc1", _wrap_vfunc1},
{"voidtestc::vfunc2", _wrap_vfunc2},
{"voidtestc::vfunc3", _wrap_vfunc3},
{"voidtestc::vfunc4", _wrap_vfunc4},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
...
XS(SWIG_init) {
  ...
  SWIG_TypeClientData(SWIGTYPE_p_Foo, (void*) "voidtest::Foo");
  ST(0) = &PL_sv_yes;
  XSRETURN(1);
}
