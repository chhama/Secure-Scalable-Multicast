...
#define SWIG_init    boot_template_type_namespace

#define SWIG_name   "template_type_namespacec::boot_template_type_namespace"
#define SWIG_prefix "template_type_namespacec::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_template_type_namespace_var::
class _wrap_template_type_namespace_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
extern "C" {
#endif
XS(_wrap_new_string_vector__SWIG_0) {
  {
    unsigned int arg1 ;
    unsigned int val1 ;
    int ecode1 = 0 ;
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: new_string_vector(size);");
    }
...
XS(_wrap_new_string_vector__SWIG_1) {
  {
    int argvi = 0;
    std::vector< std::string > *result = 0 ;
    dXSARGS;
    ...
    if ((items < 0) || (items > 0)) {
      SWIG_croak("Usage: new_string_vector();");
    }
...
XS(_wrap_new_string_vector__SWIG_2) {
  {
    unsigned int arg1 ;
    std::string arg2 ;
    unsigned int val1 ;
    ...
    if ((items < 2) || (items > 2)) {
      SWIG_croak("Usage: new_string_vector(size,value);");
    }
    ecode1 = SWIG_AsVal_unsigned_SS_int SWIG_PERL_CALL_ARGS_2(ST(0), &val1);
    if (!SWIG_IsOK(ecode1)) {
      SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "new_string_vector" "', argument " "1"" of type '" "unsigned int""'");
    ...
    arg1 = static_cast< unsigned int >(val1);
    {
      ...
      if (!SWIG_IsOK(res) || !ptr) {
        SWIG_exception_fail(SWIG_ArgError((ptr ? res : SWIG_TypeError)), "in method '" "new_string_vector" "', argument " "2"" of type '" "std::string""'"); 
      }
      arg2 = *ptr;
...
XS(_wrap_new_string_vector__SWIG_3) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: new_string_vector(std::vector< std::string > const &);");
    }
    {
      if (SWIG_ConvertPtr(ST(0),(void **) &v1, 
        ...
        SWIG_croak("Type error in argument 1 of new_string_vector. "
...
XS(_wrap_new_string_vector) {
  ...
  dispatch:
    switch(_index) {
    case 1:
      PUSHMARK(MARK); SWIG_CALLXS(_wrap_new_string_vector__SWIG_1); return;
    case 2:
      PUSHMARK(MARK); SWIG_CALLXS(_wrap_new_string_vector__SWIG_0); return;
    case 3:
      PUSHMARK(MARK); SWIG_CALLXS(_wrap_new_string_vector__SWIG_3); return;
    case 4:
      PUSHMARK(MARK); SWIG_CALLXS(_wrap_new_string_vector__SWIG_2); return;
    }
  }
  
  croak("No matching function for overloaded 'new_string_vector'");
  XSRETURN(0);
}


XS(_wrap_string_vector_size) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: string_vector_size(self);");
    }
    {
      if (SWIG_ConvertPtr(ST(0),(void **) &v1, 
          SWIGTYPE_p_std__vectorT_std__string_t,1) != -1) {
        ...
        AV *av = (AV *)SvRV(ST(0));
        if (SvTYPE(av) != SVt_PVAV)
        SWIG_croak("Type error in argument 1 of string_vector_size. "
          "Expected an array of ""std::string");
        SV **tv;
        I32 len = av_len(av) + 1;
        for (int i=0; i<len; i++) {
...
XS(_wrap_string_vector_empty) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: string_vector_empty(self);");
    }
    {
      if (SWIG_ConvertPtr(ST(0),(void **) &v1, 
          SWIGTYPE_p_std__vectorT_std__string_t,1) != -1) {
        ...
        AV *av = (AV *)SvRV(ST(0));
        if (SvTYPE(av) != SVt_PVAV)
        SWIG_croak("Type error in argument 1 of string_vector_empty. "
          "Expected an array of ""std::string");
        SV **tv;
        I32 len = av_len(av) + 1;
        for (int i=0; i<len; i++) {
...
XS(_wrap_string_vector_clear) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: string_vector_clear(self);");
    }
...
XS(_wrap_string_vector_push) {
  {
    ...
    if ((items < 2) || (items > 2)) {
      SWIG_croak("Usage: string_vector_push(self,x);");
    }
    res1 = SWIG_ConvertPtr(ST(0), &argp1,SWIGTYPE_p_std__vectorT_std__string_t, 0 |  0 );
    if (!SWIG_IsOK(res1)) {
...
XS(_wrap_string_vector_pop) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: string_vector_pop(self);");
    }
    res1 = SWIG_ConvertPtr(ST(0), &argp1,SWIGTYPE_p_std__vectorT_std__string_t, 0 |  0 );
    if (!SWIG_IsOK(res1)) {
...
XS(_wrap_string_vector_get) {
  {
    ...
    if ((items < 2) || (items > 2)) {
      SWIG_croak("Usage: string_vector_get(self,i);");
    }
    res1 = SWIG_ConvertPtr(ST(0), &argp1,SWIGTYPE_p_std__vectorT_std__string_t, 0 |  0 );
    if (!SWIG_IsOK(res1)) {
...
XS(_wrap_string_vector_set) {
  {
    ...
    if ((items < 3) || (items > 3)) {
      SWIG_croak("Usage: string_vector_set(self,i,x);");
    }
    res1 = SWIG_ConvertPtr(ST(0), &argp1,SWIGTYPE_p_std__vectorT_std__string_t, 0 |  0 );
    if (!SWIG_IsOK(res1)) {
...
XS(_wrap_delete_string_vector) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: delete_string_vector(self);");
    }
...
static swig_type_info _swigt__p_std__vectorT_std__string_t = {"_p_std__vectorT_std__string_t", "std::vector< std::string > *", 0, 0, (void*)"template_type_namespace::string_vector", 0};
...
{"template_type_namespacec::new_string_vector", _wrap_new_string_vector},
{"template_type_namespacec::string_vector_size", _wrap_string_vector_size},
{"template_type_namespacec::string_vector_empty", _wrap_string_vector_empty},
{"template_type_namespacec::string_vector_clear", _wrap_string_vector_clear},
{"template_type_namespacec::string_vector_push", _wrap_string_vector_push},
{"template_type_namespacec::string_vector_pop", _wrap_string_vector_pop},
{"template_type_namespacec::string_vector_get", _wrap_string_vector_get},
{"template_type_namespacec::string_vector_set", _wrap_string_vector_set},
{"template_type_namespacec::delete_string_vector", _wrap_delete_string_vector},
{"template_type_namespacec::foo", _wrap_foo},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
...
XS(SWIG_init) {
  ...
  SWIG_TypeClientData(SWIGTYPE_p_std__vectorT_std__string_t, (void*) "template_type_namespace::string_vector");
  ST(0) = &PL_sv_yes;
  XSRETURN(1);
}
