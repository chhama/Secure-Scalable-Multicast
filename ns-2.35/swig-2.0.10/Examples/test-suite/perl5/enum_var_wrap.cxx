...
#define SWIG_init    boot_enum_var

#define SWIG_name   "enum_varc::boot_enum_var"
#define SWIG_prefix "enum_varc::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_enum_var_var::
class _wrap_enum_var_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
SWIGCLASS_STATIC int _wrap_test_set(pTHX_ SV* sv, MAGIC * SWIGUNUSEDPARM(mg)) {
  MAGIC_PPERL
  if (sizeof(int) != sizeof(test)) {
    SWIG_exception_fail(SWIG_ArgError(SWIG_AttributeError), "in variable '""arch, read-only test""' of type '""Fruit""'");
  }  else {
    int ecode = SWIG_AsVal_int SWIG_PERL_CALL_ARGS_2(sv, reinterpret_cast< int* >(&test));
    if (!SWIG_IsOK(ecode)) {
      SWIG_exception_fail(SWIG_ArgError(ecode), "in variable '""test""' of type '""Fruit""'");
    }
  }
fail:
  return 1;
...
SWIGCLASS_STATIC int _wrap_test_get(pTHX_ SV *sv, MAGIC *SWIGUNUSEDPARM(mg)) {
  MAGIC_PPERL
  sv_setsv(sv,SWIG_From_int  SWIG_PERL_CALL_ARGS_1(static_cast< int >(test)))  ;
  return 1;
}
...
static swig_variable_info swig_variables[] = {
    { "enum_varc::test", MAGIC_CLASS _wrap_test_set, MAGIC_CLASS _wrap_test_get,0 },
{0,0,0,0}
};
...
XS(SWIG_init) {
  ...
  /*@SWIG:/home/chhama/Dropbox/mtp/o-ns-allinone-2.35.1/ns-2.35/swig-2.0.10/Lib/perl5/perltypemaps.swg,65,%set_constant@*/ do {
    SV *sv = get_sv((char*) SWIG_prefix "APPLE", TRUE | 0x2 | GV_ADDMULTI);
    sv_setsv(sv, SWIG_From_int  SWIG_PERL_CALL_ARGS_1(static_cast< int >(APPLE)));
    SvREADONLY_on(sv);
  } while(0) /*@SWIG@*/;
  /*@SWIG:/home/chhama/Dropbox/mtp/o-ns-allinone-2.35.1/ns-2.35/swig-2.0.10/Lib/perl5/perltypemaps.swg,65,%set_constant@*/ do {
    SV *sv = get_sv((char*) SWIG_prefix "PEAR", TRUE | 0x2 | GV_ADDMULTI);
    sv_setsv(sv, SWIG_From_int  SWIG_PERL_CALL_ARGS_1(static_cast< int >(PEAR)));
    SvREADONLY_on(sv);
  } while(0) /*@SWIG@*/;
  ST(0) = &PL_sv_yes;
  XSRETURN(1);
