...
#define SWIG_init    boot_sneaky1

#define SWIG_name   "sneaky1c::boot_sneaky1"
#define SWIG_prefix "sneaky1c::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_sneaky1_var::
class _wrap_sneaky1_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
XS(_wrap_subtract) {
  {
    ...
    if ((items < 2) || (items > 2)) {
      SWIG_croak("Usage: subtract(int,int);");
    }
    ecode1 = SWIG_AsVal_int SWIG_PERL_CALL_ARGS_2(ST(0), &val1);
    if (!SWIG_IsOK(ecode1)) {
...
XS(_wrap_divide) {
  {
    ...
    if ((items < 2) || (items > 2)) {
      SWIG_croak("Usage: divide(int,int);");
    }
    ecode1 = SWIG_AsVal_int SWIG_PERL_CALL_ARGS_2(ST(0), &val1);
    if (!SWIG_IsOK(ecode1)) {
...
{"sneaky1c::add", _wrap_add},
{"sneaky1c::subtract", _wrap_subtract},
{"sneaky1c::mul", _wrap_mul},
{"sneaky1c::divide", _wrap_divide},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
