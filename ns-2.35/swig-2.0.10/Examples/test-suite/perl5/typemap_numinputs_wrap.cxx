...
#define SWIG_init    boot_typemap_numinputs

#define SWIG_name   "typemap_numinputsc::boot_typemap_numinputs"
#define SWIG_prefix "typemap_numinputsc::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_typemap_numinputs_var::
class _wrap_typemap_numinputs_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
XS(_wrap_this_breaks) {
  {
    ...
    if ((items < 3) || (items > 3)) {
      SWIG_croak("Usage: this_breaks(hello,STR,LEN,OUTPUT);");
    }
    {
      arg1 = 0;
    }
...
{"typemap_numinputsc::this_breaks", _wrap_this_breaks},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
