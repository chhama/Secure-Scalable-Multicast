...
#define SWIG_init    boot_overload_copy

#define SWIG_name   "overload_copyc::boot_overload_copy"
#define SWIG_prefix "overload_copyc::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_overload_copy_var::
class _wrap_overload_copy_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
static swig_type_info _swigt__p_Foo = {"_p_Foo", "Foo *", 0, 0, (void*)"overload_copy::Foo", 0};
...
{"overload_copyc::new_Foo", _wrap_new_Foo},
{"overload_copyc::delete_Foo", _wrap_delete_Foo},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
...
XS(SWIG_init) {
  ...
  SWIG_TypeClientData(SWIGTYPE_p_Foo, (void*) "overload_copy::Foo");
  ST(0) = &PL_sv_yes;
  XSRETURN(1);
}
