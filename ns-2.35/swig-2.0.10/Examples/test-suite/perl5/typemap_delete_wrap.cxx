...
#define SWIG_init    boot_typemap_delete

#define SWIG_name   "typemap_deletec::boot_typemap_delete"
#define SWIG_prefix "typemap_deletec::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_typemap_delete_var::
class _wrap_typemap_delete_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
XS(_wrap_Rect_val_set) {
  {
    ...
    if ((items < 2) || (items > 2)) {
      SWIG_croak("Usage: Rect_val_set(self,val);");
    }
    res1 = SWIG_ConvertPtr(ST(0), &argp1,SWIGTYPE_p_Rect, 0 |  0 );
    if (!SWIG_IsOK(res1)) {
...
XS(_wrap_Rect_val_get) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: Rect_val_get(self);");
    }
    res1 = SWIG_ConvertPtr(ST(0), &argp1,SWIGTYPE_p_Rect, 0 |  0 );
    if (!SWIG_IsOK(res1)) {
...
XS(_wrap_new_Rect) {
  {
    ...
    ST(argvi) = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_Rect, SWIG_OWNER | SWIG_SHADOW); argvi++ ;
...
XS(_wrap_delete_Rect) {
  {
    ...
    res1 = SWIG_ConvertPtr(ST(0), &argp1,SWIGTYPE_p_Rect, SWIG_POINTER_DISOWN |  0 );
    if (!SWIG_IsOK(res1)) {
...
static swig_type_info _swigt__p_Rect = {"_p_Rect", "Rect *", 0, 0, (void*)"typemap_delete::Rect", 0};
...
{"typemap_deletec::Rect_val_set", _wrap_Rect_val_set},
{"typemap_deletec::Rect_val_get", _wrap_Rect_val_get},
{"typemap_deletec::new_Rect", _wrap_new_Rect},
{"typemap_deletec::delete_Rect", _wrap_delete_Rect},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
...
XS(SWIG_init) {
  ...
  SWIG_TypeClientData(SWIGTYPE_p_Rect, (void*) "typemap_delete::Rect");
  ST(0) = &PL_sv_yes;
  XSRETURN(1);
}
