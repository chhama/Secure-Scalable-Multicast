...
#define SWIG_init    boot_extern_declaration

#define SWIG_name   "extern_declarationc::boot_extern_declaration"
#define SWIG_prefix "extern_declarationc::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_extern_declaration_var::
class _wrap_extern_declaration_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
XS(_wrap_externimport) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: externimport(i);");
    }
...
XS(_wrap_externexport) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: externexport(int);");
    }
    ecode1 = SWIG_AsVal_int SWIG_PERL_CALL_ARGS_2(ST(0), &val1);
    if (!SWIG_IsOK(ecode1)) {
...
XS(_wrap_externstdcall) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: externstdcall(int);");
    }
    ecode1 = SWIG_AsVal_int SWIG_PERL_CALL_ARGS_2(ST(0), &val1);
    if (!SWIG_IsOK(ecode1)) {
...
{"extern_declarationc::externimport", _wrap_externimport},
{"extern_declarationc::externexport", _wrap_externexport},
{"extern_declarationc::externstdcall", _wrap_externstdcall},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
