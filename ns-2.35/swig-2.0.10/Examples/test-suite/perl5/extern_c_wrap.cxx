...
#define SWIG_init    boot_extern_c

#define SWIG_name   "extern_cc::boot_extern_c"
#define SWIG_prefix "extern_cc::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_extern_c_var::
class _wrap_extern_c_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
XS(_wrap_RealFunction) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: RealFunction(value);");
    }
...
{"extern_cc::RealFunction", _wrap_RealFunction},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
