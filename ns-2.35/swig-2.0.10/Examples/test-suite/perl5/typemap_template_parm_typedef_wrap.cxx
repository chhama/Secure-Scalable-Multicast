...
#define SWIG_init    boot_typemap_template_parm_typedef

#define SWIG_name   "typemap_template_parm_typedefc::boot_typemap_template_parm_typedef"
#define SWIG_prefix "typemap_template_parm_typedefc::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_typemap_template_parm_typedef_var::
class _wrap_typemap_template_parm_typedef_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
XS(_wrap_test_no_typedef) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: test_no_typedef(bada);");
    }
    {
      arg1 = tmp1;
    }
...
XS(_wrap_test_typedef) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: test_typedef(bada);");
    }
    {
      arg1 = tmp1;
    }
...
XS(_wrap_no_typedef_out) {
  {
    ...
    if ((items < 0) || (items > 0)) {
      SWIG_croak("Usage: no_typedef_out();");
    }
...
{"typemap_template_parm_typedefc::test_no_typedef", _wrap_test_no_typedef},
{"typemap_template_parm_typedefc::test_typedef", _wrap_test_typedef},
{"typemap_template_parm_typedefc::no_typedef_out", _wrap_no_typedef_out},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
