...
#define SWIG_init    boot_newobject2

#define SWIG_name   "newobject2c::boot_newobject2"
#define SWIG_prefix "newobject2c::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_newobject2_var::
class _wrap_newobject2_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
static swig_type_info _swigt__p_Foo = {"_p_Foo", "Foo *", 0, 0, (void*)"newobject2::Foo", 0};
...
{"newobject2c::Foo_dummy_set", _wrap_Foo_dummy_set},
{"newobject2c::Foo_dummy_get", _wrap_Foo_dummy_get},
{"newobject2c::delete_Foo", _wrap_delete_Foo},
{"newobject2c::new_Foo", _wrap_new_Foo},
{"newobject2c::makeFoo", _wrap_makeFoo},
{"newobject2c::fooCount", _wrap_fooCount},
{"newobject2c::do_stuff", _wrap_do_stuff},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
...
XS(SWIG_init) {
  ...
  SWIG_TypeClientData(SWIGTYPE_p_Foo, (void*) "newobject2::Foo");
  ST(0) = &PL_sv_yes;
  XSRETURN(1);
}
