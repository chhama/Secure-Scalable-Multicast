...
#define SWIG_init    boot_import_stl_b

#define SWIG_name   "import_stl_bc::boot_import_stl_b"
#define SWIG_prefix "import_stl_bc::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_import_stl_b_var::
class _wrap_import_stl_b_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
XS(_wrap_process_vector) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: process_vector(v);");
    }
    {
      if (SWIG_ConvertPtr(ST(0),(void **) &v1, 
        ...
        SWIG_croak("Type error in argument 1 of process_vector. "
...
{"import_stl_bc::process_vector", _wrap_process_vector},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
