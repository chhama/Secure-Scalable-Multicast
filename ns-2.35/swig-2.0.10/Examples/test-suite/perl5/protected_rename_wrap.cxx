...
#define SWIG_init    boot_protected_rename

#define SWIG_name   "protected_renamec::boot_protected_rename"
#define SWIG_prefix "protected_renamec::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_protected_rename_var::
class _wrap_protected_rename_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
XS(_wrap_Foo_x) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: Foo_x(self);");
    }
    res1 = SWIG_ConvertPtr(ST(0), &argp1,SWIGTYPE_p_Foo, 0 |  0 );
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Foo_x" "', argument " "1"" of type '" "Foo *""'"); 
    }
...
static swig_type_info _swigt__p_Foo = {"_p_Foo", "Foo *", 0, 0, (void*)"protected_rename::Foo", 0};
...
{"protected_renamec::Foo_x", _wrap_Foo_x},
{"protected_renamec::new_Foo", _wrap_new_Foo},
{"protected_renamec::delete_Foo", _wrap_delete_Foo},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
...
XS(SWIG_init) {
  ...
  SWIG_TypeClientData(SWIGTYPE_p_Foo, (void*) "protected_rename::Foo");
  ST(0) = &PL_sv_yes;
  XSRETURN(1);
}
