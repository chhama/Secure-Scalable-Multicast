...
#define SWIG_init    boot_name

#define SWIG_name   "namec::boot_name"
#define SWIG_prefix "namec::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_name_var::
class _wrap_name_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
SWIGCLASS_STATIC int _wrap_bar_2_set(pTHX_ SV* sv, MAGIC * SWIGUNUSEDPARM(mg)) {
  MAGIC_PPERL
  {
    int val;
...
SWIGCLASS_STATIC int _wrap_bar_2_get(pTHX_ SV *sv, MAGIC *SWIGUNUSEDPARM(mg)) {
  MAGIC_PPERL
  sv_setsv(sv,SWIG_From_int  SWIG_PERL_CALL_ARGS_1((int)(bar_1)))  ;
  return 1;
}
...
static swig_variable_info swig_variables[] = {
    { "namec::bar_2", MAGIC_CLASS _wrap_bar_2_set, MAGIC_CLASS _wrap_bar_2_get,0 },
{0,0,0,0}
};
static swig_command_info swig_commands[] = {
{"namec::foo_2", _wrap_foo_2},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
...
XS(SWIG_init) {
  ...
  /*@SWIG:/home/chhama/Dropbox/mtp/o-ns-allinone-2.35.1/ns-2.35/swig-2.0.10/Lib/perl5/perltypemaps.swg,65,%set_constant@*/ do {
    SV *sv = get_sv((char*) SWIG_prefix "Baz_2", TRUE | 0x2 | GV_ADDMULTI);
