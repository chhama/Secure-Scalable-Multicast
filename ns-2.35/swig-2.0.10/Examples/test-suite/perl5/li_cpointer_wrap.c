...
#define SWIG_init    boot_li_cpointer

#define SWIG_name   "li_cpointerc::boot_li_cpointer"
#define SWIG_prefix "li_cpointerc::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_li_cpointer_var::
class _wrap_li_cpointer_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
XS(_wrap_new_doublep) {
  {
    ...
    ST(argvi) = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_doublep, SWIG_OWNER | SWIG_SHADOW); argvi++ ;
    XSRETURN(argvi);
  fail:
    SWIG_croak_null();
  }
...
XS(_wrap_delete_doublep) {
  {
    ...
    res1 = SWIG_ConvertPtr(ST(0), &argp1,SWIGTYPE_p_doublep, SWIG_POINTER_DISOWN |  0 );
    if (!SWIG_IsOK(res1)) {
...
XS(_wrap_doublep_assign) {
  {
    ...
    res1 = SWIG_ConvertPtr(ST(0), &argp1,SWIGTYPE_p_doublep, 0 |  0 );
    if (!SWIG_IsOK(res1)) {
...
XS(_wrap_doublep_frompointer) {
  {
    ...
    ST(argvi) = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_doublep, 0 | SWIG_SHADOW); argvi++ ;
...
XS(_wrap_int_to_uint) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: int_to_uint(x);");
    }
    ecode1 = SWIG_AsVal_int SWIG_PERL_CALL_ARGS_2(ST(0), &val1);
    if (!SWIG_IsOK(ecode1)) {
...
static swig_type_info _swigt__p_doublep = {"_p_doublep", "doublep *", 0, 0, (void*)"li_cpointer::doublep", 0};
...
{"li_cpointerc::new_intp", _wrap_new_intp},
{"li_cpointerc::copy_intp", _wrap_copy_intp},
{"li_cpointerc::delete_intp", _wrap_delete_intp},
{"li_cpointerc::intp_assign", _wrap_intp_assign},
{"li_cpointerc::intp_value", _wrap_intp_value},
{"li_cpointerc::new_doublep", _wrap_new_doublep},
{"li_cpointerc::delete_doublep", _wrap_delete_doublep},
{"li_cpointerc::doublep_assign", _wrap_doublep_assign},
{"li_cpointerc::doublep_value", _wrap_doublep_value},
{"li_cpointerc::doublep_cast", _wrap_doublep_cast},
{"li_cpointerc::doublep_frompointer", _wrap_doublep_frompointer},
{"li_cpointerc::int_to_uint", _wrap_int_to_uint},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
...
XS(SWIG_init) {
  ...
  SWIG_TypeClientData(SWIGTYPE_p_doublep, (void*) "li_cpointer::doublep");
  ST(0) = &PL_sv_yes;
  XSRETURN(1);
}
