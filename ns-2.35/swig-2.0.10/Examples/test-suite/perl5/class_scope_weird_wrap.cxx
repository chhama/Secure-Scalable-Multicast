...
#define SWIG_init    boot_class_scope_weird

#define SWIG_name   "class_scope_weirdc::boot_class_scope_weird"
#define SWIG_prefix "class_scope_weirdc::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_class_scope_weird_var::
class _wrap_class_scope_weird_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
XS(_wrap_new_Quat__SWIG_0) {
  {
    ...
    if ((items < 0) || (items > 0)) {
      SWIG_croak("Usage: new_Quat();");
    }
    result = (Quat *)new Quat();
    ST(argvi) = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_Quat, SWIG_OWNER | SWIG_SHADOW); argvi++ ;
    XSRETURN(argvi);
  fail:
    SWIG_croak_null();
  }
...
XS(_wrap_new_Quat__SWIG_1) {
  {
    ...
    if ((items < 4) || (items > 4)) {
      SWIG_croak("Usage: new_Quat(in_w,x,y,z);");
    }
...
XS(_wrap_new_Quat__SWIG_2) {
  {
    ...
    if ((items < 2) || (items > 2)) {
      SWIG_croak("Usage: new_Quat(axis,angle);");
    }
    res1 = SWIG_ConvertPtr(ST(0), &argp1, SWIGTYPE_p_tacka3,  0 );
    if (!SWIG_IsOK(res1)) {
...
XS(_wrap_new_Quat__SWIG_3) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: new_Quat(m);");
    }
    res1 = SWIG_ConvertPtr(ST(0), &argp1, SWIGTYPE_p_matrix4,  0 );
    if (!SWIG_IsOK(res1)) {
...
XS(_wrap_new_Quat) {
  ...
  
  {
    ...
    if (items == 1) {
      ...
      {
        void *vptr = 0;
        int res = SWIG_ConvertPtr(ST(0), &vptr, SWIGTYPE_p_matrix4, 0);
        _v = SWIG_CheckState(res);
      }
      if (!_v) goto check_2;
      _ranki += _v*_pi;
  ...
  check_2:
    ...
    if (items == 2) {
      ...
      {
        void *vptr = 0;
        int res = SWIG_ConvertPtr(ST(0), &vptr, SWIGTYPE_p_tacka3, 0);
        _v = SWIG_CheckState(res);
      }
      if (!_v) goto check_3;
      _ranki += _v*_pi;
  ...
  dispatch:
    switch(_index) {
    case 1:
      PUSHMARK(MARK); SWIG_CALLXS(_wrap_new_Quat__SWIG_0); return;
    case 2:
      PUSHMARK(MARK); SWIG_CALLXS(_wrap_new_Quat__SWIG_3); return;
    case 3:
      PUSHMARK(MARK); SWIG_CALLXS(_wrap_new_Quat__SWIG_2); return;
    case 4:
      PUSHMARK(MARK); SWIG_CALLXS(_wrap_new_Quat__SWIG_1); return;
    }
  }
  
  croak("No matching function for overloaded 'new_Quat'");
  XSRETURN(0);
}


XS(_wrap_delete_Quat) {
  {
    Quat *arg1 = (Quat *) 0 ;
    void *argp1 = 0 ;
    int res1 = 0 ;
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: delete_Quat(self);");
    }
    res1 = SWIG_ConvertPtr(ST(0), &argp1,SWIGTYPE_p_Quat, SWIG_POINTER_DISOWN |  0 );
    if (!SWIG_IsOK(res1)) {
...
static swig_type_info _swigt__p_Foo = {"_p_Foo", "Foo *", 0, 0, (void*)"class_scope_weird::Foo", 0};
static swig_type_info _swigt__p_Quat = {"_p_Quat", "Quat *", 0, 0, (void*)"class_scope_weird::Quat", 0};
...
{"class_scope_weirdc::new_Foo", _wrap_new_Foo},
{"class_scope_weirdc::Foo_bar", _wrap_Foo_bar},
{"class_scope_weirdc::delete_Foo", _wrap_delete_Foo},
{"class_scope_weirdc::new_Quat", _wrap_new_Quat},
{"class_scope_weirdc::delete_Quat", _wrap_delete_Quat},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
...
XS(SWIG_init) {
  ...
  SWIG_TypeClientData(SWIGTYPE_p_Foo, (void*) "class_scope_weird::Foo");
  SWIG_TypeClientData(SWIGTYPE_p_Quat, (void*) "class_scope_weird::Quat");
  ST(0) = &PL_sv_yes;
  XSRETURN(1);
}
