...
#define SWIG_init    boot_li_cstring

#define SWIG_name   "li_cstringc::boot_li_cstring"
#define SWIG_prefix "li_cstringc::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_li_cstring_var::
class _wrap_li_cstring_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
XS(_wrap_count) {
  {
    ...
    if ((items < 2) || (items > 2)) {
      SWIG_croak("Usage: count(str_in,n,c);");
    }
    ...
    arg1 = (char *) buf1;					       
    arg2 = (int) size1 - 1;
    ecode3 = SWIG_AsVal_char SWIG_PERL_CALL_ARGS_2(ST(1), &val3);
    if (!SWIG_IsOK(ecode3)) {
...
XS(_wrap_test2) {
  {
    ...
    test2(arg1);
    ST(argvi) = sv_newmortal();
    if (argvi >= items) EXTEND(sp,1);  ST(argvi) = SWIG_FromCharPtrAndSize(arg1,64); argvi++  ;
    XSRETURN(argvi);
  fail:
    SWIG_croak_null();
  }
...
XS(_wrap_test3) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: test3(out3);");
    }
    res1 = SWIG_AsCharPtrAndSize(ST(0), &t1, &n1, &alloc1);
    if (!SWIG_IsOK(res1)) {
...
XS(_wrap_test5) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: test5(out5,max);");
    }
...
XS(_wrap_test6) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: test6(out6,size);");
    }
    res1 = SWIG_AsVal_size_t SWIG_PERL_CALL_ARGS_2(ST(0), &n1);
    if (!SWIG_IsOK(res1)) {
...
{"li_cstringc::count", _wrap_count},
{"li_cstringc::test1", _wrap_test1},
{"li_cstringc::test2", _wrap_test2},
{"li_cstringc::test3", _wrap_test3},
{"li_cstringc::test4", _wrap_test4},
{"li_cstringc::test5", _wrap_test5},
{"li_cstringc::test6", _wrap_test6},
{"li_cstringc::test7", _wrap_test7},
{"li_cstringc::test8", _wrap_test8},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
