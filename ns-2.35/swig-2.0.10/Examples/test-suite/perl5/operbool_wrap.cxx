...
#define SWIG_init    boot_operbool

#define SWIG_name   "operboolc::boot_operbool"
#define SWIG_prefix "operboolc::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_operbool_var::
class _wrap_operbool_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
XS(_wrap_Test_operator_bool) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: Test_operator_bool(self);");
    }
    res1 = SWIG_ConvertPtr(ST(0), &argp1,SWIGTYPE_p_Test, 0 |  0 );
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Test_operator_bool" "', argument " "1"" of type '" "Test *""'"); 
    }
...
static swig_type_info _swigt__p_Test = {"_p_Test", "Test *", 0, 0, (void*)"operbool::Test", 0};
...
{"operboolc::Test_operator_bool", _wrap_Test_operator_bool},
{"operboolc::new_Test", _wrap_new_Test},
{"operboolc::delete_Test", _wrap_delete_Test},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
...
XS(SWIG_init) {
  ...
  SWIG_TypeClientData(SWIGTYPE_p_Test, (void*) "operbool::Test");
  ST(0) = &PL_sv_yes;
  XSRETURN(1);
}
