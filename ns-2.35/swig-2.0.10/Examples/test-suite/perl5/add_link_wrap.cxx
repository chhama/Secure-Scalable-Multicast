...
#define SWIG_init    boot_add_link

#define SWIG_name   "add_linkc::boot_add_link"
#define SWIG_prefix "add_linkc::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_add_link_var::
class _wrap_add_link_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
static swig_type_info _swigt__p_Foo = {"_p_Foo", "Foo *", 0, 0, (void*)"add_link::Foo", 0};
...
{"add_linkc::new_Foo", _wrap_new_Foo},
{"add_linkc::Foo_blah", _wrap_Foo_blah},
{"add_linkc::delete_Foo", _wrap_delete_Foo},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
...
XS(SWIG_init) {
  ...
  SWIG_TypeClientData(SWIGTYPE_p_Foo, (void*) "add_link::Foo");
  ST(0) = &PL_sv_yes;
  XSRETURN(1);
}
