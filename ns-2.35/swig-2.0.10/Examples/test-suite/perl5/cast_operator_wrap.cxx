...
#define SWIG_init    boot_cast_operator

#define SWIG_name   "cast_operatorc::boot_cast_operator"
#define SWIG_prefix "cast_operatorc::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_cast_operator_var::
class _wrap_cast_operator_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
XS(_wrap_A_tochar) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: A_tochar(self);");
    }
...
static swig_type_info _swigt__p_A = {"_p_A", "A *", 0, 0, (void*)"cast_operator::A", 0};
...
{"cast_operatorc::A_tochar", _wrap_A_tochar},
{"cast_operatorc::new_A", _wrap_new_A},
{"cast_operatorc::delete_A", _wrap_delete_A},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
...
XS(SWIG_init) {
  ...
  SWIG_TypeClientData(SWIGTYPE_p_A, (void*) "cast_operator::A");
  ST(0) = &PL_sv_yes;
  XSRETURN(1);
}
