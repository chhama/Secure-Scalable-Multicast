...
#define SWIG_init    boot_typemap_manyargs

#define SWIG_name   "typemap_manyargsc::boot_typemap_manyargs"
#define SWIG_prefix "typemap_manyargsc::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_typemap_manyargs_var::
class _wrap_typemap_manyargs_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
XS(_wrap_my_c_function) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: my_c_function(filename,a2,a3,a4,a5,a6,a7,a8,a9,a10);");
    }
...
{"typemap_manyargsc::my_c_function", _wrap_my_c_function},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
