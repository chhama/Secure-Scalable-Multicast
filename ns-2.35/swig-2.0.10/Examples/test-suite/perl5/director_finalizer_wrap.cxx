...
#define SWIG_init    boot_director_finalizer

#define SWIG_name   "director_finalizerc::boot_director_finalizer"
#define SWIG_prefix "director_finalizerc::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_director_finalizer_var::
class _wrap_director_finalizer_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
XS(_wrap_Foo_orStatus) {
  {
    ...
    if ((items < 2) || (items > 2)) {
      SWIG_croak("Usage: Foo_orStatus(self,x);");
    }
...
XS(_wrap_resetStatus) {
  {
    int argvi = 0;
    dXSARGS;
    
    if ((items < 0) || (items > 0)) {
      SWIG_croak("Usage: resetStatus();");
    }
    resetStatus();
    ST(argvi) = sv_newmortal();
    XSRETURN(argvi);
...
static swig_type_info _swigt__p_Foo = {"_p_Foo", "Foo *", 0, 0, (void*)"director_finalizer::Foo", 0};
...
{"director_finalizerc::delete_Foo", _wrap_delete_Foo},
{"director_finalizerc::Foo_orStatus", _wrap_Foo_orStatus},
{"director_finalizerc::new_Foo", _wrap_new_Foo},
{"director_finalizerc::deleteFoo", _wrap_deleteFoo},
{"director_finalizerc::getStatus", _wrap_getStatus},
{"director_finalizerc::launder", _wrap_launder},
{"director_finalizerc::resetStatus", _wrap_resetStatus},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
...
XS(SWIG_init) {
  ...
  SWIG_TypeClientData(SWIGTYPE_p_Foo, (void*) "director_finalizer::Foo");
  ST(0) = &PL_sv_yes;
  XSRETURN(1);
}
