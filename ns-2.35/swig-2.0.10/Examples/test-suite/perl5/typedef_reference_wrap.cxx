...
#define SWIG_init    boot_typedef_reference

#define SWIG_name   "typedef_referencec::boot_typedef_reference"
#define SWIG_prefix "typedef_referencec::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_typedef_reference_var::
class _wrap_typedef_reference_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
XS(_wrap_somefunc) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: somefunc(i);");
    }
    res1 = SWIG_ConvertPtr(ST(0), &argp1, SWIGTYPE_p_int,  0 );
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "somefunc" "', argument " "1"" of type '" "IntRef""'"); 
    }
    if (!argp1) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "somefunc" "', argument " "1"" of type '" "IntRef""'"); 
    }
    arg1 = reinterpret_cast< int * >(argp1);
...
XS(_wrap_otherfunc) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: otherfunc(i);");
    }
    res1 = SWIG_ConvertPtr(ST(0), &argp1, SWIGTYPE_p_int,  0 );
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "otherfunc" "', argument " "1"" of type '" "int &""'"); 
    }
    if (!argp1) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "otherfunc" "', argument " "1"" of type '" "int &""'"); 
    }
    arg1 = reinterpret_cast< int * >(argp1);
...
{"typedef_referencec::new_intp", _wrap_new_intp},
{"typedef_referencec::copy_intp", _wrap_copy_intp},
{"typedef_referencec::delete_intp", _wrap_delete_intp},
{"typedef_referencec::intp_assign", _wrap_intp_assign},
{"typedef_referencec::intp_value", _wrap_intp_value},
{"typedef_referencec::somefunc", _wrap_somefunc},
{"typedef_referencec::otherfunc", _wrap_otherfunc},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
