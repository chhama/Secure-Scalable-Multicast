...
#define SWIG_init    boot_redefined

#define SWIG_name   "redefinedc::boot_redefined"
#define SWIG_prefix "redefinedc::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_redefined_var::
class _wrap_redefined_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
static swig_type_info _swigt__p_A = {"_p_A", "A *", 0, 0, (void*)"redefined::A", 0};
static swig_type_info _swigt__p_B = {"_p_B", "B *", 0, 0, (void*)"redefined::B", 0};
...
{"redefinedc::hello", _wrap_hello},
{"redefinedc::foo", _wrap_foo},
{"redefinedc::new_A", _wrap_new_A},
{"redefinedc::delete_A", _wrap_delete_A},
{"redefinedc::new_B", _wrap_new_B},
{"redefinedc::delete_B", _wrap_delete_B},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
...
XS(SWIG_init) {
  ...
  /*@SWIG:/home/chhama/Dropbox/mtp/o-ns-allinone-2.35.1/ns-2.35/swig-2.0.10/Lib/perl5/perltypemaps.swg,65,%set_constant@*/ do {
    SV *sv = get_sv((char*) SWIG_prefix "agua", TRUE | 0x2 | GV_ADDMULTI);
    sv_setsv(sv, SWIG_From_int  SWIG_PERL_CALL_ARGS_1(static_cast< int >(0)));
    SvREADONLY_on(sv);
  } while(0) /*@SWIG@*/;
  /*@SWIG:/home/chhama/Dropbox/mtp/o-ns-allinone-2.35.1/ns-2.35/swig-2.0.10/Lib/perl5/perltypemaps.swg,65,%set_constant@*/ do {
    SV *sv = get_sv((char*) SWIG_prefix "REDUNDANT", TRUE | 0x2 | GV_ADDMULTI);
    sv_setsv(sv, SWIG_From_int  SWIG_PERL_CALL_ARGS_1(static_cast< int >(1)));
    SvREADONLY_on(sv);
  } while(0) /*@SWIG@*/;
  SWIG_TypeClientData(SWIGTYPE_p_A, (void*) "redefined::A");
  SWIG_TypeClientData(SWIGTYPE_p_B, (void*) "redefined::B");
  ST(0) = &PL_sv_yes;
  XSRETURN(1);
}
