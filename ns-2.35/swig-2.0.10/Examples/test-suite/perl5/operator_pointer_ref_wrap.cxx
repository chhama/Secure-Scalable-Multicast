...
#define SWIG_init    boot_operator_pointer_ref

#define SWIG_name   "operator_pointer_refc::boot_operator_pointer_ref"
#define SWIG_prefix "operator_pointer_refc::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_operator_pointer_ref_var::
class _wrap_operator_pointer_ref_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
XS(_wrap_new_MyClass__SWIG_0) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: new_MyClass(s_);");
    }
    res1 = SWIG_AsCharPtrAndSize(ST(0), &buf1, NULL, &alloc1);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "new_MyClass" "', argument " "1"" of type '" "char const *""'");
    }
...
XS(_wrap_MyClass_AsCharStarRef) {
  {
    MyClass *arg1 = (MyClass *) 0 ;
    void *argp1 = 0 ;
    int res1 = 0 ;
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: MyClass_AsCharStarRef(self);");
    }
    res1 = SWIG_ConvertPtr(ST(0), &argp1,SWIGTYPE_p_MyClass, 0 |  0 );
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MyClass_AsCharStarRef" "', argument " "1"" of type '" "MyClass *""'"); 
    }
    arg1 = reinterpret_cast< MyClass * >(argp1);
...
static swig_type_info _swigt__p_MyClass = {"_p_MyClass", "MyClass *", 0, 0, (void*)"operator_pointer_ref::MyClass", 0};
...
{"operator_pointer_refc::new_MyClass", _wrap_new_MyClass},
{"operator_pointer_refc::delete_MyClass", _wrap_delete_MyClass},
{"operator_pointer_refc::MyClass_AsCharStarRef", _wrap_MyClass_AsCharStarRef},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
...
XS(SWIG_init) {
  ...
  SWIG_TypeClientData(SWIGTYPE_p_MyClass, (void*) "operator_pointer_ref::MyClass");
  ST(0) = &PL_sv_yes;
  XSRETURN(1);
}
