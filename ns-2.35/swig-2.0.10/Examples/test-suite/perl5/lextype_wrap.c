...
#define SWIG_init    boot_lextype

#define SWIG_name   "lextypec::boot_lextype"
#define SWIG_prefix "lextypec::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_lextype_var::
class _wrap_lextype_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
{"lextypec::eat", _wrap_eat},
{"lextypec::drink", _wrap_drink},
{"lextypec::mate", _wrap_mate},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
...
XS(SWIG_init) {
  ...
  /*@SWIG:/home/chhama/Dropbox/mtp/o-ns-allinone-2.35.1/ns-2.35/swig-2.0.10/Lib/perl5/perltypemaps.swg,65,%set_constant@*/ do {
    SV *sv = get_sv((char*) SWIG_prefix "HEIGHT_Giraffe", TRUE | 0x2 | GV_ADDMULTI);
    sv_setsv(sv, SWIG_From_int  SWIG_PERL_CALL_ARGS_1((int)(100)));
    SvREADONLY_on(sv);
  } while(0) /*@SWIG@*/;
  /*@SWIG:/home/chhama/Dropbox/mtp/o-ns-allinone-2.35.1/ns-2.35/swig-2.0.10/Lib/perl5/perltypemaps.swg,65,%set_constant@*/ do {
    SV *sv = get_sv((char*) SWIG_prefix "WIDTH_Giraffe", TRUE | 0x2 | GV_ADDMULTI);
