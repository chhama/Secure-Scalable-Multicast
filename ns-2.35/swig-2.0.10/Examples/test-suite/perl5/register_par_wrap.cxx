...
#define SWIG_init    boot_register_par

#define SWIG_name   "register_parc::boot_register_par"
#define SWIG_prefix "register_parc::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_register_par_var::
class _wrap_register_par_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
XS(_wrap_clear_tree_flags) {
  {
    ...
    if ((items < 2) || (items > 2)) {
      SWIG_croak("Usage: clear_tree_flags(tp,i);");
    }
...
{"register_parc::clear_tree_flags", _wrap_clear_tree_flags},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
