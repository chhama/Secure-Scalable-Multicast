...
#define SWIGTYPE_p_f_p_std__vector__int____void swig_types[1]
...
#define SWIG_init    boot_template_typedef_fnc

#define SWIG_name   "template_typedef_fncc::boot_template_typedef_fnc"
#define SWIG_prefix "template_typedef_fncc::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_template_typedef_fnc_var::
class _wrap_template_typedef_fnc_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
XS(_wrap_setCallback) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: setCallback(callback);");
    }
    {
      int res = SWIG_ConvertFunctionPtr(ST(0), (void**)(&arg1), SWIGTYPE_p_f_p_std__vector__int____void);
      if (!SWIG_IsOK(res)) {
        SWIG_exception_fail(SWIG_ArgError(res), "in method '" "setCallback" "', argument " "1"" of type '" "RtMidiCallback""'"); 
      }
    }
    setCallback(arg1);
    ST(argvi) = sv_newmortal();
...
static swig_type_info _swigt__p_std__vectorT_int_t = {"_p_std__vectorT_int_t", "std::vector< int > *", 0, 0, (void*)"template_typedef_fnc::IntVector", 0};
...
{"template_typedef_fncc::new_IntVector", _wrap_new_IntVector},
{"template_typedef_fncc::IntVector_size", _wrap_IntVector_size},
{"template_typedef_fncc::IntVector_empty", _wrap_IntVector_empty},
{"template_typedef_fncc::IntVector_clear", _wrap_IntVector_clear},
{"template_typedef_fncc::IntVector_push", _wrap_IntVector_push},
{"template_typedef_fncc::IntVector_pop", _wrap_IntVector_pop},
{"template_typedef_fncc::IntVector_get", _wrap_IntVector_get},
{"template_typedef_fncc::IntVector_set", _wrap_IntVector_set},
{"template_typedef_fncc::delete_IntVector", _wrap_delete_IntVector},
{"template_typedef_fncc::setCallback", _wrap_setCallback},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
...
XS(SWIG_init) {
  ...
  SWIG_TypeClientData(SWIGTYPE_p_std__vectorT_int_t, (void*) "template_typedef_fnc::IntVector");
  ST(0) = &PL_sv_yes;
  XSRETURN(1);
}
