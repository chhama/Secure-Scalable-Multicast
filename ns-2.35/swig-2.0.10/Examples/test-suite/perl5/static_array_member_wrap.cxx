...
#define SWIG_init    boot_static_array_member

#define SWIG_name   "static_array_memberc::boot_static_array_member"
#define SWIG_prefix "static_array_memberc::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_static_array_member_var::
class _wrap_static_array_member_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
XS(_wrap_new_RB) {
  {
    ...
    if ((items < 0) || (items > 0)) {
      SWIG_croak("Usage: new_RB();");
    }
    result = (RB *)new RB();
    ST(argvi) = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_RB, SWIG_OWNER | SWIG_SHADOW); argvi++ ;
    XSRETURN(argvi);
  fail:
    SWIG_croak_null();
  }
...
XS(_wrap_delete_RB) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: delete_RB(self);");
    }
    res1 = SWIG_ConvertPtr(ST(0), &argp1,SWIGTYPE_p_RB, SWIG_POINTER_DISOWN |  0 );
    if (!SWIG_IsOK(res1)) {
...
static swig_type_info _swigt__p_RB = {"_p_RB", "RB *", 0, 0, (void*)"static_array_member::RB", 0};
...
{"static_array_memberc::new_RB", _wrap_new_RB},
{"static_array_memberc::delete_RB", _wrap_delete_RB},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
...
XS(SWIG_init) {
  ...
  SWIG_TypeClientData(SWIGTYPE_p_RB, (void*) "static_array_member::RB");
  ST(0) = &PL_sv_yes;
  XSRETURN(1);
}
