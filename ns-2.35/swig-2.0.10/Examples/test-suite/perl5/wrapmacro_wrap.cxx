...
#define SWIG_init    boot_wrapmacro

#define SWIG_name   "wrapmacroc::boot_wrapmacro"
#define SWIG_prefix "wrapmacroc::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_wrapmacro_var::
class _wrap_wrapmacro_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
extern "C" {
#endif
XS(_wrap_GUINT16_SWAP_LE_BE_CONSTANT) {
  {
    guint16 arg1 ;
    unsigned short val1 ;
    int ecode1 = 0 ;
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: GUINT16_SWAP_LE_BE_CONSTANT(val);");
    }
...
XS(_wrap_maximum) {
  ...
  dispatch:
    switch(_index) {
    case 1:
      PUSHMARK(MARK); SWIG_CALLXS(_wrap_maximum__SWIG_0); return;
    case 2:
...
{"wrapmacroc::GUINT16_SWAP_LE_BE_CONSTANT", _wrap_GUINT16_SWAP_LE_BE_CONSTANT},
{"wrapmacroc::maximum", _wrap_maximum},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
