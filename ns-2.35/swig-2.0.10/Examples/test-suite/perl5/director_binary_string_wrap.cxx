...
#define SWIG_init    boot_director_binary_string

#define SWIG_name   "director_binary_stringc::boot_director_binary_string"
#define SWIG_prefix "director_binary_stringc::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_director_binary_string_var::
class _wrap_director_binary_string_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
XS(_wrap_Callback_run) {
  {
    ...
    if ((items < 3) || (items > 3)) {
      SWIG_croak("Usage: Callback_run(self,dataBufferAA,sizeAA,dataBufferBB,sizeBB);");
    }
...
XS(_wrap_Caller_setCallback) {
  {
    ...
    arg1 = reinterpret_cast< Caller * >(argp1);
    res2 = SWIG_ConvertPtr(ST(1), &argp2,SWIGTYPE_p_Callback, 0 |  0 );
    if (!SWIG_IsOK(res2)) {
...
XS(_wrap_Caller_call_null) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: Caller_call_null(self);");
    }
    res1 = SWIG_ConvertPtr(ST(0), &argp1,SWIGTYPE_p_Caller, 0 |  0 );
    if (!SWIG_IsOK(res1)) {
...
static swig_type_info _swigt__p_Callback = {"_p_Callback", "Callback *", 0, 0, (void*)"director_binary_string::Callback", 0};
static swig_type_info _swigt__p_Caller = {"_p_Caller", "Caller *", 0, 0, (void*)"director_binary_string::Caller", 0};
...
{"director_binary_stringc::delete_Callback", _wrap_delete_Callback},
{"director_binary_stringc::Callback_run", _wrap_Callback_run},
{"director_binary_stringc::new_Callback", _wrap_new_Callback},
{"director_binary_stringc::new_Caller", _wrap_new_Caller},
{"director_binary_stringc::delete_Caller", _wrap_delete_Caller},
{"director_binary_stringc::Caller_delCallback", _wrap_Caller_delCallback},
{"director_binary_stringc::Caller_setCallback", _wrap_Caller_setCallback},
{"director_binary_stringc::Caller_call", _wrap_Caller_call},
{"director_binary_stringc::Caller_call_null", _wrap_Caller_call_null},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
...
XS(SWIG_init) {
  ...
  /*@SWIG:/home/chhama/Dropbox/mtp/o-ns-allinone-2.35.1/ns-2.35/swig-2.0.10/Lib/perl5/perltypemaps.swg,65,%set_constant@*/ do {
    SV *sv = get_sv((char*) SWIG_prefix "BUFFER_SIZE_AA", TRUE | 0x2 | GV_ADDMULTI);
    sv_setsv(sv, SWIG_From_int  SWIG_PERL_CALL_ARGS_1(static_cast< int >(8)));
    SvREADONLY_on(sv);
  } while(0) /*@SWIG@*/;
  /*@SWIG:/home/chhama/Dropbox/mtp/o-ns-allinone-2.35.1/ns-2.35/swig-2.0.10/Lib/perl5/perltypemaps.swg,65,%set_constant@*/ do {
    SV *sv = get_sv((char*) SWIG_prefix "BUFFER_SIZE_BB", TRUE | 0x2 | GV_ADDMULTI);
    sv_setsv(sv, SWIG_From_int  SWIG_PERL_CALL_ARGS_1(static_cast< int >(5)));
    SvREADONLY_on(sv);
  } while(0) /*@SWIG@*/;
  SWIG_TypeClientData(SWIGTYPE_p_Callback, (void*) "director_binary_string::Callback");
  SWIG_TypeClientData(SWIGTYPE_p_Caller, (void*) "director_binary_string::Caller");
  ST(0) = &PL_sv_yes;
  XSRETURN(1);
}
