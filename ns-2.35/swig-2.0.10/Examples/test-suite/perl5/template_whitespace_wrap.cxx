...
#define SWIG_init    boot_template_whitespace

#define SWIG_name   "template_whitespacec::boot_template_whitespace"
#define SWIG_prefix "template_whitespacec::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_template_whitespace_var::
class _wrap_template_whitespace_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
XS(_wrap_foo) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: foo(v);");
    }
    {
      res1 = SWIG_ConvertPtr(ST(0), &argp1, SWIGTYPE_p_vectorT_int_t,  0 );
      if (!SWIG_IsOK(res1)) {
...
XS(_wrap_bar) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: bar(v);");
    }
    {
      res1 = SWIG_ConvertPtr(ST(0), &argp1, SWIGTYPE_p_vectorT_unsigned_int_t,  0 );
      if (!SWIG_IsOK(res1)) {
...
XS(_wrap_baz) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: baz(p);");
    }
    {
      res1 = SWIG_ConvertPtr(ST(0), &argp1, SWIGTYPE_p_mapT_int_int_t,  0 );
      if (!SWIG_IsOK(res1)) {
...
{"template_whitespacec::foo", _wrap_foo},
{"template_whitespacec::bar", _wrap_bar},
{"template_whitespacec::baz", _wrap_baz},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
