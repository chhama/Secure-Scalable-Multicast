...
#define SWIG_init    boot_integers

#define SWIG_name   "integersc::boot_integers"
#define SWIG_prefix "integersc::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_integers_var::
class _wrap_integers_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
XS(_wrap_signed_char_identity) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: signed_char_identity(x);");
    }
...
XS(_wrap_unsigned_char_identity) {
  {
    unsigned char arg1 ;
    unsigned char val1 ;
    int ecode1 = 0 ;
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: unsigned_char_identity(x);");
    }
...
XS(_wrap_signed_short_identity) {
  {
    short arg1 ;
    short val1 ;
    int ecode1 = 0 ;
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: signed_short_identity(x);");
    }
...
XS(_wrap_unsigned_short_identity) {
  {
    unsigned short arg1 ;
    unsigned short val1 ;
    int ecode1 = 0 ;
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: unsigned_short_identity(x);");
    }
...
XS(_wrap_signed_int_identity) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: signed_int_identity(x);");
    }
...
XS(_wrap_unsigned_int_identity) {
  {
    unsigned int arg1 ;
    unsigned int val1 ;
    int ecode1 = 0 ;
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: unsigned_int_identity(x);");
    }
...
XS(_wrap_signed_long_identity) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: signed_long_identity(x);");
    }
...
XS(_wrap_unsigned_long_identity) {
  {
    unsigned long arg1 ;
    unsigned long val1 ;
    int ecode1 = 0 ;
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: unsigned_long_identity(x);");
    }
...
XS(_wrap_signed_long_long_identity) {
  {
    long long arg1 ;
    long long val1 ;
    int ecode1 = 0 ;
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: signed_long_long_identity(x);");
    }
...
XS(_wrap_unsigned_long_long_identity) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: unsigned_long_long_identity(x);");
    }
...
XS(_wrap_signed_char_size) {
  {
    ...
    if ((items < 0) || (items > 0)) {
      SWIG_croak("Usage: signed_char_size();");
    }
...
XS(_wrap_unsigned_char_size) {
  {
    ...
    if ((items < 0) || (items > 0)) {
      SWIG_croak("Usage: unsigned_char_size();");
    }
...
XS(_wrap_signed_short_size) {
  {
    ...
    if ((items < 0) || (items > 0)) {
      SWIG_croak("Usage: signed_short_size();");
    }
...
XS(_wrap_unsigned_short_size) {
  {
    ...
    if ((items < 0) || (items > 0)) {
      SWIG_croak("Usage: unsigned_short_size();");
    }
...
XS(_wrap_signed_int_size) {
  {
    ...
    if ((items < 0) || (items > 0)) {
      SWIG_croak("Usage: signed_int_size();");
    }
...
XS(_wrap_unsigned_int_size) {
  {
    ...
    if ((items < 0) || (items > 0)) {
      SWIG_croak("Usage: unsigned_int_size();");
    }
...
XS(_wrap_signed_long_size) {
  {
    ...
    if ((items < 0) || (items > 0)) {
      SWIG_croak("Usage: signed_long_size();");
    }
...
XS(_wrap_unsigned_long_size) {
  {
    ...
    if ((items < 0) || (items > 0)) {
      SWIG_croak("Usage: unsigned_long_size();");
    }
...
XS(_wrap_signed_long_long_size) {
  {
    int argvi = 0;
    size_t result;
    dXSARGS;
    ...
    if ((items < 0) || (items > 0)) {
      SWIG_croak("Usage: signed_long_long_size();");
    }
...
XS(_wrap_unsigned_long_long_size) {
  {
    int argvi = 0;
    size_t result;
    dXSARGS;
    ...
    if ((items < 0) || (items > 0)) {
      SWIG_croak("Usage: unsigned_long_long_size();");
    }
...
{"integersc::signed_char_identity", _wrap_signed_char_identity},
{"integersc::unsigned_char_identity", _wrap_unsigned_char_identity},
{"integersc::signed_short_identity", _wrap_signed_short_identity},
{"integersc::unsigned_short_identity", _wrap_unsigned_short_identity},
{"integersc::signed_int_identity", _wrap_signed_int_identity},
{"integersc::unsigned_int_identity", _wrap_unsigned_int_identity},
{"integersc::signed_long_identity", _wrap_signed_long_identity},
{"integersc::unsigned_long_identity", _wrap_unsigned_long_identity},
{"integersc::signed_long_long_identity", _wrap_signed_long_long_identity},
{"integersc::unsigned_long_long_identity", _wrap_unsigned_long_long_identity},
{"integersc::signed_char_size", _wrap_signed_char_size},
{"integersc::unsigned_char_size", _wrap_unsigned_char_size},
{"integersc::signed_short_size", _wrap_signed_short_size},
{"integersc::unsigned_short_size", _wrap_unsigned_short_size},
{"integersc::signed_int_size", _wrap_signed_int_size},
{"integersc::unsigned_int_size", _wrap_unsigned_int_size},
{"integersc::signed_long_size", _wrap_signed_long_size},
{"integersc::unsigned_long_size", _wrap_unsigned_long_size},
{"integersc::signed_long_long_size", _wrap_signed_long_long_size},
{"integersc::unsigned_long_long_size", _wrap_unsigned_long_long_size},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
