...
#define SWIG_init    boot_inline_initializer

#define SWIG_name   "inline_initializerc::boot_inline_initializer"
#define SWIG_prefix "inline_initializerc::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_inline_initializer_var::
class _wrap_inline_initializer_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
static swig_type_info _swigt__p_Foo = {"_p_Foo", "Foo *", 0, 0, (void*)"inline_initializer::Foo", 0};
...
{"inline_initializerc::new_Foo", _wrap_new_Foo},
{"inline_initializerc::delete_Foo", _wrap_delete_Foo},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
...
XS(SWIG_init) {
  ...
  SWIG_TypeClientData(SWIGTYPE_p_Foo, (void*) "inline_initializer::Foo");
  ST(0) = &PL_sv_yes;
  XSRETURN(1);
}
