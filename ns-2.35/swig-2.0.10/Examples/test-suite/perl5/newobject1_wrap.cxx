...
#define SWIG_init    boot_newobject1

#define SWIG_name   "newobject1c::boot_newobject1"
#define SWIG_prefix "newobject1c::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_newobject1_var::
class _wrap_newobject1_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
XS(_wrap_Foo_makeMore) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: Foo_makeMore(self);");
    }
...
static swig_type_info _swigt__p_Foo = {"_p_Foo", "Foo *", 0, 0, (void*)"newobject1::Foo", 0};
...
{"newobject1c::Foo_makeFoo", _wrap_Foo_makeFoo},
{"newobject1c::Foo_makeMore", _wrap_Foo_makeMore},
{"newobject1c::Foo_fooCount", _wrap_Foo_fooCount},
{"newobject1c::delete_Foo", _wrap_delete_Foo},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
...
XS(SWIG_init) {
  ...
  SWIG_TypeClientData(SWIGTYPE_p_Foo, (void*) "newobject1::Foo");
  ST(0) = &PL_sv_yes;
  XSRETURN(1);
}
