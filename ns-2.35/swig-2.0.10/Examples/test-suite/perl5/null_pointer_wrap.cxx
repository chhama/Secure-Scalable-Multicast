...
#define SWIG_init    boot_null_pointer

#define SWIG_name   "null_pointerc::boot_null_pointer"
#define SWIG_prefix "null_pointerc::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_null_pointer_var::
class _wrap_null_pointer_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
static swig_type_info _swigt__p_A = {"_p_A", "A *", 0, 0, (void*)"null_pointer::A", 0};
...
{"null_pointerc::new_A", _wrap_new_A},
{"null_pointerc::delete_A", _wrap_delete_A},
{"null_pointerc::func", _wrap_func},
{"null_pointerc::getnull", _wrap_getnull},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
...
XS(SWIG_init) {
  ...
  SWIG_TypeClientData(SWIGTYPE_p_A, (void*) "null_pointer::A");
  ST(0) = &PL_sv_yes;
  XSRETURN(1);
}
