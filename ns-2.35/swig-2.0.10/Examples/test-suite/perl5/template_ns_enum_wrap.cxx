...
#define SWIG_init    boot_template_ns_enum

#define SWIG_name   "template_ns_enumc::boot_template_ns_enum"
#define SWIG_prefix "template_ns_enumc::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_template_ns_enum_var::
class _wrap_template_ns_enum_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
XS(_wrap_say_hi) {
  {
    ...
    if ((items < 0) || (items > 0)) {
      SWIG_croak("Usage: say_hi();");
    }
    result = hello::say_hi();
    ST(argvi) = SWIG_NewPointerObj((new hello::traits< hello::Hi >::value_type(static_cast< const hello::traits< hello::Hi >::value_type& >(result))), SWIGTYPE_p_hello__traitsT_hello__Hi_t__value_type, SWIG_POINTER_OWN | 0); argvi++ ;
    XSRETURN(argvi);
  fail:
    SWIG_croak_null();
  }
...
{"template_ns_enumc::say_hi", _wrap_say_hi},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
...
XS(SWIG_init) {
  ...
  /*@SWIG:/home/chhama/Dropbox/mtp/o-ns-allinone-2.35.1/ns-2.35/swig-2.0.10/Lib/perl5/perltypemaps.swg,65,%set_constant@*/ do {
    ...
    sv_setsv(sv, SWIG_From_int  SWIG_PERL_CALL_ARGS_1(static_cast< int >(hello::Hi)));
    SvREADONLY_on(sv);
  } while(0) /*@SWIG@*/;
  /*@SWIG:/home/chhama/Dropbox/mtp/o-ns-allinone-2.35.1/ns-2.35/swig-2.0.10/Lib/perl5/perltypemaps.swg,65,%set_constant@*/ do {
    SV *sv = get_sv((char*) SWIG_prefix "Hola", TRUE | 0x2 | GV_ADDMULTI);
    sv_setsv(sv, SWIG_From_int  SWIG_PERL_CALL_ARGS_1(static_cast< int >(hello::Hola)));
    SvREADONLY_on(sv);
  } while(0) /*@SWIG@*/;
  ST(0) = &PL_sv_yes;
  XSRETURN(1);
