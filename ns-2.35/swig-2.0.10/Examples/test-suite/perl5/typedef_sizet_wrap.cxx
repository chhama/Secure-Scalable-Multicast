...
#define SWIG_init    boot_typedef_sizet

#define SWIG_name   "typedef_sizetc::boot_typedef_sizet"
#define SWIG_prefix "typedef_sizetc::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_typedef_sizet_var::
class _wrap_typedef_sizet_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
{"typedef_sizetc::size", _wrap_size},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
