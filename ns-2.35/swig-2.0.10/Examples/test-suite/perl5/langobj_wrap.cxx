...
#define SWIG_init    boot_langobj

#define SWIG_name   "langobjc::boot_langobj"
#define SWIG_prefix "langobjc::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_langobj_var::
class _wrap_langobj_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
XS(_wrap_identity) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: identity(x);");
    }
    arg1 = ST(0);
    result = (SV *)identity(arg1);
...
{"langobjc::identity", _wrap_identity},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
