...
#define SWIG_init    boot_packageoption_b

#define SWIG_name   "CommonPackagec::boot_packageoption_b"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_packageoption_b_var::
class _wrap_packageoption_b_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
XS(_wrap_B_testInt) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: B_testInt(self);");
    }
...
static swig_type_info _swigt__p_B = {"_p_B", "B *", 0, 0, (void*)"CommonPackage::B", 0};
...
{"CommonPackagec::B_testInt", _wrap_B_testInt},
{"CommonPackagec::new_B", _wrap_new_B},
{"CommonPackagec::delete_B", _wrap_delete_B},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
...
XS(SWIG_init) {
  ...
  SWIG_TypeClientData(SWIGTYPE_p_B, (void*) "CommonPackage::B");
  ST(0) = &PL_sv_yes;
  XSRETURN(1);
}
