...
#define SWIG_init    boot_constant_expr

#define SWIG_name   "constant_exprc::boot_constant_expr"
#define SWIG_prefix "constant_exprc::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_constant_expr_var::
class _wrap_constant_expr_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
SWIGCLASS_STATIC int _wrap_X_get(pTHX_ SV *sv, MAGIC *SWIGUNUSEDPARM(mg)) {
  MAGIC_PPERL
  sv_setsv(sv,SWIG_From_int  SWIG_PERL_CALL_ARGS_1((int)(X)))  ;
  return 1;
}


SWIGCLASS_STATIC int _wrap_d_array_set(pTHX_ SV* sv, MAGIC * SWIGUNUSEDPARM(mg)) {
  MAGIC_PPERL
  {
    double *inp = 0;
...
SWIGCLASS_STATIC int _wrap_d_array_get(pTHX_ SV *sv, MAGIC *SWIGUNUSEDPARM(mg)) {
  MAGIC_PPERL
  sv_setiv(SvRV(sv),PTR2IV(d_array));
  return 1;
}
...
static swig_variable_info swig_variables[] = {
    { "constant_exprc::X", MAGIC_CLASS swig_magic_readonly, MAGIC_CLASS _wrap_X_get,0 },
    { "constant_exprc::d_array", MAGIC_CLASS _wrap_d_array_set, MAGIC_CLASS _wrap_d_array_get,&SWIGTYPE_p_double },
{0,0,0,0}
};
...
XS(SWIG_init) {
  ...
  /*@SWIG:/home/chhama/Dropbox/mtp/o-ns-allinone-2.35.1/ns-2.35/swig-2.0.10/Lib/perl5/perltypemaps.swg,65,%set_constant@*/ do {
    SV *sv = get_sv((char*) SWIG_prefix "FOO", TRUE | 0x2 | GV_ADDMULTI);
    sv_setsv(sv, SWIG_From_int  SWIG_PERL_CALL_ARGS_1((int)(12%9)));
    SvREADONLY_on(sv);
  } while(0) /*@SWIG@*/;
  ST(0) = &PL_sv_yes;
  XSRETURN(1);
