...
#define SWIG_init    boot_argout

#define SWIG_name   "argoutc::boot_argout"
#define SWIG_prefix "argoutc::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_argout_var::
class _wrap_argout_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
XS(_wrap_voidhandle) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: voidhandle(handle);");
    }
...
XS(_wrap_handle) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: handle(handle);");
    }
...
{"argoutc::new_intp", _wrap_new_intp},
{"argoutc::copy_intp", _wrap_copy_intp},
{"argoutc::delete_intp", _wrap_delete_intp},
{"argoutc::intp_assign", _wrap_intp_assign},
{"argoutc::intp_value", _wrap_intp_value},
{"argoutc::incp", _wrap_incp},
{"argoutc::incr", _wrap_incr},
{"argoutc::inctr", _wrap_inctr},
{"argoutc::voidhandle", _wrap_voidhandle},
{"argoutc::handle", _wrap_handle},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
