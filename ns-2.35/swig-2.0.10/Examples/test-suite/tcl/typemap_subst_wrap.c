...
#define SWIGTYPE_p_p_p_xyzzy swig_types[1]
#define SWIGTYPE_p_p_xyzzy swig_types[2]
#define SWIGTYPE_p_xyzzy swig_types[3]
...
#define SWIG_init    Typemap_subst_Init
...
#endif
SWIGINTERN int
_wrap_xyzzy_member_set(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (SWIG_GetArgs(interp, objc, objv,"oo:xyzzy_member_set self member ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_xyzzy, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "xyzzy_member_set" "', argument " "1"" of type '" "struct xyzzy *""'"); 
  }
  arg1 = (struct xyzzy *)(argp1);
  ecode2 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[2], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "xyzzy_member_set" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = (int)(val2);
...
SWIGINTERN int
_wrap_xyzzy_member_get(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  struct xyzzy *arg1 = (struct xyzzy *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  int result;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:xyzzy_member_get self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_xyzzy, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "xyzzy_member_get" "', argument " "1"" of type '" "struct xyzzy *""'"); 
  }
  arg1 = (struct xyzzy *)(argp1);
...
SWIGINTERN int
_wrap_new_xyzzy(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  struct xyzzy *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,":new_xyzzy ") == TCL_ERROR) SWIG_fail;
  result = (struct xyzzy *)calloc(1, sizeof(struct xyzzy));
  Tcl_SetObjResult(interp, SWIG_NewInstanceObj( SWIG_as_voidptr(result), SWIGTYPE_p_xyzzy,0));
  return TCL_OK;
fail:
  return TCL_ERROR;
}
...
SWIGINTERN int
_wrap_delete_xyzzy(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  struct xyzzy *arg1 = (struct xyzzy *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:delete_xyzzy self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_xyzzy, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_xyzzy" "', argument " "1"" of type '" "struct xyzzy *""'"); 
  }
  arg1 = (struct xyzzy *)(argp1);
  free((char *) arg1);
...
SWIGINTERN void swig_delete_xyzzy(void *obj) {
struct xyzzy *arg1 = (struct xyzzy *) obj;
free((char *) arg1);
}
static swig_method swig_xyzzy_methods[] = {
    {0,0}
};
static swig_attribute swig_xyzzy_attributes[] = {
    { "-member",_wrap_xyzzy_member_get, _wrap_xyzzy_member_set},
    {0,0,0}
};
static swig_class *swig_xyzzy_bases[] = {0};
static const char * swig_xyzzy_base_names[] = {0};
static swig_class _wrap_class_xyzzy = { "xyzzy", &SWIGTYPE_p_xyzzy,_wrap_new_xyzzy, swig_delete_xyzzy, swig_xyzzy_methods, swig_xyzzy_attributes, swig_xyzzy_bases,swig_xyzzy_base_names, &swig_module };
SWIGINTERN int
_wrap_foo(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (SWIG_GetArgs(interp, objc, objv,"o:foo TEST ",(void *)0) == TCL_ERROR) SWIG_fail;
  {
    {
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "xyzzy_member_set", (swig_wrapper_func) _wrap_xyzzy_member_set, NULL},
    { SWIG_prefix "xyzzy_member_get", (swig_wrapper_func) _wrap_xyzzy_member_get, NULL},
    { SWIG_prefix "new_xyzzy", (swig_wrapper_func) _wrap_new_xyzzy, NULL},
    { SWIG_prefix "delete_xyzzy", (swig_wrapper_func) _wrap_delete_xyzzy, NULL},
    { SWIG_prefix "xyzzy", (swig_wrapper_func) SWIG_ObjectConstructor, (ClientData)&_wrap_class_xyzzy},
...
static swig_type_info _swigt__p_xyzzy = {"_p_xyzzy", "struct xyzzy *|xyzzy *", 0, 0, (void*)&_wrap_class_xyzzy, 0};
...
SWIGEXPORT int Typemap_subst_SafeInit(Tcl_Interp *interp) {
