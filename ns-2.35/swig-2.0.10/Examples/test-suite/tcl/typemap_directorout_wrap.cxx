...
#define SWIG_init    Typemap_directorout_Init
...
#endif
SWIGINTERN int
_wrap_new_Class1(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Class1 *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,":new_Class1 ") == TCL_ERROR) SWIG_fail;
  result = (Class1 *)new Class1();
  Tcl_SetObjResult(interp, SWIG_NewInstanceObj( SWIG_as_voidptr(result), SWIGTYPE_p_Class1,0));
  return TCL_OK;
fail:
  return TCL_ERROR;
}
...
SWIGINTERN int
_wrap_Class1_foo1(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Class1 *arg1 = (Class1 *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  MyType *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:Class1_foo1 self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Class1, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
  ...
  /* special start */ Tcl_SetObjResult(interp, SWIG_NewInstanceObj( SWIG_as_voidptr(result), SWIGTYPE_p_int,0)); /* special end */ 
  return TCL_OK;
fail:
  return TCL_ERROR;
}
...
SWIGINTERN int
_wrap_Class1_foo2__SWIG_0(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Class1 *arg1 = (Class1 *) 0 ;
  int arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (SWIG_GetArgs(interp, objc, objv,"oo:Class1_foo2 self parm1 ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Class1, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN int
_wrap_Class1_foo2__SWIG_1(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Class1 *arg1 = (Class1 *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  MyType *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:Class1_foo2 self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Class1, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Class1_foo2" "', argument " "1"" of type '" "Class1 *""'"); 
  }
...
SWIGINTERN int
_wrap_Class1_foo2(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (argc == 1) {
    ...
    if (_v) {
      return _wrap_Class1_foo2__SWIG_1(clientData, interp, objc, argv - 1);
    }
  }
  if (argc == 2) {
    int _v;
    ...
    if (_v) {
      ...
      if (_v) {
        return _wrap_Class1_foo2__SWIG_0(clientData, interp, objc, argv - 1);
      }
    }
  }
  
  Tcl_SetResult(interp,(char *) "Wrong number or type of arguments for overloaded function 'Class1_foo2'.\n"
...
SWIGINTERN int
_wrap_delete_Class1(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Class1 *arg1 = (Class1 *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:delete_Class1 self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Class1, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN void swig_delete_Class1(void *obj) {
Class1 *arg1 = (Class1 *) obj;
delete arg1;
}
static swig_method swig_Class1_methods[] = {
    {"foo1", _wrap_Class1_foo1}, 
    {"foo2", _wrap_Class1_foo2}, 
    {0,0}
};
static swig_attribute swig_Class1_attributes[] = {
    {0,0,0}
};
static swig_class *swig_Class1_bases[] = {0};
static const char * swig_Class1_base_names[] = {0};
static swig_class _wrap_class_Class1 = { "Class1", &SWIGTYPE_p_Class1,_wrap_new_Class1, swig_delete_Class1, swig_Class1_methods, swig_Class1_attributes, swig_Class1_bases,swig_Class1_base_names, &swig_module };

static swig_command_info swig_commands[] = {
    { SWIG_prefix "new_Class1", (swig_wrapper_func) _wrap_new_Class1, NULL},
    { SWIG_prefix "Class1_foo1", (swig_wrapper_func) _wrap_Class1_foo1, NULL},
    { SWIG_prefix "Class1_foo2", (swig_wrapper_func) _wrap_Class1_foo2, NULL},
    { SWIG_prefix "delete_Class1", (swig_wrapper_func) _wrap_delete_Class1, NULL},
    { SWIG_prefix "Class1", (swig_wrapper_func) SWIG_ObjectConstructor, (ClientData)&_wrap_class_Class1},
    {0, 0, 0}
};
...
static swig_type_info _swigt__p_Class1 = {"_p_Class1", "Class1 *", 0, 0, (void*)&_wrap_class_Class1, 0};
...
SWIGEXPORT int Typemap_directorout_SafeInit(Tcl_Interp *interp) {
