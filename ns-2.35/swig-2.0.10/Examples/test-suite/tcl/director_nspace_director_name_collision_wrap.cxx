...
#define SWIG_init    Director_nspace_director_name_collision_Init
...
_wrap_delete_Foo(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_TopLevel__A__Foo, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_Foo" "', argument " "1"" of type '" "TopLevel::A::Foo *""'"); 
  }
  arg1 = reinterpret_cast< TopLevel::A::Foo * >(argp1);
  delete arg1;
...
_wrap_Foo_ping(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_TopLevel__A__Foo, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Foo_ping" "', argument " "1"" of type '" "TopLevel::A::Foo *""'"); 
  }
  arg1 = reinterpret_cast< TopLevel::A::Foo * >(argp1);
  result = (arg1)->ping();
...
_wrap_new_Foo(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  Tcl_SetObjResult(interp, SWIG_NewInstanceObj( SWIG_as_voidptr(result), SWIGTYPE_p_TopLevel__A__Foo,0));
  return TCL_OK;
fail:
  return TCL_ERROR;
}
...
TopLevel::A::Foo *arg1 = (TopLevel::A::Foo *) obj;
delete arg1;
}
static swig_method swig_TopLevel_A_Foo_methods[] = {
    {"ping", _wrap_Foo_ping}, 
    {0,0}
};
static swig_attribute swig_TopLevel_A_Foo_attributes[] = {
    {0,0,0}
};
static swig_class *swig_TopLevel_A_Foo_bases[] = {0};
static const char * swig_TopLevel_A_Foo_base_names[] = {0};
static swig_class _wrap_class_TopLevel_A_Foo = { "Foo", &SWIGTYPE_p_TopLevel__A__Foo,_wrap_new_Foo, swig_delete_Foo, swig_TopLevel_A_Foo_methods, swig_TopLevel_A_Foo_attributes, swig_TopLevel_A_Foo_bases,swig_TopLevel_A_Foo_base_names, &swig_module };
...
static swig_command_info swig_commands[] = {
    ...
    { SWIG_prefix "Foo", (swig_wrapper_func) SWIG_ObjectConstructor, (ClientData)&_wrap_class_TopLevel_A_Foo},
    {0, 0, 0}
};
...
static swig_type_info _swigt__p_TopLevel__A__Foo = {"_p_TopLevel__A__Foo", "TopLevel::A::Foo *", 0, 0, (void*)&_wrap_class_TopLevel_A_Foo, 0};
...
SWIGEXPORT int Director_nspace_director_name_collision_SafeInit(Tcl_Interp *interp) {
