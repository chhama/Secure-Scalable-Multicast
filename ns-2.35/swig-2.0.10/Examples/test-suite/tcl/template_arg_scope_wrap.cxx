...
#define SWIG_init    Template_arg_scope_Init
...
_wrap_Bar_spam(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  res2 = SWIG_ConvertPtr(objv[2], &argp2,SWIGTYPE_p_FooT_Bar_t, 0 |  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "Bar_spam" "', argument " "2"" of type '" "Foo< Bar > *""'"); 
  }
  arg2 = reinterpret_cast< Foo< Bar > * >(argp2);
  (arg1)->spam(arg2);
...
SWIGEXPORT int Template_arg_scope_SafeInit(Tcl_Interp *interp) {
