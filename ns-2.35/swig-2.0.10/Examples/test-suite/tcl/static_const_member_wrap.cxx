...
#define SWIG_init    Static_const_member_Init
...
SWIGEXPORT int SWIG_init(Tcl_Interp *interp) {
  ...
  SWIG_Tcl_SetConstantObj(interp, "X_PN", SWIG_From_int(static_cast< int >(X::PN)));
  SWIG_Tcl_SetConstantObj(interp, "X_CN", SWIG_From_int(static_cast< int >(X::CN)));
  SWIG_Tcl_SetConstantObj(interp, "X_EN", SWIG_From_int(static_cast< int >(X::EN)));
  SWIG_Tcl_SetConstantObj(interp, "X_CHARTEST", SWIG_From_char(static_cast< char >(X::CHARTEST)));
  return TCL_OK;
}
SWIGEXPORT int Static_const_member_SafeInit(Tcl_Interp *interp) {
