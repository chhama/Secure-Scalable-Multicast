...
#define SWIG_init    Typedef_scope_Init
...
#endif
SWIGINTERN int
_wrap_Bar_test1(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Bar *arg1 = (Bar *) 0 ;
  Bar::FooType arg2 ;
  ...
  if (SWIG_GetArgs(interp, objc, objv,"ooo:Bar_test1 self n data ",(void *)0,(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Bar, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Bar_test1" "', argument " "1"" of type '" "Bar *""'"); 
  }
  arg1 = reinterpret_cast< Bar * >(argp1);
  ecode2 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[2], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "Bar_test1" "', argument " "2"" of type '" "Bar::FooType""'");
  } 
  arg2 = static_cast< Bar::FooType >(val2);
  res3 = SWIG_AsCharPtrAndSize(objv[3], &buf3, NULL, &alloc3);
  if (!SWIG_IsOK(res3)) {
    SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "Bar_test1" "', argument " "3"" of type '" "::FooType""'");
  }
  arg3 = reinterpret_cast< ::FooType >(buf3);
...
SWIGINTERN int
_wrap_Bar_test2(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Bar *arg1 = (Bar *) 0 ;
  Bar::FooType arg2 ;
  ::FooType arg3 = (::FooType) 0 ;
  void *argp1 = 0 ;
  ...
  if (SWIG_GetArgs(interp, objc, objv,"ooo:Bar_test2 self n data ",(void *)0,(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Bar, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Bar_test2" "', argument " "1"" of type '" "Bar *""'"); 
  }
  arg1 = reinterpret_cast< Bar * >(argp1);
  ecode2 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[2], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "Bar_test2" "', argument " "2"" of type '" "Bar::FooType""'");
  } 
  arg2 = static_cast< Bar::FooType >(val2);
  res3 = SWIG_AsCharPtrAndSize(objv[3], &buf3, NULL, &alloc3);
  if (!SWIG_IsOK(res3)) {
    SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "Bar_test2" "', argument " "3"" of type '" "::FooType""'");
  }
  arg3 = reinterpret_cast< ::FooType >(buf3);
...
static swig_method swig_Bar_methods[] = {
    {"test1", _wrap_Bar_test1}, 
    {"test2", _wrap_Bar_test2}, 
    {0,0}
};
...
SWIGINTERN int
_wrap_new_CBaz(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  CBaz *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,":new_CBaz ") == TCL_ERROR) SWIG_fail;
  result = (CBaz *)new CBaz();
  Tcl_SetObjResult(interp, SWIG_NewInstanceObj( SWIG_as_voidptr(result), SWIGTYPE_p_CBaz,0));
  return TCL_OK;
fail:
  return TCL_ERROR;
}
...
SWIGINTERN int
_wrap_delete_CBaz(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  CBaz *arg1 = (CBaz *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:delete_CBaz self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_CBaz, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_CBaz" "', argument " "1"" of type '" "CBaz *""'"); 
  }
  arg1 = reinterpret_cast< CBaz * >(argp1);
  delete arg1;
...
SWIGINTERN void swig_delete_CBaz(void *obj) {
CBaz *arg1 = (CBaz *) obj;
delete arg1;
}
static swig_method swig_CBaz_methods[] = {
    {0,0}
};
static swig_attribute swig_CBaz_attributes[] = {
    {0,0,0}
};
static swig_class *swig_CBaz_bases[] = {0};
static const char * swig_CBaz_base_names[] = {0};
static swig_class _wrap_class_CBaz = { "CBaz", &SWIGTYPE_p_CBaz,_wrap_new_CBaz, swig_delete_CBaz, swig_CBaz_methods, swig_CBaz_attributes, swig_CBaz_bases,swig_CBaz_base_names, &swig_module };

static swig_command_info swig_commands[] = {
    { SWIG_prefix "Bar_test1", (swig_wrapper_func) _wrap_Bar_test1, NULL},
    { SWIG_prefix "Bar_test2", (swig_wrapper_func) _wrap_Bar_test2, NULL},
    ...
    { SWIG_prefix "new_CBaz", (swig_wrapper_func) _wrap_new_CBaz, NULL},
    { SWIG_prefix "delete_CBaz", (swig_wrapper_func) _wrap_delete_CBaz, NULL},
    { SWIG_prefix "CBaz", (swig_wrapper_func) SWIG_ObjectConstructor, (ClientData)&_wrap_class_CBaz},
    {0, 0, 0}
};
...
static swig_type_info _swigt__p_CBaz = {"_p_CBaz", "CBaz *", 0, 0, (void*)&_wrap_class_CBaz, 0};
static swig_type_info _swigt__p_Foo = {"_p_Foo", "FooBar *|Foo *", 0, 0, (void*)&_wrap_class_Foo, 0};
...
SWIGEXPORT int Typedef_scope_SafeInit(Tcl_Interp *interp) {
