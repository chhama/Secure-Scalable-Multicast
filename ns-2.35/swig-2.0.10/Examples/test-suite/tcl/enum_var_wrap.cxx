...
#define SWIG_init    Enum_var_Init
...
extern "C" {
#endif
SWIGINTERN const char *_wrap_test_get(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2, int flags) {
  Tcl_Obj *value = 0;
  
  value = SWIG_From_int(static_cast< int >(test));
  if (value) {
...
SWIGINTERN const char *_wrap_test_set(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2 SWIGUNUSED, int flags) {
  Tcl_Obj *value = 0;
  Tcl_Obj *name1o = 0;
  ...
  if (sizeof(int) != sizeof(test)) {
    ...
    int ecode = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(value, reinterpret_cast< int* >(&test));
    if (!SWIG_IsOK(ecode)) {
...
static swig_var_info swig_variables[] = {
    { SWIG_prefix "test", 0, (swig_variable_func) _wrap_test_get,(swig_variable_func) _wrap_test_set},
    {0,0,0,0}
};
...
SWIGEXPORT int SWIG_init(Tcl_Interp *interp) {
  ...
  SWIG_Tcl_SetConstantObj(interp, "APPLE", SWIG_From_int(static_cast< int >(APPLE)));
  SWIG_Tcl_SetConstantObj(interp, "PEAR", SWIG_From_int(static_cast< int >(PEAR)));
  return TCL_OK;
}
SWIGEXPORT int Enum_var_SafeInit(Tcl_Interp *interp) {
