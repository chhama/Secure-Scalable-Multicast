...
#define SWIG_init    Struct_rename_Init
...
_wrap_Bar_x_set(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Bar_x_set" "', argument " "1"" of type '" "Foo *""'"); 
  }
  arg1 = (Foo *)(argp1);
...
_wrap_Bar_x_get(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Foo, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Bar_x_get" "', argument " "1"" of type '" "Foo *""'"); 
  }
  arg1 = (Foo *)(argp1);
  result = (int) ((arg1)->x);
...
_wrap_delete_Bar(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_Bar" "', argument " "1"" of type '" "Foo *""'"); 
  }
  arg1 = (Foo *)(argp1);
  free((char *) arg1);
...
static swig_class _wrap_class_Foo = { "Bar", &SWIGTYPE_p_Foo,_wrap_new_Bar, swig_delete_Bar, swig_Foo_methods, swig_Foo_attributes, swig_Foo_bases,swig_Foo_base_names, &swig_module };
...
static swig_command_info swig_commands[] = {
    ...
    { SWIG_prefix "Bar", (swig_wrapper_func) SWIG_ObjectConstructor, (ClientData)&_wrap_class_Foo},
    {0, 0, 0}
};
...
SWIGEXPORT int Struct_rename_SafeInit(Tcl_Interp *interp) {
