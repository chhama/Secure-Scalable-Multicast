...
#define SWIG_init    Typemap_numinputs_Init
...
#endif
SWIGINTERN int
_wrap_this_breaks(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  int arg1 ;
  char *arg2 = (char *) 0 ;
  int arg3 ;
  int *arg4 = (int *) 0 ;
  ...
  if (SWIG_GetArgs(interp, objc, objv,"ooo:this_breaks hello STR LEN ?OUTPUT? ",(void *)0,(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  {
    arg1 = 0;
  }
  {
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "this_breaks", (swig_wrapper_func) _wrap_this_breaks, NULL},
    {0, 0, 0}
};
...
SWIGEXPORT int Typemap_numinputs_SafeInit(Tcl_Interp *interp) {
