...
#define SWIGTYPE_p_oss__Bar swig_types[1]
#define SWIGTYPE_p_oss__Foo swig_types[2]
...
#define SWIG_init    Conversion_namespace_Init
...
_wrap_new_Foo(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  Tcl_SetObjResult(interp, SWIG_NewInstanceObj( SWIG_as_voidptr(result), SWIGTYPE_p_oss__Foo,0));
  return TCL_OK;
fail:
  return TCL_ERROR;
}
...
_wrap_delete_Foo(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_oss__Foo, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_Foo" "', argument " "1"" of type '" "oss::Foo *""'"); 
  }
  arg1 = reinterpret_cast< oss::Foo * >(argp1);
  delete arg1;
...
oss::Foo *arg1 = (oss::Foo *) obj;
delete arg1;
}
static swig_method swig_oss_Foo_methods[] = {
    {0,0}
};
static swig_attribute swig_oss_Foo_attributes[] = {
    {0,0,0}
};
static swig_class *swig_oss_Foo_bases[] = {0};
static const char * swig_oss_Foo_base_names[] = {0};
static swig_class _wrap_class_oss_Foo = { "Foo", &SWIGTYPE_p_oss__Foo,_wrap_new_Foo, swig_delete_Foo, swig_oss_Foo_methods, swig_oss_Foo_attributes, swig_oss_Foo_bases,swig_oss_Foo_base_names, &swig_module };
SWIGINTERN int
_wrap_Bar_toFoo(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  oss::Bar *arg1 = (oss::Bar *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  oss::Foo result;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:Bar_toFoo self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_oss__Bar, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Bar_toFoo" "', argument " "1"" of type '" "oss::Bar *""'"); 
  }
  arg1 = reinterpret_cast< oss::Bar * >(argp1);
  result = (arg1)->operator oss::Foo();
  Tcl_SetObjResult(interp,SWIG_NewInstanceObj((new oss::Foo(static_cast< const oss::Foo& >(result))), SWIGTYPE_p_oss__Foo, SWIG_POINTER_OWN | 0 ));
  return TCL_OK;
fail:
  return TCL_ERROR;
}
...
_wrap_new_Bar(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  Tcl_SetObjResult(interp, SWIG_NewInstanceObj( SWIG_as_voidptr(result), SWIGTYPE_p_oss__Bar,0));
  return TCL_OK;
fail:
  return TCL_ERROR;
}
...
_wrap_delete_Bar(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_oss__Bar, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_Bar" "', argument " "1"" of type '" "oss::Bar *""'"); 
  }
  arg1 = reinterpret_cast< oss::Bar * >(argp1);
  delete arg1;
...
oss::Bar *arg1 = (oss::Bar *) obj;
delete arg1;
}
static swig_method swig_oss_Bar_methods[] = {
    {"toFoo", _wrap_Bar_toFoo}, 
    {0,0}
};
static swig_attribute swig_oss_Bar_attributes[] = {
    {0,0,0}
};
static swig_class *swig_oss_Bar_bases[] = {0};
static const char * swig_oss_Bar_base_names[] = {0};
static swig_class _wrap_class_oss_Bar = { "Bar", &SWIGTYPE_p_oss__Bar,_wrap_new_Bar, swig_delete_Bar, swig_oss_Bar_methods, swig_oss_Bar_attributes, swig_oss_Bar_bases,swig_oss_Bar_base_names, &swig_module };
...
static swig_command_info swig_commands[] = {
    ...
    { SWIG_prefix "Foo", (swig_wrapper_func) SWIG_ObjectConstructor, (ClientData)&_wrap_class_oss_Foo},
    { SWIG_prefix "Bar_toFoo", (swig_wrapper_func) _wrap_Bar_toFoo, NULL},
    { SWIG_prefix "new_Bar", (swig_wrapper_func) _wrap_new_Bar, NULL},
    { SWIG_prefix "delete_Bar", (swig_wrapper_func) _wrap_delete_Bar, NULL},
    { SWIG_prefix "Bar", (swig_wrapper_func) SWIG_ObjectConstructor, (ClientData)&_wrap_class_oss_Bar},
    {0, 0, 0}
};
...
static swig_type_info _swigt__p_oss__Bar = {"_p_oss__Bar", "oss::Bar *", 0, 0, (void*)&_wrap_class_oss_Bar, 0};
static swig_type_info _swigt__p_oss__Foo = {"_p_oss__Foo", "oss::Foo *", 0, 0, (void*)&_wrap_class_oss_Foo, 0};
...
SWIGEXPORT int Conversion_namespace_SafeInit(Tcl_Interp *interp) {
