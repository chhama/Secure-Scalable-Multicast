...
#define SWIG_init    Enum_macro_Init
...
SWIGEXPORT int SWIG_init(Tcl_Interp *interp) {
  ...
  SWIG_Tcl_SetConstantObj(interp, "alpha1", SWIG_From_int((int)(alpha1)));
  SWIG_Tcl_SetConstantObj(interp, "beta1", SWIG_From_int((int)(beta1)));
  SWIG_Tcl_SetConstantObj(interp, "theta1", SWIG_From_int((int)(theta1)));
  SWIG_Tcl_SetConstantObj(interp, "alpha2", SWIG_From_int((int)(alpha2)));
  SWIG_Tcl_SetConstantObj(interp, "beta2", SWIG_From_int((int)(beta2)));
  SWIG_Tcl_SetConstantObj(interp, "theta2", SWIG_From_int((int)(theta2)));
  SWIG_Tcl_SetConstantObj(interp, "alpha3", SWIG_From_int((int)(alpha3)));
  SWIG_Tcl_SetConstantObj(interp, "beta3", SWIG_From_int((int)(beta3)));
  SWIG_Tcl_SetConstantObj(interp, "theta3", SWIG_From_int((int)(theta3)));
  SWIG_Tcl_SetConstantObj(interp, "alpha4", SWIG_From_int((int)(alpha4)));
  SWIG_Tcl_SetConstantObj(interp, "beta4", SWIG_From_int((int)(beta4)));
  SWIG_Tcl_SetConstantObj(interp, "theta4", SWIG_From_int((int)(theta4)));
  SWIG_Tcl_SetConstantObj(interp, "alpha5", SWIG_From_int((int)(alpha5)));
  SWIG_Tcl_SetConstantObj(interp, "beta5", SWIG_From_int((int)(beta5)));
  SWIG_Tcl_SetConstantObj(interp, "alpha6", SWIG_From_int((int)(alpha6)));
  SWIG_Tcl_SetConstantObj(interp, "beta6", SWIG_From_int((int)(beta6)));
  SWIG_Tcl_SetConstantObj(interp, "alpha7", SWIG_From_int((int)(alpha7)));
  SWIG_Tcl_SetConstantObj(interp, "beta7", SWIG_From_int((int)(beta7)));
  SWIG_Tcl_SetConstantObj(interp, "theta8", SWIG_From_int((int)(theta8)));
  SWIG_Tcl_SetConstantObj(interp, "theta9", SWIG_From_int((int)(theta9)));
  SWIG_Tcl_SetConstantObj(interp, "theta10", SWIG_From_int((int)(theta10)));
  SWIG_Tcl_SetConstantObj(interp, "theta11", SWIG_From_int((int)(theta11)));
  SWIG_Tcl_SetConstantObj(interp, "theta12", SWIG_From_int((int)(theta12)));
  return TCL_OK;
}
SWIGEXPORT int Enum_macro_SafeInit(Tcl_Interp *interp) {
