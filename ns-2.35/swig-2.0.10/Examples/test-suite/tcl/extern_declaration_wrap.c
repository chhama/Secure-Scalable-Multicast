...
#define SWIG_init    Extern_declaration_Init
...
#endif
SWIGINTERN int
_wrap_externimport(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  int arg1 ;
  int val1 ;
  int ecode1 = 0 ;
  int result;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:externimport i ",(void *)0) == TCL_ERROR) SWIG_fail;
  ecode1 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[1], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "externimport" "', argument " "1"" of type '" "int""'");
  } 
  arg1 = (int)(val1);
...
SWIGINTERN int
_wrap_externexport(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  int arg1 ;
  int val1 ;
  int ecode1 = 0 ;
  int result;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:externexport int ",(void *)0) == TCL_ERROR) SWIG_fail;
  ecode1 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[1], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "externexport" "', argument " "1"" of type '" "int""'");
  } 
  arg1 = (int)(val1);
...
SWIGINTERN int
_wrap_externstdcall(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  int arg1 ;
  int val1 ;
  int ecode1 = 0 ;
  int result;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:externstdcall int ",(void *)0) == TCL_ERROR) SWIG_fail;
  ecode1 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[1], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "externstdcall" "', argument " "1"" of type '" "int""'");
  } 
  arg1 = (int)(val1);
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "externimport", (swig_wrapper_func) _wrap_externimport, NULL},
    { SWIG_prefix "externexport", (swig_wrapper_func) _wrap_externexport, NULL},
    { SWIG_prefix "externstdcall", (swig_wrapper_func) _wrap_externstdcall, NULL},
    {0, 0, 0}
};
...
SWIGEXPORT int Extern_declaration_SafeInit(Tcl_Interp *interp) {
