...
#define SWIG_init    Static_array_member_Init
...
#endif
SWIGINTERN int
_wrap_new_RB(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  RB *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,":new_RB ") == TCL_ERROR) SWIG_fail;
  result = (RB *)new RB();
  Tcl_SetObjResult(interp, SWIG_NewInstanceObj( SWIG_as_voidptr(result), SWIGTYPE_p_RB,0));
  return TCL_OK;
fail:
  return TCL_ERROR;
}
...
SWIGINTERN int
_wrap_delete_RB(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  RB *arg1 = (RB *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:delete_RB self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_RB, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_RB" "', argument " "1"" of type '" "RB *""'"); 
  }
  arg1 = reinterpret_cast< RB * >(argp1);
  delete arg1;
...
SWIGINTERN void swig_delete_RB(void *obj) {
RB *arg1 = (RB *) obj;
delete arg1;
}
static swig_method swig_RB_methods[] = {
    {0,0}
};
static swig_attribute swig_RB_attributes[] = {
    {0,0,0}
};
static swig_class *swig_RB_bases[] = {0};
static const char * swig_RB_base_names[] = {0};
static swig_class _wrap_class_RB = { "RB", &SWIGTYPE_p_RB,_wrap_new_RB, swig_delete_RB, swig_RB_methods, swig_RB_attributes, swig_RB_bases,swig_RB_base_names, &swig_module };

static swig_command_info swig_commands[] = {
    { SWIG_prefix "new_RB", (swig_wrapper_func) _wrap_new_RB, NULL},
    { SWIG_prefix "delete_RB", (swig_wrapper_func) _wrap_delete_RB, NULL},
    { SWIG_prefix "RB", (swig_wrapper_func) SWIG_ObjectConstructor, (ClientData)&_wrap_class_RB},
    {0, 0, 0}
};
...
static swig_type_info _swigt__p_RB = {"_p_RB", "RB *", 0, 0, (void*)&_wrap_class_RB, 0};
...
SWIGEXPORT int Static_array_member_SafeInit(Tcl_Interp *interp) {
