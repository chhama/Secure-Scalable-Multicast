...
#define SWIG_init    Conversion_Init
...
_wrap_Bar_toFoo(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Bar_toFoo" "', argument " "1"" of type '" "Bar *""'"); 
  }
...
SWIGEXPORT int Conversion_SafeInit(Tcl_Interp *interp) {
