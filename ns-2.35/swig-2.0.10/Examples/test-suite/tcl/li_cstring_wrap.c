...
#define SWIG_init    Li_cstring_Init
#define SWIG_name    "li_cstring"
#define SWIG_prefix  ""
...
_wrap_count(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  res1 = SWIG_AsCharPtrAndSize(objv[1], &buf1, &size1, &alloc1);
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "count" "', argument " "1"" of type '" "(char *str_in, int n)""'");
  }
  arg1 = (char *) buf1;					       
  arg2 = (int) size1 - 1;
  ecode3 = SWIG_AsVal_char SWIG_TCL_CALL_ARGS_2(objv[2], &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "count" "', argument " "3"" of type '" "char""'");
  } 
  arg3 = (char)(val3);
...
_wrap_test1(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  arg1[512] = 0;  
  Tcl_ListObjAppendElement(interp,Tcl_GetObjResult(interp),SWIG_FromCharPtr(arg1));
  return TCL_OK;
fail:
  return TCL_ERROR;
}
...
_wrap_test2(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  Tcl_ListObjAppendElement(interp,Tcl_GetObjResult(interp),SWIG_FromCharPtrAndSize(arg1,64));
  return TCL_OK;
fail:
  return TCL_ERROR;
}
...
_wrap_test3(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  res1 = SWIG_AsCharPtrAndSize(objv[1], &t1, &n1, &alloc1);
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "test3" "', argument " "1"" of type '" "char *out3""'");
  }
  if ( n1 > (size_t) 512 ) n1 = (size_t) 512;
  memcpy(temp1, t1, sizeof(char)*n1);
...
_wrap_test4(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  res1 = SWIG_AsCharPtrAndSize(objv[1], &t1, &n1, &alloc1);
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "test4" "', argument " "1"" of type '" "char *out4""'");
  }
  arg1 = (char *)malloc((n1+expansion1)*sizeof(char));          
...
_wrap_test5(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "test5" "', argument " "1"" of type '" "(char *out5, int max)""'");
  }
...
_wrap_test6(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "test6" "', argument " "1"" of type '" "(char *out6, int *size)""'");
  }
  buff1= (char *)malloc((n1+1)*sizeof(char));
  arg1 = (char *)(buff1);
  size1 = (int)(n1);
  arg2 = &size1;
  test6(arg1,arg2);
  
  Tcl_ListObjAppendElement(interp,Tcl_GetObjResult(interp),SWIG_FromCharPtrAndSize(arg1,*arg2));
  if (buff1) free((char*)buff1);
  return TCL_OK;
fail:
  if (buff1) free((char*)buff1);
...
SWIGEXPORT int Li_cstring_SafeInit(Tcl_Interp *interp) {
