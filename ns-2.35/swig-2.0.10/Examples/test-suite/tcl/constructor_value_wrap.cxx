...
#define SWIG_init    Constructor_value_Init
...
_wrap_new_Bar(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (SWIG_GetArgs(interp, objc, objv,"o:new_Bar ci ",(void *)0) == TCL_ERROR) SWIG_fail;
  {
    ...
    if (!argp1) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "new_Bar" "', argument " "1"" of type '" "Foo""'");
    } else {
      arg1 = *(reinterpret_cast< Foo * >(argp1));
    }
  }
...
SWIGEXPORT int Constructor_value_SafeInit(Tcl_Interp *interp) {
