...
#define SWIGTYPE_p_foo__FooT_float_t swig_types[1]
...
#define SWIG_init    Template_using_Init
...
SWIGINTERN int
_wrap_new_Foofloat(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  foo::Foo< float > *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,":new_Foofloat ") == TCL_ERROR) SWIG_fail;
  result = (foo::Foo< float > *)new foo::Foo< float >();
  Tcl_SetObjResult(interp, SWIG_NewInstanceObj( SWIG_as_voidptr(result), SWIGTYPE_p_foo__FooT_float_t,0));
  return TCL_OK;
fail:
  return TCL_ERROR;
}
...
SWIGINTERN int
_wrap_delete_Foofloat(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  foo::Foo< float > *arg1 = (foo::Foo< float > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:delete_Foofloat self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_foo__FooT_float_t, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_Foofloat" "', argument " "1"" of type '" "foo::Foo< float > *""'"); 
  }
  arg1 = reinterpret_cast< foo::Foo< float > * >(argp1);
  delete arg1;
...
SWIGINTERN void swig_delete_Foofloat(void *obj) {
foo::Foo< float > *arg1 = (foo::Foo< float > *) obj;
delete arg1;
}
static swig_method swig_foo_Foo_Sl_float_Sg__methods[] = {
    {0,0}
};
static swig_attribute swig_foo_Foo_Sl_float_Sg__attributes[] = {
    {0,0,0}
};
static swig_class *swig_foo_Foo_Sl_float_Sg__bases[] = {0};
static const char * swig_foo_Foo_Sl_float_Sg__base_names[] = {0};
static swig_class _wrap_class_foo_Foo_Sl_float_Sg_ = { "Foofloat", &SWIGTYPE_p_foo__FooT_float_t,_wrap_new_Foofloat, swig_delete_Foofloat, swig_foo_Foo_Sl_float_Sg__methods, swig_foo_Foo_Sl_float_Sg__attributes, swig_foo_Foo_Sl_float_Sg__bases,swig_foo_Foo_Sl_float_Sg__base_names, &swig_module };
SWIGINTERN int
_wrap_maxfloat(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  float arg1 ;
  float arg2 ;
  float val1 ;
  int ecode1 = 0 ;
  ...
  if (SWIG_GetArgs(interp, objc, objv,"oo:maxfloat a b ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  ecode1 = SWIG_AsVal_float SWIG_TCL_CALL_ARGS_2(objv[1], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "maxfloat" "', argument " "1"" of type '" "float""'");
  } 
  arg1 = static_cast< float >(val1);
  ecode2 = SWIG_AsVal_float SWIG_TCL_CALL_ARGS_2(objv[2], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "maxfloat" "', argument " "2"" of type '" "float""'");
  } 
...
static swig_command_info swig_commands[] = {
    ...
    { SWIG_prefix "new_Foofloat", (swig_wrapper_func) _wrap_new_Foofloat, NULL},
    { SWIG_prefix "delete_Foofloat", (swig_wrapper_func) _wrap_delete_Foofloat, NULL},
    { SWIG_prefix "Foofloat", (swig_wrapper_func) SWIG_ObjectConstructor, (ClientData)&_wrap_class_foo_Foo_Sl_float_Sg_},
    { SWIG_prefix "maxfloat", (swig_wrapper_func) _wrap_maxfloat, NULL},
    {0, 0, 0}
};
...
static swig_type_info _swigt__p_foo__FooT_float_t = {"_p_foo__FooT_float_t", "foo::Foo< float > *", 0, 0, (void*)&_wrap_class_foo_Foo_Sl_float_Sg_, 0};
...
SWIGEXPORT int Template_using_SafeInit(Tcl_Interp *interp) {
