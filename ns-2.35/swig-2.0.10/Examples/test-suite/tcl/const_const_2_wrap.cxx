...
#define SWIG_init    Const_const_2_Init
...
SWIGINTERN int
_wrap_new_Eggs(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Eggs *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,":new_Eggs ") == TCL_ERROR) SWIG_fail;
  result = (Eggs *)new Eggs();
  Tcl_SetObjResult(interp, SWIG_NewInstanceObj( SWIG_as_voidptr(result), SWIGTYPE_p_Eggs,0));
  return TCL_OK;
fail:
  return TCL_ERROR;
}
...
SWIGINTERN int
_wrap_Eggs_spam(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Eggs *arg1 = (Eggs *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  Spam *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:Eggs_spam self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Eggs, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Eggs_spam" "', argument " "1"" of type '" "Eggs const *""'"); 
  }
  arg1 = reinterpret_cast< Eggs * >(argp1);
...
SWIGINTERN int
_wrap_delete_Eggs(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Eggs *arg1 = (Eggs *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:delete_Eggs self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Eggs, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_Eggs" "', argument " "1"" of type '" "Eggs *""'"); 
  }
  arg1 = reinterpret_cast< Eggs * >(argp1);
  delete arg1;
...
SWIGINTERN void swig_delete_Eggs(void *obj) {
Eggs *arg1 = (Eggs *) obj;
delete arg1;
}
static swig_method swig_Eggs_methods[] = {
    {"spam", _wrap_Eggs_spam}, 
    {0,0}
};
static swig_attribute swig_Eggs_attributes[] = {
    {0,0,0}
};
static swig_class *swig_Eggs_bases[] = {0};
static const char * swig_Eggs_base_names[] = {0};
static swig_class _wrap_class_Eggs = { "Eggs", &SWIGTYPE_p_Eggs,_wrap_new_Eggs, swig_delete_Eggs, swig_Eggs_methods, swig_Eggs_attributes, swig_Eggs_bases,swig_Eggs_base_names, &swig_module };
...
static swig_command_info swig_commands[] = {
    ...
    { SWIG_prefix "new_Eggs", (swig_wrapper_func) _wrap_new_Eggs, NULL},
    { SWIG_prefix "Eggs_spam", (swig_wrapper_func) _wrap_Eggs_spam, NULL},
    { SWIG_prefix "delete_Eggs", (swig_wrapper_func) _wrap_delete_Eggs, NULL},
    { SWIG_prefix "Eggs", (swig_wrapper_func) SWIG_ObjectConstructor, (ClientData)&_wrap_class_Eggs},
    {0, 0, 0}
};
...
static swig_type_info _swigt__p_Eggs = {"_p_Eggs", "Eggs *", 0, 0, (void*)&_wrap_class_Eggs, 0};
...
SWIGEXPORT int Const_const_2_SafeInit(Tcl_Interp *interp) {
