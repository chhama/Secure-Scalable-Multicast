...
#define SWIGTYPE_p_s1 swig_types[2]
...
#define SWIG_init    Nested_comment_Init
...
_wrap_new_s2(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  result = (s1 *)new s1();
  Tcl_SetObjResult(interp, SWIG_NewInstanceObj( SWIG_as_voidptr(result), SWIGTYPE_p_s1,0));
  return TCL_OK;
fail:
  return TCL_ERROR;
}
...
_wrap_delete_s2(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_s1, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_s2" "', argument " "1"" of type '" "s1 *""'"); 
  }
  arg1 = reinterpret_cast< s1 * >(argp1);
  delete arg1;
...
static swig_method swig_s1_methods[] = {
    {0,0}
};
static swig_attribute swig_s1_attributes[] = {
    {0,0,0}
};
static swig_class *swig_s1_bases[] = {0};
static const char * swig_s1_base_names[] = {0};
static swig_class _wrap_class_s1 = { "s2", &SWIGTYPE_p_s1,_wrap_new_s2, swig_delete_s2, swig_s1_methods, swig_s1_attributes, swig_s1_bases,swig_s1_base_names, &swig_module };
SWIGINTERN int
...
static swig_command_info swig_commands[] = {
    ...
    { SWIG_prefix "s2", (swig_wrapper_func) SWIG_ObjectConstructor, (ClientData)&_wrap_class_s1},
...
static swig_type_info _swigt__p_s1 = {"_p_s1", "s2 *|s1 *", 0, 0, (void*)&_wrap_class_s1, 0};
...
SWIGEXPORT int Nested_comment_SafeInit(Tcl_Interp *interp) {
