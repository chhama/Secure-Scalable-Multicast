...
#define SWIG_init    Name_cxx_Init
...
#endif
SWIGINTERN int
_wrap_bar_int(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  int arg1 ;
  int val1 ;
  int ecode1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:bar_int i ",(void *)0) == TCL_ERROR) SWIG_fail;
  ecode1 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[1], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "bar_int" "', argument " "1"" of type '" "int""'");
  } 
...
SWIGINTERN int
_wrap_bar_double(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  double arg1 ;
  double val1 ;
  int ecode1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:bar_double i ",(void *)0) == TCL_ERROR) SWIG_fail;
  ecode1 = SWIG_AsVal_double SWIG_TCL_CALL_ARGS_2(objv[1], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "bar_double" "', argument " "1"" of type '" "double""'");
  } 
...
_wrap_delete_AA(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_AA" "', argument " "1"" of type '" "A *""'"); 
  }
...
static swig_class _wrap_class_A = { "AA", &SWIGTYPE_p_A,_wrap_new_AA, swig_delete_AA, swig_A_methods, swig_A_attributes, swig_A_bases,swig_A_base_names, &swig_module };
SWIGINTERN int
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "bar_int", (swig_wrapper_func) _wrap_bar_int, NULL},
    { SWIG_prefix "bar_double", (swig_wrapper_func) _wrap_bar_double, NULL},
    { SWIG_prefix "new_AA", (swig_wrapper_func) _wrap_new_AA, NULL},
    { SWIG_prefix "delete_AA", (swig_wrapper_func) _wrap_delete_AA, NULL},
    { SWIG_prefix "AA", (swig_wrapper_func) SWIG_ObjectConstructor, (ClientData)&_wrap_class_A},
...
SWIGEXPORT int Name_cxx_SafeInit(Tcl_Interp *interp) {
