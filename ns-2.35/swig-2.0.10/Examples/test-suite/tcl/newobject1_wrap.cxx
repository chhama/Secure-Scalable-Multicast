...
#define SWIG_init    Newobject1_Init
...
_wrap_Foo_makeFoo(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (SWIG_GetArgs(interp, objc, objv,":Foo_makeFoo ") == TCL_ERROR) SWIG_fail;
...
SWIGINTERN int
_wrap_Foo_makeMore(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Foo *arg1 = (Foo *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  Foo *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:Foo_makeMore self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Foo, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Foo_makeMore" "', argument " "1"" of type '" "Foo *""'"); 
  }
...
SWIGINTERN int
_wrap_Foo_fooCount(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  int result;
  
  if (SWIG_GetArgs(interp, objc, objv,":Foo_fooCount ") == TCL_ERROR) SWIG_fail;
...
static swig_command_info swig_commands[] = {
    ...
    { SWIG_prefix "Foo_makeMore", (swig_wrapper_func) _wrap_Foo_makeMore, NULL},
    { SWIG_prefix "Foo_fooCount", (swig_wrapper_func) _wrap_Foo_fooCount, NULL},
...
SWIGEXPORT int Newobject1_SafeInit(Tcl_Interp *interp) {
