...
#endif
SWIGINTERN int
_wrap_eat(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Giraffe arg1 = (Giraffe) 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:eat g ",(void *)0) == TCL_ERROR) SWIG_fail;
  {
...
SWIGINTERN int
_wrap_drink(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Giraffe *arg1 = (Giraffe *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:drink g ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_p_void, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "drink" "', argument " "1"" of type '" "Giraffe *""'"); 
  }
  arg1 = (Giraffe *)(argp1);
  drink(arg1);
...
SWIGINTERN int
_wrap_mate(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Giraffe *arg1 ;
  Giraffe result;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:mate g ",(void *)0) == TCL_ERROR) SWIG_fail;
  {
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "eat", (swig_wrapper_func) _wrap_eat, NULL},
    { SWIG_prefix "drink", (swig_wrapper_func) _wrap_drink, NULL},
    { SWIG_prefix "mate", (swig_wrapper_func) _wrap_mate, NULL},
    {0, 0, 0}
};
...
SWIGEXPORT int SWIG_init(Tcl_Interp *interp) {
  ...
  SWIG_Tcl_SetConstantObj(interp, "HEIGHT_Giraffe", SWIG_From_int((int)(100)));
  SWIG_Tcl_SetConstantObj(interp, "WIDTH_Giraffe", SWIG_From_int((int)(5)));
  return TCL_OK;
}
SWIGEXPORT int Lextype_SafeInit(Tcl_Interp *interp) {
