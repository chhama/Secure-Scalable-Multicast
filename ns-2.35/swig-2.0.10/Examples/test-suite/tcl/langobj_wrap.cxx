...
#endif
SWIGINTERN int
_wrap_identity(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Tcl_Obj *arg1 = (Tcl_Obj *) 0 ;
  Tcl_Obj *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:identity x ",(void *)0) == TCL_ERROR) SWIG_fail;
  arg1 = objv[1];
  result = (Tcl_Obj *)identity(arg1);
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "identity", (swig_wrapper_func) _wrap_identity, NULL},
    {0, 0, 0}
};
...
SWIGEXPORT int Langobj_SafeInit(Tcl_Interp *interp) {
