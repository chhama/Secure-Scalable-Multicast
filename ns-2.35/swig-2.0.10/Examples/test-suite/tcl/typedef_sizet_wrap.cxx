...
#define SWIG_init    Typedef_sizet_Init
...
#endif
SWIGINTERN int
_wrap_size(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  size_t arg1 ;
  size_t val1 ;
  int ecode1 = 0 ;
  size_t result;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:size x ",(void *)0) == TCL_ERROR) SWIG_fail;
  ecode1 = SWIG_AsVal_size_t SWIG_TCL_CALL_ARGS_2(objv[1], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "size" "', argument " "1"" of type '" "size_t""'");
  } 
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "size", (swig_wrapper_func) _wrap_size, NULL},
    {0, 0, 0}
};
...
SWIGEXPORT int Typedef_sizet_SafeInit(Tcl_Interp *interp) {
