...
#define SWIG_init    Typename_Init
...
SWIGINTERN int
_wrap_spam(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Bar::Number result;
  
  if (SWIG_GetArgs(interp, objc, objv,":spam ") == TCL_ERROR) SWIG_fail;
...
SWIGINTERN int
_wrap_twoFoo(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Foo *arg1 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  Foo::Number result;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:twoFoo obj ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1, SWIGTYPE_p_Foo,  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "twoFoo" "', argument " "1"" of type '" "Foo &""'"); 
  }
  if (!argp1) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "twoFoo" "', argument " "1"" of type '" "Foo &""'"); 
  }
  arg1 = reinterpret_cast< Foo * >(argp1);
...
SWIGINTERN int
_wrap_twoBar(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Bar *arg1 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  Bar::Number result;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:twoBar obj ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1, SWIGTYPE_p_Bar,  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "twoBar" "', argument " "1"" of type '" "Bar &""'"); 
  }
  if (!argp1) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "twoBar" "', argument " "1"" of type '" "Bar &""'"); 
  }
  arg1 = reinterpret_cast< Bar * >(argp1);
...
static swig_command_info swig_commands[] = {
    ...
    { SWIG_prefix "spam", (swig_wrapper_func) _wrap_spam, NULL},
    { SWIG_prefix "twoFoo", (swig_wrapper_func) _wrap_twoFoo, NULL},
    { SWIG_prefix "twoBar", (swig_wrapper_func) _wrap_twoBar, NULL},
    {0, 0, 0}
};
...
SWIGEXPORT int Typename_SafeInit(Tcl_Interp *interp) {
