...
#define SWIG_init    Typemap_arrays_Init
...
#endif
SWIGINTERN int
_wrap_sumA(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  int **arg1 ;
  int *temp1[3] ;
  int result;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:sumA nums ",(void *)0) == TCL_ERROR) SWIG_fail;
  {
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "sumA", (swig_wrapper_func) _wrap_sumA, NULL},
    {0, 0, 0}
};
...
SWIGEXPORT int Typemap_arrays_SafeInit(Tcl_Interp *interp) {
