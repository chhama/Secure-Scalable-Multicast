...
#define SWIG_init    Import_stl_b_Init
...
#endif
SWIGINTERN int
_wrap_process_vector(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  std::vector< int > *arg1 = 0 ;
  std::vector< int > *v1 ;
  std::vector< int > w1 ;
  std::vector< int > result;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:process_vector v ",(void *)0) == TCL_ERROR) SWIG_fail;
  {
    Tcl_Obj **listobjv;
    int       nitems;
    int       i;
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "process_vector", (swig_wrapper_func) _wrap_process_vector, NULL},
    {0, 0, 0}
};
...
SWIGEXPORT int Import_stl_b_SafeInit(Tcl_Interp *interp) {
