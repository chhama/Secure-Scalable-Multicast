...
#define SWIG_init    Template_typedef_fnc_Init
...
SWIGINTERN int
_wrap_setCallback(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  RtMidiCallback arg1 = (RtMidiCallback) 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:setCallback callback ",(void *)0) == TCL_ERROR) SWIG_fail;
  {
    int res = SWIG_ConvertFunctionPtr(objv[1], (void**)(&arg1), SWIGTYPE_p_f_p_std__vector__int____void);
    if (!SWIG_IsOK(res)) {
...
static swig_command_info swig_commands[] = {
    ...
    { SWIG_prefix "setCallback", (swig_wrapper_func) _wrap_setCallback, NULL},
    {0, 0, 0}
};
...
SWIGEXPORT int Template_typedef_fnc_SafeInit(Tcl_Interp *interp) {
