...
#define SWIG_init    Packageoption_b_Init
...
#endif
SWIGINTERN int
_wrap_B_testInt(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  B *arg1 = (B *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  int result;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:B_testInt self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_B, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "B_testInt" "', argument " "1"" of type '" "B *""'"); 
  }
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "B_testInt", (swig_wrapper_func) _wrap_B_testInt, NULL},
...
SWIGEXPORT int Packageoption_b_SafeInit(Tcl_Interp *interp) {
