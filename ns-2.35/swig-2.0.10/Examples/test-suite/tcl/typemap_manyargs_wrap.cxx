...
#define SWIG_init    Typemap_manyargs_Init
...
#endif
SWIGINTERN int
_wrap_my_c_function(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  char *arg1 = (char *) 0 ;
  int *arg2 = (int *) 0 ;
  int *arg3 = (int *) 0 ;
  int *arg4 = (int *) 0 ;
  ...
  if (SWIG_GetArgs(interp, objc, objv,"o:my_c_function filename ?a2? ?a3? ?a4? ?a5? ?a6? ?a7? ?a8? ?a9? ?a10? ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_AsCharPtrAndSize(objv[1], &buf1, NULL, &alloc1);
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "my_c_function" "', argument " "1"" of type '" "char *""'");
  }
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "my_c_function", (swig_wrapper_func) _wrap_my_c_function, NULL},
    {0, 0, 0}
};
...
SWIGEXPORT int Typemap_manyargs_SafeInit(Tcl_Interp *interp) {
