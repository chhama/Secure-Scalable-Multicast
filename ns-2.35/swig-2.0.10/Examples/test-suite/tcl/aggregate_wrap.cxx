...
#define SWIG_init    Aggregate_Init
...
SWIGINTERN int
_wrap_move(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  int arg1 ;
  int val1 ;
  int ecode1 = 0 ;
  int result;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:move direction ",(void *)0) == TCL_ERROR) SWIG_fail;
  ecode1 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[1], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "move" "', argument " "1"" of type '" "int""'");
  } 
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "move", (swig_wrapper_func) _wrap_move, NULL},
    {0, 0, 0}
};
...
SWIGEXPORT int SWIG_init(Tcl_Interp *interp) {
  ...
  SWIG_Tcl_SetConstantObj(interp, "UP", SWIG_From_int(static_cast< int >(1)));
  SWIG_Tcl_SetConstantObj(interp, "DOWN", SWIG_From_int(static_cast< int >(2)));
  SWIG_Tcl_SetConstantObj(interp, "LEFT", SWIG_From_int(static_cast< int >(3)));
  SWIG_Tcl_SetConstantObj(interp, "RIGHT", SWIG_From_int(static_cast< int >(4)));
  return TCL_OK;
}
SWIGEXPORT int Aggregate_SafeInit(Tcl_Interp *interp) {
