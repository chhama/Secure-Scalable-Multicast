...
#define SWIG_init    Wrapmacro_Init
...
#endif
SWIGINTERN int
_wrap_GUINT16_SWAP_LE_BE_CONSTANT(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  guint16 arg1 ;
  unsigned short val1 ;
  int ecode1 = 0 ;
  guint16 result;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:GUINT16_SWAP_LE_BE_CONSTANT val ",(void *)0) == TCL_ERROR) SWIG_fail;
  ecode1 = SWIG_AsVal_unsigned_SS_short SWIG_TCL_CALL_ARGS_2(objv[1], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "GUINT16_SWAP_LE_BE_CONSTANT" "', argument " "1"" of type '" "guint16""'");
  } 
  arg1 = static_cast< guint16 >(val1);
...
SWIGINTERN int
_wrap_maximum__SWIG_0(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  size_t arg1 ;
  size_t *arg2 = 0 ;
  size_t val1 ;
  int ecode1 = 0 ;
  ...
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "maximum" "', argument " "1"" of type '" "size_t""'");
  } 
  arg1 = static_cast< size_t >(val1);
  ecode2 = SWIG_AsVal_size_t SWIG_TCL_CALL_ARGS_2(objv[2], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "maximum" "', argument " "2"" of type '" "size_t""'");
  } 
...
_wrap_maximum(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (argc == 2) {
    ...
    if (_v) {
      ...
      if (_v) {
        return _wrap_maximum__SWIG_0(clientData, interp, objc, argv - 1);
      }
    }
  }
  if (argc == 2) {
  ...
  Tcl_SetResult(interp,(char *) "Wrong number or type of arguments for overloaded function 'maximum'.\n"
    ...
    "    SWIGMACRO_maximum(size_t,size_t const &)\n"
    "    SWIGMACRO_maximum(double,double)\n", TCL_STATIC);
  return TCL_ERROR;
}
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "GUINT16_SWAP_LE_BE_CONSTANT", (swig_wrapper_func) _wrap_GUINT16_SWAP_LE_BE_CONSTANT, NULL},
...
SWIGEXPORT int Wrapmacro_SafeInit(Tcl_Interp *interp) {
