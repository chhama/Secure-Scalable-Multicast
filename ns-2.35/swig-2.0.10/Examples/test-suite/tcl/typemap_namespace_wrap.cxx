...
#define SWIG_init    Typemap_namespace_Init
...
_wrap_test1(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "test1" "', argument " "1"" of type '" "Foo::Str1 *""'");
  }
  arg1 = reinterpret_cast< Foo::Str1 * >(buf1);
...
_wrap_test2(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  res1 = SWIG_AsCharPtrAndSize(objv[1], &buf1, NULL, &alloc1);
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "test2" "', argument " "1"" of type '" "Foo::Str2 *""'");
  }
  arg1 = reinterpret_cast< Foo::Str2 * >(buf1);
...
SWIGEXPORT int Typemap_namespace_SafeInit(Tcl_Interp *interp) {
