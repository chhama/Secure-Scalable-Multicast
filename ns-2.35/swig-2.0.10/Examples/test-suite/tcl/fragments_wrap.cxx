...
#define SWIG_init    Fragments_Init
...
_wrap_bar(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (SWIG_GetArgs(interp, objc, objv,"o:bar a ",(void *)0) == TCL_ERROR) SWIG_fail;
...
_wrap_foo(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (SWIG_GetArgs(interp, objc, objv,"o:foo hola ",(void *)0) == TCL_ERROR) SWIG_fail;
  arg1 = 123;
  result = (int)foo(arg1);
  Tcl_SetObjResult(interp,SWIG_From_int(static_cast< int >(result)));
  return TCL_OK;
...
SWIGEXPORT int Fragments_SafeInit(Tcl_Interp *interp) {
