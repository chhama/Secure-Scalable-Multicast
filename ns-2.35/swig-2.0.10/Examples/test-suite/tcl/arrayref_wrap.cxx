...
#define SWIG_init    Arrayref_Init
...
_wrap_foo(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  res1 = SWIG_ConvertPtr(objv[1], &argp1, SWIGTYPE_p_a_10__int,  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "foo" "', argument " "1"" of type '" "int const (&)[10]""'"); 
  }
  if (!argp1) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "foo" "', argument " "1"" of type '" "int const (&)[10]""'"); 
  }
...
_wrap_bar(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (SWIG_GetArgs(interp, objc, objv,"o:bar x ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1, SWIGTYPE_p_a_10__int,  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "bar" "', argument " "1"" of type '" "int (&)[10]""'"); 
  }
  if (!argp1) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "bar" "', argument " "1"" of type '" "int (&)[10]""'"); 
  }
  arg1 = reinterpret_cast< int (*)[10] >(argp1);
  bar((int (&)[10])*arg1);
...
SWIGEXPORT int Arrayref_SafeInit(Tcl_Interp *interp) {
