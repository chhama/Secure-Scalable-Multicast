...
#define SWIG_init    Allprotected_not_Init
...
#endif
SWIGINTERN int
_wrap_delete_AllProtectedNot(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  AllProtectedNot *arg1 = (AllProtectedNot *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:delete_AllProtectedNot self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_AllProtectedNot, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_AllProtectedNot" "', argument " "1"" of type '" "AllProtectedNot *""'"); 
  }
  arg1 = reinterpret_cast< AllProtectedNot * >(argp1);
  delete arg1;
...
SWIGINTERN int
_wrap_AllProtectedNot_PublicMethod(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  AllProtectedNot *arg1 = (AllProtectedNot *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:AllProtectedNot_PublicMethod self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_AllProtectedNot, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "AllProtectedNot_PublicMethod" "', argument " "1"" of type '" "AllProtectedNot *""'"); 
  }
  arg1 = reinterpret_cast< AllProtectedNot * >(argp1);
  (arg1)->PublicMethod();
...
SWIGINTERN int
_wrap_new_AllProtectedNot(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  AllProtectedNot *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,":new_AllProtectedNot ") == TCL_ERROR) SWIG_fail;
  result = (AllProtectedNot *)new AllProtectedNot();
  Tcl_SetObjResult(interp, SWIG_NewInstanceObj( SWIG_as_voidptr(result), SWIGTYPE_p_AllProtectedNot,0));
  return TCL_OK;
fail:
  return TCL_ERROR;
}
...
SWIGINTERN void swig_delete_AllProtectedNot(void *obj) {
AllProtectedNot *arg1 = (AllProtectedNot *) obj;
delete arg1;
}
static swig_method swig_AllProtectedNot_methods[] = {
    {"PublicMethod", _wrap_AllProtectedNot_PublicMethod}, 
    {0,0}
};
static swig_attribute swig_AllProtectedNot_attributes[] = {
    {0,0,0}
};
static swig_class *swig_AllProtectedNot_bases[] = {0};
static const char * swig_AllProtectedNot_base_names[] = {0};
static swig_class _wrap_class_AllProtectedNot = { "AllProtectedNot", &SWIGTYPE_p_AllProtectedNot,_wrap_new_AllProtectedNot, swig_delete_AllProtectedNot, swig_AllProtectedNot_methods, swig_AllProtectedNot_attributes, swig_AllProtectedNot_bases,swig_AllProtectedNot_base_names, &swig_module };

static swig_command_info swig_commands[] = {
    { SWIG_prefix "delete_AllProtectedNot", (swig_wrapper_func) _wrap_delete_AllProtectedNot, NULL},
    { SWIG_prefix "AllProtectedNot_PublicMethod", (swig_wrapper_func) _wrap_AllProtectedNot_PublicMethod, NULL},
    { SWIG_prefix "new_AllProtectedNot", (swig_wrapper_func) _wrap_new_AllProtectedNot, NULL},
    { SWIG_prefix "AllProtectedNot", (swig_wrapper_func) SWIG_ObjectConstructor, (ClientData)&_wrap_class_AllProtectedNot},
    {0, 0, 0}
};
...
static swig_type_info _swigt__p_AllProtectedNot = {"_p_AllProtectedNot", "AllProtectedNot *", 0, 0, (void*)&_wrap_class_AllProtectedNot, 0};
...
SWIGEXPORT int Allprotected_not_SafeInit(Tcl_Interp *interp) {
