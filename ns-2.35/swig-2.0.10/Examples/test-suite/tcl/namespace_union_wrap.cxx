...
#define SWIG_init    Namespace_union_Init
...
#endif
SWIGINTERN int
_wrap_new_Variant(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  SpatialIndex::Variant *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,":new_Variant ") == TCL_ERROR) SWIG_fail;
  result = (SpatialIndex::Variant *)new SpatialIndex::Variant();
  Tcl_SetObjResult(interp, SWIG_NewInstanceObj( SWIG_as_voidptr(result), SWIGTYPE_p_SpatialIndex__Variant,0));
  return TCL_OK;
fail:
  return TCL_ERROR;
}
...
SWIGINTERN int
_wrap_Variant_varType_set(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (SWIG_GetArgs(interp, objc, objv,"oo:Variant_varType_set self varType ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_SpatialIndex__Variant, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Variant_varType_set" "', argument " "1"" of type '" "SpatialIndex::Variant *""'"); 
  }
  arg1 = reinterpret_cast< SpatialIndex::Variant * >(argp1);
  ecode2 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[2], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "Variant_varType_set" "', argument " "2"" of type '" "int""'");
  } 
...
SWIGINTERN int
_wrap_Variant_varType_get(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  SpatialIndex::Variant *arg1 = (SpatialIndex::Variant *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  int result;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:Variant_varType_get self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_SpatialIndex__Variant, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Variant_varType_get" "', argument " "1"" of type '" "SpatialIndex::Variant *""'"); 
  }
  arg1 = reinterpret_cast< SpatialIndex::Variant * >(argp1);
...
SWIGINTERN int
_wrap_delete_Variant(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  SpatialIndex::Variant *arg1 = (SpatialIndex::Variant *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:delete_Variant self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_SpatialIndex__Variant, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_Variant" "', argument " "1"" of type '" "SpatialIndex::Variant *""'"); 
  }
  arg1 = reinterpret_cast< SpatialIndex::Variant * >(argp1);
  delete arg1;
...
SWIGINTERN void swig_delete_Variant(void *obj) {
SpatialIndex::Variant *arg1 = (SpatialIndex::Variant *) obj;
delete arg1;
}
static swig_method swig_SpatialIndex_Variant_methods[] = {
    {0,0}
};
static swig_attribute swig_SpatialIndex_Variant_attributes[] = {
    { "-varType",_wrap_Variant_varType_get, _wrap_Variant_varType_set},
    {0,0,0}
};
static swig_class *swig_SpatialIndex_Variant_bases[] = {0};
static const char * swig_SpatialIndex_Variant_base_names[] = {0};
static swig_class _wrap_class_SpatialIndex_Variant = { "Variant", &SWIGTYPE_p_SpatialIndex__Variant,_wrap_new_Variant, swig_delete_Variant, swig_SpatialIndex_Variant_methods, swig_SpatialIndex_Variant_attributes, swig_SpatialIndex_Variant_bases,swig_SpatialIndex_Variant_base_names, &swig_module };

static swig_command_info swig_commands[] = {
    { SWIG_prefix "new_Variant", (swig_wrapper_func) _wrap_new_Variant, NULL},
    { SWIG_prefix "Variant_varType_set", (swig_wrapper_func) _wrap_Variant_varType_set, NULL},
    { SWIG_prefix "Variant_varType_get", (swig_wrapper_func) _wrap_Variant_varType_get, NULL},
    { SWIG_prefix "delete_Variant", (swig_wrapper_func) _wrap_delete_Variant, NULL},
    { SWIG_prefix "Variant", (swig_wrapper_func) SWIG_ObjectConstructor, (ClientData)&_wrap_class_SpatialIndex_Variant},
    {0, 0, 0}
};
...
static swig_type_info _swigt__p_SpatialIndex__Variant = {"_p_SpatialIndex__Variant", "SpatialIndex::Variant *", 0, 0, (void*)&_wrap_class_SpatialIndex_Variant, 0};
...
SWIGEXPORT int Namespace_union_SafeInit(Tcl_Interp *interp) {
