...
#define SWIG_init    Li_cpointer_Init
...
_wrap_new_doublep(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (SWIG_GetArgs(interp, objc, objv,":new_doublep ") == TCL_ERROR) SWIG_fail;
  result = (doublep *)new_doublep();
  Tcl_SetObjResult(interp, SWIG_NewInstanceObj( SWIG_as_voidptr(result), SWIGTYPE_p_doublep,0));
  return TCL_OK;
fail:
  return TCL_ERROR;
}
...
_wrap_delete_doublep(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (SWIG_GetArgs(interp, objc, objv,"o:delete_doublep self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_doublep, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN int
_wrap_doublep_assign(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  doublep *arg1 = (doublep *) 0 ;
  double arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (SWIG_GetArgs(interp, objc, objv,"oo:doublep_assign self value ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_doublep, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN int
_wrap_doublep_value(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  doublep *arg1 = (doublep *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  double result;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:doublep_value self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_doublep, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN int
_wrap_doublep_cast(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  doublep *arg1 = (doublep *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  double *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:doublep_cast self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_doublep, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN int
_wrap_doublep_frompointer(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  double *arg1 = (double *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  doublep *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:doublep_frompointer t ",(void *)0) == TCL_ERROR) SWIG_fail;
...
SWIGINTERN void swig_delete_doublep(void *obj) {
doublep *arg1 = (doublep *) obj;
delete_doublep(arg1);
}
static swig_method swig_doublep_methods[] = {
    {"assign", _wrap_doublep_assign}, 
    {"value", _wrap_doublep_value}, 
    {"cast", _wrap_doublep_cast}, 
    {0,0}
};
static swig_attribute swig_doublep_attributes[] = {
    {0,0,0}
};
static swig_class *swig_doublep_bases[] = {0};
static const char * swig_doublep_base_names[] = {0};
static swig_class _wrap_class_doublep = { "doublep", &SWIGTYPE_p_doublep,_wrap_new_doublep, swig_delete_doublep, swig_doublep_methods, swig_doublep_attributes, swig_doublep_bases,swig_doublep_base_names, &swig_module };
SWIGINTERN int
_wrap_int_to_uint(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  int arg1 ;
  int val1 ;
  int ecode1 = 0 ;
  unsigned int result;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:int_to_uint x ",(void *)0) == TCL_ERROR) SWIG_fail;
  ecode1 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[1], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "int_to_uint" "', argument " "1"" of type '" "int""'");
  } 
  arg1 = (int)(val1);
...
static swig_command_info swig_commands[] = {
    ...
    { SWIG_prefix "doublep_assign", (swig_wrapper_func) _wrap_doublep_assign, NULL},
    { SWIG_prefix "doublep_value", (swig_wrapper_func) _wrap_doublep_value, NULL},
    { SWIG_prefix "doublep_cast", (swig_wrapper_func) _wrap_doublep_cast, NULL},
    { SWIG_prefix "doublep_frompointer", (swig_wrapper_func) _wrap_doublep_frompointer, NULL},
    { SWIG_prefix "doublep", (swig_wrapper_func) SWIG_ObjectConstructor, (ClientData)&_wrap_class_doublep},
    { SWIG_prefix "int_to_uint", (swig_wrapper_func) _wrap_int_to_uint, NULL},
    {0, 0, 0}
};
...
SWIGEXPORT int Li_cpointer_SafeInit(Tcl_Interp *interp) {
