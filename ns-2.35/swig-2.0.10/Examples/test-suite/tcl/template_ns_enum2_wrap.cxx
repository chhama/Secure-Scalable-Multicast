...
#define SWIG_init    Template_ns_enum2_Init
...
#endif
SWIGINTERN int
_wrap_B_evaluate(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  hi::B *arg1 = (hi::B *) 0 ;
  ...
  if (SWIG_GetArgs(interp, objc, objv,"oo:B_evaluate self e ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_hi__B, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "B_evaluate" "', argument " "1"" of type '" "hi::B const *""'"); 
  }
  arg1 = reinterpret_cast< hi::B * >(argp1);
  res2 = SWIG_ConvertPtr(objv[2], &argp2, SWIGTYPE_p_hi__traitsT_hi__Hola_t__value_type,  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "B_evaluate" "', argument " "2"" of type '" "hi::traits< hi::Hola >::value_type const &""'"); 
  }
  if (!argp2) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "B_evaluate" "', argument " "2"" of type '" "hi::traits< hi::Hola >::value_type const &""'"); 
  }
  arg2 = reinterpret_cast< hi::traits< hi::Hola >::value_type * >(argp2);
  result = (hi::traits< hi::Hola >::value_type *) &((hi::B const *)arg1)->evaluate((hi::traits< hi::Hola >::value_type const &)*arg2);
  Tcl_SetObjResult(interp, SWIG_NewInstanceObj( SWIG_as_voidptr(result), SWIGTYPE_p_hi__traitsT_hi__Hola_t__value_type,0));
  return TCL_OK;
fail:
  return TCL_ERROR;
}
...
static swig_method swig_hi_B_methods[] = {
    {"evaluate", _wrap_B_evaluate}, 
    {0,0}
};
static swig_attribute swig_hi_B_attributes[] = {
    {0,0,0}
};
static swig_class *swig_hi_B_bases[] = {0};
static const char * swig_hi_B_base_names[] = {0};
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "B_evaluate", (swig_wrapper_func) _wrap_B_evaluate, NULL},
...
SWIGEXPORT int Template_ns_enum2_SafeInit(Tcl_Interp *interp) {
