...
#define SWIGTYPE_p_nRState swig_types[1]
...
#define SWIG_init    Union_scope_Init
...
#endif
SWIGINTERN int
_wrap_new_nRState(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  nRState *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,":new_nRState ") == TCL_ERROR) SWIG_fail;
  result = (nRState *)new nRState();
  Tcl_SetObjResult(interp, SWIG_NewInstanceObj( SWIG_as_voidptr(result), SWIGTYPE_p_nRState,0));
  return TCL_OK;
fail:
  return TCL_ERROR;
}
...
SWIGINTERN int
_wrap_delete_nRState(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  nRState *arg1 = (nRState *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:delete_nRState self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_nRState, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_nRState" "', argument " "1"" of type '" "nRState *""'"); 
  }
  arg1 = reinterpret_cast< nRState * >(argp1);
  delete arg1;
...
SWIGINTERN void swig_delete_nRState(void *obj) {
nRState *arg1 = (nRState *) obj;
delete arg1;
}
static swig_method swig_nRState_methods[] = {
    {0,0}
};
static swig_attribute swig_nRState_attributes[] = {
    {0,0,0}
};
static swig_class *swig_nRState_bases[] = {0};
static const char * swig_nRState_base_names[] = {0};
static swig_class _wrap_class_nRState = { "nRState", &SWIGTYPE_p_nRState,_wrap_new_nRState, swig_delete_nRState, swig_nRState_methods, swig_nRState_attributes, swig_nRState_bases,swig_nRState_base_names, &swig_module };

static swig_command_info swig_commands[] = {
    { SWIG_prefix "new_nRState", (swig_wrapper_func) _wrap_new_nRState, NULL},
    { SWIG_prefix "delete_nRState", (swig_wrapper_func) _wrap_delete_nRState, NULL},
    { SWIG_prefix "nRState", (swig_wrapper_func) SWIG_ObjectConstructor, (ClientData)&_wrap_class_nRState},
    {0, 0, 0}
};
...
static swig_type_info _swigt__p_nRState = {"_p_nRState", "nRState *", 0, 0, (void*)&_wrap_class_nRState, 0};
...
SWIGEXPORT int Union_scope_SafeInit(Tcl_Interp *interp) {
