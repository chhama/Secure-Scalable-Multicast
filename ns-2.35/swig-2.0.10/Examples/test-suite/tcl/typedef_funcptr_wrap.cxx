...
#define SWIG_init    Typedef_funcptr_Init
...
_wrap_do_op(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (SWIG_GetArgs(interp, objc, objv,"ooo:do_op x y op ",(void *)0,(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  ecode1 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[1], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "do_op" "', argument " "1"" of type '" "Integer""'");
  } 
  ...
  arg2 = static_cast< Integer >(val2);
  {
    ...
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), "in method '" "do_op" "', argument " "3"" of type '" "Integer (*)(Integer,Integer)""'"); 
    }
  }
...
SWIGEXPORT int SWIG_init(Tcl_Interp *interp) {
  ...
  SWIG_Tcl_SetConstantObj(interp, "addf", SWIG_NewFunctionPtrObj((void *)addf, SWIGTYPE_p_f_int_int__int));
  SWIG_Tcl_SetConstantObj(interp, "subf", SWIG_NewFunctionPtrObj((void *)subf, SWIGTYPE_p_f_int_int__int));
  return TCL_OK;
}
SWIGEXPORT int Typedef_funcptr_SafeInit(Tcl_Interp *interp) {
