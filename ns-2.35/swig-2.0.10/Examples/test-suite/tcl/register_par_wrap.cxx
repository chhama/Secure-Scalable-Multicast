...
#define SWIGTYPE_p_tree swig_types[1]
...
#define SWIG_init    Register_par_Init
...
#endif
SWIGINTERN int
_wrap_clear_tree_flags(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  tree *arg1 = (tree *) 0 ;
  int arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (SWIG_GetArgs(interp, objc, objv,"oo:clear_tree_flags tp i ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_tree, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "clear_tree_flags" "', argument " "1"" of type '" "tree *""'"); 
  }
  arg1 = reinterpret_cast< tree * >(argp1);
  ecode2 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[2], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "clear_tree_flags" "', argument " "2"" of type '" "int""'");
  } 
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "clear_tree_flags", (swig_wrapper_func) _wrap_clear_tree_flags, NULL},
    {0, 0, 0}
};
...
SWIGEXPORT int Register_par_SafeInit(Tcl_Interp *interp) {
