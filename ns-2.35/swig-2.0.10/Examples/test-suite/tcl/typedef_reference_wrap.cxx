...
#define SWIG_init    Typedef_reference_Init
...
SWIGINTERN int
_wrap_somefunc(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  int *arg1 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  int result;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:somefunc i ",(void *)0) == TCL_ERROR) SWIG_fail;
...
SWIGINTERN int
_wrap_otherfunc(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  int *arg1 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  int result;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:otherfunc i ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1, SWIGTYPE_p_int,  0 );
  if (!SWIG_IsOK(res1)) {
...
static swig_command_info swig_commands[] = {
    ...
    { SWIG_prefix "somefunc", (swig_wrapper_func) _wrap_somefunc, NULL},
    { SWIG_prefix "otherfunc", (swig_wrapper_func) _wrap_otherfunc, NULL},
    {0, 0, 0}
};
...
SWIGEXPORT int Typedef_reference_SafeInit(Tcl_Interp *interp) {
