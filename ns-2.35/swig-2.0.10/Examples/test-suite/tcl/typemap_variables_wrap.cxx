...
#define SWIG_init    Typemap_variables_Init
...
extern "C" {
#endif
SWIGINTERN const char *_wrap_globul_get(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2, int flags) {
  Tcl_Obj *value = 0;
  
  /*int globul varout*/ value=0;
  if (value) {
...
SWIGINTERN const char *_wrap_globul_set(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2 SWIGUNUSED, int flags) {
  Tcl_Obj *value = 0;
  Tcl_Obj *name1o = 0;
  ...
  if (!value) SWIG_fail;
  /*int globul varin */ TYPEMAP_VARIABLES_FAIL
  return NULL;
fail:
  return "globul";
}
...
SWIGINTERN const char *_wrap_nspace_get(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2, int flags) {
  Tcl_Obj *value = 0;
  
  /*int nspace varout*/ value=0;
  if (value) {
    Tcl_SetVar2(interp,name1,name2,Tcl_GetStringFromObj(value,NULL), flags);
    Tcl_DecrRefCount(value);
  }
...
SWIGINTERN const char *_wrap_nspace_set(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2 SWIGUNUSED, int flags) {
  Tcl_Obj *value = 0;
  Tcl_Obj *name1o = 0;
  ...
  Tcl_DecrRefCount(name1o);
  if (!value) SWIG_fail;
  /*int nspace varin */ TYPEMAP_VARIABLES_FAIL
  return NULL;
fail:
  return "nspace";
}
...
SWIGINTERN int
_wrap_Struct_member_set(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Space::Struct *arg1 = (Space::Struct *) 0 ;
  int arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"oo:Struct_member_set self member ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Space__Struct, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Struct_member_set" "', argument " "1"" of type '" "Space::Struct *""'"); 
  }
  arg1 = reinterpret_cast< Space::Struct * >(argp1);
...
SWIGINTERN int
_wrap_Struct_member_get(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Space::Struct *arg1 = (Space::Struct *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  int result;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:Struct_member_get self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Space__Struct, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Struct_member_get" "', argument " "1"" of type '" "Space::Struct *""'"); 
  }
  arg1 = reinterpret_cast< Space::Struct * >(argp1);
...
SWIGINTERN const char *_wrap_Struct_smember_get(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2, int flags) {
  Tcl_Obj *value = 0;
  
  /*int smember varout*/ value=0;
  if (value) {
    Tcl_SetVar2(interp,name1,name2,Tcl_GetStringFromObj(value,NULL), flags);
    Tcl_DecrRefCount(value);
  }
...
SWIGINTERN const char *_wrap_Struct_smember_set(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2 SWIGUNUSED, int flags) {
  Tcl_Obj *value = 0;
  Tcl_Obj *name1o = 0;
  ...
  Tcl_DecrRefCount(name1o);
  if (!value) SWIG_fail;
  /*int smember varin */ TYPEMAP_VARIABLES_FAIL
  return NULL;
fail:
  return "Struct_smember";
}
...
_wrap_new_Struct(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  Tcl_SetObjResult(interp, SWIG_NewInstanceObj( SWIG_as_voidptr(result), SWIGTYPE_p_Space__Struct,0));
  return TCL_OK;
fail:
  return TCL_ERROR;
}
...
_wrap_delete_Struct(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Space__Struct, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_Struct" "', argument " "1"" of type '" "Space::Struct *""'"); 
  }
  arg1 = reinterpret_cast< Space::Struct * >(argp1);
  delete arg1;
...
Space::Struct *arg1 = (Space::Struct *) obj;
delete arg1;
}
static swig_method swig_Space_Struct_methods[] = {
    {0,0}
};
static swig_attribute swig_Space_Struct_attributes[] = {
    { "-member",_wrap_Struct_member_get, _wrap_Struct_member_set},
    {0,0,0}
};
static swig_class *swig_Space_Struct_bases[] = {0};
static const char * swig_Space_Struct_base_names[] = {0};
static swig_class _wrap_class_Space_Struct = { "Struct", &SWIGTYPE_p_Space__Struct,_wrap_new_Struct, swig_delete_Struct, swig_Space_Struct_methods, swig_Space_Struct_attributes, swig_Space_Struct_bases,swig_Space_Struct_base_names, &swig_module };

static swig_command_info swig_commands[] = {
    { SWIG_prefix "Struct_member_set", (swig_wrapper_func) _wrap_Struct_member_set, NULL},
    { SWIG_prefix "Struct_member_get", (swig_wrapper_func) _wrap_Struct_member_get, NULL},
    ...
    { SWIG_prefix "Struct", (swig_wrapper_func) SWIG_ObjectConstructor, (ClientData)&_wrap_class_Space_Struct},
    {0, 0, 0}
};

static swig_var_info swig_variables[] = {
    { SWIG_prefix "globul", 0, (swig_variable_func) _wrap_globul_get,(swig_variable_func) _wrap_globul_set},
    { SWIG_prefix "nspace", 0, (swig_variable_func) _wrap_nspace_get,(swig_variable_func) _wrap_nspace_set},
    { SWIG_prefix "Struct_smember", 0, (swig_variable_func) _wrap_Struct_smember_get,(swig_variable_func) _wrap_Struct_smember_set},
    {0,0,0,0}
};
...
static swig_type_info _swigt__p_Space__Struct = {"_p_Space__Struct", "Space::Struct *", 0, 0, (void*)&_wrap_class_Space_Struct, 0};
...
SWIGEXPORT int Typemap_variables_SafeInit(Tcl_Interp *interp) {
