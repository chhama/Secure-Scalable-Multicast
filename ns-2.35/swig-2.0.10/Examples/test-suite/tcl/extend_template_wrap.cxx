...
#define SWIGTYPE_p_oss__FooT_0_t swig_types[1]
...
#define SWIG_init    Extend_template_Init
...
#endif
SWIGINTERN int
_wrap_Foo_0_test1(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (SWIG_GetArgs(interp, objc, objv,"oo:Foo_0_test1 self x ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_oss__FooT_0_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Foo_0_test1" "', argument " "1"" of type '" "oss::Foo< 0 > *""'"); 
  }
  arg1 = reinterpret_cast< oss::Foo< 0 > * >(argp1);
  ecode2 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[2], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "Foo_0_test1" "', argument " "2"" of type '" "int""'");
  } 
...
SWIGINTERN int
_wrap_Foo_0_test2(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  oss::Foo< 0 > *arg1 = (oss::Foo< 0 > *) 0 ;
  int arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (SWIG_GetArgs(interp, objc, objv,"oo:Foo_0_test2 self x ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_oss__FooT_0_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Foo_0_test2" "', argument " "1"" of type '" "oss::Foo< 0 > *""'"); 
  }
  arg1 = reinterpret_cast< oss::Foo< 0 > * >(argp1);
  ecode2 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[2], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "Foo_0_test2" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = static_cast< int >(val2);
...
SWIGINTERN int
_wrap_new_Foo_0(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  oss::Foo< 0 > *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,":new_Foo_0 ") == TCL_ERROR) SWIG_fail;
  result = (oss::Foo< 0 > *)new oss::Foo< 0 >();
  Tcl_SetObjResult(interp, SWIG_NewInstanceObj( SWIG_as_voidptr(result), SWIGTYPE_p_oss__FooT_0_t,0));
  return TCL_OK;
fail:
  return TCL_ERROR;
}
...
SWIGINTERN int
_wrap_delete_Foo_0(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  oss::Foo< 0 > *arg1 = (oss::Foo< 0 > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:delete_Foo_0 self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_oss__FooT_0_t, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_Foo_0" "', argument " "1"" of type '" "oss::Foo< 0 > *""'"); 
  }
  arg1 = reinterpret_cast< oss::Foo< 0 > * >(argp1);
  delete arg1;
...
SWIGINTERN void swig_delete_Foo_0(void *obj) {
oss::Foo< 0 > *arg1 = (oss::Foo< 0 > *) obj;
delete arg1;
}
static swig_method swig_oss_Foo_Sl_0_Sg__methods[] = {
    {"test1", _wrap_Foo_0_test1}, 
    {"test2", _wrap_Foo_0_test2}, 
    {0,0}
};
static swig_attribute swig_oss_Foo_Sl_0_Sg__attributes[] = {
    {0,0,0}
};
static swig_class *swig_oss_Foo_Sl_0_Sg__bases[] = {0};
static const char * swig_oss_Foo_Sl_0_Sg__base_names[] = {0};
static swig_class _wrap_class_oss_Foo_Sl_0_Sg_ = { "Foo_0", &SWIGTYPE_p_oss__FooT_0_t,_wrap_new_Foo_0, swig_delete_Foo_0, swig_oss_Foo_Sl_0_Sg__methods, swig_oss_Foo_Sl_0_Sg__attributes, swig_oss_Foo_Sl_0_Sg__bases,swig_oss_Foo_Sl_0_Sg__base_names, &swig_module };

static swig_command_info swig_commands[] = {
    { SWIG_prefix "Foo_0_test1", (swig_wrapper_func) _wrap_Foo_0_test1, NULL},
    { SWIG_prefix "Foo_0_test2", (swig_wrapper_func) _wrap_Foo_0_test2, NULL},
    { SWIG_prefix "new_Foo_0", (swig_wrapper_func) _wrap_new_Foo_0, NULL},
    { SWIG_prefix "delete_Foo_0", (swig_wrapper_func) _wrap_delete_Foo_0, NULL},
    { SWIG_prefix "Foo_0", (swig_wrapper_func) SWIG_ObjectConstructor, (ClientData)&_wrap_class_oss_Foo_Sl_0_Sg_},
    {0, 0, 0}
};
...
static swig_type_info _swigt__p_oss__FooT_0_t = {"_p_oss__FooT_0_t", "oss::Foo< 0 > *", 0, 0, (void*)&_wrap_class_oss_Foo_Sl_0_Sg_, 0};
...
SWIGEXPORT int Extend_template_SafeInit(Tcl_Interp *interp) {
