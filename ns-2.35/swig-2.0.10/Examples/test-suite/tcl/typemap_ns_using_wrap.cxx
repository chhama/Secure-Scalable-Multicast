...
#define SWIG_init    Typemap_ns_using_Init
...
#endif
SWIGINTERN int
_wrap_new__FooImpl(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  X::_FooImpl *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,":new__FooImpl ") == TCL_ERROR) SWIG_fail;
  result = (X::_FooImpl *)new X::_FooImpl();
  Tcl_SetObjResult(interp, SWIG_NewInstanceObj( SWIG_as_voidptr(result), SWIGTYPE_p_X___FooImpl,0));
  return TCL_OK;
fail:
  return TCL_ERROR;
}
...
SWIGINTERN int
_wrap_delete__FooImpl(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  X::_FooImpl *arg1 = (X::_FooImpl *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:delete__FooImpl self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_X___FooImpl, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete__FooImpl" "', argument " "1"" of type '" "X::_FooImpl *""'"); 
  }
  arg1 = reinterpret_cast< X::_FooImpl * >(argp1);
  delete arg1;
...
SWIGINTERN void swig_delete__FooImpl(void *obj) {
X::_FooImpl *arg1 = (X::_FooImpl *) obj;
delete arg1;
}
static swig_method swig_X__FooImpl_methods[] = {
    {0,0}
};
static swig_attribute swig_X__FooImpl_attributes[] = {
    {0,0,0}
};
static swig_class *swig_X__FooImpl_bases[] = {0};
static const char * swig_X__FooImpl_base_names[] = {0};
static swig_class _wrap_class_X__FooImpl = { "_FooImpl", &SWIGTYPE_p_X___FooImpl,_wrap_new__FooImpl, swig_delete__FooImpl, swig_X__FooImpl_methods, swig_X__FooImpl_attributes, swig_X__FooImpl_bases,swig_X__FooImpl_base_names, &swig_module };
SWIGINTERN int
_wrap_spam(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (SWIG_GetArgs(interp, objc, objv,"o:spam x ",(void *)0) == TCL_ERROR) SWIG_fail;
  ecode1 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[1], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "spam" "', argument " "1"" of type '" "Foo::value_type""'");
  } 
  arg1 = static_cast< Foo::value_type >(val1);
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "new__FooImpl", (swig_wrapper_func) _wrap_new__FooImpl, NULL},
    { SWIG_prefix "delete__FooImpl", (swig_wrapper_func) _wrap_delete__FooImpl, NULL},
    { SWIG_prefix "_FooImpl", (swig_wrapper_func) SWIG_ObjectConstructor, (ClientData)&_wrap_class_X__FooImpl},
...
static swig_type_info _swigt__p_X___FooImpl = {"_p_X___FooImpl", "X::_FooImpl *|X::Foo *", 0, 0, (void*)&_wrap_class_X__FooImpl, 0};
...
SWIGEXPORT int Typemap_ns_using_SafeInit(Tcl_Interp *interp) {
