...
#define SWIG_init    Ordering_Init
...
#endif
SWIGINTERN int
_wrap_Klass_variable_set(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Klass *arg1 = (Klass *) 0 ;
  int arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (SWIG_GetArgs(interp, objc, objv,"oo:Klass_variable_set self variable ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Klass, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Klass_variable_set" "', argument " "1"" of type '" "Klass *""'"); 
  }
  arg1 = reinterpret_cast< Klass * >(argp1);
  ecode2 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[2], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "Klass_variable_set" "', argument " "2"" of type '" "int""'");
  } 
...
SWIGINTERN int
_wrap_Klass_variable_get(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Klass *arg1 = (Klass *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  int result;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:Klass_variable_get self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Klass, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Klass_variable_get" "', argument " "1"" of type '" "Klass *""'"); 
  }
  arg1 = reinterpret_cast< Klass * >(argp1);
...
static swig_attribute swig_Klass_attributes[] = {
    { "-variable",_wrap_Klass_variable_get, _wrap_Klass_variable_set},
    {0,0,0}
};
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "Klass_variable_set", (swig_wrapper_func) _wrap_Klass_variable_set, NULL},
    { SWIG_prefix "Klass_variable_get", (swig_wrapper_func) _wrap_Klass_variable_get, NULL},
...
SWIGEXPORT int Ordering_SafeInit(Tcl_Interp *interp) {
