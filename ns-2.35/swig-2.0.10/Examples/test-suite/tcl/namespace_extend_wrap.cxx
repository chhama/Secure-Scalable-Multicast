...
#define SWIG_init    Namespace_extend_Init
...
_wrap_bar_blah(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "bar_blah" "', argument " "2"" of type '" "int""'");
  } 
...
SWIGEXPORT int Namespace_extend_SafeInit(Tcl_Interp *interp) {
