...
#define SWIG_init    Overload_extendc_Init
...
#endif
SWIGINTERN int
_wrap_Foo_dummy_set(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (SWIG_GetArgs(interp, objc, objv,"oo:Foo_dummy_set self dummy ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Foo, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Foo_dummy_set" "', argument " "1"" of type '" "struct Foo *""'"); 
  }
  arg1 = (struct Foo *)(argp1);
  ecode2 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[2], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "Foo_dummy_set" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = (int)(val2);
...
SWIGINTERN int
_wrap_Foo_dummy_get(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  struct Foo *arg1 = (struct Foo *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  int result;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:Foo_dummy_get self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Foo, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Foo_dummy_get" "', argument " "1"" of type '" "struct Foo *""'"); 
  }
  arg1 = (struct Foo *)(argp1);
...
_wrap_Foo_test__SWIG_3(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  arg4=1000;
  if (SWIG_GetArgs(interp, objc, objv,"ooo|o:Foo_test self s int1 ?int2? ",(void *)0,(void *)0,(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Foo, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Foo_test" "', argument " "1"" of type '" "struct Foo *""'"); 
  }
  ...
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "Foo_test" "', argument " "3"" of type '" "int""'");
  } 
  arg3 = (int)(val3);
  if (objc > 4) {
    ecode4 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[4], &val4);
    if (!SWIG_IsOK(ecode4)) {
      SWIG_exception_fail(SWIG_ArgError(ecode4), "in method '" "Foo_test" "', argument " "4"" of type '" "int""'");
    } 
    arg4 = (int)(val4);
  }
...
_wrap_Foo_test__SWIG_4(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (SWIG_GetArgs(interp, objc, objv,"oo|oo:Foo_test self f ?i? ?j? ",(void *)0,(void *)0,(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Foo, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Foo_test" "', argument " "1"" of type '" "struct Foo *""'"); 
  }
  ...
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "Foo_test" "', argument " "2"" of type '" "Foo *""'"); 
  }
  arg2 = (Foo *)(argp2);
  if (objc > 3) {
    ecode3 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[3], &val3);
...
_wrap_Foo_test(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  Tcl_SetResult(interp,(char *) "Wrong number or type of arguments for overloaded function 'Foo_test'.\n"
    ...
    "    Foo::test(char *,int,int)\n"
    "    Foo::test(Foo *,int,int)\n", TCL_STATIC);
  return TCL_ERROR;
}
...
static swig_attribute swig_Foo_attributes[] = {
    { "-dummy",_wrap_Foo_dummy_get, _wrap_Foo_dummy_set},
    {0,0,0}
};
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "Foo_dummy_set", (swig_wrapper_func) _wrap_Foo_dummy_set, NULL},
    { SWIG_prefix "Foo_dummy_get", (swig_wrapper_func) _wrap_Foo_dummy_get, NULL},
...
SWIGEXPORT int Overload_extendc_SafeInit(Tcl_Interp *interp) {
