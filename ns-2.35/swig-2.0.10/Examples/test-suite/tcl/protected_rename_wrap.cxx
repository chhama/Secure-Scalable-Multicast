...
#define SWIG_init    Protected_rename_Init
...
#endif
SWIGINTERN int
_wrap_Foo_x(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Foo *arg1 = (Foo *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:Foo_x self ",(void *)0) == TCL_ERROR) SWIG_fail;
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "Foo_x", (swig_wrapper_func) _wrap_Foo_x, NULL},
...
SWIGEXPORT int Protected_rename_SafeInit(Tcl_Interp *interp) {
