...
#endif
SWIGINTERN int
_wrap_c_clone(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  char *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,":c_clone ") == TCL_ERROR) SWIG_fail;
  result = (char *)clone();
...
SWIGINTERN int
_wrap__delegate(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  char *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,":_delegate ") == TCL_ERROR) SWIG_fail;
...
SWIGINTERN int
_wrap__pass(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  char *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,":_pass ") == TCL_ERROR) SWIG_fail;
  result = (char *)pass();
  Tcl_SetObjResult(interp,SWIG_FromCharPtr((const char *)result));
  return TCL_OK;
fail:
...
SWIGINTERN int
_wrap__alias(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  char *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,":_alias ") == TCL_ERROR) SWIG_fail;
  result = (char *)alias();
  Tcl_SetObjResult(interp,SWIG_FromCharPtr((const char *)result));
  return TCL_OK;
fail:
...
SWIGINTERN int
_wrap_C_rescue(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  char *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,":C_rescue ") == TCL_ERROR) SWIG_fail;
  result = (char *)rescue();
  Tcl_SetObjResult(interp,SWIG_FromCharPtr((const char *)result));
  return TCL_OK;
fail:
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "c_clone", (swig_wrapper_func) _wrap_c_clone, NULL},
    { SWIG_prefix "_delegate", (swig_wrapper_func) _wrap__delegate, NULL},
    { SWIG_prefix "_pass", (swig_wrapper_func) _wrap__pass, NULL},
    { SWIG_prefix "_alias", (swig_wrapper_func) _wrap__alias, NULL},
    { SWIG_prefix "C_rescue", (swig_wrapper_func) _wrap_C_rescue, NULL},
    {0, 0, 0}
};
...
SWIGEXPORT int Wallkw_SafeInit(Tcl_Interp *interp) {
