...
#define SWIG_init    Newobject2_Init
...
_wrap_Foo_dummy_set(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Foo_dummy_set" "', argument " "1"" of type '" "Foo *""'"); 
  }
  arg1 = (Foo *)(argp1);
...
_wrap_Foo_dummy_get(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Foo, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Foo_dummy_get" "', argument " "1"" of type '" "Foo *""'"); 
  }
  arg1 = (Foo *)(argp1);
...
SWIGINTERN int
_wrap_makeFoo(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Foo *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,":makeFoo ") == TCL_ERROR) SWIG_fail;
  result = (Foo *)makeFoo();
  Tcl_SetObjResult(interp, SWIG_NewInstanceObj( SWIG_as_voidptr(result), SWIGTYPE_p_Foo,0));
  return TCL_OK;
fail:
...
SWIGINTERN int
_wrap_fooCount(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  int result;
  
  if (SWIG_GetArgs(interp, objc, objv,":fooCount ") == TCL_ERROR) SWIG_fail;
  result = (int)fooCount();
  Tcl_SetObjResult(interp,SWIG_From_int((int)(result)));
  return TCL_OK;
fail:
...
SWIGINTERN int
_wrap_do_stuff(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Foo *arg1 = (Foo *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:do_stuff f ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Foo, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "do_stuff" "', argument " "1"" of type '" "Foo *""'"); 
  }
  arg1 = (Foo *)(argp1);
  do_stuff(arg1);
...
static swig_command_info swig_commands[] = {
    ...
    { SWIG_prefix "makeFoo", (swig_wrapper_func) _wrap_makeFoo, NULL},
    { SWIG_prefix "fooCount", (swig_wrapper_func) _wrap_fooCount, NULL},
    { SWIG_prefix "do_stuff", (swig_wrapper_func) _wrap_do_stuff, NULL},
    {0, 0, 0}
};
...
SWIGEXPORT int Newobject2_SafeInit(Tcl_Interp *interp) {
