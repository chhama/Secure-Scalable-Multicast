...
#define SWIGTYPE_p_p_wchar_t swig_types[2]
...
#define SWIG_init    Li_cwstring_Init
#define SWIG_name    "li_cwstring"
#define SWIG_prefix  ""
...
SWIGINTERN int
SWIG_AsWCharArray(Tcl_Obj * obj, wchar_t *val, size_t size)
{ 
...
SWIGINTERN int
SWIG_AsVal_wchar_t SWIG_TCL_DECL_ARGS_2(Tcl_Obj * obj, wchar_t *val)
{    
...
#endif
SWIGINTERN int
_wrap_count(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (SWIG_GetArgs(interp, objc, objv,"oo:count str_in n ?c? ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_AsWCharPtrAndSize(objv[1], &buf1, &size1, &alloc1);
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "count" "', argument " "1"" of type '" "(wchar_t *str_in, int n)""'");
  }
  arg1 = (wchar_t *) buf1;					       
  arg2 = (int) size1 - 1;
  ecode3 = SWIG_AsVal_wchar_t SWIG_TCL_CALL_ARGS_2(objv[2], &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "count" "', argument " "3"" of type '" "wchar_t""'");
  } 
  arg3 = (wchar_t)(val3);
...
_wrap_test1(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  arg1 = (wchar_t *) temp1;
  if (SWIG_GetArgs(interp, objc, objv,":test1 ") == TCL_ERROR) SWIG_fail;
  test1(arg1);
  
  arg1[512] = 0;  
  Tcl_ListObjAppendElement(interp,Tcl_GetObjResult(interp),SWIG_FromWCharPtr(arg1));
  return TCL_OK;
fail:
  return TCL_ERROR;
}
...
_wrap_test2(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  Tcl_ListObjAppendElement(interp,Tcl_GetObjResult(interp),SWIG_FromWCharPtrAndSize(arg1,64));
  return TCL_OK;
fail:
  return TCL_ERROR;
}
...
SWIGINTERN int
_wrap_test3(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  wchar_t *arg1 = (wchar_t *) 0 ;
  int res1 ;
  wchar_t temp1[512+1] ;
  wchar_t *t1 = 0 ;
  ...
  if (SWIG_GetArgs(interp, objc, objv,"o:test3 out3 ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_AsWCharPtrAndSize(objv[1], &t1, &n1, &alloc1);
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "test3" "', argument " "1"" of type '" "wchar_t *out3""'");
  }
  if ( n1 > (size_t) 512 ) n1 = (size_t) 512;
  memcpy(temp1, t1, sizeof(wchar_t)*n1);
  if (alloc1 == SWIG_NEWOBJ) free((char*)t1);
  temp1[n1 - 1] = 0;                                                             
  arg1 = (wchar_t *) temp1;
  test3(arg1);
...
SWIGINTERN int
_wrap_test4(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  wchar_t *arg1 = (wchar_t *) 0 ;
  int res1 ;
  wchar_t *t1 = 0 ;
  size_t n1 = 0 ;
  ...
  if (SWIG_GetArgs(interp, objc, objv,"o:test4 out4 ",(void *)0) == TCL_ERROR) SWIG_fail;
  expansion1 += 32;
  
  res1 = SWIG_AsWCharPtrAndSize(objv[1], &t1, &n1, &alloc1);
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "test4" "', argument " "1"" of type '" "wchar_t *out4""'");
  }
  arg1 = (wchar_t *)malloc((n1+expansion1)*sizeof(wchar_t));          
  memcpy(arg1,t1,sizeof(wchar_t)*n1);
  if (alloc1 == SWIG_NEWOBJ) free((char*)t1);
  arg1[n1-1] = 0;
  test4(arg1);
...
SWIGINTERN int
_wrap_test5(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  wchar_t *arg1 = (wchar_t *) 0 ;
  int arg2 ;
  int res1 ;
  size_t size1 ;
  ...
  if (SWIG_GetArgs(interp, objc, objv,"o:test5 out5 ?max? ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_AsVal_size_t SWIG_TCL_CALL_ARGS_2(objv[1], &size1);
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "test5" "', argument " "1"" of type '" "(wchar_t *out5, int max)""'");
  }
  buff1= (wchar_t *)malloc((size1+1)*sizeof(wchar_t));
  arg2 = (int)(size1);
  arg1 = (wchar_t *)(buff1);
  test5(arg1,arg2);
...
SWIGINTERN int
_wrap_test6(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  wchar_t *arg1 = (wchar_t *) 0 ;
  int *arg2 = (int *) 0 ;
  int res1 ;
  size_t n1 ;
  ...
  if (SWIG_GetArgs(interp, objc, objv,"o:test6 out6 ?size? ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_AsVal_size_t SWIG_TCL_CALL_ARGS_2(objv[1], &n1);
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "test6" "', argument " "1"" of type '" "(wchar_t *out6, int *size)""'");
  }
  buff1= (wchar_t *)malloc((n1+1)*sizeof(wchar_t));
  arg1 = (wchar_t *)(buff1);
  size1 = (int)(n1);
  arg2 = &size1;
  test6(arg1,arg2);
  
  Tcl_ListObjAppendElement(interp,Tcl_GetObjResult(interp),SWIG_FromWCharPtrAndSize(arg1,*arg2));
  if (buff1) free((char*)buff1);
  return TCL_OK;
fail:
  if (buff1) free((char*)buff1);
...
SWIGINTERN int
_wrap_test7(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  wchar_t **arg1 = (wchar_t **) 0 ;
  wchar_t *temp1 = 0 ;
  
  arg1 = &temp1;
  if (SWIG_GetArgs(interp, objc, objv,":test7 ") == TCL_ERROR) SWIG_fail;
  test7(arg1);
...
SWIGINTERN int
_wrap_test8(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  wchar_t **arg1 = (wchar_t **) 0 ;
  int *arg2 = (int *) 0 ;
  wchar_t *temp1 = 0 ;
  int tempn1 ;
  ...
  if (SWIG_GetArgs(interp, objc, objv,":test8 ?size? ") == TCL_ERROR) SWIG_fail;
  test8(arg1,arg2);
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "count", (swig_wrapper_func) _wrap_count, NULL},
    { SWIG_prefix "test1", (swig_wrapper_func) _wrap_test1, NULL},
    { SWIG_prefix "test2", (swig_wrapper_func) _wrap_test2, NULL},
    { SWIG_prefix "test3", (swig_wrapper_func) _wrap_test3, NULL},
    { SWIG_prefix "test4", (swig_wrapper_func) _wrap_test4, NULL},
    { SWIG_prefix "test5", (swig_wrapper_func) _wrap_test5, NULL},
    { SWIG_prefix "test6", (swig_wrapper_func) _wrap_test6, NULL},
    { SWIG_prefix "test7", (swig_wrapper_func) _wrap_test7, NULL},
    { SWIG_prefix "test8", (swig_wrapper_func) _wrap_test8, NULL},
    {0, 0, 0}
};
...
SWIGEXPORT int Li_cwstring_SafeInit(Tcl_Interp *interp) {
