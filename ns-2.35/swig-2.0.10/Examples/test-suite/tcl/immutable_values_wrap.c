...
#define SWIG_init    Immutable_values_Init
...
SWIGEXPORT int SWIG_init(Tcl_Interp *interp) {
  ...
  SWIG_Tcl_SetConstantObj(interp, "ABC", SWIG_From_int((int)(-11)));
  SWIG_Tcl_SetConstantObj(interp, "Zero", SWIG_From_int((int)(Zero)));
  SWIG_Tcl_SetConstantObj(interp, "One", SWIG_From_int((int)(One)));
  SWIG_Tcl_SetConstantObj(interp, "Two", SWIG_From_int((int)(Two)));
  SWIG_Tcl_SetConstantObj(interp, "XYZ", SWIG_From_int((int)(-22)));
  SWIG_Tcl_SetConstantObj(interp, "Tre", SWIG_From_int((int)(Tre)));
  SWIG_Tcl_SetConstantObj(interp, "Duo", SWIG_From_int((int)(Duo)));
  SWIG_Tcl_SetConstantObj(interp, "Uno", SWIG_From_int((int)(Uno)));
  return TCL_OK;
}
SWIGEXPORT int Immutable_values_SafeInit(Tcl_Interp *interp) {
