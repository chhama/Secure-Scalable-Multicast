...
#define SWIG_init    Template_virtual_Init
...
SWIGINTERN int
_wrap_A_int_say_hi(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  A< int > *arg1 = (A< int > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:A_int_say_hi self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_AT_int_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "A_int_say_hi" "', argument " "1"" of type '" "A< int > *""'"); 
  }
  arg1 = reinterpret_cast< A< int > * >(argp1);
  (arg1)->say_hi();
...
SWIGINTERN int
_wrap_A_int_say_hello(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  A< int > *arg1 = (A< int > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:A_int_say_hello self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_AT_int_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "A_int_say_hello" "', argument " "1"" of type '" "A< int > *""'"); 
  }
  arg1 = reinterpret_cast< A< int > * >(argp1);
  (arg1)->say_hello();
...
static swig_method swig_A_Sl_int_Sg__methods[] = {
    {"say_hi", _wrap_A_int_say_hi}, 
    {"say_hello", _wrap_A_int_say_hello}, 
    {0,0}
};
...
static swig_class _wrap_class_A_Sl_int_Sg_ = { "A_int", &SWIGTYPE_p_AT_int_t,0, swig_delete_A_int, swig_A_Sl_int_Sg__methods, swig_A_Sl_int_Sg__attributes, swig_A_Sl_int_Sg__bases,swig_A_Sl_int_Sg__base_names, &swig_module };
SWIGINTERN int
...
static swig_class _wrap_class_B_Sl_int_Sg_ = { "B_int", &SWIGTYPE_p_BT_int_t,0, swig_delete_B_int, swig_B_Sl_int_Sg__methods, swig_B_Sl_int_Sg__attributes, swig_B_Sl_int_Sg__bases,swig_B_Sl_int_Sg__base_names, &swig_module };

static swig_command_info swig_commands[] = {
    { SWIG_prefix "delete_A_int", (swig_wrapper_func) _wrap_delete_A_int, NULL},
    { SWIG_prefix "A_int_say_hi", (swig_wrapper_func) _wrap_A_int_say_hi, NULL},
    { SWIG_prefix "A_int_say_hello", (swig_wrapper_func) _wrap_A_int_say_hello, NULL},
...
SWIGEXPORT int Template_virtual_SafeInit(Tcl_Interp *interp) {
