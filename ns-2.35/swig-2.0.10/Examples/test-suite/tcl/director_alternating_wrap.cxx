...
#define SWIG_init    Director_alternating_Init
...
SWIGINTERN int
_wrap_Foo_id(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Foo *arg1 = (Foo *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  int result;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:Foo_id self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Foo, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Foo_id" "', argument " "1"" of type '" "Foo *""'"); 
  }
  arg1 = reinterpret_cast< Foo * >(argp1);
  result = (int)(arg1)->id();
...
SWIGINTERN int
_wrap_Baz_id(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Baz *arg1 = (Baz *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  int result;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:Baz_id self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Baz, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Baz_id" "', argument " "1"" of type '" "Baz *""'"); 
  }
...
static const char * swig_Baz_base_names[] = {"Bar *",0};
...
SWIGINTERN int
_wrap_getBar(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Bar *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,":getBar ") == TCL_ERROR) SWIG_fail;
  result = (Bar *)getBar();
  Tcl_SetObjResult(interp, SWIG_NewInstanceObj( SWIG_as_voidptr(result), SWIGTYPE_p_Bar,0));
  return TCL_OK;
fail:
...
SWIGINTERN int
_wrap_idFromGetBar(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  int result;
  
  if (SWIG_GetArgs(interp, objc, objv,":idFromGetBar ") == TCL_ERROR) SWIG_fail;
...
static swig_command_info swig_commands[] = {
    ...
    { SWIG_prefix "Foo_id", (swig_wrapper_func) _wrap_Foo_id, NULL},
    ...
    { SWIG_prefix "Baz_id", (swig_wrapper_func) _wrap_Baz_id, NULL},
    ...
    { SWIG_prefix "getBar", (swig_wrapper_func) _wrap_getBar, NULL},
    { SWIG_prefix "idFromGetBar", (swig_wrapper_func) _wrap_idFromGetBar, NULL},
    {0, 0, 0}
};
...
SWIGEXPORT int Director_alternating_SafeInit(Tcl_Interp *interp) {
