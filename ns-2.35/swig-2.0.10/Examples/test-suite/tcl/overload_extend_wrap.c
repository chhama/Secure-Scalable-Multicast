...
_wrap_Foo_variable_set(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Foo_variable_set" "', argument " "1"" of type '" "struct Foo *""'"); 
  }
...
_wrap_Foo_variable_get(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Foo, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Foo_variable_get" "', argument " "1"" of type '" "struct Foo *""'"); 
  }
  arg1 = (struct Foo *)(argp1);
...
_wrap_Foo_test__SWIG_0(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Foo, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Foo_test" "', argument " "1"" of type '" "struct Foo *""'"); 
  }
  arg1 = (struct Foo *)(argp1);
...
_wrap_Foo_test__SWIG_3(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  arg3=1000;
  if (SWIG_GetArgs(interp, objc, objv,"oo|o:Foo_test self x ?y? ",(void *)0,(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Foo, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Foo_test" "', argument " "1"" of type '" "struct Foo *""'"); 
  }
...
_wrap_delete_Foo(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_Foo" "', argument " "1"" of type '" "struct Foo *""'"); 
  }
  arg1 = (struct Foo *)(argp1);
  free((char *) arg1);
...
struct Foo *arg1 = (struct Foo *) obj;
free((char *) arg1);
}
...
static swig_type_info _swigt__p_Foo = {"_p_Foo", "struct Foo *|Foo *", 0, 0, (void*)&_wrap_class_Foo, 0};
