...
#define SWIGTYPE_p_foo__barT_int_p_t swig_types[1]
#define SWIGTYPE_p_foo__barT_int_t swig_types[2]
...
#define SWIG_init    Template_ns2_Init
...
_wrap_test1(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "test1" "', argument " "1"" of type '" "foo::bar< int > *""'"); 
  }
...
_wrap_test2(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_foo__barT_int_p_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "test2" "', argument " "1"" of type '" "foo::bar< foo::Integer * > *""'"); 
  }
  arg1 = reinterpret_cast< foo::bar< foo::Integer * > * >(argp1);
  result = (foo::bar< foo::Integer * > *)foo::test2(arg1);
  Tcl_SetObjResult(interp, SWIG_NewInstanceObj( SWIG_as_voidptr(result), SWIGTYPE_p_foo__barT_int_p_t,0));
  return TCL_OK;
fail:
  return TCL_ERROR;
}
...
SWIGEXPORT int Template_ns2_SafeInit(Tcl_Interp *interp) {
