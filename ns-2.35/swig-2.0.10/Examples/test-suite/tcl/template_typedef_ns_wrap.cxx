...
#define SWIG_init    Template_typedef_ns_Init
...
#endif
SWIGINTERN int
_wrap_AlphaInt_x_set(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (SWIG_GetArgs(interp, objc, objv,"oo:AlphaInt_x_set self x ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Beta__AlphaT_int_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "AlphaInt_x_set" "', argument " "1"" of type '" "Beta::Alpha< int > *""'"); 
  }
  arg1 = reinterpret_cast< Beta::Alpha< int > * >(argp1);
  ecode2 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[2], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "AlphaInt_x_set" "', argument " "2"" of type '" "int""'");
  } 
...
SWIGINTERN int
_wrap_AlphaInt_x_get(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Beta::Alpha< int > *arg1 = (Beta::Alpha< int > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  int result;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:AlphaInt_x_get self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Beta__AlphaT_int_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "AlphaInt_x_get" "', argument " "1"" of type '" "Beta::Alpha< int > *""'"); 
  }
  arg1 = reinterpret_cast< Beta::Alpha< int > * >(argp1);
  result = (int) ((arg1)->x);
...
SWIGINTERN int
_wrap_new_AlphaInt(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Beta::Alpha< int > *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,":new_AlphaInt ") == TCL_ERROR) SWIG_fail;
  result = (Beta::Alpha< int > *)new Beta::Alpha< int >();
  Tcl_SetObjResult(interp, SWIG_NewInstanceObj( SWIG_as_voidptr(result), SWIGTYPE_p_Beta__AlphaT_int_t,0));
  return TCL_OK;
fail:
  return TCL_ERROR;
}
...
SWIGINTERN int
_wrap_delete_AlphaInt(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Beta::Alpha< int > *arg1 = (Beta::Alpha< int > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:delete_AlphaInt self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Beta__AlphaT_int_t, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_AlphaInt" "', argument " "1"" of type '" "Beta::Alpha< int > *""'"); 
  }
  arg1 = reinterpret_cast< Beta::Alpha< int > * >(argp1);
  delete arg1;
...
SWIGINTERN void swig_delete_AlphaInt(void *obj) {
Beta::Alpha< int > *arg1 = (Beta::Alpha< int > *) obj;
delete arg1;
}
static swig_method swig_Beta_Alpha_Sl_int_Sg__methods[] = {
    {0,0}
};
static swig_attribute swig_Beta_Alpha_Sl_int_Sg__attributes[] = {
    { "-x",_wrap_AlphaInt_x_get, _wrap_AlphaInt_x_set},
    {0,0,0}
};
static swig_class *swig_Beta_Alpha_Sl_int_Sg__bases[] = {0};
static const char * swig_Beta_Alpha_Sl_int_Sg__base_names[] = {0};
static swig_class _wrap_class_Beta_Alpha_Sl_int_Sg_ = { "AlphaInt", &SWIGTYPE_p_Beta__AlphaT_int_t,_wrap_new_AlphaInt, swig_delete_AlphaInt, swig_Beta_Alpha_Sl_int_Sg__methods, swig_Beta_Alpha_Sl_int_Sg__attributes, swig_Beta_Alpha_Sl_int_Sg__bases,swig_Beta_Alpha_Sl_int_Sg__base_names, &swig_module };

static swig_command_info swig_commands[] = {
    { SWIG_prefix "AlphaInt_x_set", (swig_wrapper_func) _wrap_AlphaInt_x_set, NULL},
    { SWIG_prefix "AlphaInt_x_get", (swig_wrapper_func) _wrap_AlphaInt_x_get, NULL},
    { SWIG_prefix "new_AlphaInt", (swig_wrapper_func) _wrap_new_AlphaInt, NULL},
    { SWIG_prefix "delete_AlphaInt", (swig_wrapper_func) _wrap_delete_AlphaInt, NULL},
    { SWIG_prefix "AlphaInt", (swig_wrapper_func) SWIG_ObjectConstructor, (ClientData)&_wrap_class_Beta_Alpha_Sl_int_Sg_},
    {0, 0, 0}
};
...
static swig_type_info _swigt__p_Beta__AlphaT_int_t = {"_p_Beta__AlphaT_int_t", "Beta::Alpha< int > *", 0, 0, (void*)&_wrap_class_Beta_Alpha_Sl_int_Sg_, 0};
...
SWIGEXPORT int Template_typedef_ns_SafeInit(Tcl_Interp *interp) {
