...
#define SWIG_init    Director_protected_overloaded_Init
...
#endif
SWIGINTERN int
_wrap_delete_IDataObserver(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  IDataObserver *arg1 = (IDataObserver *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:delete_IDataObserver self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_IDataObserver, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN void swig_delete_IDataObserver(void *obj) {
IDataObserver *arg1 = (IDataObserver *) obj;
delete arg1;
}
static swig_method swig_IDataObserver_methods[] = {
    {0,0}
};
static swig_attribute swig_IDataObserver_attributes[] = {
    {0,0,0}
};
static swig_class *swig_IDataObserver_bases[] = {0};
static const char * swig_IDataObserver_base_names[] = {0};
static swig_class _wrap_class_IDataObserver = { "IDataObserver", &SWIGTYPE_p_IDataObserver,0, swig_delete_IDataObserver, swig_IDataObserver_methods, swig_IDataObserver_attributes, swig_IDataObserver_bases,swig_IDataObserver_base_names, &swig_module };
SWIGINTERN int
_wrap_delete_DerivedDataObserver(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  DerivedDataObserver *arg1 = (DerivedDataObserver *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:delete_DerivedDataObserver self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_DerivedDataObserver, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN void swig_delete_DerivedDataObserver(void *obj) {
DerivedDataObserver *arg1 = (DerivedDataObserver *) obj;
delete arg1;
}
static swig_method swig_DerivedDataObserver_methods[] = {
    {0,0}
};
static swig_attribute swig_DerivedDataObserver_attributes[] = {
    {0,0,0}
};
static swig_class *swig_DerivedDataObserver_bases[] = {0,0};
static const char * swig_DerivedDataObserver_base_names[] = {"IDataObserver *",0};
static swig_class _wrap_class_DerivedDataObserver = { "DerivedDataObserver", &SWIGTYPE_p_DerivedDataObserver,0, swig_delete_DerivedDataObserver, swig_DerivedDataObserver_methods, swig_DerivedDataObserver_attributes, swig_DerivedDataObserver_bases,swig_DerivedDataObserver_base_names, &swig_module };

static swig_command_info swig_commands[] = {
    { SWIG_prefix "delete_IDataObserver", (swig_wrapper_func) _wrap_delete_IDataObserver, NULL},
    { SWIG_prefix "IDataObserver", (swig_wrapper_func) SWIG_ObjectConstructor, (ClientData)&_wrap_class_IDataObserver},
    { SWIG_prefix "delete_DerivedDataObserver", (swig_wrapper_func) _wrap_delete_DerivedDataObserver, NULL},
    { SWIG_prefix "DerivedDataObserver", (swig_wrapper_func) SWIG_ObjectConstructor, (ClientData)&_wrap_class_DerivedDataObserver},
    {0, 0, 0}
};
...
static swig_type_info _swigt__p_DerivedDataObserver = {"_p_DerivedDataObserver", "DerivedDataObserver *", 0, 0, (void*)&_wrap_class_DerivedDataObserver, 0};
static swig_type_info _swigt__p_IDataObserver = {"_p_IDataObserver", "IDataObserver *", 0, 0, (void*)&_wrap_class_IDataObserver, 0};
...
SWIGEXPORT int Director_protected_overloaded_SafeInit(Tcl_Interp *interp) {
