...
#define SWIG_init    Constant_expr_Init
...
SWIGINTERN const char *_wrap_d_array_get(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2, int flags) {
  Tcl_Obj *value = 0;
  
  value = SWIG_NewPointerObj(SWIG_as_voidptr(d_array), SWIGTYPE_p_double,  0 );
  if (value) {
    Tcl_SetVar2(interp,name1,name2,Tcl_GetStringFromObj(value,NULL), flags);
    Tcl_DecrRefCount(value);
  }
...
SWIGINTERN const char *_wrap_d_array_set(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2 SWIGUNUSED, int flags) {
  Tcl_Obj *value = 0;
  Tcl_Obj *name1o = 0;
  ...
  if (!value) SWIG_fail;
  {
    ...
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), "in variable '""d_array""' of type '""double [12%9]""'");
    } else if (inp) {
      size_t ii = 0;
      for (; ii < (size_t)12%9; ++ii) d_array[ii] = inp[ii];
    } else {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in variable '""d_array""' of type '""double [12%9]""'");
    }
  }
  return NULL;
fail:
...
static swig_var_info swig_variables[] = {
    { SWIG_prefix "X", 0, (swig_variable_func) _wrap_X_get,(swig_variable_func) swig_readonly},
    { SWIG_prefix "d_array", 0, (swig_variable_func) _wrap_d_array_get,(swig_variable_func) _wrap_d_array_set},
    {0,0,0,0}
};
...
SWIGEXPORT int SWIG_init(Tcl_Interp *interp) {
  ...
  SWIG_Tcl_SetConstantObj(interp, "FOO", SWIG_From_int((int)(12%9)));
  return TCL_OK;
}
SWIGEXPORT int Constant_expr_SafeInit(Tcl_Interp *interp) {
