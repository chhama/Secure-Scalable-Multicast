...
#define SWIG_init    Memberin_extend_Init
...
#endif
SWIGINTERN int
_wrap_ExtendMe_thing_set(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (SWIG_GetArgs(interp, objc, objv,"oo:ExtendMe_thing_set self thing ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_ExtendMe, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ExtendMe_thing_set" "', argument " "1"" of type '" "ExtendMe *""'"); 
  }
  arg1 = reinterpret_cast< ExtendMe * >(argp1);
  res2 = SWIG_AsCharPtrAndSize(objv[2], &buf2, NULL, &alloc2);
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "ExtendMe_thing_set" "', argument " "2"" of type '" "char *""'");
  }
...
SWIGINTERN int
_wrap_ExtendMe_thing_get(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ExtendMe *arg1 = (ExtendMe *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  char *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:ExtendMe_thing_get self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_ExtendMe, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ExtendMe_thing_get" "', argument " "1"" of type '" "ExtendMe *""'"); 
  }
  arg1 = reinterpret_cast< ExtendMe * >(argp1);
...
SWIGINTERN int
_wrap_new_ExtendMe(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ExtendMe *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,":new_ExtendMe ") == TCL_ERROR) SWIG_fail;
  result = (ExtendMe *)new ExtendMe();
  Tcl_SetObjResult(interp, SWIG_NewInstanceObj( SWIG_as_voidptr(result), SWIGTYPE_p_ExtendMe,0));
  return TCL_OK;
fail:
  return TCL_ERROR;
}
...
SWIGINTERN int
_wrap_delete_ExtendMe(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ExtendMe *arg1 = (ExtendMe *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:delete_ExtendMe self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_ExtendMe, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_ExtendMe" "', argument " "1"" of type '" "ExtendMe *""'"); 
  }
  arg1 = reinterpret_cast< ExtendMe * >(argp1);
  delete arg1;
...
SWIGINTERN void swig_delete_ExtendMe(void *obj) {
ExtendMe *arg1 = (ExtendMe *) obj;
delete arg1;
}
static swig_method swig_ExtendMe_methods[] = {
    {0,0}
};
static swig_attribute swig_ExtendMe_attributes[] = {
    { "-thing",_wrap_ExtendMe_thing_get, _wrap_ExtendMe_thing_set},
    {0,0,0}
};
static swig_class *swig_ExtendMe_bases[] = {0};
static const char * swig_ExtendMe_base_names[] = {0};
static swig_class _wrap_class_ExtendMe = { "ExtendMe", &SWIGTYPE_p_ExtendMe,_wrap_new_ExtendMe, swig_delete_ExtendMe, swig_ExtendMe_methods, swig_ExtendMe_attributes, swig_ExtendMe_bases,swig_ExtendMe_base_names, &swig_module };

static swig_command_info swig_commands[] = {
    { SWIG_prefix "ExtendMe_thing_set", (swig_wrapper_func) _wrap_ExtendMe_thing_set, NULL},
    { SWIG_prefix "ExtendMe_thing_get", (swig_wrapper_func) _wrap_ExtendMe_thing_get, NULL},
    { SWIG_prefix "new_ExtendMe", (swig_wrapper_func) _wrap_new_ExtendMe, NULL},
    { SWIG_prefix "delete_ExtendMe", (swig_wrapper_func) _wrap_delete_ExtendMe, NULL},
    { SWIG_prefix "ExtendMe", (swig_wrapper_func) SWIG_ObjectConstructor, (ClientData)&_wrap_class_ExtendMe},
    {0, 0, 0}
};
...
static swig_type_info _swigt__p_ExtendMe = {"_p_ExtendMe", "ExtendMe *", 0, 0, (void*)&_wrap_class_ExtendMe, 0};
...
SWIGEXPORT int Memberin_extend_SafeInit(Tcl_Interp *interp) {
