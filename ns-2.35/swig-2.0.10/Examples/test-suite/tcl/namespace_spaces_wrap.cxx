...
#define SWIG_init    Namespace_spaces_Init
...
_wrap_Foo_bar(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  ecode2 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[2], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "Foo_bar" "', argument " "2"" of type '" "Foo::Integer""'");
  } 
  arg2 = static_cast< Foo::Integer >(val2);
...
_wrap_Foo_func_ptr_set(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  arg1 = reinterpret_cast< Foo * >(argp1);
  {
    int res = SWIG_ConvertMember(objv[2], SWIG_as_voidptr(&arg2), sizeof(void (Foo::*)(int)),SWIGTYPE_m_Foo__f_int__void);
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), "in method '" "Foo_func_ptr_set" "', argument " "2"" of type '" "void (Foo::*)(int)""'"); 
    }
  }
...
_wrap_Foo_func_ptr_get(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  Tcl_SetObjResult(interp,SWIG_NewMemberObj(SWIG_as_voidptr(&result), sizeof(void (Foo::*)(int)), SWIGTYPE_m_Foo__f_int__void));
  return TCL_OK;
fail:
  return TCL_ERROR;
}
...
SWIGEXPORT int Namespace_spaces_SafeInit(Tcl_Interp *interp) {
