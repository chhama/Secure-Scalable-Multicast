...
#define SWIG_init    Template_qualifier_Init
...
#endif
SWIGINTERN int
_wrap_X_xalloc_int(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  X *arg1 = (X *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  X *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:X_xalloc_int self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_X, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "X_xalloc_int" "', argument " "1"" of type '" "X *""'"); 
  }
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "X_xalloc_int", (swig_wrapper_func) _wrap_X_xalloc_int, NULL},
...
SWIGEXPORT int Template_qualifier_SafeInit(Tcl_Interp *interp) {
