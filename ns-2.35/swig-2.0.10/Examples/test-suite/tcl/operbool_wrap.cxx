...
#define SWIG_init    Operbool_Init
...
#endif
SWIGINTERN int
_wrap_Test_operator_bool(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Test *arg1 = (Test *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  bool result;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:Test_operator_bool self ",(void *)0) == TCL_ERROR) SWIG_fail;
...
static swig_method swig_Test_methods[] = {
    {"operator_bool", _wrap_Test_operator_bool}, 
    {0,0}
};
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "Test_operator_bool", (swig_wrapper_func) _wrap_Test_operator_bool, NULL},
...
SWIGEXPORT int Operbool_SafeInit(Tcl_Interp *interp) {
