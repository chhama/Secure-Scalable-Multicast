...
#define SWIG_init    Clientdata_prop_a_Init
...
#endif
SWIGINTERN int
_wrap_A_fA(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  A *arg1 = (A *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:A_fA self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_A, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "A_fA" "', argument " "1"" of type '" "A *""'"); 
  }
...
_wrap_test_A(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_A, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "test_A" "', argument " "1"" of type '" "A *""'"); 
  }
  arg1 = reinterpret_cast< A * >(argp1);
  test_A(arg1);
...
SWIGINTERN int
_wrap_test_tA(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  tA *arg1 = (tA *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:test_tA a ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_A, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "test_tA" "', argument " "1"" of type '" "tA *""'"); 
  }
  arg1 = reinterpret_cast< tA * >(argp1);
  test_tA(arg1);
...
SWIGINTERN int
_wrap_new_tA(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  tA *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,":new_tA ") == TCL_ERROR) SWIG_fail;
  result = (tA *)new_tA();
  Tcl_SetObjResult(interp, SWIG_NewInstanceObj( SWIG_as_voidptr(result), SWIGTYPE_p_A,0));
  return TCL_OK;
fail:
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "A_fA", (swig_wrapper_func) _wrap_A_fA, NULL},
    ...
    { SWIG_prefix "test_tA", (swig_wrapper_func) _wrap_test_tA, NULL},
    { SWIG_prefix "new_tA", (swig_wrapper_func) _wrap_new_tA, NULL},
    {0, 0, 0}
};
...
static swig_type_info _swigt__p_A = {"_p_A", "tA *|A *", 0, 0, (void*)&_wrap_class_A, 0};
...
SWIGEXPORT int Clientdata_prop_a_SafeInit(Tcl_Interp *interp) {
