...
#define SWIGTYPE_p_tacka3 swig_types[4]
...
#define SWIG_init    Class_scope_weird_Init
...
SWIGINTERN int
_wrap_new_Quat__SWIG_0(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Quat *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,":new_Quat ") == TCL_ERROR) SWIG_fail;
  result = (Quat *)new Quat();
  Tcl_SetObjResult(interp, SWIG_NewInstanceObj( SWIG_as_voidptr(result), SWIGTYPE_p_Quat,0));
  return TCL_OK;
fail:
  return TCL_ERROR;
}
...
SWIGINTERN int
_wrap_new_Quat__SWIG_1(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  float arg1 ;
  float arg2 ;
  float arg3 ;
  float arg4 ;
  ...
  if (SWIG_GetArgs(interp, objc, objv,"oooo:new_Quat in_w x y z ",(void *)0,(void *)0,(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
...
SWIGINTERN int
_wrap_new_Quat__SWIG_2(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  tacka3 *arg1 = 0 ;
  float arg2 ;
  void *argp1 ;
  int res1 = 0 ;
  ...
  if (SWIG_GetArgs(interp, objc, objv,"oo:new_Quat axis angle ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1, SWIGTYPE_p_tacka3,  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "new_Quat" "', argument " "1"" of type '" "tacka3 const &""'"); 
  }
  if (!argp1) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "new_Quat" "', argument " "1"" of type '" "tacka3 const &""'"); 
  }
  arg1 = reinterpret_cast< tacka3 * >(argp1);
  ecode2 = SWIG_AsVal_float SWIG_TCL_CALL_ARGS_2(objv[2], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "new_Quat" "', argument " "2"" of type '" "float""'");
  } 
...
SWIGINTERN int
_wrap_new_Quat__SWIG_3(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  matrix4 *arg1 = 0 ;
  void *argp1 ;
  int res1 = 0 ;
  Quat *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:new_Quat m ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1, SWIGTYPE_p_matrix4,  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "new_Quat" "', argument " "1"" of type '" "matrix4 const &""'"); 
  }
  if (!argp1) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "new_Quat" "', argument " "1"" of type '" "matrix4 const &""'"); 
  }
...
SWIGINTERN int
_wrap_new_Quat(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Tcl_Obj *CONST *argv = objv+1;
  int argc = objc-1;
  if (argc == 0) {
    return _wrap_new_Quat__SWIG_0(clientData, interp, objc, argv - 1);
  }
  if (argc == 1) {
    int _v;
    void *vptr = 0;
    int res = SWIG_ConvertPtr(argv[0], &vptr, SWIGTYPE_p_matrix4, 0);
    _v = SWIG_CheckState(res);
    if (_v) {
      return _wrap_new_Quat__SWIG_3(clientData, interp, objc, argv - 1);
    }
  }
  if (argc == 2) {
    int _v;
    void *vptr = 0;
    int res = SWIG_ConvertPtr(argv[0], &vptr, SWIGTYPE_p_tacka3, 0);
    _v = SWIG_CheckState(res);
    if (_v) {
      {
      ...
      if (_v) {
        return _wrap_new_Quat__SWIG_2(clientData, interp, objc, argv - 1);
      }
    }
  }
  if (argc == 4) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        if (_v) {
          {
            int res = SWIG_AsVal_float SWIG_TCL_CALL_ARGS_2(argv[3], NULL);
            _v = SWIG_CheckState(res);
          }
          if (_v) {
            return _wrap_new_Quat__SWIG_1(clientData, interp, objc, argv - 1);
          }
        }
      }
    }
  ...
  Tcl_SetResult(interp,(char *) "Wrong number or type of arguments for overloaded function 'new_Quat'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    Quat::Quat()\n"
    "    Quat::Quat(float,float,float,float)\n"
    "    Quat::Quat(tacka3 const &,float)\n"
    "    Quat::Quat(matrix4 const &)\n", TCL_STATIC);
  return TCL_ERROR;
}


SWIGINTERN int
_wrap_delete_Quat(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Quat *arg1 = (Quat *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:delete_Quat self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Quat, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_Quat" "', argument " "1"" of type '" "Quat *""'"); 
  }
  arg1 = reinterpret_cast< Quat * >(argp1);
  delete arg1;
...
SWIGINTERN void swig_delete_Quat(void *obj) {
Quat *arg1 = (Quat *) obj;
delete arg1;
}
static swig_method swig_Quat_methods[] = {
    {0,0}
};
static swig_attribute swig_Quat_attributes[] = {
    {0,0,0}
};
static swig_class *swig_Quat_bases[] = {0};
static const char * swig_Quat_base_names[] = {0};
static swig_class _wrap_class_Quat = { "Quat", &SWIGTYPE_p_Quat,_wrap_new_Quat, swig_delete_Quat, swig_Quat_methods, swig_Quat_attributes, swig_Quat_bases,swig_Quat_base_names, &swig_module };
...
static swig_command_info swig_commands[] = {
    ...
    { SWIG_prefix "new_Quat", (swig_wrapper_func) _wrap_new_Quat, NULL},
    { SWIG_prefix "delete_Quat", (swig_wrapper_func) _wrap_delete_Quat, NULL},
    { SWIG_prefix "Quat", (swig_wrapper_func) SWIG_ObjectConstructor, (ClientData)&_wrap_class_Quat},
    {0, 0, 0}
};
...
SWIGEXPORT int Class_scope_weird_SafeInit(Tcl_Interp *interp) {
