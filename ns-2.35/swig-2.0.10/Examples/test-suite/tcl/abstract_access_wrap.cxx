...
#define SWIG_init    Abstract_access_Init
...
SWIGINTERN int
_wrap_A_z(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  A *arg1 = (A *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  int result;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:A_z self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_A, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "A_z" "', argument " "1"" of type '" "A *""'"); 
  }
  arg1 = reinterpret_cast< A * >(argp1);
  result = (int)(arg1)->z();
...
SWIGINTERN int
_wrap_A_do_x(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  A *arg1 = (A *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  int result;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:A_do_x self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_A, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "A_do_x" "', argument " "1"" of type '" "A *""'"); 
  }
  arg1 = reinterpret_cast< A * >(argp1);
...
static const char * swig_C_base_names[] = {"B *",0};
...
static swig_command_info swig_commands[] = {
    ...
    { SWIG_prefix "A_z", (swig_wrapper_func) _wrap_A_z, NULL},
    { SWIG_prefix "A_do_x", (swig_wrapper_func) _wrap_A_do_x, NULL},
...
SWIGEXPORT int Abstract_access_SafeInit(Tcl_Interp *interp) {
