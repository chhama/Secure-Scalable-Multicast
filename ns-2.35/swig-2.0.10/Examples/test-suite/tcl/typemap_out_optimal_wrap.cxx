...
#define SWIG_init    Typemap_out_optimal_Init
...
#endif
SWIGINTERN int
_wrap_new_XX__SWIG_0(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  XX *result = 0 ;
...
SWIGINTERN int
_wrap_new_XX__SWIG_1(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  int arg1 ;
  int val1 ;
  int ecode1 = 0 ;
  XX *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:new_XX i ",(void *)0) == TCL_ERROR) SWIG_fail;
  ecode1 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[1], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "new_XX" "', argument " "1"" of type '" "int""'");
  } 
...
SWIGINTERN int
_wrap_new_XX__SWIG_2(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  XX *arg1 = 0 ;
  void *argp1 ;
  int res1 = 0 ;
  XX *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:new_XX other ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1, SWIGTYPE_p_XX,  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "new_XX" "', argument " "1"" of type '" "XX const &""'"); 
  }
  if (!argp1) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "new_XX" "', argument " "1"" of type '" "XX const &""'"); 
  }
...
_wrap_new_XX(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  int argc = objc-1;
  if (argc == 0) {
    return _wrap_new_XX__SWIG_0(clientData, interp, objc, argv - 1);
  }
  if (argc == 1) {
    int _v;
    void *vptr = 0;
    int res = SWIG_ConvertPtr(argv[0], &vptr, SWIGTYPE_p_XX, 0);
    _v = SWIG_CheckState(res);
    if (_v) {
      return _wrap_new_XX__SWIG_2(clientData, interp, objc, argv - 1);
    }
  }
  if (argc == 1) {
    int _v;
    ...
    if (_v) {
      return _wrap_new_XX__SWIG_1(clientData, interp, objc, argv - 1);
    }
  }
  
  Tcl_SetResult(interp,(char *) "Wrong number or type of arguments for overloaded function 'new_XX'.\n"
...
SWIGINTERN int
_wrap_XX_create(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  if (SWIG_GetArgs(interp, objc, objv,":XX_create ") == TCL_ERROR) SWIG_fail;
  Tcl_SetObjResult(interp,SWIG_NewPointerObj((new XX(static_cast< const XX& >(XX::create()))), SWIGTYPE_p_XX, SWIG_POINTER_OWN |  0 ));
  return TCL_OK;
fail:
  return TCL_ERROR;
}
...
SWIGINTERN const char *_wrap_XX_debug_get(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2, int flags) {
  Tcl_Obj *value = 0;
  
  value = SWIG_From_bool(static_cast< bool >(XX::debug));
  if (value) {
...
SWIGINTERN const char *_wrap_XX_debug_set(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2 SWIGUNUSED, int flags) {
  Tcl_Obj *value = 0;
  Tcl_Obj *name1o = 0;
  ...
  if (!value) SWIG_fail;
  {
    ...
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), "in variable '""XX::debug""' of type '""bool""'");
    }
    XX::debug = static_cast< bool >(val);
  }
  return NULL;
fail:
  return "XX_debug";
...
static swig_command_info swig_commands[] = {
    ...
    { SWIG_prefix "XX_create", (swig_wrapper_func) _wrap_XX_create, NULL},
    { SWIG_prefix "XX", (swig_wrapper_func) SWIG_ObjectConstructor, (ClientData)&_wrap_class_XX},
    {0, 0, 0}
};

static swig_var_info swig_variables[] = {
    { SWIG_prefix "XX_debug", 0, (swig_variable_func) _wrap_XX_debug_get,(swig_variable_func) _wrap_XX_debug_set},
    {0,0,0,0}
};
...
static swig_type_info _swigt__p_XX = {"_p_XX", "XX *", 0, 0, (void*)&_wrap_class_XX, 0};
...
SWIGEXPORT int Typemap_out_optimal_SafeInit(Tcl_Interp *interp) {
