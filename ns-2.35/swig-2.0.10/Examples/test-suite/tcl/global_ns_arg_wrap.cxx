...
#define SWIG_init    Global_ns_arg_Init
...
_wrap_foo(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "foo" "', argument " "1"" of type '" "::Integer""'");
  } 
...
SWIGINTERN int
_wrap_bar_fn(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ::Integer result;
  
  if (SWIG_GetArgs(interp, objc, objv,":bar_fn ") == TCL_ERROR) SWIG_fail;
...
static swig_command_info swig_commands[] = {
    ...
    { SWIG_prefix "bar_fn", (swig_wrapper_func) _wrap_bar_fn, NULL},
    {0, 0, 0}
};
...
SWIGEXPORT int Global_ns_arg_SafeInit(Tcl_Interp *interp) {
