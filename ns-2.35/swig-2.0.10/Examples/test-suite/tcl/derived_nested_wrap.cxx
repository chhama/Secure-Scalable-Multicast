...
#define SWIG_init    Derived_nested_Init
...
SWIGINTERN int
_wrap_BB_ff_instance_set(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  BB *arg1 = (BB *) 0 ;
  BB::FF *arg2 = (BB::FF *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (SWIG_GetArgs(interp, objc, objv,"oo:BB_ff_instance_set self ff_instance ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_BB, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "BB_ff_instance_set" "', argument " "1"" of type '" "BB *""'"); 
  }
  arg1 = reinterpret_cast< BB * >(argp1);
  res2 = SWIG_ConvertPtr(objv[2], &argp2,SWIGTYPE_p_BB__FF, 0 |  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "BB_ff_instance_set" "', argument " "2"" of type '" "BB::FF *""'"); 
  }
  arg2 = reinterpret_cast< BB::FF * >(argp2);
...
SWIGINTERN int
_wrap_BB_ff_instance_get(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  BB *arg1 = (BB *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  BB::FF *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:BB_ff_instance_get self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_BB, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "BB_ff_instance_get" "', argument " "1"" of type '" "BB *""'"); 
  }
  arg1 = reinterpret_cast< BB * >(argp1);
  result = (BB::FF *)& ((arg1)->ff_instance);
  Tcl_SetObjResult(interp, SWIG_NewInstanceObj( SWIG_as_voidptr(result), SWIGTYPE_p_BB__FF,0));
  return TCL_OK;
fail:
  return TCL_ERROR;
}
...
SWIGINTERN int
_wrap_BB_useEE(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  BB *arg1 = (BB *) 0 ;
  BB::EE *arg2 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (SWIG_GetArgs(interp, objc, objv,"oo:BB_useEE self e ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_BB, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "BB_useEE" "', argument " "1"" of type '" "BB *""'"); 
  }
  arg1 = reinterpret_cast< BB * >(argp1);
  res2 = SWIG_ConvertPtr(objv[2], &argp2, SWIGTYPE_p_BB__EE,  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "BB_useEE" "', argument " "2"" of type '" "BB::EE const &""'"); 
  }
  if (!argp2) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "BB_useEE" "', argument " "2"" of type '" "BB::EE const &""'"); 
  }
  arg2 = reinterpret_cast< BB::EE * >(argp2);
...
static swig_method swig_BB_methods[] = {
    {"useEE", _wrap_BB_useEE}, 
    {0,0}
};
static swig_attribute swig_BB_attributes[] = {
    { "-ff_instance",_wrap_BB_ff_instance_get, _wrap_BB_ff_instance_set},
    {0,0,0}
};
static swig_class *swig_BB_bases[] = {0};
static const char * swig_BB_base_names[] = {0};
...
static swig_command_info swig_commands[] = {
    ...
    { SWIG_prefix "BB_ff_instance_set", (swig_wrapper_func) _wrap_BB_ff_instance_set, NULL},
    { SWIG_prefix "BB_ff_instance_get", (swig_wrapper_func) _wrap_BB_ff_instance_get, NULL},
    { SWIG_prefix "BB_useEE", (swig_wrapper_func) _wrap_BB_useEE, NULL},
...
SWIGEXPORT int Derived_nested_SafeInit(Tcl_Interp *interp) {
