...
#define SWIG_init    Overload_return_type_Init
...
_wrap_B_foo__SWIG_0(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (SWIG_GetArgs(interp, objc, objv,"oo:B_foo self x ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
...
_wrap_B_foo__SWIG_1(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "B_foo" "', argument " "2"" of type '" "char const *""'");
  }
...
_wrap_foo__SWIG_0(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (SWIG_GetArgs(interp, objc, objv,"o:foo i ",(void *)0) == TCL_ERROR) SWIG_fail;
...
SWIGINTERN int
_wrap_bar__SWIG_0(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  int result;
...
SWIGINTERN int
_wrap_bar__SWIG_1(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  int arg1 ;
  int val1 ;
  int ecode1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:bar i ",(void *)0) == TCL_ERROR) SWIG_fail;
  ecode1 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[1], &val1);
  if (!SWIG_IsOK(ecode1)) {
...
_wrap_bar(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  int argc = objc-1;
  if (argc == 0) {
    return _wrap_bar__SWIG_0(clientData, interp, objc, argv - 1);
  }
  if (argc == 1) {
    int _v;
    {
    ...
    if (_v) {
      return _wrap_bar__SWIG_1(clientData, interp, objc, argv - 1);
    }
  }
  
  Tcl_SetResult(interp,(char *) "Wrong number or type of arguments for overloaded function 'bar'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    bar()\n"
    "    bar(int)\n", TCL_STATIC);
  return TCL_ERROR;
...
SWIGEXPORT int Overload_return_type_SafeInit(Tcl_Interp *interp) {
