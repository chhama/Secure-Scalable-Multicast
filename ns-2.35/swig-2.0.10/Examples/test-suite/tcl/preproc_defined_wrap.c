...
#define SWIGTYPE_p_Defined swig_types[0]
...
#define SWIG_init    Preproc_defined_Init
#define SWIG_name    "preproc_defined"
#define SWIG_prefix  ""
...
#endif
SWIGINTERN int
_wrap_call_checking(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  int result;
  
  if (SWIG_GetArgs(interp, objc, objv,":call_checking ") == TCL_ERROR) SWIG_fail;
...
SWIGINTERN int
_wrap_thing(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  int arg1 ;
  int val1 ;
  int ecode1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:thing int ",(void *)0) == TCL_ERROR) SWIG_fail;
  ecode1 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[1], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "thing" "', argument " "1"" of type '" "int""'");
  } 
  arg1 = (int)(val1);
  thing(arg1);
...
SWIGINTERN int
_wrap_stuff(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  int arg1 ;
  int val1 ;
  int ecode1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:stuff int ",(void *)0) == TCL_ERROR) SWIG_fail;
  ecode1 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[1], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "stuff" "', argument " "1"" of type '" "int""'");
  } 
  arg1 = (int)(val1);
  stuff(arg1);
...
SWIGINTERN int
_wrap_Defined_defined_set(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (SWIG_GetArgs(interp, objc, objv,"oo:Defined_defined_set self defined ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Defined, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Defined_defined_set" "', argument " "1"" of type '" "struct Defined *""'"); 
  }
  arg1 = (struct Defined *)(argp1);
  ecode2 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[2], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "Defined_defined_set" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = (int)(val2);
...
SWIGINTERN int
_wrap_Defined_defined_get(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  struct Defined *arg1 = (struct Defined *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  int result;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:Defined_defined_get self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Defined, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Defined_defined_get" "', argument " "1"" of type '" "struct Defined *""'"); 
  }
  arg1 = (struct Defined *)(argp1);
...
SWIGINTERN int
_wrap_new_Defined(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  struct Defined *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,":new_Defined ") == TCL_ERROR) SWIG_fail;
  result = (struct Defined *)calloc(1, sizeof(struct Defined));
  Tcl_SetObjResult(interp, SWIG_NewInstanceObj( SWIG_as_voidptr(result), SWIGTYPE_p_Defined,0));
  return TCL_OK;
fail:
  return TCL_ERROR;
}
...
SWIGINTERN int
_wrap_delete_Defined(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  struct Defined *arg1 = (struct Defined *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:delete_Defined self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Defined, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_Defined" "', argument " "1"" of type '" "struct Defined *""'"); 
  }
  arg1 = (struct Defined *)(argp1);
  free((char *) arg1);
...
SWIGINTERN void swig_delete_Defined(void *obj) {
struct Defined *arg1 = (struct Defined *) obj;
free((char *) arg1);
}
static swig_method swig_Defined_methods[] = {
    {0,0}
};
static swig_attribute swig_Defined_attributes[] = {
    { "-defined",_wrap_Defined_defined_get, _wrap_Defined_defined_set},
    {0,0,0}
};
static swig_class *swig_Defined_bases[] = {0};
static const char * swig_Defined_base_names[] = {0};
static swig_class _wrap_class_Defined = { "Defined", &SWIGTYPE_p_Defined,_wrap_new_Defined, swig_delete_Defined, swig_Defined_methods, swig_Defined_attributes, swig_Defined_bases,swig_Defined_base_names, &swig_module };
SWIGINTERN int
_wrap_bumpf(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  int arg1 ;
  int val1 ;
  int ecode1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:bumpf int ",(void *)0) == TCL_ERROR) SWIG_fail;
  ecode1 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[1], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "bumpf" "', argument " "1"" of type '" "int""'");
  } 
  arg1 = (int)(val1);
  bumpf(arg1);
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "call_checking", (swig_wrapper_func) _wrap_call_checking, NULL},
    { SWIG_prefix "thing", (swig_wrapper_func) _wrap_thing, NULL},
    { SWIG_prefix "stuff", (swig_wrapper_func) _wrap_stuff, NULL},
    { SWIG_prefix "Defined_defined_set", (swig_wrapper_func) _wrap_Defined_defined_set, NULL},
    { SWIG_prefix "Defined_defined_get", (swig_wrapper_func) _wrap_Defined_defined_get, NULL},
    { SWIG_prefix "new_Defined", (swig_wrapper_func) _wrap_new_Defined, NULL},
    { SWIG_prefix "delete_Defined", (swig_wrapper_func) _wrap_delete_Defined, NULL},
    { SWIG_prefix "Defined", (swig_wrapper_func) SWIG_ObjectConstructor, (ClientData)&_wrap_class_Defined},
    { SWIG_prefix "bumpf", (swig_wrapper_func) _wrap_bumpf, NULL},
    {0, 0, 0}
};
...
static swig_type_info _swigt__p_Defined = {"_p_Defined", "struct Defined *|Defined *", 0, 0, (void*)&_wrap_class_Defined, 0};
...
static swig_cast_info _swigc__p_Defined[] = {  {&_swigt__p_Defined, 0, 0, 0},{0, 0, 0, 0}};
...
SWIGEXPORT int Preproc_defined_SafeInit(Tcl_Interp *interp) {
