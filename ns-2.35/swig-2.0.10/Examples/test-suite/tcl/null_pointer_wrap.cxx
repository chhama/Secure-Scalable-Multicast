...
#define SWIG_init    Null_pointer_Init
...
_wrap_func(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (SWIG_GetArgs(interp, objc, objv,"o:func a ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_A, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "func" "', argument " "1"" of type '" "A *""'"); 
  }
  arg1 = reinterpret_cast< A * >(argp1);
...
SWIGINTERN int
_wrap_getnull(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  A *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,":getnull ") == TCL_ERROR) SWIG_fail;
  result = (A *)getnull();
  Tcl_SetObjResult(interp, SWIG_NewInstanceObj( SWIG_as_voidptr(result), SWIGTYPE_p_A,0));
  return TCL_OK;
fail:
...
static swig_command_info swig_commands[] = {
    ...
    { SWIG_prefix "getnull", (swig_wrapper_func) _wrap_getnull, NULL},
    {0, 0, 0}
};
...
SWIGEXPORT int Null_pointer_SafeInit(Tcl_Interp *interp) {
