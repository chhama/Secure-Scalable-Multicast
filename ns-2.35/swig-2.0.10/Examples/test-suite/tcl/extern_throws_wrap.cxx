...
#define SWIG_init    Extern_throws_Init
...
_wrap_get(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  try {
    ...
    SWIG_Tcl_SetErrorObj(interp,"std::exception",SWIG_NewPointerObj((new std::exception(static_cast< const std::exception& >(_e))),SWIGTYPE_p_std__exception,SWIG_POINTER_OWN)); SWIG_fail;
  }
...
SWIGEXPORT int Extern_throws_SafeInit(Tcl_Interp *interp) {
