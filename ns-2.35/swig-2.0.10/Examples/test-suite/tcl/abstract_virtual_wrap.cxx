...
#define SWIG_init    Abstract_virtual_Init
...
_wrap_B_foo(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (SWIG_GetArgs(interp, objc, objv,"o:B_foo self ",(void *)0) == TCL_ERROR) SWIG_fail;
...
static swig_class *swig_D_bases[] = {0,0,0};
static const char * swig_D_base_names[] = {"B *","C *",0};
...
static const char * swig_E_base_names[] = {"C *","B *",0};
...
SWIGEXPORT int Abstract_virtual_SafeInit(Tcl_Interp *interp) {
