...
#define SWIG_init    Restrict_cplusplus_Init
...
#endif
SWIGINTERN int
_wrap_Foo_restrict_set(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Foo *arg1 = (Foo *) 0 ;
  int arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (SWIG_GetArgs(interp, objc, objv,"oo:Foo_restrict_set self restrict ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Foo, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Foo_restrict_set" "', argument " "1"" of type '" "Foo *""'"); 
  }
  arg1 = reinterpret_cast< Foo * >(argp1);
  ecode2 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[2], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "Foo_restrict_set" "', argument " "2"" of type '" "int""'");
  } 
...
SWIGINTERN int
_wrap_Foo_restrict_get(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Foo *arg1 = (Foo *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  int result;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:Foo_restrict_get self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Foo, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Foo_restrict_get" "', argument " "1"" of type '" "Foo *""'"); 
  }
  arg1 = reinterpret_cast< Foo * >(argp1);
...
static swig_attribute swig_Foo_attributes[] = {
    { "-restrict",_wrap_Foo_restrict_get, _wrap_Foo_restrict_set},
    {0,0,0}
};
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "Foo_restrict_set", (swig_wrapper_func) _wrap_Foo_restrict_set, NULL},
    { SWIG_prefix "Foo_restrict_get", (swig_wrapper_func) _wrap_Foo_restrict_get, NULL},
...
SWIGEXPORT int Restrict_cplusplus_SafeInit(Tcl_Interp *interp) {
