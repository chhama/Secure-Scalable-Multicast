...
#define SWIG_init    Virtual_destructor_Init
...
#endif
SWIGINTERN int
_wrap_new_VirtualVoidDestructor(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  VirtualVoidDestructor *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,":new_VirtualVoidDestructor ") == TCL_ERROR) SWIG_fail;
  result = (VirtualVoidDestructor *)new VirtualVoidDestructor();
  Tcl_SetObjResult(interp, SWIG_NewInstanceObj( SWIG_as_voidptr(result), SWIGTYPE_p_VirtualVoidDestructor,0));
  return TCL_OK;
fail:
  return TCL_ERROR;
}
...
SWIGINTERN int
_wrap_delete_VirtualVoidDestructor(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  VirtualVoidDestructor *arg1 = (VirtualVoidDestructor *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:delete_VirtualVoidDestructor self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_VirtualVoidDestructor, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_VirtualVoidDestructor" "', argument " "1"" of type '" "VirtualVoidDestructor *""'"); 
  }
  arg1 = reinterpret_cast< VirtualVoidDestructor * >(argp1);
  delete arg1;
...
SWIGINTERN void swig_delete_VirtualVoidDestructor(void *obj) {
VirtualVoidDestructor *arg1 = (VirtualVoidDestructor *) obj;
delete arg1;
}
static swig_method swig_VirtualVoidDestructor_methods[] = {
    {0,0}
};
static swig_attribute swig_VirtualVoidDestructor_attributes[] = {
    {0,0,0}
};
static swig_class *swig_VirtualVoidDestructor_bases[] = {0};
static const char * swig_VirtualVoidDestructor_base_names[] = {0};
static swig_class _wrap_class_VirtualVoidDestructor = { "VirtualVoidDestructor", &SWIGTYPE_p_VirtualVoidDestructor,_wrap_new_VirtualVoidDestructor, swig_delete_VirtualVoidDestructor, swig_VirtualVoidDestructor_methods, swig_VirtualVoidDestructor_attributes, swig_VirtualVoidDestructor_bases,swig_VirtualVoidDestructor_base_names, &swig_module };
SWIGINTERN int
...
static const char * swig_Derived_base_names[] = {"VirtualVoidDestructor *",0};
static swig_class _wrap_class_Derived = { "Derived", &SWIGTYPE_p_Derived,_wrap_new_Derived,0, swig_Derived_methods, swig_Derived_attributes, swig_Derived_bases,swig_Derived_base_names, &swig_module };

static swig_command_info swig_commands[] = {
    { SWIG_prefix "new_VirtualVoidDestructor", (swig_wrapper_func) _wrap_new_VirtualVoidDestructor, NULL},
    { SWIG_prefix "delete_VirtualVoidDestructor", (swig_wrapper_func) _wrap_delete_VirtualVoidDestructor, NULL},
    { SWIG_prefix "VirtualVoidDestructor", (swig_wrapper_func) SWIG_ObjectConstructor, (ClientData)&_wrap_class_VirtualVoidDestructor},
...
static swig_type_info _swigt__p_VirtualVoidDestructor = {"_p_VirtualVoidDestructor", "VirtualVoidDestructor *", 0, 0, (void*)&_wrap_class_VirtualVoidDestructor, 0};
...
SWIGEXPORT int Virtual_destructor_SafeInit(Tcl_Interp *interp) {
