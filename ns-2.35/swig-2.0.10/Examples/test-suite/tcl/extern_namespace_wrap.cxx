...
#define SWIG_init    Extern_namespace_Init
...
_wrap_bar__SWIG_0(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (SWIG_GetArgs(interp, objc, objv,"o:bar blah ",(void *)0) == TCL_ERROR) SWIG_fail;
...
SWIGINTERN int
_wrap_foobar(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  int arg1 ;
  int val1 ;
  int ecode1 = 0 ;
  int result;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:foobar i ",(void *)0) == TCL_ERROR) SWIG_fail;
  ecode1 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[1], &val1);
  if (!SWIG_IsOK(ecode1)) {
...
static swig_command_info swig_commands[] = {
    ...
    { SWIG_prefix "foobar", (swig_wrapper_func) _wrap_foobar, NULL},
    {0, 0, 0}
};
...
SWIGEXPORT int Extern_namespace_SafeInit(Tcl_Interp *interp) {
