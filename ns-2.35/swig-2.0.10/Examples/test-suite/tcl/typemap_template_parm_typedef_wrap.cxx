...
#define SWIGTYPE_p_std__listT_unsigned_int_t swig_types[1]
#define SWIGTYPE_p_std__vectorT_unsigned_int_t swig_types[2]
...
#define SWIG_init    Typemap_template_parm_typedef_Init
...
#endif
SWIGINTERN int
_wrap_test_no_typedef(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  std::list< jada::uint > arg1 ;
  std::list< unsigned int > tmp1 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:test_no_typedef bada ",(void *)0) == TCL_ERROR) SWIG_fail;
  {
    arg1 = tmp1;
  }
...
SWIGINTERN int
_wrap_test_typedef(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  std::vector< jada::uint > arg1 ;
  std::vector< unsigned int > tmp1 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:test_typedef bada ",(void *)0) == TCL_ERROR) SWIG_fail;
  {
    arg1 = tmp1;
  }
...
SWIGINTERN int
_wrap_no_typedef_out(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  std::deque< unsigned int > result;
  
  if (SWIG_GetArgs(interp, objc, objv,":no_typedef_out ") == TCL_ERROR) SWIG_fail;
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "test_no_typedef", (swig_wrapper_func) _wrap_test_no_typedef, NULL},
    { SWIG_prefix "test_typedef", (swig_wrapper_func) _wrap_test_typedef, NULL},
    { SWIG_prefix "no_typedef_out", (swig_wrapper_func) _wrap_no_typedef_out, NULL},
    {0, 0, 0}
};
...
SWIGEXPORT int Typemap_template_parm_typedef_SafeInit(Tcl_Interp *interp) {
