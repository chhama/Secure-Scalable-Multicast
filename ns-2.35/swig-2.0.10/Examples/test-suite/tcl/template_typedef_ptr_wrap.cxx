...
#define SWIG_init    Template_typedef_ptr_Init
...
SWIGINTERN int
_wrap_new_test_pC(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  C *arg1 = (C *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  Test< int,C * > *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:new_test_pC a ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_C, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "new_test_pC" "', argument " "1"" of type '" "C *""'"); 
  }
  arg1 = reinterpret_cast< C * >(argp1);
  result = (Test< int,C * > *)new Test< int,C * >(arg1);
  Tcl_SetObjResult(interp, SWIG_NewInstanceObj( SWIG_as_voidptr(result), SWIGTYPE_p_TestT_int_C_p_t,0));
  return TCL_OK;
fail:
  return TCL_ERROR;
}
...
SWIGINTERN int
_wrap_delete_test_pC(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Test< int,C * > *arg1 = (Test< int,C * > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:delete_test_pC self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_TestT_int_C_p_t, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_test_pC" "', argument " "1"" of type '" "Test< int,C * > *""'"); 
  }
  arg1 = reinterpret_cast< Test< int,C * > * >(argp1);
  delete arg1;
...
SWIGINTERN void swig_delete_test_pC(void *obj) {
Test< int,C * > *arg1 = (Test< int,C * > *) obj;
delete arg1;
}
static swig_method swig_Test_Sl_int_Sc_C_Sm__Sg__methods[] = {
    {0,0}
};
static swig_attribute swig_Test_Sl_int_Sc_C_Sm__Sg__attributes[] = {
    {0,0,0}
};
static swig_class *swig_Test_Sl_int_Sc_C_Sm__Sg__bases[] = {0};
static const char * swig_Test_Sl_int_Sc_C_Sm__Sg__base_names[] = {0};
static swig_class _wrap_class_Test_Sl_int_Sc_C_Sm__Sg_ = { "test_pC", &SWIGTYPE_p_TestT_int_C_p_t,_wrap_new_test_pC, swig_delete_test_pC, swig_Test_Sl_int_Sc_C_Sm__Sg__methods, swig_Test_Sl_int_Sc_C_Sm__Sg__attributes, swig_Test_Sl_int_Sc_C_Sm__Sg__bases,swig_Test_Sl_int_Sc_C_Sm__Sg__base_names, &swig_module };
...
static swig_command_info swig_commands[] = {
    ...
    { SWIG_prefix "new_test_pC", (swig_wrapper_func) _wrap_new_test_pC, NULL},
    { SWIG_prefix "delete_test_pC", (swig_wrapper_func) _wrap_delete_test_pC, NULL},
    { SWIG_prefix "test_pC", (swig_wrapper_func) SWIG_ObjectConstructor, (ClientData)&_wrap_class_Test_Sl_int_Sc_C_Sm__Sg_},
    {0, 0, 0}
};
...
static swig_type_info _swigt__p_TestT_int_C_p_t = {"_p_TestT_int_C_p_t", "Test< int,C * > *", 0, 0, (void*)&_wrap_class_Test_Sl_int_Sc_C_Sm__Sg_, 0};
...
SWIGEXPORT int Template_typedef_ptr_SafeInit(Tcl_Interp *interp) {
