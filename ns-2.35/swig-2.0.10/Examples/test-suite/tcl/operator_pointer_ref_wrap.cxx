...
#define SWIG_init    Operator_pointer_ref_Init
...
_wrap_new_MyClass__SWIG_0(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (SWIG_GetArgs(interp, objc, objv,"o:new_MyClass s_ ",(void *)0) == TCL_ERROR) SWIG_fail;
...
SWIGINTERN int
_wrap_MyClass_AsCharStarRef(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  MyClass *arg1 = (MyClass *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  char **result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:MyClass_AsCharStarRef self ",(void *)0) == TCL_ERROR) SWIG_fail;
...
static swig_method swig_MyClass_methods[] = {
    {"AsCharStarRef", _wrap_MyClass_AsCharStarRef}, 
    {0,0}
};
...
static swig_command_info swig_commands[] = {
    ...
    { SWIG_prefix "MyClass_AsCharStarRef", (swig_wrapper_func) _wrap_MyClass_AsCharStarRef, NULL},
...
SWIGEXPORT int Operator_pointer_ref_SafeInit(Tcl_Interp *interp) {
