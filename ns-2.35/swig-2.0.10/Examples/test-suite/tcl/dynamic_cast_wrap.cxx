...
#define SWIG_init    Dynamic_cast_Init
...
_wrap_Foo_blah(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  {
    swig_type_info *ty = SWIG_TypeDynamicCast(SWIGTYPE_p_Foo,SWIG_as_voidptrptr(&result));
    Tcl_SetObjResult(interp,SWIG_NewInstanceObj(SWIG_as_voidptr(result), ty,0));
  }
  return TCL_OK;
fail:
  return TCL_ERROR;
...
SWIGINTERN int
_wrap_do_test(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Bar *arg1 = (Bar *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  char *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:do_test b ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Bar, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "do_test" "', argument " "1"" of type '" "Bar *""'"); 
  }
  arg1 = reinterpret_cast< Bar * >(argp1);
...
static swig_command_info swig_commands[] = {
    ...
    { SWIG_prefix "do_test", (swig_wrapper_func) _wrap_do_test, NULL},
    {0, 0, 0}
};
...
SWIGEXPORT int Dynamic_cast_SafeInit(Tcl_Interp *interp) {
