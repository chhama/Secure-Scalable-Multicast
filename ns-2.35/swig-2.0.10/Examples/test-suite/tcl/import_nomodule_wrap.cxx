...
#define SWIG_init    Import_nomodule_Init
...
#endif
SWIGINTERN int
_wrap_create_Foo(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Foo *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,":create_Foo ") == TCL_ERROR) SWIG_fail;
...
_wrap_test1(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (SWIG_GetArgs(interp, objc, objv,"oo:test1 f x ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Foo, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "test1" "', argument " "1"" of type '" "Foo *""'"); 
  }
  arg1 = reinterpret_cast< Foo * >(argp1);
  ecode2 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[2], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "test1" "', argument " "2"" of type '" "Integer""'");
  } 
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "create_Foo", (swig_wrapper_func) _wrap_create_Foo, NULL},
...
SWIGEXPORT int Import_nomodule_SafeInit(Tcl_Interp *interp) {
