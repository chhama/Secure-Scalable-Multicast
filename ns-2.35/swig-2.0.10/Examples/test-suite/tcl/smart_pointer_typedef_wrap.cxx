...
#define SWIG_init    Smart_pointer_typedef_Init
...
static swig_type_info _swigt__p_Foo = {"_p_Foo", "FooPtr|Foo *", 0, 0, (void*)&_wrap_class_Foo, 0};
...
SWIGEXPORT int Smart_pointer_typedef_SafeInit(Tcl_Interp *interp) {
