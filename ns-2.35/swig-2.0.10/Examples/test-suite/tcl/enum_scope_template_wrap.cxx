...
#define SWIGTYPE_p_TreeT_int_t swig_types[0]
...
#define SWIG_init    Enum_scope_template_Init
...
#endif
SWIGINTERN int
_wrap_chop(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  enum Tree< int >::types arg1 ;
  int val1 ;
  int ecode1 = 0 ;
  enum Tree< int >::types result;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:chop type ",(void *)0) == TCL_ERROR) SWIG_fail;
  ecode1 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[1], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "chop" "', argument " "1"" of type '" "enum Tree< int >::types""'");
  } 
  arg1 = static_cast< enum Tree< int >::types >(val1);
...
SWIGINTERN int
_wrap_TreeInt_chop(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (SWIG_GetArgs(interp, objc, objv,"oo:TreeInt_chop self type ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_TreeT_int_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "TreeInt_chop" "', argument " "1"" of type '" "Tree< int > *""'"); 
  }
  arg1 = reinterpret_cast< Tree< int > * >(argp1);
  ecode2 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[2], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "TreeInt_chop" "', argument " "2"" of type '" "enum Tree< int >::types""'");
  } 
  arg2 = static_cast< enum Tree< int >::types >(val2);
  (arg1)->chop(arg2);
...
SWIGINTERN int
_wrap_new_TreeInt(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Tree< int > *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,":new_TreeInt ") == TCL_ERROR) SWIG_fail;
  result = (Tree< int > *)new Tree< int >();
  Tcl_SetObjResult(interp, SWIG_NewInstanceObj( SWIG_as_voidptr(result), SWIGTYPE_p_TreeT_int_t,0));
  return TCL_OK;
fail:
  return TCL_ERROR;
}
...
SWIGINTERN int
_wrap_delete_TreeInt(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Tree< int > *arg1 = (Tree< int > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:delete_TreeInt self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_TreeT_int_t, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_TreeInt" "', argument " "1"" of type '" "Tree< int > *""'"); 
  }
  arg1 = reinterpret_cast< Tree< int > * >(argp1);
  delete arg1;
...
SWIGINTERN void swig_delete_TreeInt(void *obj) {
Tree< int > *arg1 = (Tree< int > *) obj;
delete arg1;
}
static swig_method swig_Tree_Sl_int_Sg__methods[] = {
    {"chop", _wrap_TreeInt_chop}, 
    {0,0}
};
static swig_attribute swig_Tree_Sl_int_Sg__attributes[] = {
    {0,0,0}
};
static swig_class *swig_Tree_Sl_int_Sg__bases[] = {0};
static const char * swig_Tree_Sl_int_Sg__base_names[] = {0};
static swig_class _wrap_class_Tree_Sl_int_Sg_ = { "TreeInt", &SWIGTYPE_p_TreeT_int_t,_wrap_new_TreeInt, swig_delete_TreeInt, swig_Tree_Sl_int_Sg__methods, swig_Tree_Sl_int_Sg__attributes, swig_Tree_Sl_int_Sg__bases,swig_Tree_Sl_int_Sg__base_names, &swig_module };

static swig_command_info swig_commands[] = {
    { SWIG_prefix "chop", (swig_wrapper_func) _wrap_chop, NULL},
    { SWIG_prefix "TreeInt_chop", (swig_wrapper_func) _wrap_TreeInt_chop, NULL},
    { SWIG_prefix "new_TreeInt", (swig_wrapper_func) _wrap_new_TreeInt, NULL},
    { SWIG_prefix "delete_TreeInt", (swig_wrapper_func) _wrap_delete_TreeInt, NULL},
    { SWIG_prefix "TreeInt", (swig_wrapper_func) SWIG_ObjectConstructor, (ClientData)&_wrap_class_Tree_Sl_int_Sg_},
    {0, 0, 0}
};
...
static swig_type_info _swigt__p_TreeT_int_t = {"_p_TreeT_int_t", "Tree< int > *", 0, 0, (void*)&_wrap_class_Tree_Sl_int_Sg_, 0};
...
SWIGEXPORT int SWIG_init(Tcl_Interp *interp) {
  ...
  SWIG_Tcl_SetConstantObj(interp, "TreeInt_Oak", SWIG_From_int(static_cast< int >(Tree< int >::Oak)));
  SWIG_Tcl_SetConstantObj(interp, "TreeInt_Fir", SWIG_From_int(static_cast< int >(Tree< int >::Fir)));
  SWIG_Tcl_SetConstantObj(interp, "TreeInt_Cedar", SWIG_From_int(static_cast< int >(Tree< int >::Cedar)));
  return TCL_OK;
}
SWIGEXPORT int Enum_scope_template_SafeInit(Tcl_Interp *interp) {
