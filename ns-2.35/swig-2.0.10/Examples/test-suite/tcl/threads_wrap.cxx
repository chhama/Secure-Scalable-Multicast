...
#define SWIGTYPE_p_Kerfuffle swig_types[0]
...
#define SWIG_init    Threads_Init
#define SWIG_name    "threads"
#define SWIG_prefix  ""
...
#endif
SWIGINTERN int
_wrap_Kerfuffle_StdString(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Kerfuffle *arg1 = (Kerfuffle *) 0 ;
  std::string arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  std::string result;
  
  if (SWIG_GetArgs(interp, objc, objv,"oo:Kerfuffle_StdString self str ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Kerfuffle, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Kerfuffle_StdString" "', argument " "1"" of type '" "Kerfuffle *""'"); 
  }
  arg1 = reinterpret_cast< Kerfuffle * >(argp1);
  {
    std::string *ptr = (std::string *)0;
    int res = SWIG_AsPtr_std_string SWIG_TCL_CALL_ARGS_2(objv[2], &ptr);
    if (!SWIG_IsOK(res) || !ptr) {
      SWIG_exception_fail(SWIG_ArgError((ptr ? res : SWIG_TypeError)), "in method '" "Kerfuffle_StdString" "', argument " "2"" of type '" "std::string""'"); 
    }
    arg2 = *ptr;
    if (SWIG_IsNewObj(res)) delete ptr;
  }
  result = (arg1)->StdString(arg2);
...
SWIGINTERN int
_wrap_Kerfuffle_CharString(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Kerfuffle *arg1 = (Kerfuffle *) 0 ;
  char *arg2 = (char *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (SWIG_GetArgs(interp, objc, objv,"oo:Kerfuffle_CharString self str ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Kerfuffle, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Kerfuffle_CharString" "', argument " "1"" of type '" "Kerfuffle *""'"); 
  }
  arg1 = reinterpret_cast< Kerfuffle * >(argp1);
  res2 = SWIG_AsCharPtrAndSize(objv[2], &buf2, NULL, &alloc2);
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "Kerfuffle_CharString" "', argument " "2"" of type '" "char const *""'");
  }
...
SWIGINTERN int
_wrap_new_Kerfuffle(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Kerfuffle *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,":new_Kerfuffle ") == TCL_ERROR) SWIG_fail;
  result = (Kerfuffle *)new Kerfuffle();
  Tcl_SetObjResult(interp, SWIG_NewInstanceObj( SWIG_as_voidptr(result), SWIGTYPE_p_Kerfuffle,0));
  return TCL_OK;
fail:
  return TCL_ERROR;
}
...
SWIGINTERN int
_wrap_delete_Kerfuffle(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Kerfuffle *arg1 = (Kerfuffle *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:delete_Kerfuffle self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Kerfuffle, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_Kerfuffle" "', argument " "1"" of type '" "Kerfuffle *""'"); 
  }
  arg1 = reinterpret_cast< Kerfuffle * >(argp1);
  delete arg1;
...
SWIGINTERN void swig_delete_Kerfuffle(void *obj) {
Kerfuffle *arg1 = (Kerfuffle *) obj;
delete arg1;
}
static swig_method swig_Kerfuffle_methods[] = {
    {"StdString", _wrap_Kerfuffle_StdString}, 
    {"CharString", _wrap_Kerfuffle_CharString}, 
    {0,0}
};
static swig_attribute swig_Kerfuffle_attributes[] = {
    {0,0,0}
};
static swig_class *swig_Kerfuffle_bases[] = {0};
static const char * swig_Kerfuffle_base_names[] = {0};
static swig_class _wrap_class_Kerfuffle = { "Kerfuffle", &SWIGTYPE_p_Kerfuffle,_wrap_new_Kerfuffle, swig_delete_Kerfuffle, swig_Kerfuffle_methods, swig_Kerfuffle_attributes, swig_Kerfuffle_bases,swig_Kerfuffle_base_names, &swig_module };

static swig_command_info swig_commands[] = {
    { SWIG_prefix "Kerfuffle_StdString", (swig_wrapper_func) _wrap_Kerfuffle_StdString, NULL},
    { SWIG_prefix "Kerfuffle_CharString", (swig_wrapper_func) _wrap_Kerfuffle_CharString, NULL},
    { SWIG_prefix "new_Kerfuffle", (swig_wrapper_func) _wrap_new_Kerfuffle, NULL},
    { SWIG_prefix "delete_Kerfuffle", (swig_wrapper_func) _wrap_delete_Kerfuffle, NULL},
    { SWIG_prefix "Kerfuffle", (swig_wrapper_func) SWIG_ObjectConstructor, (ClientData)&_wrap_class_Kerfuffle},
    {0, 0, 0}
};
...
static swig_type_info _swigt__p_Kerfuffle = {"_p_Kerfuffle", "Kerfuffle *", 0, 0, (void*)&_wrap_class_Kerfuffle, 0};
...
static swig_cast_info _swigc__p_Kerfuffle[] = {  {&_swigt__p_Kerfuffle, 0, 0, 0},{0, 0, 0, 0}};
...
SWIGEXPORT int Threads_SafeInit(Tcl_Interp *interp) {
