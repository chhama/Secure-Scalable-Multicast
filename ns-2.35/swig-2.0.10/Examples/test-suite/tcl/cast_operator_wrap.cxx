...
#define SWIG_init    Cast_operator_Init
...
#endif
SWIGINTERN int
_wrap_A_tochar(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  A *arg1 = (A *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  char *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:A_tochar self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_A, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "A_tochar" "', argument " "1"" of type '" "A const *""'"); 
  }
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "A_tochar", (swig_wrapper_func) _wrap_A_tochar, NULL},
...
SWIGEXPORT int Cast_operator_SafeInit(Tcl_Interp *interp) {
