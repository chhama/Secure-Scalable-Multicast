...
#define SWIGTYPE_p_samename swig_types[1]
...
#define SWIG_init    Samename_Init
...
#endif
SWIGINTERN int
_wrap_samename_do_something(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  samename *arg1 = (samename *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:samename_do_something self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_samename, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "samename_do_something" "', argument " "1"" of type '" "samename *""'"); 
  }
  arg1 = reinterpret_cast< samename * >(argp1);
  (arg1)->do_something();
...
SWIGINTERN int
_wrap_new_samename(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  samename *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,":new_samename ") == TCL_ERROR) SWIG_fail;
  result = (samename *)new samename();
  Tcl_SetObjResult(interp, SWIG_NewInstanceObj( SWIG_as_voidptr(result), SWIGTYPE_p_samename,0));
  return TCL_OK;
fail:
  return TCL_ERROR;
}
...
SWIGINTERN int
_wrap_delete_samename(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  samename *arg1 = (samename *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:delete_samename self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_samename, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_samename" "', argument " "1"" of type '" "samename *""'"); 
  }
  arg1 = reinterpret_cast< samename * >(argp1);
  delete arg1;
...
SWIGINTERN void swig_delete_samename(void *obj) {
samename *arg1 = (samename *) obj;
delete arg1;
}
static swig_method swig_samename_methods[] = {
    {"do_something", _wrap_samename_do_something}, 
    {0,0}
};
static swig_attribute swig_samename_attributes[] = {
    {0,0,0}
};
static swig_class *swig_samename_bases[] = {0};
static const char * swig_samename_base_names[] = {0};
static swig_class _wrap_class_samename = { "samename", &SWIGTYPE_p_samename,_wrap_new_samename, swig_delete_samename, swig_samename_methods, swig_samename_attributes, swig_samename_bases,swig_samename_base_names, &swig_module };

static swig_command_info swig_commands[] = {
    { SWIG_prefix "samename_do_something", (swig_wrapper_func) _wrap_samename_do_something, NULL},
    { SWIG_prefix "new_samename", (swig_wrapper_func) _wrap_new_samename, NULL},
    { SWIG_prefix "delete_samename", (swig_wrapper_func) _wrap_delete_samename, NULL},
    { SWIG_prefix "samename", (swig_wrapper_func) SWIG_ObjectConstructor, (ClientData)&_wrap_class_samename},
    {0, 0, 0}
};
...
static swig_type_info _swigt__p_samename = {"_p_samename", "samename *", 0, 0, (void*)&_wrap_class_samename, 0};
...
SWIGEXPORT int Samename_SafeInit(Tcl_Interp *interp) {
