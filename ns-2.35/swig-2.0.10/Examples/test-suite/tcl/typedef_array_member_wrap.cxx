...
#define SWIG_init    Typedef_array_member_Init
...
_wrap_Foo_x_set(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  res2 = SWIG_AsCharArray(objv[2], temp2, 20);
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "Foo_x_set" "', argument " "2"" of type '" "char [20]""'");
  }
  arg2 = reinterpret_cast< char * >(temp2);
  if (arg2) memcpy(arg1->x,arg2,20*sizeof(char));
  else memset(arg1->x,0,20*sizeof(char));
...
SWIGINTERN int
_wrap_Ast_channel_jmp_set(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (SWIG_GetArgs(interp, objc, objv,"oo:Ast_channel_jmp_set self jmp ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Ast_channel, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Ast_channel_jmp_set" "', argument " "1"" of type '" "Ast_channel *""'"); 
  }
  arg1 = reinterpret_cast< Ast_channel * >(argp1);
  res2 = SWIG_ConvertPtr(objv[2], &argp2,SWIGTYPE_p_a_1__jbuf_tag, 0 |  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "Ast_channel_jmp_set" "', argument " "2"" of type '" "jbuf_tag [32][1]""'"); 
  } 
  arg2 = reinterpret_cast< jbuf_tag (*)[1] >(argp2);
  {
    if (arg2) {
      size_t ii = 0;
      for (; ii < (size_t)32; ++ii) {
        if (arg2[ii]) {
          size_t jj = 0;
          for (; jj < (size_t)1; ++jj) arg1->jmp[ii][jj] = arg2[ii][jj];
        } else {
          SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in variable '""jmp""' of type '""jbuf_tag [32][1]""'");
        }
      }
    } else {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in variable '""jmp""' of type '""jbuf_tag [32][1]""'");
...
SWIGINTERN int
_wrap_Ast_channel_jmp_get(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Ast_channel *arg1 = (Ast_channel *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  jbuf *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:Ast_channel_jmp_get self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Ast_channel, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Ast_channel_jmp_get" "', argument " "1"" of type '" "Ast_channel *""'"); 
  }
  arg1 = reinterpret_cast< Ast_channel * >(argp1);
  result = (jbuf *)(jbuf *) ((arg1)->jmp);
  Tcl_SetObjResult(interp, SWIG_NewInstanceObj( SWIG_as_voidptr(result), SWIGTYPE_p_a_1__jbuf_tag,0));
  return TCL_OK;
fail:
  return TCL_ERROR;
}
...
SWIGINTERN int
_wrap_new_Ast_channel(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Ast_channel *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,":new_Ast_channel ") == TCL_ERROR) SWIG_fail;
  result = (Ast_channel *)new Ast_channel();
  Tcl_SetObjResult(interp, SWIG_NewInstanceObj( SWIG_as_voidptr(result), SWIGTYPE_p_Ast_channel,0));
  return TCL_OK;
fail:
  return TCL_ERROR;
}
...
SWIGINTERN int
_wrap_delete_Ast_channel(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Ast_channel *arg1 = (Ast_channel *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:delete_Ast_channel self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Ast_channel, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_Ast_channel" "', argument " "1"" of type '" "Ast_channel *""'"); 
  }
  arg1 = reinterpret_cast< Ast_channel * >(argp1);
  delete arg1;
...
SWIGINTERN void swig_delete_Ast_channel(void *obj) {
Ast_channel *arg1 = (Ast_channel *) obj;
delete arg1;
}
static swig_method swig_Ast_channel_methods[] = {
    {0,0}
};
static swig_attribute swig_Ast_channel_attributes[] = {
    { "-jmp",_wrap_Ast_channel_jmp_get, _wrap_Ast_channel_jmp_set},
    {0,0,0}
};
static swig_class *swig_Ast_channel_bases[] = {0};
static const char * swig_Ast_channel_base_names[] = {0};
static swig_class _wrap_class_Ast_channel = { "Ast_channel", &SWIGTYPE_p_Ast_channel,_wrap_new_Ast_channel, swig_delete_Ast_channel, swig_Ast_channel_methods, swig_Ast_channel_attributes, swig_Ast_channel_bases,swig_Ast_channel_base_names, &swig_module };
...
static swig_command_info swig_commands[] = {
    ...
    { SWIG_prefix "Ast_channel_jmp_set", (swig_wrapper_func) _wrap_Ast_channel_jmp_set, NULL},
    { SWIG_prefix "Ast_channel_jmp_get", (swig_wrapper_func) _wrap_Ast_channel_jmp_get, NULL},
    { SWIG_prefix "new_Ast_channel", (swig_wrapper_func) _wrap_new_Ast_channel, NULL},
    { SWIG_prefix "delete_Ast_channel", (swig_wrapper_func) _wrap_delete_Ast_channel, NULL},
    { SWIG_prefix "Ast_channel", (swig_wrapper_func) SWIG_ObjectConstructor, (ClientData)&_wrap_class_Ast_channel},
    {0, 0, 0}
};
...
static swig_type_info _swigt__p_Ast_channel = {"_p_Ast_channel", "Ast_channel *", 0, 0, (void*)&_wrap_class_Ast_channel, 0};
...
SWIGEXPORT int Typedef_array_member_SafeInit(Tcl_Interp *interp) {
