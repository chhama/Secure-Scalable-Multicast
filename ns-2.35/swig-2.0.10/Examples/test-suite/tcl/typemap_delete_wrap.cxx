...
#define SWIG_init    Typemap_delete_Init
...
#endif
SWIGINTERN int
_wrap_Rect_val_set(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Rect *arg1 = (Rect *) 0 ;
  int arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (SWIG_GetArgs(interp, objc, objv,"oo:Rect_val_set self val ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Rect, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Rect_val_set" "', argument " "1"" of type '" "Rect *""'"); 
  }
  arg1 = reinterpret_cast< Rect * >(argp1);
  ecode2 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[2], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "Rect_val_set" "', argument " "2"" of type '" "int""'");
  } 
...
SWIGINTERN int
_wrap_Rect_val_get(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Rect *arg1 = (Rect *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  int result;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:Rect_val_get self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Rect, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Rect_val_get" "', argument " "1"" of type '" "Rect *""'"); 
  }
  arg1 = reinterpret_cast< Rect * >(argp1);
  result = (int) ((arg1)->val);
...
SWIGINTERN int
_wrap_new_Rect(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  int arg1 ;
  int val1 ;
  int ecode1 = 0 ;
  Rect *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:new_Rect v ",(void *)0) == TCL_ERROR) SWIG_fail;
  ...
  Tcl_SetObjResult(interp, SWIG_NewInstanceObj( SWIG_as_voidptr(result), SWIGTYPE_p_Rect,0));
  return TCL_OK;
fail:
  return TCL_ERROR;
}
...
SWIGINTERN int
_wrap_delete_Rect(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Rect *arg1 = (Rect *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:delete_Rect self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Rect, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
...
SWIGINTERN void swig_delete_Rect(void *obj) {
Rect *arg1 = (Rect *) obj;
delete arg1;
}
static swig_method swig_Rect_methods[] = {
    {0,0}
};
static swig_attribute swig_Rect_attributes[] = {
    { "-val",_wrap_Rect_val_get, _wrap_Rect_val_set},
    {0,0,0}
};
static swig_class *swig_Rect_bases[] = {0};
static const char * swig_Rect_base_names[] = {0};
static swig_class _wrap_class_Rect = { "Rect", &SWIGTYPE_p_Rect,_wrap_new_Rect, swig_delete_Rect, swig_Rect_methods, swig_Rect_attributes, swig_Rect_bases,swig_Rect_base_names, &swig_module };

static swig_command_info swig_commands[] = {
    { SWIG_prefix "Rect_val_set", (swig_wrapper_func) _wrap_Rect_val_set, NULL},
    { SWIG_prefix "Rect_val_get", (swig_wrapper_func) _wrap_Rect_val_get, NULL},
    { SWIG_prefix "new_Rect", (swig_wrapper_func) _wrap_new_Rect, NULL},
    { SWIG_prefix "delete_Rect", (swig_wrapper_func) _wrap_delete_Rect, NULL},
    { SWIG_prefix "Rect", (swig_wrapper_func) SWIG_ObjectConstructor, (ClientData)&_wrap_class_Rect},
    {0, 0, 0}
};
...
SWIGEXPORT int Typemap_delete_SafeInit(Tcl_Interp *interp) {
