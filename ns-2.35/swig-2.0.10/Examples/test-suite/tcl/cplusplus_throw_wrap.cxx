...
#define SWIG_init    Cplusplus_throw_Init
...
SWIGINTERN int
_wrap_Bar_baz(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Bar *arg1 = (Bar *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:Bar_baz self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Bar, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Bar_baz" "', argument " "1"" of type '" "Bar const *""'"); 
  }
...
_wrap_Bar_foo(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (SWIG_GetArgs(interp, objc, objv,"o:Bar_foo self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Bar, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
  ...
  try {
    ...
    SWIG_Tcl_SetErrorObj(interp,"Foo",SWIG_NewPointerObj((new Foo(static_cast< const Foo& >(_e))),SWIGTYPE_p_Foo,SWIG_POINTER_OWN)); SWIG_fail;
  }
...
SWIGINTERN int
_wrap_Bar_bazfoo(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Bar *arg1 = (Bar *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:Bar_bazfoo self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Bar, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Bar_bazfoo" "', argument " "1"" of type '" "Bar const *""'"); 
  }
  arg1 = reinterpret_cast< Bar * >(argp1);
  try {
...
static swig_command_info swig_commands[] = {
    ...
    { SWIG_prefix "Bar_baz", (swig_wrapper_func) _wrap_Bar_baz, NULL},
    { SWIG_prefix "Bar_foo", (swig_wrapper_func) _wrap_Bar_foo, NULL},
    { SWIG_prefix "Bar_bazfoo", (swig_wrapper_func) _wrap_Bar_bazfoo, NULL},
...
SWIGEXPORT int Cplusplus_throw_SafeInit(Tcl_Interp *interp) {
