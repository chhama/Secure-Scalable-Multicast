...
#define SWIG_init    Packageoption_c_Init
...
#endif
SWIGINTERN int
_wrap_Derived_vmethod(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Derived *arg1 = (Derived *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  int result;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:Derived_vmethod self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Derived, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Derived_vmethod" "', argument " "1"" of type '" "Derived *""'"); 
  }
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "Derived_vmethod", (swig_wrapper_func) _wrap_Derived_vmethod, NULL},
...
SWIGEXPORT int Packageoption_c_SafeInit(Tcl_Interp *interp) {
