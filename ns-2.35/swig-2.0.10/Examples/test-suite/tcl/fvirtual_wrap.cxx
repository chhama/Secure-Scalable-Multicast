...
#define SWIG_init    Fvirtual_Init
...
#endif
SWIGINTERN int
_wrap_Node_addChild(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Node *arg1 = (Node *) 0 ;
  Node *arg2 = (Node *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (SWIG_GetArgs(interp, objc, objv,"oo:Node_addChild self child ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  ...
  res2 = SWIG_ConvertPtr(objv[2], &argp2,SWIGTYPE_p_Node, 0 |  0 );
  if (!SWIG_IsOK(res2)) {
...
static swig_class _wrap_class_Node = { "Node", &SWIGTYPE_p_Node,_wrap_new_Node, swig_delete_Node, swig_Node_methods, swig_Node_attributes, swig_Node_bases,swig_Node_base_names, &swig_module };
SWIGINTERN int
_wrap_NodeSwitch_addChild__SWIG_0(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (SWIG_GetArgs(interp, objc, objv,"oo:NodeSwitch_addChild self child ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_NodeSwitch, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "NodeSwitch_addChild" "', argument " "1"" of type '" "NodeSwitch *""'"); 
  }
  arg1 = reinterpret_cast< NodeSwitch * >(argp1);
  res2 = SWIG_ConvertPtr(objv[2], &argp2,SWIGTYPE_p_Node, 0 |  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "NodeSwitch_addChild" "', argument " "2"" of type '" "Node *""'"); 
  }
  arg2 = reinterpret_cast< Node * >(argp2);
  result = (int)(arg1)->addChild(arg2);
  Tcl_SetObjResult(interp,SWIG_From_int(static_cast< int >(result)));
...
SWIGINTERN int
_wrap_NodeSwitch_addChild__SWIG_1(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  NodeSwitch *arg1 = (NodeSwitch *) 0 ;
  Node *arg2 = (Node *) 0 ;
  bool arg3 ;
  void *argp1 = 0 ;
  ...
  if (SWIG_GetArgs(interp, objc, objv,"ooo:NodeSwitch_addChild self child value ",(void *)0,(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_NodeSwitch, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "NodeSwitch_addChild" "', argument " "1"" of type '" "NodeSwitch *""'"); 
  }
  ...
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "NodeSwitch_addChild" "', argument " "3"" of type '" "bool""'");
  } 
...
SWIGINTERN int
_wrap_NodeSwitch_addChild(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Tcl_Obj *CONST *argv = objv+1;
  int argc = objc-1;
  if (argc == 2) {
    int _v;
    void *vptr = 0;
    int res = SWIG_ConvertPtr(argv[0], &vptr, SWIGTYPE_p_NodeSwitch, 0);
    ...
    if (_v) {
      ...
      _v = SWIG_CheckState(res);
      if (_v) {
        return _wrap_NodeSwitch_addChild__SWIG_0(clientData, interp, objc, argv - 1);
      }
    }
  }
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        if (_v) {
          return _wrap_NodeSwitch_addChild__SWIG_1(clientData, interp, objc, argv - 1);
        }
      }
    }
  }
  
  Tcl_SetResult(interp,(char *) "Wrong number or type of arguments for overloaded function 'NodeSwitch_addChild'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    NodeSwitch::addChild(Node *)\n"
    "    NodeSwitch::addChild(Node *,bool)\n", TCL_STATIC);
  return TCL_ERROR;
}


SWIGINTERN int
_wrap_delete_NodeSwitch(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  NodeSwitch *arg1 = (NodeSwitch *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:delete_NodeSwitch self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_NodeSwitch, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_NodeSwitch" "', argument " "1"" of type '" "NodeSwitch *""'"); 
  }
  arg1 = reinterpret_cast< NodeSwitch * >(argp1);
  delete arg1;
...
SWIGINTERN int
_wrap_new_NodeSwitch(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  NodeSwitch *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,":new_NodeSwitch ") == TCL_ERROR) SWIG_fail;
  result = (NodeSwitch *)new NodeSwitch();
  Tcl_SetObjResult(interp, SWIG_NewInstanceObj( SWIG_as_voidptr(result), SWIGTYPE_p_NodeSwitch,0));
  return TCL_OK;
fail:
  return TCL_ERROR;
}
...
SWIGINTERN void swig_delete_NodeSwitch(void *obj) {
NodeSwitch *arg1 = (NodeSwitch *) obj;
delete arg1;
}
static swig_method swig_NodeSwitch_methods[] = {
    {"addChild", _wrap_NodeSwitch_addChild}, 
    {0,0}
};
static swig_attribute swig_NodeSwitch_attributes[] = {
    {0,0,0}
};
static swig_class *swig_NodeSwitch_bases[] = {0,0};
static const char * swig_NodeSwitch_base_names[] = {"Node *",0};
static swig_class _wrap_class_NodeSwitch = { "NodeSwitch", &SWIGTYPE_p_NodeSwitch,_wrap_new_NodeSwitch, swig_delete_NodeSwitch, swig_NodeSwitch_methods, swig_NodeSwitch_attributes, swig_NodeSwitch_bases,swig_NodeSwitch_base_names, &swig_module };

static swig_command_info swig_commands[] = {
    { SWIG_prefix "Node_addChild", (swig_wrapper_func) _wrap_Node_addChild, NULL},
    ...
    { SWIG_prefix "NodeSwitch_addChild", (swig_wrapper_func) _wrap_NodeSwitch_addChild, NULL},
    { SWIG_prefix "delete_NodeSwitch", (swig_wrapper_func) _wrap_delete_NodeSwitch, NULL},
    { SWIG_prefix "new_NodeSwitch", (swig_wrapper_func) _wrap_new_NodeSwitch, NULL},
    { SWIG_prefix "NodeSwitch", (swig_wrapper_func) SWIG_ObjectConstructor, (ClientData)&_wrap_class_NodeSwitch},
    {0, 0, 0}
};
...
static swig_type_info _swigt__p_NodeSwitch = {"_p_NodeSwitch", "NodeSwitch *", 0, 0, (void*)&_wrap_class_NodeSwitch, 0};
...
SWIGEXPORT int Fvirtual_SafeInit(Tcl_Interp *interp) {
