...
#define SWIG_init    Constructor_rename_Init
...
#endif
SWIGINTERN int
_wrap_new_RenamedConstructor(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Foo *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,":new_RenamedConstructor ") == TCL_ERROR) SWIG_fail;
  result = (Foo *)new Foo();
...
static swig_class _wrap_class_Foo = { "Foo", &SWIGTYPE_p_Foo,_wrap_new_RenamedConstructor, swig_delete_Foo, swig_Foo_methods, swig_Foo_attributes, swig_Foo_bases,swig_Foo_base_names, &swig_module };

static swig_command_info swig_commands[] = {
    { SWIG_prefix "new_RenamedConstructor", (swig_wrapper_func) _wrap_new_RenamedConstructor, NULL},
...
SWIGEXPORT int Constructor_rename_SafeInit(Tcl_Interp *interp) {
