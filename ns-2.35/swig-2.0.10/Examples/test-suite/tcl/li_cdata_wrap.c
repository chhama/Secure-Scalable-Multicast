...
#define SWIG_init    Li_cdata_Init
...
SWIGINTERN int
_wrap_cdata_int(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  int *arg1 = (int *) 0 ;
  size_t arg2 = (size_t) 1 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (SWIG_GetArgs(interp, objc, objv,"o|o:cdata_int ptr ?nelements? ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_int, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "cdata_int" "', argument " "1"" of type '" "int *""'"); 
  }
  arg1 = (int *)(argp1);
  if (objc > 2) {
    ecode2 = SWIG_AsVal_size_t SWIG_TCL_CALL_ARGS_2(objv[2], &val2);
    if (!SWIG_IsOK(ecode2)) {
      SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "cdata_int" "', argument " "2"" of type '" "size_t""'");
    } 
    arg2 = (size_t)(val2);
  }
...
SWIGINTERN int
_wrap_cdata_double(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (SWIG_GetArgs(interp, objc, objv,"o|o:cdata_double ptr ?nelements? ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_double, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "cdata_double" "', argument " "1"" of type '" "double *""'"); 
  }
  arg1 = (double *)(argp1);
  if (objc > 2) {
    ecode2 = SWIG_AsVal_size_t SWIG_TCL_CALL_ARGS_2(objv[2], &val2);
    if (!SWIG_IsOK(ecode2)) {
      SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "cdata_double" "', argument " "2"" of type '" "size_t""'");
    } 
    arg2 = (size_t)(val2);
  }
...
SWIGINTERN int
_wrap_malloc(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  size_t arg1 ;
  size_t val1 ;
  int ecode1 = 0 ;
  void *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:malloc size ",(void *)0) == TCL_ERROR) SWIG_fail;
...
static swig_command_info swig_commands[] = {
    ...
    { SWIG_prefix "cdata_int", (swig_wrapper_func) _wrap_cdata_int, NULL},
    { SWIG_prefix "cdata_double", (swig_wrapper_func) _wrap_cdata_double, NULL},
    { SWIG_prefix "malloc", (swig_wrapper_func) _wrap_malloc, NULL},
    {0, 0, 0}
};
...
SWIGEXPORT int Li_cdata_SafeInit(Tcl_Interp *interp) {
