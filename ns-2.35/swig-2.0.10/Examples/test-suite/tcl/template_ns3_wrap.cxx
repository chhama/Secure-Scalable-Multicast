...
#define SWIG_init    Template_ns3_Init
...
#endif
SWIGINTERN int
_wrap_bari_test(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (SWIG_GetArgs(interp, objc, objv,"oo:bari_test self x ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_foo__barT_int_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "bari_test" "', argument " "1"" of type '" "foo::bar< int > *""'"); 
  }
  arg1 = reinterpret_cast< foo::bar< int > * >(argp1);
  ecode2 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[2], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "bari_test" "', argument " "2"" of type '" "foo::Integer""'");
  } 
...
_wrap_new_bari(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  Tcl_SetObjResult(interp, SWIG_NewInstanceObj( SWIG_as_voidptr(result), SWIGTYPE_p_foo__barT_int_t,0));
  return TCL_OK;
fail:
  return TCL_ERROR;
}
...
_wrap_delete_bari(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_foo__barT_int_t, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_bari" "', argument " "1"" of type '" "foo::bar< int > *""'"); 
  }
  arg1 = reinterpret_cast< foo::bar< int > * >(argp1);
  delete arg1;
...
foo::bar< int > *arg1 = (foo::bar< int > *) obj;
delete arg1;
}
static swig_method swig_foo_bar_Sl_int_Sg__methods[] = {
    {"test", _wrap_bari_test}, 
    {0,0}
};
static swig_attribute swig_foo_bar_Sl_int_Sg__attributes[] = {
    {0,0,0}
};
static swig_class *swig_foo_bar_Sl_int_Sg__bases[] = {0};
static const char * swig_foo_bar_Sl_int_Sg__base_names[] = {0};
static swig_class _wrap_class_foo_bar_Sl_int_Sg_ = { "bari", &SWIGTYPE_p_foo__barT_int_t,_wrap_new_bari, swig_delete_bari, swig_foo_bar_Sl_int_Sg__methods, swig_foo_bar_Sl_int_Sg__attributes, swig_foo_bar_Sl_int_Sg__bases,swig_foo_bar_Sl_int_Sg__base_names, &swig_module };

static swig_command_info swig_commands[] = {
    { SWIG_prefix "bari_test", (swig_wrapper_func) _wrap_bari_test, NULL},
    ...
    { SWIG_prefix "bari", (swig_wrapper_func) SWIG_ObjectConstructor, (ClientData)&_wrap_class_foo_bar_Sl_int_Sg_},
    {0, 0, 0}
};
...
static swig_type_info _swigt__p_foo__barT_int_t = {"_p_foo__barT_int_t", "foo::bar< int > *", 0, 0, (void*)&_wrap_class_foo_bar_Sl_int_Sg_, 0};
...
SWIGEXPORT int Template_ns3_SafeInit(Tcl_Interp *interp) {
