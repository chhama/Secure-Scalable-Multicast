...
#define SWIG_init    Template_ns_enum_Init
...
#endif
SWIGINTERN int
_wrap_say_hi(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  SwigValueWrapper< hello::traits< hello::Hi >::value_type > result;
  
  if (SWIG_GetArgs(interp, objc, objv,":say_hi ") == TCL_ERROR) SWIG_fail;
  result = hello::say_hi();
  Tcl_SetObjResult(interp,SWIG_NewInstanceObj((new hello::traits< hello::Hi >::value_type(static_cast< const hello::traits< hello::Hi >::value_type& >(result))), SWIGTYPE_p_hello__traitsT_hello__Hi_t__value_type, SWIG_POINTER_OWN | 0 ));
  return TCL_OK;
fail:
  return TCL_ERROR;
}
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "say_hi", (swig_wrapper_func) _wrap_say_hi, NULL},
    {0, 0, 0}
};
...
SWIGEXPORT int SWIG_init(Tcl_Interp *interp) {
  ...
  SWIG_Tcl_SetConstantObj(interp, "Hi", SWIG_From_int(static_cast< int >(hello::Hi)));
  SWIG_Tcl_SetConstantObj(interp, "Hola", SWIG_From_int(static_cast< int >(hello::Hola)));
  return TCL_OK;
}
SWIGEXPORT int Template_ns_enum_SafeInit(Tcl_Interp *interp) {
