...
#define SWIGTYPE_p_test_MatrixT_float_3_3_t swig_types[1]
...
#define SWIG_init    Template_arg_replace_Init
...
#endif
SWIGINTERN int
_wrap_matrix33f_Func(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (SWIG_GetArgs(interp, objc, objv,"oo:matrix33f_Func self m ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_test_MatrixT_float_3_3_t, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "matrix33f_Func" "', argument " "1"" of type '" "test_Matrix< float,3,3 > *""'"); 
  }
  arg1 = reinterpret_cast< test_Matrix< float,3,3 > * >(argp1);
  res2 = SWIG_ConvertPtr(objv[2], &argp2, SWIGTYPE_p_test_MatrixT_float_3_3_t,  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "matrix33f_Func" "', argument " "2"" of type '" "test_Matrix< float,3,3 > const &""'"); 
  }
  if (!argp2) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "matrix33f_Func" "', argument " "2"" of type '" "test_Matrix< float,3,3 > const &""'"); 
  }
  arg2 = reinterpret_cast< test_Matrix< float,3,3 > * >(argp2);
...
SWIGINTERN int
_wrap_new_matrix33f(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  test_Matrix< float,3,3 > *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,":new_matrix33f ") == TCL_ERROR) SWIG_fail;
  result = (test_Matrix< float,3,3 > *)new test_Matrix< float,3,3 >();
  Tcl_SetObjResult(interp, SWIG_NewInstanceObj( SWIG_as_voidptr(result), SWIGTYPE_p_test_MatrixT_float_3_3_t,0));
  return TCL_OK;
fail:
  return TCL_ERROR;
}
...
SWIGINTERN int
_wrap_delete_matrix33f(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  test_Matrix< float,3,3 > *arg1 = (test_Matrix< float,3,3 > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:delete_matrix33f self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_test_MatrixT_float_3_3_t, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_matrix33f" "', argument " "1"" of type '" "test_Matrix< float,3,3 > *""'"); 
  }
  arg1 = reinterpret_cast< test_Matrix< float,3,3 > * >(argp1);
  delete arg1;
...
SWIGINTERN void swig_delete_matrix33f(void *obj) {
test_Matrix< float,3,3 > *arg1 = (test_Matrix< float,3,3 > *) obj;
delete arg1;
}
static swig_method swig_test_Matrix_Sl_float_Sc_3_Sc_3_Sg__methods[] = {
    {"Func", _wrap_matrix33f_Func}, 
    {0,0}
};
static swig_attribute swig_test_Matrix_Sl_float_Sc_3_Sc_3_Sg__attributes[] = {
    {0,0,0}
};
static swig_class *swig_test_Matrix_Sl_float_Sc_3_Sc_3_Sg__bases[] = {0};
static const char * swig_test_Matrix_Sl_float_Sc_3_Sc_3_Sg__base_names[] = {0};
static swig_class _wrap_class_test_Matrix_Sl_float_Sc_3_Sc_3_Sg_ = { "matrix33f", &SWIGTYPE_p_test_MatrixT_float_3_3_t,_wrap_new_matrix33f, swig_delete_matrix33f, swig_test_Matrix_Sl_float_Sc_3_Sc_3_Sg__methods, swig_test_Matrix_Sl_float_Sc_3_Sc_3_Sg__attributes, swig_test_Matrix_Sl_float_Sc_3_Sc_3_Sg__bases,swig_test_Matrix_Sl_float_Sc_3_Sc_3_Sg__base_names, &swig_module };

static swig_command_info swig_commands[] = {
    { SWIG_prefix "matrix33f_Func", (swig_wrapper_func) _wrap_matrix33f_Func, NULL},
    { SWIG_prefix "new_matrix33f", (swig_wrapper_func) _wrap_new_matrix33f, NULL},
    { SWIG_prefix "delete_matrix33f", (swig_wrapper_func) _wrap_delete_matrix33f, NULL},
    { SWIG_prefix "matrix33f", (swig_wrapper_func) SWIG_ObjectConstructor, (ClientData)&_wrap_class_test_Matrix_Sl_float_Sc_3_Sc_3_Sg_},
    {0, 0, 0}
};
...
static swig_type_info _swigt__p_test_MatrixT_float_3_3_t = {"_p_test_MatrixT_float_3_3_t", "test_Matrix< float,3,3 > *", 0, 0, (void*)&_wrap_class_test_Matrix_Sl_float_Sc_3_Sc_3_Sg_, 0};
...
SWIGEXPORT int Template_arg_replace_SafeInit(Tcl_Interp *interp) {
