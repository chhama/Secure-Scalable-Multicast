...
#define SWIG_init    Director_extend_Init
...
#endif
SWIGINTERN int
_wrap_new_SpObject(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  SpObject *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,":new_SpObject ") == TCL_ERROR) SWIG_fail;
  result = (SpObject *)new SpObject();
  Tcl_SetObjResult(interp, SWIG_NewInstanceObj( SWIG_as_voidptr(result), SWIGTYPE_p_SpObject,0));
  return TCL_OK;
fail:
  return TCL_ERROR;
}
...
SWIGINTERN int
_wrap_delete_SpObject(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  SpObject *arg1 = (SpObject *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:delete_SpObject self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_SpObject, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_SpObject" "', argument " "1"" of type '" "SpObject *""'"); 
  }
  arg1 = reinterpret_cast< SpObject * >(argp1);
  delete arg1;
...
SWIGINTERN int
_wrap_SpObject_getFooBar(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  SpObject *arg1 = (SpObject *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  int result;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:SpObject_getFooBar self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_SpObject, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "SpObject_getFooBar" "', argument " "1"" of type '" "SpObject const *""'"); 
  }
  arg1 = reinterpret_cast< SpObject * >(argp1);
...
SWIGINTERN int
_wrap_SpObject_dummy(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  SpObject *arg1 = (SpObject *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  int result;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:SpObject_dummy self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_SpObject, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "SpObject_dummy" "', argument " "1"" of type '" "SpObject *""'"); 
  }
  arg1 = reinterpret_cast< SpObject * >(argp1);
...
SWIGINTERN int
_wrap_SpObject_ExceptionMethod(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  SpObject *arg1 = (SpObject *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  size_t result;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:SpObject_ExceptionMethod self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_SpObject, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "SpObject_ExceptionMethod" "', argument " "1"" of type '" "SpObject *""'"); 
  }
  arg1 = reinterpret_cast< SpObject * >(argp1);
...
SWIGINTERN void swig_delete_SpObject(void *obj) {
SpObject *arg1 = (SpObject *) obj;
delete arg1;
}
static swig_method swig_SpObject_methods[] = {
    {"getFooBar", _wrap_SpObject_getFooBar}, 
    {"dummy", _wrap_SpObject_dummy}, 
    {"ExceptionMethod", _wrap_SpObject_ExceptionMethod}, 
    {0,0}
};
static swig_attribute swig_SpObject_attributes[] = {
    {0,0,0}
};
static swig_class *swig_SpObject_bases[] = {0};
static const char * swig_SpObject_base_names[] = {0};
static swig_class _wrap_class_SpObject = { "SpObject", &SWIGTYPE_p_SpObject,_wrap_new_SpObject, swig_delete_SpObject, swig_SpObject_methods, swig_SpObject_attributes, swig_SpObject_bases,swig_SpObject_base_names, &swig_module };

static swig_command_info swig_commands[] = {
    { SWIG_prefix "new_SpObject", (swig_wrapper_func) _wrap_new_SpObject, NULL},
    { SWIG_prefix "delete_SpObject", (swig_wrapper_func) _wrap_delete_SpObject, NULL},
    { SWIG_prefix "SpObject_getFooBar", (swig_wrapper_func) _wrap_SpObject_getFooBar, NULL},
    { SWIG_prefix "SpObject_dummy", (swig_wrapper_func) _wrap_SpObject_dummy, NULL},
    { SWIG_prefix "SpObject_ExceptionMethod", (swig_wrapper_func) _wrap_SpObject_ExceptionMethod, NULL},
    { SWIG_prefix "SpObject", (swig_wrapper_func) SWIG_ObjectConstructor, (ClientData)&_wrap_class_SpObject},
    {0, 0, 0}
};
...
static swig_type_info _swigt__p_SpObject = {"_p_SpObject", "SpObject *", 0, 0, (void*)&_wrap_class_SpObject, 0};
...
SWIGEXPORT int Director_extend_SafeInit(Tcl_Interp *interp) {
