...
#define SWIG_init    Template_typedef_cplx5_Init
...
#endif
SWIGINTERN int
_wrap_A_test1(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  A *arg1 = (A *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  complex result;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:A_test1 self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_A, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "A_test1" "', argument " "1"" of type '" "A *""'"); 
  }
  arg1 = reinterpret_cast< A * >(argp1);
  result = (arg1)->test1();
  Tcl_SetObjResult(interp,SWIG_NewInstanceObj((new complex(static_cast< const complex& >(result))), SWIGTYPE_p_std__complexT_double_t, SWIG_POINTER_OWN | 0 ));
  return TCL_OK;
fail:
  return TCL_ERROR;
}
...
SWIGINTERN int
_wrap_A_test2(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  A *arg1 = (A *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  std::complex< double > result;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:A_test2 self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_A, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "A_test2" "', argument " "1"" of type '" "A *""'"); 
  }
  arg1 = reinterpret_cast< A * >(argp1);
  result = (arg1)->test2();
  Tcl_SetObjResult(interp,SWIG_NewInstanceObj((new std::complex< double >(static_cast< const std::complex< double >& >(result))), SWIGTYPE_p_std__complexT_double_t, SWIG_POINTER_OWN | 0 ));
  return TCL_OK;
fail:
  return TCL_ERROR;
}
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "A_test1", (swig_wrapper_func) _wrap_A_test1, NULL},
    { SWIG_prefix "A_test2", (swig_wrapper_func) _wrap_A_test2, NULL},
...
SWIGEXPORT int Template_typedef_cplx5_SafeInit(Tcl_Interp *interp) {
