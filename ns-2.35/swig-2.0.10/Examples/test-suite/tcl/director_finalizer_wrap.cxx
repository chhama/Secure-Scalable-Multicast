...
#define SWIG_init    Director_finalizer_Init
...
SWIGINTERN int
_wrap_Foo_orStatus(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Foo *arg1 = (Foo *) 0 ;
  int arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (SWIG_GetArgs(interp, objc, objv,"oo:Foo_orStatus self x ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Foo, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Foo_orStatus" "', argument " "1"" of type '" "Foo *""'"); 
  }
  arg1 = reinterpret_cast< Foo * >(argp1);
  ecode2 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[2], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "Foo_orStatus" "', argument " "2"" of type '" "int""'");
  } 
...
SWIGINTERN int
_wrap_deleteFoo(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Foo *arg1 = (Foo *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:deleteFoo f ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Foo, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "deleteFoo" "', argument " "1"" of type '" "Foo *""'"); 
  }
  arg1 = reinterpret_cast< Foo * >(argp1);
  deleteFoo(arg1);
...
_wrap_getStatus(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (SWIG_GetArgs(interp, objc, objv,":getStatus ") == TCL_ERROR) SWIG_fail;
...
SWIGINTERN int
_wrap_resetStatus(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  if (SWIG_GetArgs(interp, objc, objv,":resetStatus ") == TCL_ERROR) SWIG_fail;
  resetStatus();
...
static swig_command_info swig_commands[] = {
    ...
    { SWIG_prefix "Foo_orStatus", (swig_wrapper_func) _wrap_Foo_orStatus, NULL},
    ...
    { SWIG_prefix "deleteFoo", (swig_wrapper_func) _wrap_deleteFoo, NULL},
    { SWIG_prefix "getStatus", (swig_wrapper_func) _wrap_getStatus, NULL},
    { SWIG_prefix "launder", (swig_wrapper_func) _wrap_launder, NULL},
    { SWIG_prefix "resetStatus", (swig_wrapper_func) _wrap_resetStatus, NULL},
    {0, 0, 0}
};
...
SWIGEXPORT int Director_finalizer_SafeInit(Tcl_Interp *interp) {
