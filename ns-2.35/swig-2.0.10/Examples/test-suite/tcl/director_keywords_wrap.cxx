...
#define SWIG_init    Director_keywords_Init
...
_wrap_Foo_bar(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (SWIG_GetArgs(interp, objc, objv,"oo:Foo_bar self abstract ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
...
SWIGEXPORT int Director_keywords_SafeInit(Tcl_Interp *interp) {
