...
#define SWIG_init    Li_constraints_Init
...
#endif
SWIGINTERN int
_wrap_test_nonnegative(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  double arg1 ;
  double val1 ;
  int ecode1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:test_nonnegative NONNEGATIVE ",(void *)0) == TCL_ERROR) SWIG_fail;
  ecode1 = SWIG_AsVal_double SWIG_TCL_CALL_ARGS_2(objv[1], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "test_nonnegative" "', argument " "1"" of type '" "double""'");
  } 
  arg1 = (double)(val1);
  {
    if (arg1 < 0) {
...
SWIGINTERN int
_wrap_test_nonpositive(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  double arg1 ;
  double val1 ;
  int ecode1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:test_nonpositive NONPOSITIVE ",(void *)0) == TCL_ERROR) SWIG_fail;
  ecode1 = SWIG_AsVal_double SWIG_TCL_CALL_ARGS_2(objv[1], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "test_nonpositive" "', argument " "1"" of type '" "double""'");
  } 
  arg1 = (double)(val1);
  {
    if (arg1 > 0) {
...
SWIGINTERN int
_wrap_test_positive(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  double arg1 ;
  double val1 ;
  int ecode1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:test_positive POSITIVE ",(void *)0) == TCL_ERROR) SWIG_fail;
  ecode1 = SWIG_AsVal_double SWIG_TCL_CALL_ARGS_2(objv[1], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "test_positive" "', argument " "1"" of type '" "double""'");
  } 
  arg1 = (double)(val1);
  {
    if (arg1 <= 0) {
...
SWIGINTERN int
_wrap_test_negative(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  double arg1 ;
  double val1 ;
  int ecode1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:test_negative POSITIVE ",(void *)0) == TCL_ERROR) SWIG_fail;
  ecode1 = SWIG_AsVal_double SWIG_TCL_CALL_ARGS_2(objv[1], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "test_negative" "', argument " "1"" of type '" "double""'");
  } 
  arg1 = (double)(val1);
  {
    if (arg1 <= 0) {
...
SWIGINTERN int
_wrap_test_nonzero(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  double arg1 ;
  double val1 ;
  int ecode1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:test_nonzero NONZERO ",(void *)0) == TCL_ERROR) SWIG_fail;
  ecode1 = SWIG_AsVal_double SWIG_TCL_CALL_ARGS_2(objv[1], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "test_nonzero" "', argument " "1"" of type '" "double""'");
  } 
  arg1 = (double)(val1);
  {
    if (arg1 == 0) {
...
SWIGINTERN int
_wrap_test_nonnull(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  void *arg1 = (void *) 0 ;
  int res1 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:test_nonnull NONNULL ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1],SWIG_as_voidptrptr(&arg1), 0, 0);
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "test_nonnull" "', argument " "1"" of type '" "void *""'"); 
  }
  {
    if (!arg1) {
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "test_nonnegative", (swig_wrapper_func) _wrap_test_nonnegative, NULL},
    { SWIG_prefix "test_nonpositive", (swig_wrapper_func) _wrap_test_nonpositive, NULL},
    { SWIG_prefix "test_positive", (swig_wrapper_func) _wrap_test_positive, NULL},
    { SWIG_prefix "test_negative", (swig_wrapper_func) _wrap_test_negative, NULL},
    { SWIG_prefix "test_nonzero", (swig_wrapper_func) _wrap_test_nonzero, NULL},
    { SWIG_prefix "test_nonnull", (swig_wrapper_func) _wrap_test_nonnull, NULL},
    {0, 0, 0}
};
...
SWIGEXPORT int Li_constraints_SafeInit(Tcl_Interp *interp) {
