...
#define SWIGTYPE_p_mapT_int_int_t swig_types[1]
#define SWIGTYPE_p_vectorT_int_t swig_types[2]
#define SWIGTYPE_p_vectorT_unsigned_int_t swig_types[3]
...
#define SWIG_init    Template_whitespace_Init
...
_wrap_foo(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (SWIG_GetArgs(interp, objc, objv,"o:foo v ",(void *)0) == TCL_ERROR) SWIG_fail;
  {
    res1 = SWIG_ConvertPtr(objv[1], &argp1, SWIGTYPE_p_vectorT_int_t,  0 );
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "foo" "', argument " "1"" of type '" "vector< int >""'"); 
    }  
    if (!argp1) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "foo" "', argument " "1"" of type '" "vector< int >""'");
    } else {
...
_wrap_bar(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (SWIG_GetArgs(interp, objc, objv,"o:bar v ",(void *)0) == TCL_ERROR) SWIG_fail;
  {
    res1 = SWIG_ConvertPtr(objv[1], &argp1, SWIGTYPE_p_vectorT_unsigned_int_t,  0 );
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "bar" "', argument " "1"" of type '" "vector< unsigned int >""'"); 
    }  
    if (!argp1) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "bar" "', argument " "1"" of type '" "vector< unsigned int >""'");
    } else {
...
_wrap_baz(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (SWIG_GetArgs(interp, objc, objv,"o:baz p ",(void *)0) == TCL_ERROR) SWIG_fail;
  {
    res1 = SWIG_ConvertPtr(objv[1], &argp1, SWIGTYPE_p_mapT_int_int_t,  0 );
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "baz" "', argument " "1"" of type '" "map< int,int >""'"); 
    }  
    if (!argp1) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "baz" "', argument " "1"" of type '" "map< int,int >""'");
    } else {
      arg1 = *(reinterpret_cast< map< int,int > * >(argp1));
    }
  }
  baz(arg1);
...
SWIGEXPORT int Template_whitespace_SafeInit(Tcl_Interp *interp) {
