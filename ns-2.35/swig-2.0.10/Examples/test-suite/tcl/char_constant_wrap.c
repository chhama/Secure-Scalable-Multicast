...
#define SWIG_init    Char_constant_Init
...
extern "C" {
#endif
SWIGINTERN const char *_wrap_ia_get(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2, int flags) {
  Tcl_Obj *value = 0;
  
  value = SWIG_From_int((int)(ia));
  if (value) {
...
SWIGINTERN const char *_wrap_ib_get(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2, int flags) {
  Tcl_Obj *value = 0;
  
  value = SWIG_From_int((int)(ib));
  if (value) {
    Tcl_SetVar2(interp,name1,name2,Tcl_GetStringFromObj(value,NULL), flags);
    Tcl_DecrRefCount(value);
  }
...
static swig_var_info swig_variables[] = {
    { SWIG_prefix "ia", 0, (swig_variable_func) _wrap_ia_get,(swig_variable_func) swig_readonly},
    { SWIG_prefix "ib", 0, (swig_variable_func) _wrap_ib_get,(swig_variable_func) swig_readonly},
    {0,0,0,0}
};
...
SWIGEXPORT int SWIG_init(Tcl_Interp *interp) {
  ...
  SWIG_Tcl_SetConstantObj(interp, "CHAR_CONSTANT", SWIG_From_char((char)('x')));
  SWIG_Tcl_SetConstantObj(interp, "STRING_CONSTANT", SWIG_FromCharPtr("xyzzy"));
  SWIG_Tcl_SetConstantObj(interp, "ESC_CONST", SWIG_From_char((char)('\1')));
  SWIG_Tcl_SetConstantObj(interp, "NULL_CONST", SWIG_From_char((char)('\0')));
  SWIG_Tcl_SetConstantObj(interp, "SPECIALCHAR", SWIG_From_char((char)('\341')));
  return TCL_OK;
}
SWIGEXPORT int Char_constant_SafeInit(Tcl_Interp *interp) {
