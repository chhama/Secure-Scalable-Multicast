...
#define SWIG_init    Overload_method_Init
...
_wrap_Base_method(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (SWIG_GetArgs(interp, objc, objv,"o:Base_method self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Base, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Base_method" "', argument " "1"" of type '" "Base const *""'"); 
  }
...
SWIGINTERN int
_wrap_Base_overloaded_method__SWIG_0(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Base *arg1 = (Base *) 0 ;
  int arg2 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (SWIG_GetArgs(interp, objc, objv,"oo:Base_overloaded_method self aArg ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Base, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Base_overloaded_method" "', argument " "1"" of type '" "Base *""'"); 
  }
  arg1 = reinterpret_cast< Base * >(argp1);
  ecode2 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[2], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "Base_overloaded_method" "', argument " "2"" of type '" "int""'");
  } 
...
SWIGINTERN int
_wrap_Base_overloaded_method__SWIG_1(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Base *arg1 = (Base *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  int result;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:Base_overloaded_method self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Base, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Base_overloaded_method" "', argument " "1"" of type '" "Base const *""'"); 
  }
  arg1 = reinterpret_cast< Base * >(argp1);
...
SWIGINTERN int
_wrap_Base_overloaded_method(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (argc == 1) {
    ...
    if (_v) {
      return _wrap_Base_overloaded_method__SWIG_1(clientData, interp, objc, argv - 1);
    }
  }
  if (argc == 2) {
    int _v;
    ...
    if (_v) {
      ...
      if (_v) {
        return _wrap_Base_overloaded_method__SWIG_0(clientData, interp, objc, argv - 1);
      }
    }
  }
  
  Tcl_SetResult(interp,(char *) "Wrong number or type of arguments for overloaded function 'Base_overloaded_method'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    Base::overloaded_method(int)\n"
    "    Base::overloaded_method() const\n", TCL_STATIC);
  return TCL_ERROR;
}
...
static swig_method swig_Base_methods[] = {
    ...
    {"overloaded_method", _wrap_Base_overloaded_method}, 
    {0,0}
};
...
static swig_command_info swig_commands[] = {
    ...
    { SWIG_prefix "Base_overloaded_method", (swig_wrapper_func) _wrap_Base_overloaded_method, NULL},
...
SWIGEXPORT int Overload_method_SafeInit(Tcl_Interp *interp) {
