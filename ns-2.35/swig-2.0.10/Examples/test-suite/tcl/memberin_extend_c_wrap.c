...
#define SWIG_init    Memberin_extend_c_Init
...
#endif
SWIGINTERN int
_wrap_Person_name_set(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (SWIG_GetArgs(interp, objc, objv,"oo:Person_name_set self name ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  ...
  arg1 = (Person *)(argp1);
  res2 = SWIG_AsCharArray(objv[2], temp2, 50);
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "Person_name_set" "', argument " "2"" of type '" "char [50]""'");
  }
  arg2 = (char *)(temp2);
...
SWIGINTERN int
_wrap_Person_name_get(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Person *arg1 = (Person *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  char *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:Person_name_get self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_Person, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
static swig_attribute swig_Person_attributes[] = {
    { "-name",_wrap_Person_name_get, _wrap_Person_name_set},
    {0,0,0}
};
static swig_class *swig_Person_bases[] = {0};
static const char * swig_Person_base_names[] = {0};
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "Person_name_set", (swig_wrapper_func) _wrap_Person_name_set, NULL},
    { SWIG_prefix "Person_name_get", (swig_wrapper_func) _wrap_Person_name_get, NULL},
...
SWIGEXPORT int Memberin_extend_c_SafeInit(Tcl_Interp *interp) {
