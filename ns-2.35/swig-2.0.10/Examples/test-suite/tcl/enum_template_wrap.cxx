...
#define SWIGTYPE_p_CTemplT_ETest_t swig_types[0]
...
#define SWIG_init    Enum_template_Init
...
#endif
SWIGINTERN int
_wrap_TakeETest(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ETest arg1 ;
  int val1 ;
  int ecode1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:TakeETest test ",(void *)0) == TCL_ERROR) SWIG_fail;
  ecode1 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[1], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "TakeETest" "', argument " "1"" of type '" "ETest""'");
  } 
  arg1 = static_cast< ETest >(val1);
  TakeETest(arg1);
...
SWIGINTERN int
_wrap_MakeETest(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ETest result;
  
  if (SWIG_GetArgs(interp, objc, objv,":MakeETest ") == TCL_ERROR) SWIG_fail;
...
SWIGINTERN int
_wrap_new_CTempl_ETest(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  CTempl< ETest > *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,":new_CTempl_ETest ") == TCL_ERROR) SWIG_fail;
  result = (CTempl< ETest > *)new CTempl< ETest >();
  Tcl_SetObjResult(interp, SWIG_NewInstanceObj( SWIG_as_voidptr(result), SWIGTYPE_p_CTemplT_ETest_t,0));
  return TCL_OK;
fail:
  return TCL_ERROR;
}
...
SWIGINTERN int
_wrap_delete_CTempl_ETest(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  CTempl< ETest > *arg1 = (CTempl< ETest > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:delete_CTempl_ETest self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_CTemplT_ETest_t, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_CTempl_ETest" "', argument " "1"" of type '" "CTempl< ETest > *""'"); 
  }
  arg1 = reinterpret_cast< CTempl< ETest > * >(argp1);
  delete arg1;
...
SWIGINTERN void swig_delete_CTempl_ETest(void *obj) {
CTempl< ETest > *arg1 = (CTempl< ETest > *) obj;
delete arg1;
}
static swig_method swig_CTempl_Sl_ETest_Sg__methods[] = {
    {0,0}
};
static swig_attribute swig_CTempl_Sl_ETest_Sg__attributes[] = {
    {0,0,0}
};
static swig_class *swig_CTempl_Sl_ETest_Sg__bases[] = {0};
static const char * swig_CTempl_Sl_ETest_Sg__base_names[] = {0};
static swig_class _wrap_class_CTempl_Sl_ETest_Sg_ = { "CTempl_ETest", &SWIGTYPE_p_CTemplT_ETest_t,_wrap_new_CTempl_ETest, swig_delete_CTempl_ETest, swig_CTempl_Sl_ETest_Sg__methods, swig_CTempl_Sl_ETest_Sg__attributes, swig_CTempl_Sl_ETest_Sg__bases,swig_CTempl_Sl_ETest_Sg__base_names, &swig_module };

static swig_command_info swig_commands[] = {
    { SWIG_prefix "TakeETest", (swig_wrapper_func) _wrap_TakeETest, NULL},
    { SWIG_prefix "MakeETest", (swig_wrapper_func) _wrap_MakeETest, NULL},
    { SWIG_prefix "new_CTempl_ETest", (swig_wrapper_func) _wrap_new_CTempl_ETest, NULL},
    { SWIG_prefix "delete_CTempl_ETest", (swig_wrapper_func) _wrap_delete_CTempl_ETest, NULL},
    { SWIG_prefix "CTempl_ETest", (swig_wrapper_func) SWIG_ObjectConstructor, (ClientData)&_wrap_class_CTempl_Sl_ETest_Sg_},
    {0, 0, 0}
};
...
static swig_type_info _swigt__p_CTemplT_ETest_t = {"_p_CTemplT_ETest_t", "CTempl< enum ETest > *|CTempl< ETest > *", 0, 0, (void*)&_wrap_class_CTempl_Sl_ETest_Sg_, 0};
...
SWIGEXPORT int SWIG_init(Tcl_Interp *interp) {
  ...
  SWIG_Tcl_SetConstantObj(interp, "eTest0", SWIG_From_int(static_cast< int >(eTest0)));
  SWIG_Tcl_SetConstantObj(interp, "eTest1", SWIG_From_int(static_cast< int >(eTest1)));
  SWIG_Tcl_SetConstantObj(interp, "eTest2", SWIG_From_int(static_cast< int >(eTest2)));
  return TCL_OK;
}
SWIGEXPORT int Enum_template_SafeInit(Tcl_Interp *interp) {
