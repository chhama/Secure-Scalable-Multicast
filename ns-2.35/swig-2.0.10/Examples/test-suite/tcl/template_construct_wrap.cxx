...
#define SWIG_init    Template_construct_Init
...
_wrap_new_Foo_int(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (SWIG_GetArgs(interp, objc, objv,"o:new_Foo_int x ",(void *)0) == TCL_ERROR) SWIG_fail;
  ecode1 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[1], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "new_Foo_int" "', argument " "1"" of type '" "int""'");
  } 
...
SWIGEXPORT int Template_construct_SafeInit(Tcl_Interp *interp) {
