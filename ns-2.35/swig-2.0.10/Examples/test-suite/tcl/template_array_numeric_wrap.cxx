...
#define SWIG_init    Template_array_numeric_Init
...
#endif
SWIGINTERN int
_wrap_new_Array4f__SWIG_0(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Arrayf< 4 > *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,":new_Array4f ") == TCL_ERROR) SWIG_fail;
  result = (Arrayf< 4 > *)new Arrayf< 4 >();
  Tcl_SetObjResult(interp, SWIG_NewInstanceObj( SWIG_as_voidptr(result), SWIGTYPE_p_ArrayfT_4_t,0));
  return TCL_OK;
fail:
  return TCL_ERROR;
}
...
SWIGINTERN int
_wrap_new_Array4f__SWIG_1(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  float *arg1 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  Arrayf< 4 > *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:new_Array4f l ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_float, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "new_Array4f" "', argument " "1"" of type '" "float const [4]""'"); 
  } 
...
SWIGINTERN int
_wrap_new_Array4f(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Tcl_Obj *CONST *argv = objv+1;
  int argc = objc-1;
  if (argc == 0) {
    return _wrap_new_Array4f__SWIG_0(clientData, interp, objc, argv - 1);
  }
  if (argc == 1) {
    int _v;
    void *vptr = 0;
    ...
    if (_v) {
      return _wrap_new_Array4f__SWIG_1(clientData, interp, objc, argv - 1);
    }
  }
  
  Tcl_SetResult(interp,(char *) "Wrong number or type of arguments for overloaded function 'new_Array4f'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    Arrayf< 4 >::Arrayf()\n"
    "    Arrayf< 4 >::Arrayf(float const [4])\n", TCL_STATIC);
  return TCL_ERROR;
}


SWIGINTERN int
_wrap_delete_Array4f(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  Arrayf< 4 > *arg1 = (Arrayf< 4 > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:delete_Array4f self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_ArrayfT_4_t, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_Array4f" "', argument " "1"" of type '" "Arrayf< 4 > *""'"); 
  }
  arg1 = reinterpret_cast< Arrayf< 4 > * >(argp1);
  delete arg1;
...
SWIGINTERN void swig_delete_Array4f(void *obj) {
Arrayf< 4 > *arg1 = (Arrayf< 4 > *) obj;
delete arg1;
}
static swig_method swig_Arrayf_Sl_4_Sg__methods[] = {
    {0,0}
};
static swig_attribute swig_Arrayf_Sl_4_Sg__attributes[] = {
    {0,0,0}
};
static swig_class *swig_Arrayf_Sl_4_Sg__bases[] = {0};
static const char * swig_Arrayf_Sl_4_Sg__base_names[] = {0};
static swig_class _wrap_class_Arrayf_Sl_4_Sg_ = { "Array4f", &SWIGTYPE_p_ArrayfT_4_t,_wrap_new_Array4f, swig_delete_Array4f, swig_Arrayf_Sl_4_Sg__methods, swig_Arrayf_Sl_4_Sg__attributes, swig_Arrayf_Sl_4_Sg__bases,swig_Arrayf_Sl_4_Sg__base_names, &swig_module };
SWIGINTERN int
_wrap_make_array4f(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  float *arg1 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  Arrayf< 4 > result;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:make_array4f l ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_float, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "make_array4f" "', argument " "1"" of type '" "float const [4]""'"); 
  } 
  arg1 = reinterpret_cast< float * >(argp1);
  result = make_arrayf< 4 >((float const (*))arg1);
  Tcl_SetObjResult(interp,SWIG_NewInstanceObj((new Arrayf< 4 >(static_cast< const Arrayf< 4 >& >(result))), SWIGTYPE_p_ArrayfT_4_t, SWIG_POINTER_OWN | 0 ));
  return TCL_OK;
fail:
  return TCL_ERROR;
}
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "new_Array4f", (swig_wrapper_func) _wrap_new_Array4f, NULL},
    { SWIG_prefix "delete_Array4f", (swig_wrapper_func) _wrap_delete_Array4f, NULL},
    { SWIG_prefix "Array4f", (swig_wrapper_func) SWIG_ObjectConstructor, (ClientData)&_wrap_class_Arrayf_Sl_4_Sg_},
    { SWIG_prefix "make_array4f", (swig_wrapper_func) _wrap_make_array4f, NULL},
    {0, 0, 0}
};
...
static swig_type_info _swigt__p_ArrayfT_4_t = {"_p_ArrayfT_4_t", "Arrayf< 4 > *|Array4f *", 0, 0, (void*)&_wrap_class_Arrayf_Sl_4_Sg_, 0};
...
SWIGEXPORT int Template_array_numeric_SafeInit(Tcl_Interp *interp) {
