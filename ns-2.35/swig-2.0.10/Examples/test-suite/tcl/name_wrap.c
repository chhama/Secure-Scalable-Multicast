...
#endif
SWIGINTERN int
_wrap_foo_2(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  if (SWIG_GetArgs(interp, objc, objv,":foo_2 ") == TCL_ERROR) SWIG_fail;
  foo_1();
...
SWIGINTERN const char *_wrap_bar_2_get(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2, int flags) {
  Tcl_Obj *value = 0;
  
  value = SWIG_From_int((int)(bar_1));
  if (value) {
...
SWIGINTERN const char *_wrap_bar_2_set(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, char *name1, char *name2 SWIGUNUSED, int flags) {
  Tcl_Obj *value = 0;
  Tcl_Obj *name1o = 0;
  ...
  if (!value) SWIG_fail;
  {
    ...
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), "in variable '""bar_1""' of type '""int""'");
    }
    bar_1 = (int)(val);
  }
  return NULL;
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "foo_2", (swig_wrapper_func) _wrap_foo_2, NULL},
    {0, 0, 0}
};

static swig_var_info swig_variables[] = {
    { SWIG_prefix "bar_2", 0, (swig_variable_func) _wrap_bar_2_get,(swig_variable_func) _wrap_bar_2_set},
    {0,0,0,0}
};
...
SWIGEXPORT int SWIG_init(Tcl_Interp *interp) {
  ...
  SWIG_Tcl_SetConstantObj(interp, "Baz_2", SWIG_From_int((int)(47)));
  return TCL_OK;
}
SWIGEXPORT int Name_SafeInit(Tcl_Interp *interp) {
