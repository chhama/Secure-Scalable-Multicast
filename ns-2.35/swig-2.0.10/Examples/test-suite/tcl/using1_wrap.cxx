...
_wrap_spam(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "spam" "', argument " "1"" of type '" "X::Foo::value_type""'");
  } 
  arg1 = static_cast< X::Foo::value_type >(val1);
...
SWIGEXPORT int Using1_SafeInit(Tcl_Interp *interp) {
