...
#define SWIG_init    Private_assign_Init
...
_wrap_blah(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (SWIG_GetArgs(interp, objc, objv,":blah ") == TCL_ERROR) SWIG_fail;
  result = blah();
...
SWIGINTERN int
_wrap_delete_TROOT(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  TROOT *arg1 = (TROOT *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:delete_TROOT self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_TROOT, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_TROOT" "', argument " "1"" of type '" "TROOT *""'"); 
  }
  arg1 = reinterpret_cast< TROOT * >(argp1);
  delete arg1;
...
SWIGINTERN void swig_delete_TROOT(void *obj) {
TROOT *arg1 = (TROOT *) obj;
delete arg1;
}
static swig_method swig_TROOT_methods[] = {
    {0,0}
};
static swig_attribute swig_TROOT_attributes[] = {
    {0,0,0}
};
static swig_class *swig_TROOT_bases[] = {0};
static const char * swig_TROOT_base_names[] = {0};
static swig_class _wrap_class_TROOT = { "TROOT", &SWIGTYPE_p_TROOT,0, swig_delete_TROOT, swig_TROOT_methods, swig_TROOT_attributes, swig_TROOT_bases,swig_TROOT_base_names, &swig_module };
SWIGINTERN int
...
static swig_command_info swig_commands[] = {
    ...
    { SWIG_prefix "delete_TROOT", (swig_wrapper_func) _wrap_delete_TROOT, NULL},
    { SWIG_prefix "TROOT", (swig_wrapper_func) SWIG_ObjectConstructor, (ClientData)&_wrap_class_TROOT},
...
static swig_type_info _swigt__p_TROOT = {"_p_TROOT", "TROOT *", 0, 0, (void*)&_wrap_class_TROOT, 0};
...
SWIGEXPORT int Private_assign_SafeInit(Tcl_Interp *interp) {
