...
#define SWIG_init    Multi_import_a_Init
...
#endif
SWIGINTERN int
_wrap_ZZZ_testz(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ZZZ *arg1 = (ZZZ *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  int result;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:ZZZ_testz self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_ZZZ, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ZZZ_testz" "', argument " "1"" of type '" "ZZZ *""'"); 
  }
  arg1 = reinterpret_cast< ZZZ * >(argp1);
...
SWIGINTERN int
_wrap_new_ZZZ(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ZZZ *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,":new_ZZZ ") == TCL_ERROR) SWIG_fail;
  result = (ZZZ *)new ZZZ();
  Tcl_SetObjResult(interp, SWIG_NewInstanceObj( SWIG_as_voidptr(result), SWIGTYPE_p_ZZZ,0));
  return TCL_OK;
fail:
  return TCL_ERROR;
}
...
SWIGINTERN int
_wrap_delete_ZZZ(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ZZZ *arg1 = (ZZZ *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:delete_ZZZ self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_ZZZ, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_ZZZ" "', argument " "1"" of type '" "ZZZ *""'"); 
  }
  arg1 = reinterpret_cast< ZZZ * >(argp1);
  delete arg1;
...
SWIGINTERN void swig_delete_ZZZ(void *obj) {
ZZZ *arg1 = (ZZZ *) obj;
delete arg1;
}
static swig_method swig_ZZZ_methods[] = {
    {"testz", _wrap_ZZZ_testz}, 
    {0,0}
};
static swig_attribute swig_ZZZ_attributes[] = {
    {0,0,0}
};
static swig_class *swig_ZZZ_bases[] = {0,0};
static const char * swig_ZZZ_base_names[] = {"XXX *",0};
static swig_class _wrap_class_ZZZ = { "ZZZ", &SWIGTYPE_p_ZZZ,_wrap_new_ZZZ, swig_delete_ZZZ, swig_ZZZ_methods, swig_ZZZ_attributes, swig_ZZZ_bases,swig_ZZZ_base_names, &swig_module };

static swig_command_info swig_commands[] = {
    { SWIG_prefix "ZZZ_testz", (swig_wrapper_func) _wrap_ZZZ_testz, NULL},
    { SWIG_prefix "new_ZZZ", (swig_wrapper_func) _wrap_new_ZZZ, NULL},
    { SWIG_prefix "delete_ZZZ", (swig_wrapper_func) _wrap_delete_ZZZ, NULL},
    { SWIG_prefix "ZZZ", (swig_wrapper_func) SWIG_ObjectConstructor, (ClientData)&_wrap_class_ZZZ},
    {0, 0, 0}
};
...
static swig_type_info _swigt__p_ZZZ = {"_p_ZZZ", "ZZZ *", 0, 0, (void*)&_wrap_class_ZZZ, 0};
...
SWIGEXPORT int Multi_import_a_SafeInit(Tcl_Interp *interp) {
