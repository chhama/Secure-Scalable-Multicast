...
#define SWIG_init    Extern_c_Init
...
#endif
SWIGINTERN int
_wrap_RealFunction(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  int arg1 ;
  int val1 ;
  int ecode1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:RealFunction value ",(void *)0) == TCL_ERROR) SWIG_fail;
  ecode1 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[1], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "RealFunction" "', argument " "1"" of type '" "int""'");
  } 
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "RealFunction", (swig_wrapper_func) _wrap_RealFunction, NULL},
    {0, 0, 0}
};
...
SWIGEXPORT int Extern_c_SafeInit(Tcl_Interp *interp) {
