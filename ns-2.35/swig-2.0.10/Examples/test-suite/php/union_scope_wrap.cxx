...
#define SWIGTYPE_p_nRState swig_types[0]
...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(union_scope)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(union_scope)
ZEND_DECLARE_MODULE_GLOBALS(union_scope)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(union_scope_globals_id, zend_union_scope_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(union_scope_globals_id, zend_union_scope_globals *, error_code )
#else
#define SWIG_ErrorMsg() (union_scope_globals.error_msg)
#define SWIG_ErrorCode() (union_scope_globals.error_code)
#endif
...
static void union_scope_init_globals(zend_union_scope_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void union_scope_destroy_globals(zend_union_scope_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_union_scope_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_union_scope_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
static swig_type_info _swigt__p_nRState = {"_p_nRState", "nRState *", 0, 0, (void*)0, 0};

static swig_type_info *swig_type_initial[] = {
  &_swigt__p_nRState,
};

static swig_cast_info _swigc__p_nRState[] = {  {&_swigt__p_nRState, 0, 0, 0},{0, 0, 0, 0}};
...
/* end header section */
/* vdecl subsection */
static int le_swig__p_nRState=0; /* handle for nRState */
/* end vdecl subsection */
/* wrapper section */
ZEND_NAMED_FUNCTION(_wrap_new_nRState) {
  nRState *result = 0 ;
  ...
  SWIG_SetPointerZval(return_value, (void *)result, SWIGTYPE_p_nRState, 1);
...
static void __wrap_delete_nRState(zend_rsrc_list_entry *rsrc, const char *type_name TSRMLS_DC) {
  swig_object_wrapper *value=(swig_object_wrapper *) rsrc->ptr ;
  void *ptr=value->ptr ;
  int newobject=value->newobject ;
  nRState *arg1 = (nRState *) 0 ;
  
  efree(value);
  if (! newobject) return; /* can't delete it! */
  arg1 = (nRState *)SWIG_ZTS_ConvertResourceData(ptr,type_name,SWIGTYPE_p_nRState TSRMLS_CC);
  if (! arg1) zend_error(E_ERROR, "nRState resource already free'd");
  delete arg1;
  return;
fail:
  SWIG_FAIL();
...
static ZEND_RSRC_DTOR_FUNC(_wrap_destroy_p_nRState) {
  __wrap_delete_nRState(rsrc, SWIGTYPE_p_nRState->name TSRMLS_CC);
}
/* end wrapper section */
...
static zend_function_entry union_scope_functions[] = {
 SWIG_ZEND_NAMED_FE(new_nrstate,_wrap_new_nRState,NULL)
 SWIG_ZEND_NAMED_FE(swig_union_scope_alter_newobject,_wrap_swig_union_scope_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_union_scope_get_newobject,_wrap_swig_union_scope_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry union_scope_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"union_scope",
    union_scope_functions,
    PHP_MINIT(union_scope),
    PHP_MSHUTDOWN(union_scope),
    PHP_RINIT(union_scope),
    PHP_RSHUTDOWN(union_scope),
    PHP_MINFO(union_scope),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &union_scope_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &union_scope_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(union_scope)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(union_scope, union_scope_init_globals, union_scope_destroy_globals);

/* Register resource destructors for pointer types */
le_swig__p_nRState=zend_register_list_destructors_ex(_wrap_destroy_p_nRState,NULL,(char *)(SWIGTYPE_p_nRState->name),module_number);
SWIG_TypeClientData(SWIGTYPE_p_nRState,&le_swig__p_nRState);
...
PHP_RINIT_FUNCTION(union_scope)
{
/* rinit section */
...
PHP_MSHUTDOWN_FUNCTION(union_scope)
{
/* shutdown section */
#ifdef ZTS
    ts_free_id(union_scope_globals_id);
#endif
    return SUCCESS;
}

PHP_RSHUTDOWN_FUNCTION(union_scope)
{
/* rshutdown section */
...
PHP_MINFO_FUNCTION(union_scope)
{
}
/* end init section */
