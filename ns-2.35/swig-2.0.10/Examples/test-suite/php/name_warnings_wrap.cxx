...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(name_warnings)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(name_warnings)
ZEND_DECLARE_MODULE_GLOBALS(name_warnings)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(name_warnings_globals_id, zend_name_warnings_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(name_warnings_globals_id, zend_name_warnings_globals *, error_code )
#else
#define SWIG_ErrorMsg() (name_warnings_globals.error_msg)
#define SWIG_ErrorCode() (name_warnings_globals.error_code)
#endif
...
static void name_warnings_init_globals(zend_name_warnings_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void name_warnings_destroy_globals(zend_name_warnings_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_name_warnings_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_name_warnings_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
#define SWIG_name  "name_warnings"
#ifdef __cplusplus
extern "C" {
#endif
#include "php.h"
...
static swig_type_info _swigt__p_complex = {"_p_complex", "complex *|None *", 0, 0, (void*)0, 0};
...
static int le_swig__p_complex=0; /* handle for _p_complex */
...
ZEND_NAMED_FUNCTION(_wrap_A_func) {
  ...
  
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_A, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of A_func. Expected SWIGTYPE_p_A");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
  result = (int)(arg1)->func();
  {
...
static ZEND_RSRC_DTOR_FUNC(_wrap_destroy_p_complex) {
  /* No destructor for simple type _p_complex */
  efree(rsrc->ptr);
}
...
static zend_function_entry name_warnings_functions[] = {
 SWIG_ZEND_NAMED_FE(a_func,_wrap_A_func,NULL)
 SWIG_ZEND_NAMED_FE(max_i,_wrap_max_i,NULL)
 SWIG_ZEND_NAMED_FE(foo,_wrap_foo,NULL)
 SWIG_ZEND_NAMED_FE(bar,_wrap_bar,NULL)
 SWIG_ZEND_NAMED_FE(swig_name_warnings_alter_newobject,_wrap_swig_name_warnings_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_name_warnings_get_newobject,_wrap_swig_name_warnings_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry name_warnings_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"name_warnings",
    name_warnings_functions,
    PHP_MINIT(name_warnings),
    PHP_MSHUTDOWN(name_warnings),
    PHP_RINIT(name_warnings),
    PHP_RSHUTDOWN(name_warnings),
    PHP_MINFO(name_warnings),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &name_warnings_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &name_warnings_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(name_warnings)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(name_warnings, name_warnings_init_globals, name_warnings_destroy_globals);
...
le_swig__p_complex=zend_register_list_destructors_ex(_wrap_destroy_p_complex,NULL,(char *)(SWIGTYPE_p_complex->name),module_number);
SWIG_TypeClientData(SWIGTYPE_p_complex,&le_swig__p_complex);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(name_warnings_globals_id);
#endif
    return SUCCESS;
}
