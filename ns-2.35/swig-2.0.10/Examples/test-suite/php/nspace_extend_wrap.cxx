...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(nspace_extend)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(nspace_extend)
ZEND_DECLARE_MODULE_GLOBALS(nspace_extend)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(nspace_extend_globals_id, zend_nspace_extend_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(nspace_extend_globals_id, zend_nspace_extend_globals *, error_code )
#else
#define SWIG_ErrorMsg() (nspace_extend_globals.error_msg)
#define SWIG_ErrorCode() (nspace_extend_globals.error_code)
#endif
...
static void nspace_extend_init_globals(zend_nspace_extend_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void nspace_extend_destroy_globals(zend_nspace_extend_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_nspace_extend_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_nspace_extend_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
#define SWIG_name  "nspace_extend"
#ifdef __cplusplus
extern "C" {
#endif
#include "php.h"
...
static zend_function_entry nspace_extend_functions[] = {
 SWIG_ZEND_NAMED_FE(swig_nspace_extend_alter_newobject,_wrap_swig_nspace_extend_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_nspace_extend_get_newobject,_wrap_swig_nspace_extend_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry nspace_extend_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"nspace_extend",
    nspace_extend_functions,
    PHP_MINIT(nspace_extend),
    PHP_MSHUTDOWN(nspace_extend),
    PHP_RINIT(nspace_extend),
    PHP_RSHUTDOWN(nspace_extend),
    PHP_MINFO(nspace_extend),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &nspace_extend_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &nspace_extend_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(nspace_extend)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(nspace_extend, nspace_extend_init_globals, nspace_extend_destroy_globals);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(nspace_extend_globals_id);
#endif
    return SUCCESS;
}
