...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(li_typemaps)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(li_typemaps)
ZEND_DECLARE_MODULE_GLOBALS(li_typemaps)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(li_typemaps_globals_id, zend_li_typemaps_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(li_typemaps_globals_id, zend_li_typemaps_globals *, error_code )
#else
#define SWIG_ErrorMsg() (li_typemaps_globals.error_msg)
#define SWIG_ErrorCode() (li_typemaps_globals.error_code)
#endif
...
static void li_typemaps_init_globals(zend_li_typemaps_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void li_typemaps_destroy_globals(zend_li_typemaps_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_li_typemaps_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_li_typemaps_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
ZEND_NAMED_FUNCTION(_wrap_Foo_a_set) {
  ...
  
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_Foo, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of Foo_a_set. Expected SWIGTYPE_p_Foo");
    }
  }
...
ZEND_NAMED_FUNCTION(_wrap_Foo_a_get) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_Foo, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of Foo_a_get. Expected SWIGTYPE_p_Foo");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
  result = (int) ((arg1)->a);
...
static zend_function_entry li_typemaps_functions[] = {
 SWIG_ZEND_NAMED_FE(foo_a_set,_wrap_Foo_a_set,NULL)
 SWIG_ZEND_NAMED_FE(foo_a_get,_wrap_Foo_a_get,NULL)
 SWIG_ZEND_NAMED_FE(new_foo,_wrap_new_Foo,NULL)
 SWIG_ZEND_NAMED_FE(in_bool,_wrap_in_bool,NULL)
 SWIG_ZEND_NAMED_FE(in_int,_wrap_in_int,NULL)
 SWIG_ZEND_NAMED_FE(in_long,_wrap_in_long,NULL)
 SWIG_ZEND_NAMED_FE(in_short,_wrap_in_short,NULL)
 SWIG_ZEND_NAMED_FE(in_uint,_wrap_in_uint,NULL)
 SWIG_ZEND_NAMED_FE(in_ushort,_wrap_in_ushort,NULL)
 SWIG_ZEND_NAMED_FE(in_ulong,_wrap_in_ulong,NULL)
 SWIG_ZEND_NAMED_FE(in_uchar,_wrap_in_uchar,NULL)
 SWIG_ZEND_NAMED_FE(in_schar,_wrap_in_schar,NULL)
 SWIG_ZEND_NAMED_FE(in_float,_wrap_in_float,NULL)
 SWIG_ZEND_NAMED_FE(in_double,_wrap_in_double,NULL)
 SWIG_ZEND_NAMED_FE(in_longlong,_wrap_in_longlong,NULL)
 SWIG_ZEND_NAMED_FE(in_ulonglong,_wrap_in_ulonglong,NULL)
 SWIG_ZEND_NAMED_FE(inr_bool,_wrap_inr_bool,NULL)
 SWIG_ZEND_NAMED_FE(inr_int,_wrap_inr_int,NULL)
 SWIG_ZEND_NAMED_FE(inr_long,_wrap_inr_long,NULL)
 SWIG_ZEND_NAMED_FE(inr_short,_wrap_inr_short,NULL)
 SWIG_ZEND_NAMED_FE(inr_uint,_wrap_inr_uint,NULL)
 SWIG_ZEND_NAMED_FE(inr_ushort,_wrap_inr_ushort,NULL)
 SWIG_ZEND_NAMED_FE(inr_ulong,_wrap_inr_ulong,NULL)
 SWIG_ZEND_NAMED_FE(inr_uchar,_wrap_inr_uchar,NULL)
 SWIG_ZEND_NAMED_FE(inr_schar,_wrap_inr_schar,NULL)
 SWIG_ZEND_NAMED_FE(inr_float,_wrap_inr_float,NULL)
 SWIG_ZEND_NAMED_FE(inr_double,_wrap_inr_double,NULL)
 SWIG_ZEND_NAMED_FE(inr_longlong,_wrap_inr_longlong,NULL)
 SWIG_ZEND_NAMED_FE(inr_ulonglong,_wrap_inr_ulonglong,NULL)
 SWIG_ZEND_NAMED_FE(out_bool,_wrap_out_bool,NULL)
 SWIG_ZEND_NAMED_FE(out_int,_wrap_out_int,NULL)
 SWIG_ZEND_NAMED_FE(out_short,_wrap_out_short,NULL)
 SWIG_ZEND_NAMED_FE(out_long,_wrap_out_long,NULL)
 SWIG_ZEND_NAMED_FE(out_uint,_wrap_out_uint,NULL)
 SWIG_ZEND_NAMED_FE(out_ushort,_wrap_out_ushort,NULL)
 SWIG_ZEND_NAMED_FE(out_ulong,_wrap_out_ulong,NULL)
 SWIG_ZEND_NAMED_FE(out_uchar,_wrap_out_uchar,NULL)
 SWIG_ZEND_NAMED_FE(out_schar,_wrap_out_schar,NULL)
 SWIG_ZEND_NAMED_FE(out_float,_wrap_out_float,NULL)
 SWIG_ZEND_NAMED_FE(out_double,_wrap_out_double,NULL)
 SWIG_ZEND_NAMED_FE(out_longlong,_wrap_out_longlong,NULL)
 SWIG_ZEND_NAMED_FE(out_ulonglong,_wrap_out_ulonglong,NULL)
 SWIG_ZEND_NAMED_FE(out_foo,_wrap_out_foo,NULL)
 SWIG_ZEND_NAMED_FE(outr_bool,_wrap_outr_bool,NULL)
 SWIG_ZEND_NAMED_FE(outr_int,_wrap_outr_int,NULL)
 SWIG_ZEND_NAMED_FE(outr_short,_wrap_outr_short,NULL)
 SWIG_ZEND_NAMED_FE(outr_long,_wrap_outr_long,NULL)
 SWIG_ZEND_NAMED_FE(outr_uint,_wrap_outr_uint,NULL)
 SWIG_ZEND_NAMED_FE(outr_ushort,_wrap_outr_ushort,NULL)
 SWIG_ZEND_NAMED_FE(outr_ulong,_wrap_outr_ulong,NULL)
 SWIG_ZEND_NAMED_FE(outr_uchar,_wrap_outr_uchar,NULL)
 SWIG_ZEND_NAMED_FE(outr_schar,_wrap_outr_schar,NULL)
 SWIG_ZEND_NAMED_FE(outr_float,_wrap_outr_float,NULL)
 SWIG_ZEND_NAMED_FE(outr_double,_wrap_outr_double,NULL)
 SWIG_ZEND_NAMED_FE(outr_longlong,_wrap_outr_longlong,NULL)
 SWIG_ZEND_NAMED_FE(outr_ulonglong,_wrap_outr_ulonglong,NULL)
 SWIG_ZEND_NAMED_FE(inout_bool,_wrap_inout_bool,NULL)
 SWIG_ZEND_NAMED_FE(inout_int,_wrap_inout_int,NULL)
 SWIG_ZEND_NAMED_FE(inout_short,_wrap_inout_short,NULL)
 SWIG_ZEND_NAMED_FE(inout_long,_wrap_inout_long,NULL)
 SWIG_ZEND_NAMED_FE(inout_uint,_wrap_inout_uint,NULL)
 SWIG_ZEND_NAMED_FE(inout_ushort,_wrap_inout_ushort,NULL)
 SWIG_ZEND_NAMED_FE(inout_ulong,_wrap_inout_ulong,NULL)
 SWIG_ZEND_NAMED_FE(inout_uchar,_wrap_inout_uchar,NULL)
 SWIG_ZEND_NAMED_FE(inout_schar,_wrap_inout_schar,NULL)
 SWIG_ZEND_NAMED_FE(inout_float,_wrap_inout_float,NULL)
 SWIG_ZEND_NAMED_FE(inout_double,_wrap_inout_double,NULL)
 SWIG_ZEND_NAMED_FE(inout_longlong,_wrap_inout_longlong,NULL)
 SWIG_ZEND_NAMED_FE(inout_ulonglong,_wrap_inout_ulonglong,NULL)
 SWIG_ZEND_NAMED_FE(inoutr_bool,_wrap_inoutr_bool,NULL)
 SWIG_ZEND_NAMED_FE(inoutr_int,_wrap_inoutr_int,NULL)
 SWIG_ZEND_NAMED_FE(inoutr_short,_wrap_inoutr_short,NULL)
 SWIG_ZEND_NAMED_FE(inoutr_long,_wrap_inoutr_long,NULL)
 SWIG_ZEND_NAMED_FE(inoutr_uint,_wrap_inoutr_uint,NULL)
 SWIG_ZEND_NAMED_FE(inoutr_ushort,_wrap_inoutr_ushort,NULL)
 SWIG_ZEND_NAMED_FE(inoutr_ulong,_wrap_inoutr_ulong,NULL)
 SWIG_ZEND_NAMED_FE(inoutr_uchar,_wrap_inoutr_uchar,NULL)
 SWIG_ZEND_NAMED_FE(inoutr_schar,_wrap_inoutr_schar,NULL)
 SWIG_ZEND_NAMED_FE(inoutr_float,_wrap_inoutr_float,NULL)
 SWIG_ZEND_NAMED_FE(inoutr_double,_wrap_inoutr_double,NULL)
 SWIG_ZEND_NAMED_FE(inoutr_longlong,_wrap_inoutr_longlong,NULL)
 SWIG_ZEND_NAMED_FE(inoutr_ulonglong,_wrap_inoutr_ulonglong,NULL)
 SWIG_ZEND_NAMED_FE(inoutr_int2,_wrap_inoutr_int2,NULL)
 SWIG_ZEND_NAMED_FE(swig_li_typemaps_alter_newobject,_wrap_swig_li_typemaps_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_li_typemaps_get_newobject,_wrap_swig_li_typemaps_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry li_typemaps_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"li_typemaps",
    li_typemaps_functions,
    PHP_MINIT(li_typemaps),
    PHP_MSHUTDOWN(li_typemaps),
    PHP_RINIT(li_typemaps),
    PHP_RSHUTDOWN(li_typemaps),
    PHP_MINFO(li_typemaps),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &li_typemaps_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &li_typemaps_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(li_typemaps)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(li_typemaps, li_typemaps_init_globals, li_typemaps_destroy_globals);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(li_typemaps_globals_id);
#endif
    return SUCCESS;
}
