...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(cast_operator)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(cast_operator)
ZEND_DECLARE_MODULE_GLOBALS(cast_operator)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(cast_operator_globals_id, zend_cast_operator_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(cast_operator_globals_id, zend_cast_operator_globals *, error_code )
#else
#define SWIG_ErrorMsg() (cast_operator_globals.error_msg)
#define SWIG_ErrorCode() (cast_operator_globals.error_code)
#endif
...
static void cast_operator_init_globals(zend_cast_operator_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void cast_operator_destroy_globals(zend_cast_operator_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_cast_operator_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_cast_operator_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
#define SWIG_name  "cast_operator"
#ifdef __cplusplus
extern "C" {
#endif
#include "php.h"
...
ZEND_NAMED_FUNCTION(_wrap_A_tochar) {
  ...
  
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_A, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of A_tochar. Expected SWIGTYPE_p_A");
    }
  }
...
static zend_function_entry cast_operator_functions[] = {
 SWIG_ZEND_NAMED_FE(a_tochar,_wrap_A_tochar,NULL)
 SWIG_ZEND_NAMED_FE(new_a,_wrap_new_A,NULL)
 SWIG_ZEND_NAMED_FE(swig_cast_operator_alter_newobject,_wrap_swig_cast_operator_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_cast_operator_get_newobject,_wrap_swig_cast_operator_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry cast_operator_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"cast_operator",
    cast_operator_functions,
    PHP_MINIT(cast_operator),
    PHP_MSHUTDOWN(cast_operator),
    PHP_RINIT(cast_operator),
    PHP_RSHUTDOWN(cast_operator),
    PHP_MINFO(cast_operator),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &cast_operator_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &cast_operator_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(cast_operator)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(cast_operator, cast_operator_init_globals, cast_operator_destroy_globals);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(cast_operator_globals_id);
#endif
    return SUCCESS;
}
