...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(constover)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(constover)
ZEND_DECLARE_MODULE_GLOBALS(constover)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(constover_globals_id, zend_constover_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(constover_globals_id, zend_constover_globals *, error_code )
#else
#define SWIG_ErrorMsg() (constover_globals.error_msg)
#define SWIG_ErrorCode() (constover_globals.error_code)
#endif
...
static void constover_init_globals(zend_constover_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void constover_destroy_globals(zend_constover_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_constover_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_constover_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
ZEND_NAMED_FUNCTION(_wrap_Foo_test_pconst) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_Foo, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of Foo_test_pconst. Expected SWIGTYPE_p_Foo");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
...
ZEND_NAMED_FUNCTION(_wrap_Foo_test_constm) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_Foo, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of Foo_test_constm. Expected SWIGTYPE_p_Foo");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
...
ZEND_NAMED_FUNCTION(_wrap_Foo_test_pconstm) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_Foo, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of Foo_test_pconstm. Expected SWIGTYPE_p_Foo");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
...
static zend_function_entry constover_functions[] = {
 SWIG_ZEND_NAMED_FE(test,_wrap_test,NULL)
 SWIG_ZEND_NAMED_FE(test_pconst,_wrap_test_pconst,NULL)
 SWIG_ZEND_NAMED_FE(new_foo,_wrap_new_Foo,NULL)
 SWIG_ZEND_NAMED_FE(foo_test,_wrap_Foo_test,NULL)
 SWIG_ZEND_NAMED_FE(foo_test_pconst,_wrap_Foo_test_pconst,NULL)
 SWIG_ZEND_NAMED_FE(foo_test_constm,_wrap_Foo_test_constm,NULL)
 SWIG_ZEND_NAMED_FE(foo_test_pconstm,_wrap_Foo_test_pconstm,NULL)
 SWIG_ZEND_NAMED_FE(swig_constover_alter_newobject,_wrap_swig_constover_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_constover_get_newobject,_wrap_swig_constover_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry constover_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"constover",
    constover_functions,
    PHP_MINIT(constover),
    PHP_MSHUTDOWN(constover),
    PHP_RINIT(constover),
    PHP_RSHUTDOWN(constover),
    PHP_MINFO(constover),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &constover_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &constover_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(constover)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(constover, constover_init_globals, constover_destroy_globals);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(constover_globals_id);
#endif
    return SUCCESS;
}
