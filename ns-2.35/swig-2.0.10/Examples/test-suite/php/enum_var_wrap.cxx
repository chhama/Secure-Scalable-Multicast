...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(enum_var)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(enum_var)
ZEND_DECLARE_MODULE_GLOBALS(enum_var)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(enum_var_globals_id, zend_enum_var_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(enum_var_globals_id, zend_enum_var_globals *, error_code )
#else
#define SWIG_ErrorMsg() (enum_var_globals.error_msg)
#define SWIG_ErrorCode() (enum_var_globals.error_code)
#endif
...
static void enum_var_init_globals(zend_enum_var_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void enum_var_destroy_globals(zend_enum_var_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_enum_var_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_enum_var_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
static zend_function_entry enum_var_functions[] = {
 SWIG_ZEND_NAMED_FE(test_set,_wrap_test_set,NULL)
 SWIG_ZEND_NAMED_FE(test_get,_wrap_test_get,NULL)
 SWIG_ZEND_NAMED_FE(swig_enum_var_alter_newobject,_wrap_swig_enum_var_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_enum_var_get_newobject,_wrap_swig_enum_var_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry enum_var_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"enum_var",
    enum_var_functions,
    PHP_MINIT(enum_var),
    PHP_MSHUTDOWN(enum_var),
    PHP_RINIT(enum_var),
    PHP_RSHUTDOWN(enum_var),
    PHP_MINFO(enum_var),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &enum_var_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &enum_var_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(enum_var)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(enum_var, enum_var_init_globals, enum_var_destroy_globals);
...
/* cinit subsection */
SWIG_LONG_CONSTANT(APPLE, APPLE);
SWIG_LONG_CONSTANT(PEAR, PEAR);
...
/* vinit subsection */
{
  ...
  MAKE_STD_ZVAL(z_var);
  z_var->type = IS_LONG;
  z_var->value.lval = test;
  zend_hash_add(&EG(symbol_table), (char*)"test", sizeof("test"), (void *)&z_var, sizeof(zval *), NULL);
}
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(enum_var_globals_id);
#endif
    return SUCCESS;
}
