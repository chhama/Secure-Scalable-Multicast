...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(empty)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(empty)
ZEND_DECLARE_MODULE_GLOBALS(empty)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(empty_globals_id, zend_empty_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(empty_globals_id, zend_empty_globals *, error_code )
#else
#define SWIG_ErrorMsg() (empty_globals.error_msg)
#define SWIG_ErrorCode() (empty_globals.error_code)
#endif
...
static void empty_init_globals(zend_empty_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void empty_destroy_globals(zend_empty_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_empty_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_empty_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
static zend_function_entry empty_functions[] = {
 SWIG_ZEND_NAMED_FE(swig_empty_alter_newobject,_wrap_swig_empty_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_empty_get_newobject,_wrap_swig_empty_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry empty_module_entry = {
...
zend_module_entry* SWIG_module_entry = &empty_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &empty_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(empty)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(empty, empty_init_globals, empty_destroy_globals);
