...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(li_cdata)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(li_cdata)
ZEND_DECLARE_MODULE_GLOBALS(li_cdata)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(li_cdata_globals_id, zend_li_cdata_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(li_cdata_globals_id, zend_li_cdata_globals *, error_code )
#else
#define SWIG_ErrorMsg() (li_cdata_globals.error_msg)
#define SWIG_ErrorCode() (li_cdata_globals.error_code)
#endif
...
static void li_cdata_init_globals(zend_li_cdata_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void li_cdata_destroy_globals(zend_li_cdata_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_li_cdata_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_li_cdata_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
static SWIGCDATA cdata_int(int *ptr, int nelements) {
...
static SWIGCDATA cdata_double(double *ptr, int nelements) {
...
ZEND_NAMED_FUNCTION(_wrap_cdata) {
  ...
  
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, 0, 0) < 0) {
      ...
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of cdata. Expected SWIGTYPE_p_p_void");
    }
  }
  if(arg_count > 1) {
  ...
  {
    ZVAL_STRINGL(return_value, (&result)->data, (&result)->len, 1);
  }
  return;
fail:
  SWIG_FAIL();
...
ZEND_NAMED_FUNCTION(_wrap_memmove) {
  ...
  
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, 0, 0) < 0) {
      ...
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of memmove. Expected SWIGTYPE_p_p_void");
    }
  }
  {
    convert_to_string_ex(args[1]);
    arg2 = (void *) Z_STRVAL_PP(args[1]);
...
ZEND_NAMED_FUNCTION(_wrap_cdata_int) {
  ...
  
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_int, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of cdata_int. Expected SWIGTYPE_p_int");
    }
  }
  if(arg_count > 1) {
    /*@SWIG:/home/chhama/Dropbox/mtp/o-ns-allinone-2.35.1/ns-2.35/swig-2.0.10/Lib/php/utils.i,7,CONVERT_INT_IN@*/
...
ZEND_NAMED_FUNCTION(_wrap_cdata_double) {
  ...
  
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_double, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of cdata_double. Expected SWIGTYPE_p_double");
    }
  }
  if(arg_count > 1) {
    /*@SWIG:/home/chhama/Dropbox/mtp/o-ns-allinone-2.35.1/ns-2.35/swig-2.0.10/Lib/php/utils.i,7,CONVERT_INT_IN@*/
...
static zend_function_entry li_cdata_functions[] = {
 SWIG_ZEND_NAMED_FE(cdata,_wrap_cdata,NULL)
 SWIG_ZEND_NAMED_FE(memmove,_wrap_memmove,NULL)
 SWIG_ZEND_NAMED_FE(cdata_int,_wrap_cdata_int,NULL)
 SWIG_ZEND_NAMED_FE(cdata_double,_wrap_cdata_double,NULL)
 SWIG_ZEND_NAMED_FE(malloc,_wrap_malloc,NULL)
 SWIG_ZEND_NAMED_FE(swig_li_cdata_alter_newobject,_wrap_swig_li_cdata_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_li_cdata_get_newobject,_wrap_swig_li_cdata_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry li_cdata_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"li_cdata",
    li_cdata_functions,
    PHP_MINIT(li_cdata),
    PHP_MSHUTDOWN(li_cdata),
    PHP_RINIT(li_cdata),
    PHP_RSHUTDOWN(li_cdata),
    PHP_MINFO(li_cdata),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &li_cdata_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &li_cdata_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(li_cdata)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(li_cdata, li_cdata_init_globals, li_cdata_destroy_globals);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(li_cdata_globals_id);
#endif
    return SUCCESS;
}
