...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(wallkw)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(wallkw)
ZEND_DECLARE_MODULE_GLOBALS(wallkw)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(wallkw_globals_id, zend_wallkw_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(wallkw_globals_id, zend_wallkw_globals *, error_code )
#else
#define SWIG_ErrorMsg() (wallkw_globals.error_msg)
#define SWIG_ErrorCode() (wallkw_globals.error_code)
#endif
...
static void wallkw_init_globals(zend_wallkw_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void wallkw_destroy_globals(zend_wallkw_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_wallkw_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_wallkw_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
static zend_function_entry wallkw_functions[] = {
 SWIG_ZEND_NAMED_FE(c_clone,_wrap_c_clone,NULL)
 SWIG_ZEND_NAMED_FE(_delegate,_wrap__delegate,NULL)
 SWIG_ZEND_NAMED_FE(_pass,_wrap__pass,NULL)
 SWIG_ZEND_NAMED_FE(_alias,_wrap__alias,NULL)
 SWIG_ZEND_NAMED_FE(c_rescue,_wrap_C_rescue,NULL)
 SWIG_ZEND_NAMED_FE(swig_wallkw_alter_newobject,_wrap_swig_wallkw_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_wallkw_get_newobject,_wrap_swig_wallkw_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry wallkw_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"wallkw",
    wallkw_functions,
    PHP_MINIT(wallkw),
    PHP_MSHUTDOWN(wallkw),
    PHP_RINIT(wallkw),
    PHP_RSHUTDOWN(wallkw),
    PHP_MINFO(wallkw),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &wallkw_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &wallkw_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(wallkw)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(wallkw, wallkw_init_globals, wallkw_destroy_globals);
