...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(arrayref)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(arrayref)
ZEND_DECLARE_MODULE_GLOBALS(arrayref)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(arrayref_globals_id, zend_arrayref_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(arrayref_globals_id, zend_arrayref_globals *, error_code )
#else
#define SWIG_ErrorMsg() (arrayref_globals.error_msg)
#define SWIG_ErrorCode() (arrayref_globals.error_code)
#endif
...
static void arrayref_init_globals(zend_arrayref_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void arrayref_destroy_globals(zend_arrayref_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_arrayref_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_arrayref_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
ZEND_NAMED_FUNCTION(_wrap_foo) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_a_10__int, 0) < 0 || arg1 == NULL) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of foo. Expected SWIGTYPE_p_a_10__int");
    }
  }
...
ZEND_NAMED_FUNCTION(_wrap_bar) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_a_10__int, 0) < 0 || arg1 == NULL) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of bar. Expected SWIGTYPE_p_a_10__int");
    }
  }
  bar((int (&)[10])*arg1);
...
static zend_function_entry arrayref_functions[] = {
 SWIG_ZEND_NAMED_FE(foo,_wrap_foo,NULL)
 SWIG_ZEND_NAMED_FE(bar,_wrap_bar,NULL)
 SWIG_ZEND_NAMED_FE(swig_arrayref_alter_newobject,_wrap_swig_arrayref_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_arrayref_get_newobject,_wrap_swig_arrayref_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry arrayref_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"arrayref",
    arrayref_functions,
    PHP_MINIT(arrayref),
    PHP_MSHUTDOWN(arrayref),
    PHP_RINIT(arrayref),
    PHP_RSHUTDOWN(arrayref),
    PHP_MINFO(arrayref),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &arrayref_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &arrayref_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(arrayref)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(arrayref, arrayref_init_globals, arrayref_destroy_globals);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(arrayref_globals_id);
#endif
    return SUCCESS;
}
