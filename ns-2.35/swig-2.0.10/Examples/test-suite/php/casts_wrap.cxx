...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(casts)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(casts)
ZEND_DECLARE_MODULE_GLOBALS(casts)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(casts_globals_id, zend_casts_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(casts_globals_id, zend_casts_globals *, error_code )
#else
#define SWIG_ErrorMsg() (casts_globals.error_msg)
#define SWIG_ErrorCode() (casts_globals.error_code)
#endif
...
static void casts_init_globals(zend_casts_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void casts_destroy_globals(zend_casts_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_casts_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_casts_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
static zend_function_entry casts_functions[] = {
 ...
 SWIG_ZEND_NAMED_FE(swig_casts_alter_newobject,_wrap_swig_casts_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_casts_get_newobject,_wrap_swig_casts_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry casts_module_entry = {
...
zend_module_entry* SWIG_module_entry = &casts_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &casts_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(casts)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(casts, casts_init_globals, casts_destroy_globals);
