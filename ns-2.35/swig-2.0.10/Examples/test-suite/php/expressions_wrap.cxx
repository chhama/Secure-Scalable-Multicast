...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(expressions)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(expressions)
ZEND_DECLARE_MODULE_GLOBALS(expressions)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(expressions_globals_id, zend_expressions_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(expressions_globals_id, zend_expressions_globals *, error_code )
#else
#define SWIG_ErrorMsg() (expressions_globals.error_msg)
#define SWIG_ErrorCode() (expressions_globals.error_code)
#endif
...
static void expressions_init_globals(zend_expressions_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void expressions_destroy_globals(zend_expressions_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_expressions_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_expressions_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
ZEND_NAMED_FUNCTION(_wrap_A_k_set) {
  A *arg1 = (A *) 0 ;
  int arg2 ;
  zval **args[2];
  ...
  
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_A, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of A_k_set. Expected SWIGTYPE_p_A");
    }
  }
...
ZEND_NAMED_FUNCTION(_wrap_A_k_get) {
  A *arg1 = (A *) 0 ;
  zval **args[1];
  int result;
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_A, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of A_k_get. Expected SWIGTYPE_p_A");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
  result = (int) ((arg1)->k);
...
static zend_function_entry expressions_functions[] = {
 SWIG_ZEND_NAMED_FE(new_a,_wrap_new_A,NULL)
 SWIG_ZEND_NAMED_FE(a_k_set,_wrap_A_k_set,NULL)
 SWIG_ZEND_NAMED_FE(a_k_get,_wrap_A_k_get,NULL)
 SWIG_ZEND_NAMED_FE(swig_expressions_alter_newobject,_wrap_swig_expressions_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_expressions_get_newobject,_wrap_swig_expressions_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry expressions_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"expressions",
    expressions_functions,
    PHP_MINIT(expressions),
    PHP_MSHUTDOWN(expressions),
    PHP_RINIT(expressions),
    PHP_RSHUTDOWN(expressions),
    PHP_MINFO(expressions),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &expressions_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &expressions_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(expressions)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(expressions, expressions_init_globals, expressions_destroy_globals);
...
PHP_RINIT_FUNCTION(expressions)
{
/* rinit section */
...
PHP_MSHUTDOWN_FUNCTION(expressions)
{
/* shutdown section */
#ifdef ZTS
    ts_free_id(expressions_globals_id);
#endif
    return SUCCESS;
}

PHP_RSHUTDOWN_FUNCTION(expressions)
{
/* rshutdown section */
...
PHP_MINFO_FUNCTION(expressions)
{
}
/* end init section */
