...
#define SWIGTYPE_p_Rect swig_types[0]
...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(typemap_delete)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(typemap_delete)
ZEND_DECLARE_MODULE_GLOBALS(typemap_delete)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(typemap_delete_globals_id, zend_typemap_delete_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(typemap_delete_globals_id, zend_typemap_delete_globals *, error_code )
#else
#define SWIG_ErrorMsg() (typemap_delete_globals.error_msg)
#define SWIG_ErrorCode() (typemap_delete_globals.error_code)
#endif
...
static void typemap_delete_init_globals(zend_typemap_delete_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void typemap_delete_destroy_globals(zend_typemap_delete_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_typemap_delete_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_typemap_delete_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
#define SWIG_name  "typemap_delete"
#ifdef __cplusplus
extern "C" {
#endif
#include "php.h"
...
/* end header section */
/* vdecl subsection */
static int le_swig__p_Rect=0; /* handle for Rect */
...
ZEND_NAMED_FUNCTION(_wrap_Rect_val_set) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_Rect, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of Rect_val_set. Expected SWIGTYPE_p_Rect");
    }
  }
...
ZEND_NAMED_FUNCTION(_wrap_Rect_val_get) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_Rect, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of Rect_val_get. Expected SWIGTYPE_p_Rect");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
  result = (int) ((arg1)->val);
...
ZEND_NAMED_FUNCTION(_wrap_new_Rect) {
  ...
  SWIG_SetPointerZval(return_value, (void *)result, SWIGTYPE_p_Rect, 1);
...
static void __wrap_delete_Rect(zend_rsrc_list_entry *rsrc, const char *type_name TSRMLS_DC) {
  ...
  arg1 = (Rect *)SWIG_ZTS_ConvertResourceData(ptr,type_name,SWIGTYPE_p_Rect TSRMLS_CC);
  if (! arg1) zend_error(E_ERROR, "Rect resource already free'd");
  delete arg1;
  return;
fail:
  SWIG_FAIL();
...
static ZEND_RSRC_DTOR_FUNC(_wrap_destroy_p_Rect) {
  __wrap_delete_Rect(rsrc, SWIGTYPE_p_Rect->name TSRMLS_CC);
}
/* end wrapper section */
...
static zend_function_entry typemap_delete_functions[] = {
 SWIG_ZEND_NAMED_FE(rect_val_set,_wrap_Rect_val_set,NULL)
 SWIG_ZEND_NAMED_FE(rect_val_get,_wrap_Rect_val_get,NULL)
 SWIG_ZEND_NAMED_FE(new_rect,_wrap_new_Rect,NULL)
 SWIG_ZEND_NAMED_FE(swig_typemap_delete_alter_newobject,_wrap_swig_typemap_delete_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_typemap_delete_get_newobject,_wrap_swig_typemap_delete_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry typemap_delete_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"typemap_delete",
    typemap_delete_functions,
    PHP_MINIT(typemap_delete),
    PHP_MSHUTDOWN(typemap_delete),
    PHP_RINIT(typemap_delete),
    PHP_RSHUTDOWN(typemap_delete),
    PHP_MINFO(typemap_delete),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &typemap_delete_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &typemap_delete_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(typemap_delete)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(typemap_delete, typemap_delete_init_globals, typemap_delete_destroy_globals);

/* Register resource destructors for pointer types */
le_swig__p_Rect=zend_register_list_destructors_ex(_wrap_destroy_p_Rect,NULL,(char *)(SWIGTYPE_p_Rect->name),module_number);
SWIG_TypeClientData(SWIGTYPE_p_Rect,&le_swig__p_Rect);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(typemap_delete_globals_id);
#endif
    return SUCCESS;
}
