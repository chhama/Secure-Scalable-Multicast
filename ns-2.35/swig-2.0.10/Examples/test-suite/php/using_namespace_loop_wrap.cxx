...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(using_namespace_loop)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(using_namespace_loop)
ZEND_DECLARE_MODULE_GLOBALS(using_namespace_loop)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(using_namespace_loop_globals_id, zend_using_namespace_loop_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(using_namespace_loop_globals_id, zend_using_namespace_loop_globals *, error_code )
#else
#define SWIG_ErrorMsg() (using_namespace_loop_globals.error_msg)
#define SWIG_ErrorCode() (using_namespace_loop_globals.error_code)
#endif
...
static void using_namespace_loop_init_globals(zend_using_namespace_loop_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void using_namespace_loop_destroy_globals(zend_using_namespace_loop_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_using_namespace_loop_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_using_namespace_loop_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
#define SWIG_name  "using_namespace_loop"
#ifdef __cplusplus
extern "C" {
#endif
#include "php.h"
...
#include "php_using_namespace_loop.h"
#ifdef __cplusplus
}
#endif
...
/* end header section */
/* vdecl subsection */
static int le_swig__p_A__Foo=0; /* handle for _p_A__Foo */
/* end vdecl subsection */
/* wrapper section */
static ZEND_RSRC_DTOR_FUNC(_wrap_destroy_p_A__Foo) {
  /* No destructor for simple type _p_A__Foo */
  efree(rsrc->ptr);
}
/* end wrapper section */
...
static zend_function_entry using_namespace_loop_functions[] = {
 SWIG_ZEND_NAMED_FE(swig_using_namespace_loop_alter_newobject,_wrap_swig_using_namespace_loop_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_using_namespace_loop_get_newobject,_wrap_swig_using_namespace_loop_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry using_namespace_loop_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"using_namespace_loop",
    using_namespace_loop_functions,
    PHP_MINIT(using_namespace_loop),
    PHP_MSHUTDOWN(using_namespace_loop),
    PHP_RINIT(using_namespace_loop),
    PHP_RSHUTDOWN(using_namespace_loop),
    PHP_MINFO(using_namespace_loop),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &using_namespace_loop_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &using_namespace_loop_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(using_namespace_loop)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(using_namespace_loop, using_namespace_loop_init_globals, using_namespace_loop_destroy_globals);

/* Register resource destructors for pointer types */
le_swig__p_A__Foo=zend_register_list_destructors_ex(_wrap_destroy_p_A__Foo,NULL,(char *)(SWIGTYPE_p_A__Foo->name),module_number);
SWIG_TypeClientData(SWIGTYPE_p_A__Foo,&le_swig__p_A__Foo);
...
PHP_RINIT_FUNCTION(using_namespace_loop)
{
/* rinit section */
...
PHP_MSHUTDOWN_FUNCTION(using_namespace_loop)
{
/* shutdown section */
#ifdef ZTS
    ts_free_id(using_namespace_loop_globals_id);
#endif
    return SUCCESS;
}

PHP_RSHUTDOWN_FUNCTION(using_namespace_loop)
{
/* rshutdown section */
...
PHP_MINFO_FUNCTION(using_namespace_loop)
{
}
/* end init section */
