...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(typedef_funcptr)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(typedef_funcptr)
ZEND_DECLARE_MODULE_GLOBALS(typedef_funcptr)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(typedef_funcptr_globals_id, zend_typedef_funcptr_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(typedef_funcptr_globals_id, zend_typedef_funcptr_globals *, error_code )
#else
#define SWIG_ErrorMsg() (typedef_funcptr_globals.error_msg)
#define SWIG_ErrorCode() (typedef_funcptr_globals.error_code)
#endif
...
static void typedef_funcptr_init_globals(zend_typedef_funcptr_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void typedef_funcptr_destroy_globals(zend_typedef_funcptr_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_typedef_funcptr_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_typedef_funcptr_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
#define SWIG_name  "typedef_funcptr"
#ifdef __cplusplus
extern "C" {
#endif
#include "php.h"
...
static swig_type_info _swigt__p_f_int_int__int = {"_p_f_int_int__int", "Integer (*)(Integer,Integer)|int (*)(int,int)", 0, 0, (void*)0, 0};
...
ZEND_NAMED_FUNCTION(_wrap_do_op) {
  Integer arg1 ;
  Integer arg2 ;
  Integer (*arg3)(Integer,Integer) = (Integer (*)(Integer,Integer)) 0 ;
  zval **args[3];
  Integer result;
...
static zend_function_entry typedef_funcptr_functions[] = {
 SWIG_ZEND_NAMED_FE(do_op,_wrap_do_op,NULL)
 SWIG_ZEND_NAMED_FE(swig_typedef_funcptr_alter_newobject,_wrap_swig_typedef_funcptr_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_typedef_funcptr_get_newobject,_wrap_swig_typedef_funcptr_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry typedef_funcptr_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"typedef_funcptr",
    typedef_funcptr_functions,
    PHP_MINIT(typedef_funcptr),
    PHP_MSHUTDOWN(typedef_funcptr),
    PHP_RINIT(typedef_funcptr),
    PHP_RSHUTDOWN(typedef_funcptr),
    PHP_MINFO(typedef_funcptr),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &typedef_funcptr_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &typedef_funcptr_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(typedef_funcptr)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(typedef_funcptr, typedef_funcptr_init_globals, typedef_funcptr_destroy_globals);
...
/* cinit subsection */
{
  zval *z_var;
  MAKE_STD_ZVAL(z_var);
  SWIG_SetPointerZval(z_var, (void*)addf, SWIGTYPE_p_f_int_int__int, 0);
  zend_constant c;
  c.value = *z_var;
  zval_copy_ctor(&c.value);
  size_t len = sizeof("addf") - 1;
  c.name = zend_strndup("addf", len);
  c.name_len = len+1;
...
}
{
  zval *z_var;
  MAKE_STD_ZVAL(z_var);
  SWIG_SetPointerZval(z_var, (void*)subf, SWIGTYPE_p_f_int_int__int, 0);
  zend_constant c;
  c.value = *z_var;
  zval_copy_ctor(&c.value);
  size_t len = sizeof("subf") - 1;
  c.name = zend_strndup("subf", len);
  c.name_len = len+1;
  c.flags = CONST_CS | CONST_PERSISTENT;
  c.module_number = module_number;
  zend_register_constant( &c TSRMLS_CC );
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(typedef_funcptr_globals_id);
#endif
    return SUCCESS;
}
