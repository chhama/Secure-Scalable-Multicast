...
#ifndef PHP_TEMPLATE_TYPEDEF_CPLX_H
#define PHP_TEMPLATE_TYPEDEF_CPLX_H

extern zend_module_entry template_typedef_cplx_module_entry;
#define phpext_template_typedef_cplx_ptr &template_typedef_cplx_module_entry

#ifdef PHP_WIN32
# define PHP_TEMPLATE_TYPEDEF_CPLX_API __declspec(dllexport)
#else
# define PHP_TEMPLATE_TYPEDEF_CPLX_API
#endif
...
PHP_MINIT_FUNCTION(template_typedef_cplx);
...
#endif /* PHP_TEMPLATE_TYPEDEF_CPLX_H */
