...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(fragments)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(fragments)
ZEND_DECLARE_MODULE_GLOBALS(fragments)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(fragments_globals_id, zend_fragments_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(fragments_globals_id, zend_fragments_globals *, error_code )
#else
#define SWIG_ErrorMsg() (fragments_globals.error_msg)
#define SWIG_ErrorCode() (fragments_globals.error_code)
#endif
...
static void fragments_init_globals(zend_fragments_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void fragments_destroy_globals(zend_fragments_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_fragments_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_fragments_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
static zend_function_entry fragments_functions[] = {
 SWIG_ZEND_NAMED_FE(bar,_wrap_bar,NULL)
 SWIG_ZEND_NAMED_FE(foo,_wrap_foo,NULL)
 SWIG_ZEND_NAMED_FE(swig_fragments_alter_newobject,_wrap_swig_fragments_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_fragments_get_newobject,_wrap_swig_fragments_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry fragments_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"fragments",
    fragments_functions,
    PHP_MINIT(fragments),
    PHP_MSHUTDOWN(fragments),
    PHP_RINIT(fragments),
    PHP_RSHUTDOWN(fragments),
    PHP_MINFO(fragments),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &fragments_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &fragments_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(fragments)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(fragments, fragments_init_globals, fragments_destroy_globals);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(fragments_globals_id);
#endif
    return SUCCESS;
}
