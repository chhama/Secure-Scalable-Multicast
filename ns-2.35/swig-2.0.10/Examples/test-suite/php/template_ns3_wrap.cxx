...
#define SWIGTYPE_p_foo__barT_int_t swig_types[0]
...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(template_ns3)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(template_ns3)
ZEND_DECLARE_MODULE_GLOBALS(template_ns3)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(template_ns3_globals_id, zend_template_ns3_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(template_ns3_globals_id, zend_template_ns3_globals *, error_code )
#else
#define SWIG_ErrorMsg() (template_ns3_globals.error_msg)
#define SWIG_ErrorCode() (template_ns3_globals.error_code)
#endif
...
static void template_ns3_init_globals(zend_template_ns3_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void template_ns3_destroy_globals(zend_template_ns3_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_template_ns3_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_template_ns3_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
/* end header section */
/* vdecl subsection */
static int le_swig__p_foo__barT_int_t=0; /* handle for bari */
static int le_swig__p_int=0; /* handle for _p_int */
/* end vdecl subsection */
/* wrapper section */
ZEND_NAMED_FUNCTION(_wrap_bari_test) {
  ...
  
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_foo__barT_int_t, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of bari_test. Expected SWIGTYPE_p_foo__barT_int_t");
    }
  }
...
ZEND_NAMED_FUNCTION(_wrap_new_bari) {
  ...
  SWIG_SetPointerZval(return_value, (void *)result, SWIGTYPE_p_foo__barT_int_t, 1);
...
static void __wrap_delete_bari(zend_rsrc_list_entry *rsrc, const char *type_name TSRMLS_DC) {
  ...
  arg1 = (foo::bar< int > *)SWIG_ZTS_ConvertResourceData(ptr,type_name,SWIGTYPE_p_foo__barT_int_t TSRMLS_CC);
  if (! arg1) zend_error(E_ERROR, "foo::bar<(int)> resource already free'd");
  delete arg1;
  return;
fail:
  SWIG_FAIL();
...
static ZEND_RSRC_DTOR_FUNC(_wrap_destroy_p_foo__barT_int_t) {
  __wrap_delete_bari(rsrc, SWIGTYPE_p_foo__barT_int_t->name TSRMLS_CC);
}
...
static zend_function_entry template_ns3_functions[] = {
 SWIG_ZEND_NAMED_FE(bari_test,_wrap_bari_test,NULL)
 SWIG_ZEND_NAMED_FE(new_bari,_wrap_new_bari,NULL)
 SWIG_ZEND_NAMED_FE(swig_template_ns3_alter_newobject,_wrap_swig_template_ns3_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_template_ns3_get_newobject,_wrap_swig_template_ns3_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry template_ns3_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"template_ns3",
    template_ns3_functions,
    PHP_MINIT(template_ns3),
    PHP_MSHUTDOWN(template_ns3),
    PHP_RINIT(template_ns3),
    PHP_RSHUTDOWN(template_ns3),
    PHP_MINFO(template_ns3),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &template_ns3_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &template_ns3_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(template_ns3)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(template_ns3, template_ns3_init_globals, template_ns3_destroy_globals);
...
PHP_RINIT_FUNCTION(template_ns3)
{
/* rinit section */
...
PHP_MSHUTDOWN_FUNCTION(template_ns3)
{
/* shutdown section */
#ifdef ZTS
    ts_free_id(template_ns3_globals_id);
#endif
    return SUCCESS;
}

PHP_RSHUTDOWN_FUNCTION(template_ns3)
{
/* rshutdown section */
...
PHP_MINFO_FUNCTION(template_ns3)
{
}
/* end init section */
