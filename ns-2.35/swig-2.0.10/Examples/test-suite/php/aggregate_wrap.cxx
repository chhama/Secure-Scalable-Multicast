...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(aggregate)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(aggregate)
ZEND_DECLARE_MODULE_GLOBALS(aggregate)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(aggregate_globals_id, zend_aggregate_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(aggregate_globals_id, zend_aggregate_globals *, error_code )
#else
#define SWIG_ErrorMsg() (aggregate_globals.error_msg)
#define SWIG_ErrorCode() (aggregate_globals.error_code)
#endif
...
static void aggregate_init_globals(zend_aggregate_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void aggregate_destroy_globals(zend_aggregate_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_aggregate_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_aggregate_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
ZEND_NAMED_FUNCTION(_wrap_move) {
  int arg1 ;
  zval **args[1];
  int result;
  ...
  SWIG_contract_assert((check_direction(arg1)), "Contract violation: require: (check_direction(arg1))");
...
static zend_function_entry aggregate_functions[] = {
 SWIG_ZEND_NAMED_FE(move,_wrap_move,NULL)
 SWIG_ZEND_NAMED_FE(swig_aggregate_alter_newobject,_wrap_swig_aggregate_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_aggregate_get_newobject,_wrap_swig_aggregate_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry aggregate_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"aggregate",
    aggregate_functions,
    PHP_MINIT(aggregate),
    PHP_MSHUTDOWN(aggregate),
    PHP_RINIT(aggregate),
    PHP_RSHUTDOWN(aggregate),
    PHP_MINFO(aggregate),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &aggregate_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &aggregate_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(aggregate)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(aggregate, aggregate_init_globals, aggregate_destroy_globals);
...
/* cinit subsection */
SWIG_LONG_CONSTANT(UP, 1);
SWIG_LONG_CONSTANT(DOWN, 2);
SWIG_LONG_CONSTANT(LEFT, 3);
SWIG_LONG_CONSTANT(RIGHT, 4);
/* end cinit subsection */

    return SUCCESS;
}

PHP_RINIT_FUNCTION(aggregate)
{
/* rinit section */
...
PHP_MSHUTDOWN_FUNCTION(aggregate)
{
/* shutdown section */
#ifdef ZTS
    ts_free_id(aggregate_globals_id);
#endif
    return SUCCESS;
}

PHP_RSHUTDOWN_FUNCTION(aggregate)
{
/* rshutdown section */
