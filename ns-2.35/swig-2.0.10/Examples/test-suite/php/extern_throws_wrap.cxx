...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(extern_throws)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(extern_throws)
ZEND_DECLARE_MODULE_GLOBALS(extern_throws)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(extern_throws_globals_id, zend_extern_throws_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(extern_throws_globals_id, zend_extern_throws_globals *, error_code )
#else
#define SWIG_ErrorMsg() (extern_throws_globals.error_msg)
#define SWIG_ErrorCode() (extern_throws_globals.error_code)
#endif
...
static void extern_throws_init_globals(zend_extern_throws_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void extern_throws_destroy_globals(zend_extern_throws_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_extern_throws_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_extern_throws_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
#define SWIG_name  "extern_throws"
#ifdef __cplusplus
extern "C" {
#endif
#include "php.h"
...
ZEND_NAMED_FUNCTION(_wrap_get) {
  ...
  try {
    ...
    (void)_e;
    zend_throw_exception(NULL, const_cast<char*>("C++ std::exception exception thrown"), 0 TSRMLS_CC);
    return;
...
static zend_function_entry extern_throws_functions[] = {
 SWIG_ZEND_NAMED_FE(get,_wrap_get,NULL)
 SWIG_ZEND_NAMED_FE(swig_extern_throws_alter_newobject,_wrap_swig_extern_throws_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_extern_throws_get_newobject,_wrap_swig_extern_throws_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry extern_throws_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"extern_throws",
    extern_throws_functions,
    PHP_MINIT(extern_throws),
    PHP_MSHUTDOWN(extern_throws),
    PHP_RINIT(extern_throws),
    PHP_RSHUTDOWN(extern_throws),
    PHP_MINFO(extern_throws),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &extern_throws_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &extern_throws_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(extern_throws)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(extern_throws, extern_throws_init_globals, extern_throws_destroy_globals);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(extern_throws_globals_id);
#endif
    return SUCCESS;
}
