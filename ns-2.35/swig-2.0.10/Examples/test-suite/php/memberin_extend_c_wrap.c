...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(memberin_extend_c)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(memberin_extend_c)
ZEND_DECLARE_MODULE_GLOBALS(memberin_extend_c)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(memberin_extend_c_globals_id, zend_memberin_extend_c_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(memberin_extend_c_globals_id, zend_memberin_extend_c_globals *, error_code )
#else
#define SWIG_ErrorMsg() (memberin_extend_c_globals.error_msg)
#define SWIG_ErrorCode() (memberin_extend_c_globals.error_code)
#endif
...
static void memberin_extend_c_init_globals(zend_memberin_extend_c_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void memberin_extend_c_destroy_globals(zend_memberin_extend_c_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_memberin_extend_c_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_memberin_extend_c_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
#define SWIG_name  "memberin_extend_c"
#ifdef __cplusplus
extern "C" {
#endif
#include "php.h"
...
#include "php_memberin_extend_c.h"
#ifdef __cplusplus
}
#endif
...
ZEND_NAMED_FUNCTION(_wrap_Person_name_set) {
  ...
  
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_Person, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of Person_name_set. Expected SWIGTYPE_p_Person");
    }
  }
...
ZEND_NAMED_FUNCTION(_wrap_Person_name_get) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_Person, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of Person_name_get. Expected SWIGTYPE_p_Person");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
...
static zend_function_entry memberin_extend_c_functions[] = {
 SWIG_ZEND_NAMED_FE(person_name_set,_wrap_Person_name_set,NULL)
 SWIG_ZEND_NAMED_FE(person_name_get,_wrap_Person_name_get,NULL)
 SWIG_ZEND_NAMED_FE(new_person,_wrap_new_Person,NULL)
 SWIG_ZEND_NAMED_FE(swig_memberin_extend_c_alter_newobject,_wrap_swig_memberin_extend_c_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_memberin_extend_c_get_newobject,_wrap_swig_memberin_extend_c_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry memberin_extend_c_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"memberin_extend_c",
    memberin_extend_c_functions,
    PHP_MINIT(memberin_extend_c),
    PHP_MSHUTDOWN(memberin_extend_c),
    PHP_RINIT(memberin_extend_c),
    PHP_RSHUTDOWN(memberin_extend_c),
    PHP_MINFO(memberin_extend_c),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &memberin_extend_c_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &memberin_extend_c_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(memberin_extend_c)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(memberin_extend_c, memberin_extend_c_init_globals, memberin_extend_c_destroy_globals);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(memberin_extend_c_globals_id);
#endif
    return SUCCESS;
}
