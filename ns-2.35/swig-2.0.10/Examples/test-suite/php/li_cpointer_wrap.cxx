...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(li_cpointer)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(li_cpointer)
ZEND_DECLARE_MODULE_GLOBALS(li_cpointer)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(li_cpointer_globals_id, zend_li_cpointer_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(li_cpointer_globals_id, zend_li_cpointer_globals *, error_code )
#else
#define SWIG_ErrorMsg() (li_cpointer_globals.error_msg)
#define SWIG_ErrorCode() (li_cpointer_globals.error_code)
#endif
...
static void li_cpointer_init_globals(zend_li_cpointer_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void li_cpointer_destroy_globals(zend_li_cpointer_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_li_cpointer_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_li_cpointer_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
static int le_swig__p_doublep=0; /* handle for doublep */
...
ZEND_NAMED_FUNCTION(_wrap_delete_intp) {
  ...
  
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_int, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of delete_intp. Expected SWIGTYPE_p_int");
    }
  }
  delete_intp(arg1);
...
ZEND_NAMED_FUNCTION(_wrap_intp_assign) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_int, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of intp_assign. Expected SWIGTYPE_p_int");
    }
  }
...
ZEND_NAMED_FUNCTION(_wrap_intp_value) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_int, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of intp_value. Expected SWIGTYPE_p_int");
    }
  }
...
ZEND_NAMED_FUNCTION(_wrap_new_doublep) {
  ...
  SWIG_SetPointerZval(return_value, (void *)result, SWIGTYPE_p_doublep, 1);
...
static void __wrap_delete_doublep(zend_rsrc_list_entry *rsrc, const char *type_name TSRMLS_DC) {
  ...
  arg1 = (doublep *)SWIG_ZTS_ConvertResourceData(ptr,type_name,SWIGTYPE_p_doublep TSRMLS_CC);
  if (! arg1) zend_error(E_ERROR, "doublep resource already free'd");
  delete_doublep(arg1);
  return;
fail:
  SWIG_FAIL();
...
ZEND_NAMED_FUNCTION(_wrap_doublep_assign) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_doublep, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of doublep_assign. Expected SWIGTYPE_p_doublep");
    }
  }
...
ZEND_NAMED_FUNCTION(_wrap_doublep_value) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_doublep, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of doublep_value. Expected SWIGTYPE_p_doublep");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
...
ZEND_NAMED_FUNCTION(_wrap_doublep_cast) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_doublep, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of doublep_cast. Expected SWIGTYPE_p_doublep");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
...
ZEND_NAMED_FUNCTION(_wrap_doublep_frompointer) {
  ...
  
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_double, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of doublep_frompointer. Expected SWIGTYPE_p_double");
    }
  }
  result = (doublep *)doublep_frompointer(arg1);
  
  SWIG_SetPointerZval(return_value, (void *)result, SWIGTYPE_p_doublep, 0);
...
static ZEND_RSRC_DTOR_FUNC(_wrap_destroy_p_doublep) {
  __wrap_delete_doublep(rsrc, SWIGTYPE_p_doublep->name TSRMLS_CC);
}
/* end wrapper section */
...
static zend_function_entry li_cpointer_functions[] = {
 SWIG_ZEND_NAMED_FE(new_intp,_wrap_new_intp,NULL)
 SWIG_ZEND_NAMED_FE(copy_intp,_wrap_copy_intp,NULL)
 SWIG_ZEND_NAMED_FE(delete_intp,_wrap_delete_intp,NULL)
 SWIG_ZEND_NAMED_FE(intp_assign,_wrap_intp_assign,NULL)
 SWIG_ZEND_NAMED_FE(intp_value,_wrap_intp_value,NULL)
 SWIG_ZEND_NAMED_FE(new_doublep,_wrap_new_doublep,NULL)
 SWIG_ZEND_NAMED_FE(doublep_assign,_wrap_doublep_assign,NULL)
 SWIG_ZEND_NAMED_FE(doublep_value,_wrap_doublep_value,NULL)
 SWIG_ZEND_NAMED_FE(doublep_cast,_wrap_doublep_cast,NULL)
 SWIG_ZEND_NAMED_FE(doublep_frompointer,_wrap_doublep_frompointer,NULL)
 SWIG_ZEND_NAMED_FE(int_to_uint,_wrap_int_to_uint,NULL)
 SWIG_ZEND_NAMED_FE(swig_li_cpointer_alter_newobject,_wrap_swig_li_cpointer_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_li_cpointer_get_newobject,_wrap_swig_li_cpointer_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry li_cpointer_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"li_cpointer",
    li_cpointer_functions,
    PHP_MINIT(li_cpointer),
    PHP_MSHUTDOWN(li_cpointer),
    PHP_RINIT(li_cpointer),
    PHP_RSHUTDOWN(li_cpointer),
    PHP_MINFO(li_cpointer),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &li_cpointer_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &li_cpointer_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(li_cpointer)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(li_cpointer, li_cpointer_init_globals, li_cpointer_destroy_globals);
...
le_swig__p_doublep=zend_register_list_destructors_ex(_wrap_destroy_p_doublep,NULL,(char *)(SWIGTYPE_p_doublep->name),module_number);
SWIG_TypeClientData(SWIGTYPE_p_doublep,&le_swig__p_doublep);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(li_cpointer_globals_id);
#endif
    return SUCCESS;
}
