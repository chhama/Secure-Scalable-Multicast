...
#define SWIGTYPE_p_std__size_t swig_types[0]
...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(sizet)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(sizet)
ZEND_DECLARE_MODULE_GLOBALS(sizet)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(sizet_globals_id, zend_sizet_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(sizet_globals_id, zend_sizet_globals *, error_code )
#else
#define SWIG_ErrorMsg() (sizet_globals.error_msg)
#define SWIG_ErrorCode() (sizet_globals.error_code)
#endif
...
static void sizet_init_globals(zend_sizet_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void sizet_destroy_globals(zend_sizet_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_sizet_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_sizet_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
/* end header section */
/* vdecl subsection */
static int le_swig__p_std__size_t=0; /* handle for _p_std__size_t */
...
ZEND_NAMED_FUNCTION(_wrap_test2) {
  ...
  /*@SWIG:/home/chhama/Dropbox/mtp/o-ns-allinone-2.35.1/ns-2.35/swig-2.0.10/Lib/php/utils.i,7,CONVERT_INT_IN@*/
  convert_to_long_ex(args[0]);
  arg1 = (std::size_t) Z_LVAL_PP(args[0]);
  /*@SWIG@*/;
...
ZEND_NAMED_FUNCTION(_wrap_test3) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_std__size_t, 0) < 0 || arg1 == NULL) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of test3. Expected SWIGTYPE_p_std__size_t");
    }
  }
  result = (std::size_t *) &test3((std::size_t const &)*arg1);
  
  SWIG_SetPointerZval(return_value, (void *)result, SWIGTYPE_p_std__size_t, 0);
...
static ZEND_RSRC_DTOR_FUNC(_wrap_destroy_p_std__size_t) {
  /* No destructor for simple type _p_std__size_t */
  efree(rsrc->ptr);
}
/* end wrapper section */
...
static zend_function_entry sizet_functions[] = {
 SWIG_ZEND_NAMED_FE(test1,_wrap_test1,NULL)
 SWIG_ZEND_NAMED_FE(test2,_wrap_test2,NULL)
 SWIG_ZEND_NAMED_FE(test3,_wrap_test3,NULL)
 SWIG_ZEND_NAMED_FE(test4,_wrap_test4,NULL)
 SWIG_ZEND_NAMED_FE(swig_sizet_alter_newobject,_wrap_swig_sizet_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_sizet_get_newobject,_wrap_swig_sizet_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry sizet_module_entry = {
...
zend_module_entry* SWIG_module_entry = &sizet_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &sizet_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(sizet)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(sizet, sizet_init_globals, sizet_destroy_globals);

/* Register resource destructors for pointer types */
le_swig__p_std__size_t=zend_register_list_destructors_ex(_wrap_destroy_p_std__size_t,NULL,(char *)(SWIGTYPE_p_std__size_t->name),module_number);
SWIG_TypeClientData(SWIGTYPE_p_std__size_t,&le_swig__p_std__size_t);
