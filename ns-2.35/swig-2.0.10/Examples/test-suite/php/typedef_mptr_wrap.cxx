...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(typedef_mptr)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(typedef_mptr)
ZEND_DECLARE_MODULE_GLOBALS(typedef_mptr)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(typedef_mptr_globals_id, zend_typedef_mptr_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(typedef_mptr_globals_id, zend_typedef_mptr_globals *, error_code )
#else
#define SWIG_ErrorMsg() (typedef_mptr_globals.error_msg)
#define SWIG_ErrorCode() (typedef_mptr_globals.error_code)
#endif
...
static void typedef_mptr_init_globals(zend_typedef_mptr_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void typedef_mptr_destroy_globals(zend_typedef_mptr_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_typedef_mptr_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_typedef_mptr_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
static zend_function_entry typedef_mptr_functions[] = {
 SWIG_ZEND_NAMED_FE(swig_typedef_mptr_alter_newobject,_wrap_swig_typedef_mptr_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_typedef_mptr_get_newobject,_wrap_swig_typedef_mptr_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry typedef_mptr_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"typedef_mptr",
    typedef_mptr_functions,
    PHP_MINIT(typedef_mptr),
    PHP_MSHUTDOWN(typedef_mptr),
    PHP_RINIT(typedef_mptr),
    PHP_RSHUTDOWN(typedef_mptr),
    PHP_MINFO(typedef_mptr),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &typedef_mptr_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &typedef_mptr_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(typedef_mptr)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(typedef_mptr, typedef_mptr_init_globals, typedef_mptr_destroy_globals);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(typedef_mptr_globals_id);
#endif
    return SUCCESS;
}
