...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(argout)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(argout)
ZEND_DECLARE_MODULE_GLOBALS(argout)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(argout_globals_id, zend_argout_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(argout_globals_id, zend_argout_globals *, error_code )
#else
#define SWIG_ErrorMsg() (argout_globals.error_msg)
#define SWIG_ErrorCode() (argout_globals.error_code)
#endif
...
static void argout_init_globals(zend_argout_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void argout_destroy_globals(zend_argout_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_argout_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_argout_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
ZEND_NAMED_FUNCTION(_wrap_incp) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_int, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of incp. Expected SWIGTYPE_p_int");
    }
  }
...
ZEND_NAMED_FUNCTION(_wrap_incr) {
  ...
  
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_int, 0) < 0 || arg1 == NULL) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of incr. Expected SWIGTYPE_p_int");
    }
  }
...
ZEND_NAMED_FUNCTION(_wrap_inctr) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_int, 0) < 0 || arg1 == NULL) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of inctr. Expected SWIGTYPE_p_int");
    }
  }
  ...
  
  {
    ...
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_p_void, 0) < 0) {
      ...
      if (!((*args[0])->type==IS_NULL && PZVAL_IS_REF(*args[0]))) {
        ...
        SWIG_PHP_Error(E_ERROR, "Type error in argument $arg of voidhandle.");
      }
    }
    force1=0;
    if (arg1==NULL) {
...
ZEND_NAMED_FUNCTION(_wrap_handle) {
  ...
  
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, 0, 0) < 0) {
      ...
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of handle. Expected SWIGTYPE_p_p_void");
    }
  }
...
static zend_function_entry argout_functions[] = {
 ...
 SWIG_ZEND_NAMED_FE(incp,_wrap_incp,NULL)
 SWIG_ZEND_NAMED_FE(incr,_wrap_incr,NULL)
 SWIG_ZEND_NAMED_FE(inctr,_wrap_inctr,NULL)
 SWIG_ZEND_NAMED_FE(voidhandle,_wrap_voidhandle,NULL)
 SWIG_ZEND_NAMED_FE(handle,_wrap_handle,NULL)
 SWIG_ZEND_NAMED_FE(swig_argout_alter_newobject,_wrap_swig_argout_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_argout_get_newobject,_wrap_swig_argout_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry argout_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"argout",
    argout_functions,
    PHP_MINIT(argout),
    PHP_MSHUTDOWN(argout),
    PHP_RINIT(argout),
    PHP_RSHUTDOWN(argout),
    PHP_MINFO(argout),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &argout_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &argout_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(argout)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(argout, argout_init_globals, argout_destroy_globals);
