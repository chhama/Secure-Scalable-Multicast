...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(immutable_values)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(immutable_values)
ZEND_DECLARE_MODULE_GLOBALS(immutable_values)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(immutable_values_globals_id, zend_immutable_values_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(immutable_values_globals_id, zend_immutable_values_globals *, error_code )
#else
#define SWIG_ErrorMsg() (immutable_values_globals.error_msg)
#define SWIG_ErrorCode() (immutable_values_globals.error_code)
#endif
...
static void immutable_values_init_globals(zend_immutable_values_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void immutable_values_destroy_globals(zend_immutable_values_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_immutable_values_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_immutable_values_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
#define SWIG_name  "immutable_values"
#ifdef __cplusplus
extern "C" {
#endif
#include "php.h"
...
#include "php_immutable_values.h"
#ifdef __cplusplus
}
#endif
...
static zend_function_entry immutable_values_functions[] = {
 SWIG_ZEND_NAMED_FE(swig_immutable_values_alter_newobject,_wrap_swig_immutable_values_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_immutable_values_get_newobject,_wrap_swig_immutable_values_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry immutable_values_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"immutable_values",
    immutable_values_functions,
    PHP_MINIT(immutable_values),
    PHP_MSHUTDOWN(immutable_values),
    PHP_RINIT(immutable_values),
    PHP_RSHUTDOWN(immutable_values),
    PHP_MINFO(immutable_values),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &immutable_values_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &immutable_values_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(immutable_values)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(immutable_values, immutable_values_init_globals, immutable_values_destroy_globals);
...
/* cinit subsection */
SWIG_LONG_CONSTANT(ABC, -11);
SWIG_LONG_CONSTANT(Zero, Zero);
SWIG_LONG_CONSTANT(One, One);
SWIG_LONG_CONSTANT(Two, Two);
SWIG_LONG_CONSTANT(XYZ, -22);
SWIG_LONG_CONSTANT(Tre, Tre);
SWIG_LONG_CONSTANT(Duo, Duo);
SWIG_LONG_CONSTANT(Uno, Uno);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(immutable_values_globals_id);
#endif
    return SUCCESS;
}
