...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(langobj)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(langobj)
ZEND_DECLARE_MODULE_GLOBALS(langobj)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(langobj_globals_id, zend_langobj_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(langobj_globals_id, zend_langobj_globals *, error_code )
#else
#define SWIG_ErrorMsg() (langobj_globals.error_msg)
#define SWIG_ErrorCode() (langobj_globals.error_code)
#endif
...
static void langobj_init_globals(zend_langobj_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void langobj_destroy_globals(zend_langobj_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_langobj_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_langobj_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
ZEND_NAMED_FUNCTION(_wrap_identity) {
  ...
  
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, 0, 0) < 0) {
      ...
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of identity. Expected SWIGTYPE_p_p_void");
    }
  }
...
static zend_function_entry langobj_functions[] = {
 SWIG_ZEND_NAMED_FE(identity,_wrap_identity,NULL)
 SWIG_ZEND_NAMED_FE(swig_langobj_alter_newobject,_wrap_swig_langobj_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_langobj_get_newobject,_wrap_swig_langobj_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry langobj_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"langobj",
    langobj_functions,
    PHP_MINIT(langobj),
    PHP_MSHUTDOWN(langobj),
    PHP_RINIT(langobj),
    PHP_RSHUTDOWN(langobj),
    PHP_MINFO(langobj),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &langobj_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &langobj_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(langobj)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(langobj, langobj_init_globals, langobj_destroy_globals);
