...
#define SWIGTYPE_p_std__pairT_int_int_t swig_types[0]
...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(li_std_pair)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(li_std_pair)
ZEND_DECLARE_MODULE_GLOBALS(li_std_pair)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(li_std_pair_globals_id, zend_li_std_pair_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(li_std_pair_globals_id, zend_li_std_pair_globals *, error_code )
#else
#define SWIG_ErrorMsg() (li_std_pair_globals.error_msg)
#define SWIG_ErrorCode() (li_std_pair_globals.error_code)
#endif
...
static void li_std_pair_init_globals(zend_li_std_pair_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void li_std_pair_destroy_globals(zend_li_std_pair_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_li_std_pair_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_li_std_pair_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
/* end header section */
/* vdecl subsection */
static int le_swig__p_std__pairT_int_int_t=0; /* handle for IntPair */
/* end vdecl subsection */
/* wrapper section */
ZEND_NAMED_FUNCTION(_wrap_new_IntPair__SWIG_0) {
...
ZEND_NAMED_FUNCTION(_wrap_new_IntPair__SWIG_1) {
  int arg1 ;
  int arg2 ;
  zval **args[2];
  std::pair< int,int > *result = 0 ;
...
ZEND_NAMED_FUNCTION(_wrap_new_IntPair__SWIG_2) {
  ...
  
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_std__pairT_int_int_t, 0) < 0 || arg1 == NULL) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of new_IntPair. Expected SWIGTYPE_p_std__pairT_int_int_t");
    }
  }
...
ZEND_NAMED_FUNCTION(_wrap_new_IntPair) {
  ...
  if (argc == 0) {
    _wrap_new_IntPair__SWIG_0(INTERNAL_FUNCTION_PARAM_PASSTHRU); return;
  }
  if (argc == 1) {
    int _v;
    {
    ...
    if (_v) {
      _wrap_new_IntPair__SWIG_2(INTERNAL_FUNCTION_PARAM_PASSTHRU); return;
    }
  }
  if (argc == 2) {
    int _v;
    ...
    if (_v) {
      ...
      if (_v) {
        _wrap_new_IntPair__SWIG_1(INTERNAL_FUNCTION_PARAM_PASSTHRU); return;
      }
    }
  }
  
  SWIG_ErrorCode() = E_ERROR;
  SWIG_ErrorMsg() = "No matching function for overloaded 'new_IntPair'";
  SWIG_FAIL();
}
...
ZEND_NAMED_FUNCTION(_wrap_IntPair_first_set) {
  ...
  
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_std__pairT_int_int_t, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of IntPair_first_set. Expected SWIGTYPE_p_std__pairT_int_int_t");
    }
  }
...
ZEND_NAMED_FUNCTION(_wrap_IntPair_first_get) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_std__pairT_int_int_t, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of IntPair_first_get. Expected SWIGTYPE_p_std__pairT_int_int_t");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
...
ZEND_NAMED_FUNCTION(_wrap_IntPair_second_set) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_std__pairT_int_int_t, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of IntPair_second_set. Expected SWIGTYPE_p_std__pairT_int_int_t");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
...
ZEND_NAMED_FUNCTION(_wrap_IntPair_second_get) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_std__pairT_int_int_t, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of IntPair_second_get. Expected SWIGTYPE_p_std__pairT_int_int_t");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
...
static void __wrap_delete_IntPair(zend_rsrc_list_entry *rsrc, const char *type_name TSRMLS_DC) {
...
ZEND_NAMED_FUNCTION(_wrap_makeIntPair) {
  ...
  result = makeIntPair(arg1,arg2);
  {
    ...
    SWIG_SetPointerZval(return_value, (void *)resultobj, SWIGTYPE_p_std__pairT_int_int_t, 1);
  }
  return;
fail:
  SWIG_FAIL();
...
ZEND_NAMED_FUNCTION(_wrap_makeIntPairPtr) {
  ...
  SWIG_SetPointerZval(return_value, (void *)result, SWIGTYPE_p_std__pairT_int_int_t, 0);
...
ZEND_NAMED_FUNCTION(_wrap_product1) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &tmp1, SWIGTYPE_p_std__pairT_int_int_t, 0) < 0 || tmp1 == NULL) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of product1. Expected SWIGTYPE_p_std__pairT_int_int_t");
    }
    arg1 = *tmp1;
  }
...
ZEND_NAMED_FUNCTION(_wrap_product2) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_std__pairT_int_int_t, 0) < 0 || arg1 == NULL) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of product2. Expected SWIGTYPE_p_std__pairT_int_int_t");
    }
  }
...
ZEND_NAMED_FUNCTION(_wrap_product3) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_std__pairT_int_int_t, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of product3. Expected SWIGTYPE_p_std__pairT_int_int_t");
    }
  }
...
static ZEND_RSRC_DTOR_FUNC(_wrap_destroy_p_std__pairT_int_int_t) {
  __wrap_delete_IntPair(rsrc, SWIGTYPE_p_std__pairT_int_int_t->name TSRMLS_CC);
}
/* end wrapper section */
...
static zend_function_entry li_std_pair_functions[] = {
 SWIG_ZEND_NAMED_FE(new_intpair,_wrap_new_IntPair,NULL)
 SWIG_ZEND_NAMED_FE(intpair_first_set,_wrap_IntPair_first_set,NULL)
 SWIG_ZEND_NAMED_FE(intpair_first_get,_wrap_IntPair_first_get,NULL)
 SWIG_ZEND_NAMED_FE(intpair_second_set,_wrap_IntPair_second_set,NULL)
 SWIG_ZEND_NAMED_FE(intpair_second_get,_wrap_IntPair_second_get,NULL)
 SWIG_ZEND_NAMED_FE(makeintpair,_wrap_makeIntPair,NULL)
 SWIG_ZEND_NAMED_FE(makeintpairptr,_wrap_makeIntPairPtr,NULL)
 SWIG_ZEND_NAMED_FE(makeintpairref,_wrap_makeIntPairRef,NULL)
 SWIG_ZEND_NAMED_FE(makeintpairconstref,_wrap_makeIntPairConstRef,NULL)
 SWIG_ZEND_NAMED_FE(product1,_wrap_product1,NULL)
 SWIG_ZEND_NAMED_FE(product2,_wrap_product2,NULL)
 SWIG_ZEND_NAMED_FE(product3,_wrap_product3,NULL)
 SWIG_ZEND_NAMED_FE(swig_li_std_pair_alter_newobject,_wrap_swig_li_std_pair_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_li_std_pair_get_newobject,_wrap_swig_li_std_pair_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry li_std_pair_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"li_std_pair",
    li_std_pair_functions,
    PHP_MINIT(li_std_pair),
    PHP_MSHUTDOWN(li_std_pair),
    PHP_RINIT(li_std_pair),
    PHP_RSHUTDOWN(li_std_pair),
    PHP_MINFO(li_std_pair),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &li_std_pair_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &li_std_pair_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(li_std_pair)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(li_std_pair, li_std_pair_init_globals, li_std_pair_destroy_globals);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(li_std_pair_globals_id);
#endif
    return SUCCESS;
}
