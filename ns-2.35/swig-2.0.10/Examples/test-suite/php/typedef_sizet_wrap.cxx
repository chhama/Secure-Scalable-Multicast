...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(typedef_sizet)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(typedef_sizet)
ZEND_DECLARE_MODULE_GLOBALS(typedef_sizet)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(typedef_sizet_globals_id, zend_typedef_sizet_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(typedef_sizet_globals_id, zend_typedef_sizet_globals *, error_code )
#else
#define SWIG_ErrorMsg() (typedef_sizet_globals.error_msg)
#define SWIG_ErrorCode() (typedef_sizet_globals.error_code)
#endif
...
static void typedef_sizet_init_globals(zend_typedef_sizet_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void typedef_sizet_destroy_globals(zend_typedef_sizet_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_typedef_sizet_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_typedef_sizet_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
#define SWIG_name  "typedef_sizet"
#ifdef __cplusplus
extern "C" {
#endif
#include "php.h"
...
static zend_function_entry typedef_sizet_functions[] = {
 SWIG_ZEND_NAMED_FE(size,_wrap_size,NULL)
 SWIG_ZEND_NAMED_FE(swig_typedef_sizet_alter_newobject,_wrap_swig_typedef_sizet_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_typedef_sizet_get_newobject,_wrap_swig_typedef_sizet_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry typedef_sizet_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"typedef_sizet",
    typedef_sizet_functions,
    PHP_MINIT(typedef_sizet),
    PHP_MSHUTDOWN(typedef_sizet),
    PHP_RINIT(typedef_sizet),
    PHP_RSHUTDOWN(typedef_sizet),
    PHP_MINFO(typedef_sizet),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &typedef_sizet_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &typedef_sizet_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(typedef_sizet)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(typedef_sizet, typedef_sizet_init_globals, typedef_sizet_destroy_globals);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(typedef_sizet_globals_id);
#endif
    return SUCCESS;
}
