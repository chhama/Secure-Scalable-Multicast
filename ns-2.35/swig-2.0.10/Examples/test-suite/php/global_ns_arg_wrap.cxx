...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(global_ns_arg)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(global_ns_arg)
ZEND_DECLARE_MODULE_GLOBALS(global_ns_arg)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(global_ns_arg_globals_id, zend_global_ns_arg_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(global_ns_arg_globals_id, zend_global_ns_arg_globals *, error_code )
#else
#define SWIG_ErrorMsg() (global_ns_arg_globals.error_msg)
#define SWIG_ErrorCode() (global_ns_arg_globals.error_code)
#endif
...
static void global_ns_arg_init_globals(zend_global_ns_arg_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void global_ns_arg_destroy_globals(zend_global_ns_arg_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_global_ns_arg_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_global_ns_arg_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
#define SWIG_name  "global_ns_arg"
#ifdef __cplusplus
extern "C" {
#endif
#include "php.h"
...
static zend_function_entry global_ns_arg_functions[] = {
 SWIG_ZEND_NAMED_FE(foo,_wrap_foo,NULL)
 SWIG_ZEND_NAMED_FE(bar_fn,_wrap_bar_fn,NULL)
 SWIG_ZEND_NAMED_FE(swig_global_ns_arg_alter_newobject,_wrap_swig_global_ns_arg_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_global_ns_arg_get_newobject,_wrap_swig_global_ns_arg_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry global_ns_arg_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"global_ns_arg",
    global_ns_arg_functions,
    PHP_MINIT(global_ns_arg),
    PHP_MSHUTDOWN(global_ns_arg),
    PHP_RINIT(global_ns_arg),
    PHP_RSHUTDOWN(global_ns_arg),
    PHP_MINFO(global_ns_arg),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &global_ns_arg_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &global_ns_arg_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(global_ns_arg)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(global_ns_arg, global_ns_arg_init_globals, global_ns_arg_destroy_globals);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(global_ns_arg_globals_id);
#endif
    return SUCCESS;
}
