...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(typedef_reference)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(typedef_reference)
ZEND_DECLARE_MODULE_GLOBALS(typedef_reference)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(typedef_reference_globals_id, zend_typedef_reference_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(typedef_reference_globals_id, zend_typedef_reference_globals *, error_code )
#else
#define SWIG_ErrorMsg() (typedef_reference_globals.error_msg)
#define SWIG_ErrorCode() (typedef_reference_globals.error_code)
#endif
...
static void typedef_reference_init_globals(zend_typedef_reference_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void typedef_reference_destroy_globals(zend_typedef_reference_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_typedef_reference_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_typedef_reference_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
#define SWIG_name  "typedef_reference"
#ifdef __cplusplus
extern "C" {
#endif
#include "php.h"
...
#include "php_typedef_reference.h"
#ifdef __cplusplus
}
#endif
...
ZEND_NAMED_FUNCTION(_wrap_somefunc) {
  ...
  
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_int, 0) < 0 || arg1 == NULL) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of somefunc. Expected SWIGTYPE_p_int");
    }
  }
...
ZEND_NAMED_FUNCTION(_wrap_otherfunc) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_int, 0) < 0 || arg1 == NULL) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of otherfunc. Expected SWIGTYPE_p_int");
    }
  }
...
static zend_function_entry typedef_reference_functions[] = {
 ...
 SWIG_ZEND_NAMED_FE(somefunc,_wrap_somefunc,NULL)
 SWIG_ZEND_NAMED_FE(otherfunc,_wrap_otherfunc,NULL)
 SWIG_ZEND_NAMED_FE(swig_typedef_reference_alter_newobject,_wrap_swig_typedef_reference_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_typedef_reference_get_newobject,_wrap_swig_typedef_reference_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry typedef_reference_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"typedef_reference",
    typedef_reference_functions,
    PHP_MINIT(typedef_reference),
    PHP_MSHUTDOWN(typedef_reference),
    PHP_RINIT(typedef_reference),
    PHP_RSHUTDOWN(typedef_reference),
    PHP_MINFO(typedef_reference),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &typedef_reference_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &typedef_reference_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(typedef_reference)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(typedef_reference, typedef_reference_init_globals, typedef_reference_destroy_globals);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(typedef_reference_globals_id);
#endif
    return SUCCESS;
}
