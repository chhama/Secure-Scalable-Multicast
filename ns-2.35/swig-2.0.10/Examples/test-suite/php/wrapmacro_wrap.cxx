...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(wrapmacro)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(wrapmacro)
ZEND_DECLARE_MODULE_GLOBALS(wrapmacro)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(wrapmacro_globals_id, zend_wrapmacro_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(wrapmacro_globals_id, zend_wrapmacro_globals *, error_code )
#else
#define SWIG_ErrorMsg() (wrapmacro_globals.error_msg)
#define SWIG_ErrorCode() (wrapmacro_globals.error_code)
#endif
...
static void wrapmacro_init_globals(zend_wrapmacro_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void wrapmacro_destroy_globals(zend_wrapmacro_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_wrapmacro_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_wrapmacro_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
ZEND_NAMED_FUNCTION(_wrap_maximum__SWIG_0) {
  size_t arg1 ;
  size_t *arg2 = 0 ;
  size_t temp2 ;
  zval **args[2];
  ...
  result = SWIGMACRO_maximum(arg1,(size_t const &)*arg2);
  {
    ZVAL_LONG(return_value,result);
  }
  return;
...
ZEND_NAMED_FUNCTION(_wrap_maximum__SWIG_1) {
  ...
  result = (double)SWIGMACRO_maximum(arg1,arg2);
  {
...
ZEND_NAMED_FUNCTION(_wrap_maximum) {
  ...
  if (argc == 2) {
    ...
    if (_v) {
      ...
      if (_v) {
        _wrap_maximum__SWIG_0(INTERNAL_FUNCTION_PARAM_PASSTHRU); return;
      }
    }
  }
  if (argc == 2) {
...
static zend_function_entry wrapmacro_functions[] = {
 SWIG_ZEND_NAMED_FE(guint16_swap_le_be_constant,_wrap_GUINT16_SWAP_LE_BE_CONSTANT,NULL)
 SWIG_ZEND_NAMED_FE(maximum,_wrap_maximum,NULL)
 SWIG_ZEND_NAMED_FE(swig_wrapmacro_alter_newobject,_wrap_swig_wrapmacro_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_wrapmacro_get_newobject,_wrap_swig_wrapmacro_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry wrapmacro_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"wrapmacro",
    wrapmacro_functions,
    PHP_MINIT(wrapmacro),
    PHP_MSHUTDOWN(wrapmacro),
    PHP_RINIT(wrapmacro),
    PHP_RSHUTDOWN(wrapmacro),
    PHP_MINFO(wrapmacro),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &wrapmacro_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &wrapmacro_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(wrapmacro)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(wrapmacro, wrapmacro_init_globals, wrapmacro_destroy_globals);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(wrapmacro_globals_id);
#endif
    return SUCCESS;
}
