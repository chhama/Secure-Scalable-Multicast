...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(imports_a)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(imports_a)
ZEND_DECLARE_MODULE_GLOBALS(imports_a)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(imports_a_globals_id, zend_imports_a_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(imports_a_globals_id, zend_imports_a_globals *, error_code )
#else
#define SWIG_ErrorMsg() (imports_a_globals.error_msg)
#define SWIG_ErrorCode() (imports_a_globals.error_code)
#endif
...
static void imports_a_init_globals(zend_imports_a_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void imports_a_destroy_globals(zend_imports_a_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_imports_a_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_imports_a_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
ZEND_NAMED_FUNCTION(_wrap_global_test) {
  ...
  arg1 = (GlobalEnum) Z_LVAL_PP(args[0]);
  /*@SWIG@*/;
...
ZEND_NAMED_FUNCTION(_wrap_A_hello) {
  ...
  
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_A, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of A_hello. Expected SWIGTYPE_p_A");
    }
  }
...
ZEND_NAMED_FUNCTION(_wrap_A_member_virtual_test) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_A, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of A_member_virtual_test. Expected SWIGTYPE_p_A");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
...
ZEND_NAMED_FUNCTION(_wrap_A_global_virtual_test) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_A, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of A_global_virtual_test. Expected SWIGTYPE_p_A");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
...
static zend_function_entry imports_a_functions[] = {
 SWIG_ZEND_NAMED_FE(global_test,_wrap_global_test,NULL)
 SWIG_ZEND_NAMED_FE(new_a,_wrap_new_A,NULL)
 SWIG_ZEND_NAMED_FE(a_hello,_wrap_A_hello,NULL)
 SWIG_ZEND_NAMED_FE(a_member_virtual_test,_wrap_A_member_virtual_test,NULL)
 SWIG_ZEND_NAMED_FE(a_global_virtual_test,_wrap_A_global_virtual_test,NULL)
 SWIG_ZEND_NAMED_FE(swig_imports_a_alter_newobject,_wrap_swig_imports_a_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_imports_a_get_newobject,_wrap_swig_imports_a_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry imports_a_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"imports_a",
    imports_a_functions,
    PHP_MINIT(imports_a),
    PHP_MSHUTDOWN(imports_a),
    PHP_RINIT(imports_a),
    PHP_RSHUTDOWN(imports_a),
    PHP_MINFO(imports_a),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &imports_a_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &imports_a_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(imports_a)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(imports_a, imports_a_init_globals, imports_a_destroy_globals);
...
/* cinit subsection */
SWIG_LONG_CONSTANT(globalenum1, globalenum1);
SWIG_LONG_CONSTANT(globalenum2, globalenum2);
SWIG_LONG_CONSTANT(A_memberenum1, A::memberenum1);
SWIG_LONG_CONSTANT(A_memberenum2, A::memberenum2);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(imports_a_globals_id);
#endif
    return SUCCESS;
}
