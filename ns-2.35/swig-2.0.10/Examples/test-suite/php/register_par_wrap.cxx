...
#define SWIGTYPE_p_tree swig_types[0]
...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(register_par)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(register_par)
ZEND_DECLARE_MODULE_GLOBALS(register_par)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(register_par_globals_id, zend_register_par_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(register_par_globals_id, zend_register_par_globals *, error_code )
#else
#define SWIG_ErrorMsg() (register_par_globals.error_msg)
#define SWIG_ErrorCode() (register_par_globals.error_code)
#endif
...
static void register_par_init_globals(zend_register_par_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void register_par_destroy_globals(zend_register_par_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_register_par_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_register_par_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
/* end header section */
/* vdecl subsection */
static int le_swig__p_tree=0; /* handle for _p_tree */
...
ZEND_NAMED_FUNCTION(_wrap_clear_tree_flags) {
  ...
  
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_tree, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of clear_tree_flags. Expected SWIGTYPE_p_tree");
    }
  }
...
static ZEND_RSRC_DTOR_FUNC(_wrap_destroy_p_tree) {
  /* No destructor for simple type _p_tree */
  efree(rsrc->ptr);
}
/* end wrapper section */
...
static zend_function_entry register_par_functions[] = {
 SWIG_ZEND_NAMED_FE(clear_tree_flags,_wrap_clear_tree_flags,NULL)
 SWIG_ZEND_NAMED_FE(swig_register_par_alter_newobject,_wrap_swig_register_par_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_register_par_get_newobject,_wrap_swig_register_par_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry register_par_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"register_par",
    register_par_functions,
    PHP_MINIT(register_par),
    PHP_MSHUTDOWN(register_par),
    PHP_RINIT(register_par),
    PHP_RSHUTDOWN(register_par),
    PHP_MINFO(register_par),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &register_par_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &register_par_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(register_par)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(register_par, register_par_init_globals, register_par_destroy_globals);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(register_par_globals_id);
#endif
    return SUCCESS;
}
