...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(default_arg_values)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(default_arg_values)
ZEND_DECLARE_MODULE_GLOBALS(default_arg_values)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(default_arg_values_globals_id, zend_default_arg_values_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(default_arg_values_globals_id, zend_default_arg_values_globals *, error_code )
#else
#define SWIG_ErrorMsg() (default_arg_values_globals.error_msg)
#define SWIG_ErrorCode() (default_arg_values_globals.error_code)
#endif
...
static void default_arg_values_init_globals(zend_default_arg_values_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void default_arg_values_destroy_globals(zend_default_arg_values_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_default_arg_values_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_default_arg_values_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
#include "php_default_arg_values.h"
#ifdef __cplusplus
}
#endif
...
/* end header section */
/* vdecl subsection */
static int le_swig__p_Display=0; /* handle for Display */
static int le_swig__p_float=0; /* handle for _p_float */
/* end vdecl subsection */
/* wrapper section */
ZEND_NAMED_FUNCTION(_wrap_Display_draw1__SWIG_0) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_Display, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of Display_draw1. Expected SWIGTYPE_p_Display");
    }
  }
...
ZEND_NAMED_FUNCTION(_wrap_Display_draw1__SWIG_1) {
  Display *arg1 = (Display *) 0 ;
  zval **args[1];
  float result;
...
ZEND_NAMED_FUNCTION(_wrap_Display_draw1) {
  ...
  if (argc == 1) {
    ...
    {
      void *tmp;
      _v = (SWIG_ConvertPtr(*argv[0], (void**)&tmp, SWIGTYPE_p_Display, 0) >= 0);
    }
    if (_v) {
      _wrap_Display_draw1__SWIG_1(INTERNAL_FUNCTION_PARAM_PASSTHRU); return;
    }
  }
  if (argc == 2) {
    int _v;
    ...
    if (_v) {
      ...
      if (_v) {
        _wrap_Display_draw1__SWIG_0(INTERNAL_FUNCTION_PARAM_PASSTHRU); return;
      }
    }
  }
  
  SWIG_ErrorCode() = E_ERROR;
  SWIG_ErrorMsg() = "No matching function for overloaded 'Display_draw1'";
  SWIG_FAIL();
}


ZEND_NAMED_FUNCTION(_wrap_Display_draw2__SWIG_0) {
  Display *arg1 = (Display *) 0 ;
  float *arg2 = (float *) 0 ;
  zval **args[2];
  float result;
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_Display, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of Display_draw2. Expected SWIGTYPE_p_Display");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
  {
    if(SWIG_ConvertPtr(*args[1], (void **) &arg2, SWIGTYPE_p_float, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 2 of Display_draw2. Expected SWIGTYPE_p_float");
    }
  }
...
ZEND_NAMED_FUNCTION(_wrap_Display_draw2__SWIG_1) {
  Display *arg1 = (Display *) 0 ;
  zval **args[1];
  float result;
...
ZEND_NAMED_FUNCTION(_wrap_Display_draw2) {
  ...
  if (argc == 1) {
    ...
    if (_v) {
      _wrap_Display_draw2__SWIG_1(INTERNAL_FUNCTION_PARAM_PASSTHRU); return;
    }
  }
  if (argc == 2) {
    int _v;
    ...
    if (_v) {
      {
        void *tmp;
        _v = (SWIG_ConvertPtr(*argv[1], (void**)&tmp, SWIGTYPE_p_float, 0) >= 0);
      }
      if (_v) {
        _wrap_Display_draw2__SWIG_0(INTERNAL_FUNCTION_PARAM_PASSTHRU); return;
      }
    }
  }
  
  SWIG_ErrorCode() = E_ERROR;
  SWIG_ErrorMsg() = "No matching function for overloaded 'Display_draw2'";
  SWIG_FAIL();
}
...
ZEND_NAMED_FUNCTION(_wrap_new_Display) {
  ...
  SWIG_SetPointerZval(return_value, (void *)result, SWIGTYPE_p_Display, 1);
...
static void __wrap_delete_Display(zend_rsrc_list_entry *rsrc, const char *type_name TSRMLS_DC) {
  ...
  arg1 = (Display *)SWIG_ZTS_ConvertResourceData(ptr,type_name,SWIGTYPE_p_Display TSRMLS_CC);
  if (! arg1) zend_error(E_ERROR, "Display resource already free'd");
  delete arg1;
  return;
fail:
  SWIG_FAIL();
...
static ZEND_RSRC_DTOR_FUNC(_wrap_destroy_p_Display) {
  __wrap_delete_Display(rsrc, SWIGTYPE_p_Display->name TSRMLS_CC);
}
...
static zend_function_entry default_arg_values_functions[] = {
 SWIG_ZEND_NAMED_FE(display_draw1,_wrap_Display_draw1,NULL)
 SWIG_ZEND_NAMED_FE(display_draw2,_wrap_Display_draw2,NULL)
 SWIG_ZEND_NAMED_FE(new_display,_wrap_new_Display,NULL)
 SWIG_ZEND_NAMED_FE(createptr,_wrap_createPtr,NULL)
 SWIG_ZEND_NAMED_FE(swig_default_arg_values_alter_newobject,_wrap_swig_default_arg_values_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_default_arg_values_get_newobject,_wrap_swig_default_arg_values_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry default_arg_values_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"default_arg_values",
    default_arg_values_functions,
    PHP_MINIT(default_arg_values),
    PHP_MSHUTDOWN(default_arg_values),
    PHP_RINIT(default_arg_values),
    PHP_RSHUTDOWN(default_arg_values),
    PHP_MINFO(default_arg_values),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &default_arg_values_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &default_arg_values_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(default_arg_values)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(default_arg_values, default_arg_values_init_globals, default_arg_values_destroy_globals);

/* Register resource destructors for pointer types */
le_swig__p_Display=zend_register_list_destructors_ex(_wrap_destroy_p_Display,NULL,(char *)(SWIGTYPE_p_Display->name),module_number);
SWIG_TypeClientData(SWIGTYPE_p_Display,&le_swig__p_Display);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(default_arg_values_globals_id);
#endif
    return SUCCESS;
}
