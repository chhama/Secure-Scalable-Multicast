...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(mod_a)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(mod_a)
ZEND_DECLARE_MODULE_GLOBALS(mod_a)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(mod_a_globals_id, zend_mod_a_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(mod_a_globals_id, zend_mod_a_globals *, error_code )
#else
#define SWIG_ErrorMsg() (mod_a_globals.error_msg)
#define SWIG_ErrorCode() (mod_a_globals.error_code)
#endif
...
static void mod_a_init_globals(zend_mod_a_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void mod_a_destroy_globals(zend_mod_a_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_mod_a_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_mod_a_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
ZEND_NAMED_FUNCTION(_wrap_A_GetC) {
  ...
  
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_A, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of A_GetC. Expected SWIGTYPE_p_A");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
  result = (C *)(arg1)->GetC();
  
  SWIG_SetPointerZval(return_value, (void *)result, SWIGTYPE_p_C, 0);
...
ZEND_NAMED_FUNCTION(_wrap_A_DoSomething) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_A, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of A_DoSomething. Expected SWIGTYPE_p_A");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
  {
    if(SWIG_ConvertPtr(*args[1], (void **) &arg2, SWIGTYPE_p_A, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 2 of A_DoSomething. Expected SWIGTYPE_p_A");
    }
  }
...
static zend_function_entry mod_a_functions[] = {
 SWIG_ZEND_NAMED_FE(new_a,_wrap_new_A,NULL)
 SWIG_ZEND_NAMED_FE(a_getc,_wrap_A_GetC,NULL)
 SWIG_ZEND_NAMED_FE(a_dosomething,_wrap_A_DoSomething,NULL)
 SWIG_ZEND_NAMED_FE(new_b,_wrap_new_B,NULL)
 SWIG_ZEND_NAMED_FE(swig_mod_a_alter_newobject,_wrap_swig_mod_a_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_mod_a_get_newobject,_wrap_swig_mod_a_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry mod_a_module_entry = {
...
zend_module_entry* SWIG_module_entry = &mod_a_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &mod_a_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(mod_a)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(mod_a, mod_a_init_globals, mod_a_destroy_globals);
