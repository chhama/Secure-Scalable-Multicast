...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(operbool)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(operbool)
ZEND_DECLARE_MODULE_GLOBALS(operbool)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(operbool_globals_id, zend_operbool_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(operbool_globals_id, zend_operbool_globals *, error_code )
#else
#define SWIG_ErrorMsg() (operbool_globals.error_msg)
#define SWIG_ErrorCode() (operbool_globals.error_code)
#endif
...
static void operbool_init_globals(zend_operbool_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void operbool_destroy_globals(zend_operbool_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_operbool_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_operbool_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
ZEND_NAMED_FUNCTION(_wrap_Test_operator_bool) {
  ...
  
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_Test, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of Test_operator_bool. Expected SWIGTYPE_p_Test");
    }
  }
...
static zend_function_entry operbool_functions[] = {
 SWIG_ZEND_NAMED_FE(test_operator_bool,_wrap_Test_operator_bool,NULL)
 SWIG_ZEND_NAMED_FE(new_test,_wrap_new_Test,NULL)
 SWIG_ZEND_NAMED_FE(swig_operbool_alter_newobject,_wrap_swig_operbool_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_operbool_get_newobject,_wrap_swig_operbool_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry operbool_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"operbool",
    operbool_functions,
    PHP_MINIT(operbool),
    PHP_MSHUTDOWN(operbool),
    PHP_RINIT(operbool),
    PHP_RSHUTDOWN(operbool),
    PHP_MINFO(operbool),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &operbool_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &operbool_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(operbool)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(operbool, operbool_init_globals, operbool_destroy_globals);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(operbool_globals_id);
#endif
    return SUCCESS;
}
