...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(null_pointer)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(null_pointer)
ZEND_DECLARE_MODULE_GLOBALS(null_pointer)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(null_pointer_globals_id, zend_null_pointer_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(null_pointer_globals_id, zend_null_pointer_globals *, error_code )
#else
#define SWIG_ErrorMsg() (null_pointer_globals.error_msg)
#define SWIG_ErrorCode() (null_pointer_globals.error_code)
#endif
...
static void null_pointer_init_globals(zend_null_pointer_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void null_pointer_destroy_globals(zend_null_pointer_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_null_pointer_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_null_pointer_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
ZEND_NAMED_FUNCTION(_wrap_func) {
  ...
  
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_A, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of func. Expected SWIGTYPE_p_A");
    }
  }
  result = (bool)func(arg1);
  {
...
ZEND_NAMED_FUNCTION(_wrap_getnull) {
  A *result = 0 ;
...
static zend_function_entry null_pointer_functions[] = {
 SWIG_ZEND_NAMED_FE(new_a,_wrap_new_A,NULL)
 SWIG_ZEND_NAMED_FE(func,_wrap_func,NULL)
 SWIG_ZEND_NAMED_FE(getnull,_wrap_getnull,NULL)
 SWIG_ZEND_NAMED_FE(swig_null_pointer_alter_newobject,_wrap_swig_null_pointer_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_null_pointer_get_newobject,_wrap_swig_null_pointer_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry null_pointer_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"null_pointer",
    null_pointer_functions,
    PHP_MINIT(null_pointer),
    PHP_MSHUTDOWN(null_pointer),
    PHP_RINIT(null_pointer),
    PHP_RSHUTDOWN(null_pointer),
    PHP_MINFO(null_pointer),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &null_pointer_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &null_pointer_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(null_pointer)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(null_pointer, null_pointer_init_globals, null_pointer_destroy_globals);
...
PHP_RINIT_FUNCTION(null_pointer)
{
/* rinit section */
...
PHP_MSHUTDOWN_FUNCTION(null_pointer)
{
/* shutdown section */
#ifdef ZTS
    ts_free_id(null_pointer_globals_id);
#endif
    return SUCCESS;
}

PHP_RSHUTDOWN_FUNCTION(null_pointer)
{
/* rshutdown section */
...
PHP_MINFO_FUNCTION(null_pointer)
{
}
/* end init section */
