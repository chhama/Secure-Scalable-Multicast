...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(constructor_rename)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(constructor_rename)
ZEND_DECLARE_MODULE_GLOBALS(constructor_rename)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(constructor_rename_globals_id, zend_constructor_rename_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(constructor_rename_globals_id, zend_constructor_rename_globals *, error_code )
#else
#define SWIG_ErrorMsg() (constructor_rename_globals.error_msg)
#define SWIG_ErrorCode() (constructor_rename_globals.error_code)
#endif
...
static void constructor_rename_init_globals(zend_constructor_rename_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void constructor_rename_destroy_globals(zend_constructor_rename_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_constructor_rename_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_constructor_rename_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
#define SWIG_name  "constructor_rename"
#ifdef __cplusplus
extern "C" {
#endif
#include "php.h"
...
#include "php_constructor_rename.h"
#ifdef __cplusplus
}
#endif
...
static zend_function_entry constructor_rename_functions[] = {
 SWIG_ZEND_NAMED_FE(new_renamedconstructor,_wrap_new_RenamedConstructor,NULL)
 SWIG_ZEND_NAMED_FE(swig_constructor_rename_alter_newobject,_wrap_swig_constructor_rename_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_constructor_rename_get_newobject,_wrap_swig_constructor_rename_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry constructor_rename_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"constructor_rename",
    constructor_rename_functions,
    PHP_MINIT(constructor_rename),
    PHP_MSHUTDOWN(constructor_rename),
    PHP_RINIT(constructor_rename),
    PHP_RSHUTDOWN(constructor_rename),
    PHP_MINFO(constructor_rename),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &constructor_rename_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &constructor_rename_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(constructor_rename)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(constructor_rename, constructor_rename_init_globals, constructor_rename_destroy_globals);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(constructor_rename_globals_id);
#endif
    return SUCCESS;
}
