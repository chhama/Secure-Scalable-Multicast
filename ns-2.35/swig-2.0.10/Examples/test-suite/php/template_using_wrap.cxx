...
#define SWIGTYPE_p_foo__FooT_float_t swig_types[0]
...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(template_using)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(template_using)
ZEND_DECLARE_MODULE_GLOBALS(template_using)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(template_using_globals_id, zend_template_using_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(template_using_globals_id, zend_template_using_globals *, error_code )
#else
#define SWIG_ErrorMsg() (template_using_globals.error_msg)
#define SWIG_ErrorCode() (template_using_globals.error_code)
#endif
...
static void template_using_init_globals(zend_template_using_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void template_using_destroy_globals(zend_template_using_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_template_using_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_template_using_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
#define SWIG_name  "template_using"
#ifdef __cplusplus
extern "C" {
#endif
#include "php.h"
...
static swig_type_info _swigt__p_foo__FooT_float_t = {"_p_foo__FooT_float_t", "foo::Foo< float > *", 0, 0, (void*)0, 0};

static swig_type_info *swig_type_initial[] = {
  &_swigt__p_foo__FooT_float_t,
};

static swig_cast_info _swigc__p_foo__FooT_float_t[] = {  {&_swigt__p_foo__FooT_float_t, 0, 0, 0},{0, 0, 0, 0}};

static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_foo__FooT_float_t,
};
...
/* end header section */
/* vdecl subsection */
static int le_swig__p_foo__FooT_float_t=0; /* handle for Foofloat */
...
ZEND_NAMED_FUNCTION(_wrap_new_Foofloat) {
  ...
  SWIG_SetPointerZval(return_value, (void *)result, SWIGTYPE_p_foo__FooT_float_t, 1);
...
static void __wrap_delete_Foofloat(zend_rsrc_list_entry *rsrc, const char *type_name TSRMLS_DC) {
  swig_object_wrapper *value=(swig_object_wrapper *) rsrc->ptr ;
  void *ptr=value->ptr ;
  int newobject=value->newobject ;
  foo::Foo< float > *arg1 = (foo::Foo< float > *) 0 ;
  
  efree(value);
  if (! newobject) return; /* can't delete it! */
  arg1 = (foo::Foo< float > *)SWIG_ZTS_ConvertResourceData(ptr,type_name,SWIGTYPE_p_foo__FooT_float_t TSRMLS_CC);
  if (! arg1) zend_error(E_ERROR, "foo::Foo<(float)> resource already free'd");
  delete arg1;
  return;
fail:
  SWIG_FAIL();
...
ZEND_NAMED_FUNCTION(_wrap_maxfloat) {
  float arg1 ;
  float arg2 ;
  zval **args[2];
  float result;
...
static ZEND_RSRC_DTOR_FUNC(_wrap_destroy_p_foo__FooT_float_t) {
  __wrap_delete_Foofloat(rsrc, SWIGTYPE_p_foo__FooT_float_t->name TSRMLS_CC);
}
/* end wrapper section */
...
static zend_function_entry template_using_functions[] = {
 SWIG_ZEND_NAMED_FE(maxint,_wrap_maxint,NULL)
 SWIG_ZEND_NAMED_FE(new_foofloat,_wrap_new_Foofloat,NULL)
 SWIG_ZEND_NAMED_FE(maxfloat,_wrap_maxfloat,NULL)
 SWIG_ZEND_NAMED_FE(swig_template_using_alter_newobject,_wrap_swig_template_using_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_template_using_get_newobject,_wrap_swig_template_using_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry template_using_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"template_using",
    template_using_functions,
    PHP_MINIT(template_using),
    PHP_MSHUTDOWN(template_using),
    PHP_RINIT(template_using),
    PHP_RSHUTDOWN(template_using),
    PHP_MINFO(template_using),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &template_using_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &template_using_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(template_using)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(template_using, template_using_init_globals, template_using_destroy_globals);

/* Register resource destructors for pointer types */
le_swig__p_foo__FooT_float_t=zend_register_list_destructors_ex(_wrap_destroy_p_foo__FooT_float_t,NULL,(char *)(SWIGTYPE_p_foo__FooT_float_t->name),module_number);
SWIG_TypeClientData(SWIGTYPE_p_foo__FooT_float_t,&le_swig__p_foo__FooT_float_t);
...
PHP_RINIT_FUNCTION(template_using)
{
/* rinit section */
...
PHP_MSHUTDOWN_FUNCTION(template_using)
{
/* shutdown section */
#ifdef ZTS
    ts_free_id(template_using_globals_id);
#endif
    return SUCCESS;
}

PHP_RSHUTDOWN_FUNCTION(template_using)
{
/* rshutdown section */
...
PHP_MINFO_FUNCTION(template_using)
{
}
/* end init section */
