...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(redefined_not)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(redefined_not)
ZEND_DECLARE_MODULE_GLOBALS(redefined_not)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(redefined_not_globals_id, zend_redefined_not_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(redefined_not_globals_id, zend_redefined_not_globals *, error_code )
#else
#define SWIG_ErrorMsg() (redefined_not_globals.error_msg)
#define SWIG_ErrorCode() (redefined_not_globals.error_code)
#endif
...
static void redefined_not_init_globals(zend_redefined_not_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void redefined_not_destroy_globals(zend_redefined_not_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_redefined_not_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_redefined_not_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
#define SWIG_name  "redefined_not"
#ifdef __cplusplus
extern "C" {
#endif
#include "php.h"
...
static zend_function_entry redefined_not_functions[] = {
 SWIG_ZEND_NAMED_FE(swig_redefined_not_alter_newobject,_wrap_swig_redefined_not_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_redefined_not_get_newobject,_wrap_swig_redefined_not_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry redefined_not_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"redefined_not",
    redefined_not_functions,
    PHP_MINIT(redefined_not),
    PHP_MSHUTDOWN(redefined_not),
    PHP_RINIT(redefined_not),
    PHP_RSHUTDOWN(redefined_not),
    PHP_MINFO(redefined_not),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &redefined_not_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &redefined_not_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(redefined_not)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(redefined_not, redefined_not_init_globals, redefined_not_destroy_globals);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(redefined_not_globals_id);
#endif
    return SUCCESS;
}
