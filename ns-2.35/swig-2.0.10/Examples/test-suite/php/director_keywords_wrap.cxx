...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(director_keywords)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(director_keywords)
ZEND_DECLARE_MODULE_GLOBALS(director_keywords)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(director_keywords_globals_id, zend_director_keywords_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(director_keywords_globals_id, zend_director_keywords_globals *, error_code )
#else
#define SWIG_ErrorMsg() (director_keywords_globals.error_msg)
#define SWIG_ErrorCode() (director_keywords_globals.error_code)
#endif
...
static void director_keywords_init_globals(zend_director_keywords_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void director_keywords_destroy_globals(zend_director_keywords_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_director_keywords_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_director_keywords_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
#define SWIG_name  "director_keywords"
#ifdef __cplusplus
extern "C" {
#endif
#include "php.h"
...
#include "php_director_keywords.h"
#ifdef __cplusplus
}
#endif
...
#include "director_keywords_wrap.h"
...
void SwigDirector_Foo::bar(int abstract) {
  TSRMLS_FETCH_FROM_CTX(swig_zts_ctx);
  zval *args[1];
  zval *result, funcname;
  MAKE_STD_ZVAL(result);
  ZVAL_STRINGL(&funcname, (char *)"bar", 3, 0);
  if (!swig_self) {
...
ZEND_NAMED_FUNCTION(_wrap_Foo_bar) {
  ...
  upcall = !director->swig_is_overridden_method((char *)"Foo", (char *)"bar");
  SWIG_ResetError();
  if(ZEND_NUM_ARGS() != 2 || zend_get_parameters_array_ex(2, args) != SUCCESS) {
    WRONG_PARAM_COUNT;
  }
...
static zend_function_entry director_keywords_functions[] = {
 SWIG_ZEND_NAMED_FE(foo_bar,_wrap_Foo_bar,NULL)
 SWIG_ZEND_NAMED_FE(new_foo,_wrap_new_Foo,NULL)
 SWIG_ZEND_NAMED_FE(swig_director_keywords_alter_newobject,_wrap_swig_director_keywords_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_director_keywords_get_newobject,_wrap_swig_director_keywords_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry director_keywords_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"director_keywords",
    director_keywords_functions,
    PHP_MINIT(director_keywords),
    PHP_MSHUTDOWN(director_keywords),
    PHP_RINIT(director_keywords),
    PHP_RSHUTDOWN(director_keywords),
    PHP_MINFO(director_keywords),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &director_keywords_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &director_keywords_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(director_keywords)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(director_keywords, director_keywords_init_globals, director_keywords_destroy_globals);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(director_keywords_globals_id);
#endif
    return SUCCESS;
}
