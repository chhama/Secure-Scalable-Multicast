...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(overload_copy)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(overload_copy)
ZEND_DECLARE_MODULE_GLOBALS(overload_copy)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(overload_copy_globals_id, zend_overload_copy_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(overload_copy_globals_id, zend_overload_copy_globals *, error_code )
#else
#define SWIG_ErrorMsg() (overload_copy_globals.error_msg)
#define SWIG_ErrorCode() (overload_copy_globals.error_code)
#endif
...
static void overload_copy_init_globals(zend_overload_copy_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void overload_copy_destroy_globals(zend_overload_copy_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_overload_copy_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_overload_copy_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
#define SWIG_name  "overload_copy"
#ifdef __cplusplus
extern "C" {
#endif
#include "php.h"
...
ZEND_NAMED_FUNCTION(_wrap_new_Foo__SWIG_1) {
  ...
  
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_Foo, 0) < 0 || arg1 == NULL) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of new_Foo. Expected SWIGTYPE_p_Foo");
    }
  }
...
static zend_function_entry overload_copy_functions[] = {
 SWIG_ZEND_NAMED_FE(new_foo,_wrap_new_Foo,NULL)
 SWIG_ZEND_NAMED_FE(swig_overload_copy_alter_newobject,_wrap_swig_overload_copy_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_overload_copy_get_newobject,_wrap_swig_overload_copy_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry overload_copy_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"overload_copy",
    overload_copy_functions,
    PHP_MINIT(overload_copy),
    PHP_MSHUTDOWN(overload_copy),
    PHP_RINIT(overload_copy),
    PHP_RSHUTDOWN(overload_copy),
    PHP_MINFO(overload_copy),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &overload_copy_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &overload_copy_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(overload_copy)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(overload_copy, overload_copy_init_globals, overload_copy_destroy_globals);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(overload_copy_globals_id);
#endif
    return SUCCESS;
}
