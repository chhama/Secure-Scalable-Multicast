...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(template_qualifier)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(template_qualifier)
ZEND_DECLARE_MODULE_GLOBALS(template_qualifier)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(template_qualifier_globals_id, zend_template_qualifier_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(template_qualifier_globals_id, zend_template_qualifier_globals *, error_code )
#else
#define SWIG_ErrorMsg() (template_qualifier_globals.error_msg)
#define SWIG_ErrorCode() (template_qualifier_globals.error_code)
#endif
...
static void template_qualifier_init_globals(zend_template_qualifier_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void template_qualifier_destroy_globals(zend_template_qualifier_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_template_qualifier_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_template_qualifier_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
#define SWIG_name  "template_qualifier"
#ifdef __cplusplus
extern "C" {
#endif
#include "php.h"
...
#include "php_template_qualifier.h"
#ifdef __cplusplus
}
#endif
...
ZEND_NAMED_FUNCTION(_wrap_X_xalloc_int) {
  ...
  
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_X, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of X_xalloc_int. Expected SWIGTYPE_p_X");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
  result = (X *)(arg1)->SWIGTEMPLATEDISAMBIGUATOR xalloc< 200 >();
  
  SWIG_SetPointerZval(return_value, (void *)result, SWIGTYPE_p_X, 0);
...
static zend_function_entry template_qualifier_functions[] = {
 SWIG_ZEND_NAMED_FE(x_xalloc_int,_wrap_X_xalloc_int,NULL)
 SWIG_ZEND_NAMED_FE(new_x,_wrap_new_X,NULL)
 SWIG_ZEND_NAMED_FE(swig_template_qualifier_alter_newobject,_wrap_swig_template_qualifier_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_template_qualifier_get_newobject,_wrap_swig_template_qualifier_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry template_qualifier_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"template_qualifier",
    template_qualifier_functions,
    PHP_MINIT(template_qualifier),
    PHP_MSHUTDOWN(template_qualifier),
    PHP_RINIT(template_qualifier),
    PHP_RSHUTDOWN(template_qualifier),
    PHP_MINFO(template_qualifier),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &template_qualifier_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &template_qualifier_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(template_qualifier)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(template_qualifier, template_qualifier_init_globals, template_qualifier_destroy_globals);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(template_qualifier_globals_id);
#endif
    return SUCCESS;
}
