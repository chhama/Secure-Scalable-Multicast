...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(redefined)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(redefined)
ZEND_DECLARE_MODULE_GLOBALS(redefined)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(redefined_globals_id, zend_redefined_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(redefined_globals_id, zend_redefined_globals *, error_code )
#else
#define SWIG_ErrorMsg() (redefined_globals.error_msg)
#define SWIG_ErrorCode() (redefined_globals.error_code)
#endif
...
static void redefined_init_globals(zend_redefined_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void redefined_destroy_globals(zend_redefined_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_redefined_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_redefined_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
/* wrapper section */
ZEND_NAMED_FUNCTION(_wrap_hello) {
  int arg1 ;
  zval **args[1];
  int result;
...
ZEND_NAMED_FUNCTION(_wrap_foo) {
  ...
  
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_A, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of foo. Expected SWIGTYPE_p_A");
    }
  }
  {
    if(SWIG_ConvertPtr(*args[1], (void **) &arg2, SWIGTYPE_p_B, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 2 of foo. Expected SWIGTYPE_p_B");
    }
  }
...
static zend_function_entry redefined_functions[] = {
 SWIG_ZEND_NAMED_FE(hello,_wrap_hello,NULL)
 SWIG_ZEND_NAMED_FE(foo,_wrap_foo,NULL)
 SWIG_ZEND_NAMED_FE(new_a,_wrap_new_A,NULL)
 SWIG_ZEND_NAMED_FE(new_b,_wrap_new_B,NULL)
 SWIG_ZEND_NAMED_FE(swig_redefined_alter_newobject,_wrap_swig_redefined_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_redefined_get_newobject,_wrap_swig_redefined_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry redefined_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"redefined",
    redefined_functions,
    PHP_MINIT(redefined),
    PHP_MSHUTDOWN(redefined),
    PHP_RINIT(redefined),
    PHP_RSHUTDOWN(redefined),
    PHP_MINFO(redefined),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &redefined_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &redefined_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(redefined)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(redefined, redefined_init_globals, redefined_destroy_globals);
...
/* cinit subsection */
SWIG_LONG_CONSTANT(agua, 0);
SWIG_LONG_CONSTANT(REDUNDANT, 1);
/* end cinit subsection */

    return SUCCESS;
}

PHP_RINIT_FUNCTION(redefined)
{
/* rinit section */
...
PHP_MSHUTDOWN_FUNCTION(redefined)
{
/* shutdown section */
#ifdef ZTS
    ts_free_id(redefined_globals_id);
#endif
    return SUCCESS;
}

PHP_RSHUTDOWN_FUNCTION(redefined)
{
/* rshutdown section */
