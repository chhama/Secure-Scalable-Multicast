...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(operator_pointer_ref)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(operator_pointer_ref)
ZEND_DECLARE_MODULE_GLOBALS(operator_pointer_ref)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(operator_pointer_ref_globals_id, zend_operator_pointer_ref_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(operator_pointer_ref_globals_id, zend_operator_pointer_ref_globals *, error_code )
#else
#define SWIG_ErrorMsg() (operator_pointer_ref_globals.error_msg)
#define SWIG_ErrorCode() (operator_pointer_ref_globals.error_code)
#endif
...
static void operator_pointer_ref_init_globals(zend_operator_pointer_ref_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void operator_pointer_ref_destroy_globals(zend_operator_pointer_ref_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_operator_pointer_ref_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_operator_pointer_ref_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
#define SWIG_name  "operator_pointer_ref"
#ifdef __cplusplus
extern "C" {
#endif
#include "php.h"
...
#include "php_operator_pointer_ref.h"
#ifdef __cplusplus
}
#endif
...
ZEND_NAMED_FUNCTION(_wrap_MyClass_AsCharStarRef) {
  ...
  
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_MyClass, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of MyClass_AsCharStarRef. Expected SWIGTYPE_p_MyClass");
    }
  }
...
static zend_function_entry operator_pointer_ref_functions[] = {
 SWIG_ZEND_NAMED_FE(new_myclass,_wrap_new_MyClass,NULL)
 SWIG_ZEND_NAMED_FE(myclass_ascharstarref,_wrap_MyClass_AsCharStarRef,NULL)
 SWIG_ZEND_NAMED_FE(swig_operator_pointer_ref_alter_newobject,_wrap_swig_operator_pointer_ref_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_operator_pointer_ref_get_newobject,_wrap_swig_operator_pointer_ref_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry operator_pointer_ref_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"operator_pointer_ref",
    operator_pointer_ref_functions,
    PHP_MINIT(operator_pointer_ref),
    PHP_MSHUTDOWN(operator_pointer_ref),
    PHP_RINIT(operator_pointer_ref),
    PHP_RSHUTDOWN(operator_pointer_ref),
    PHP_MINFO(operator_pointer_ref),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &operator_pointer_ref_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &operator_pointer_ref_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(operator_pointer_ref)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(operator_pointer_ref, operator_pointer_ref_init_globals, operator_pointer_ref_destroy_globals);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(operator_pointer_ref_globals_id);
#endif
    return SUCCESS;
}
