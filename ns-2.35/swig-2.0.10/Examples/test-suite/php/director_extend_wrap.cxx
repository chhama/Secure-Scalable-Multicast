...
#define SWIGTYPE_p_SpObject swig_types[0]
...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(director_extend)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(director_extend)
ZEND_DECLARE_MODULE_GLOBALS(director_extend)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(director_extend_globals_id, zend_director_extend_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(director_extend_globals_id, zend_director_extend_globals *, error_code )
#else
#define SWIG_ErrorMsg() (director_extend_globals.error_msg)
#define SWIG_ErrorCode() (director_extend_globals.error_code)
#endif
...
static void director_extend_init_globals(zend_director_extend_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void director_extend_destroy_globals(zend_director_extend_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_director_extend_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_director_extend_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
#define SWIG_name  "director_extend"
#ifdef __cplusplus
extern "C" {
#endif
#include "php.h"
...
static swig_type_info _swigt__p_SpObject = {"_p_SpObject", "SpObject *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_int = {"_p_int", "int *|Swig::Director *", 0, 0, (void*)0, 0};
...
static swig_cast_info _swigc__p_SpObject[] = {  {&_swigt__p_SpObject, 0, 0, 0},{0, 0, 0, 0}};
...
/* vdecl subsection */
static int le_swig__p_SpObject=0; /* handle for SpObject */
...
ZEND_NAMED_FUNCTION(_wrap_new_SpObject) {
  ...
  SWIG_SetPointerZval(return_value, (void *)result, SWIGTYPE_p_SpObject, 1);
...
static void __wrap_delete_SpObject(zend_rsrc_list_entry *rsrc, const char *type_name TSRMLS_DC) {
  swig_object_wrapper *value=(swig_object_wrapper *) rsrc->ptr ;
  void *ptr=value->ptr ;
  int newobject=value->newobject ;
  SpObject *arg1 = (SpObject *) 0 ;
  
  efree(value);
  if (! newobject) return; /* can't delete it! */
  arg1 = (SpObject *)SWIG_ZTS_ConvertResourceData(ptr,type_name,SWIGTYPE_p_SpObject TSRMLS_CC);
  if (! arg1) zend_error(E_ERROR, "SpObject resource already free'd");
  delete arg1;
  return;
fail:
  SWIG_FAIL();
...
ZEND_NAMED_FUNCTION(_wrap_SpObject_getFooBar) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_SpObject, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of SpObject_getFooBar. Expected SWIGTYPE_p_SpObject");
    }
  }
...
ZEND_NAMED_FUNCTION(_wrap_SpObject_dummy) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_SpObject, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of SpObject_dummy. Expected SWIGTYPE_p_SpObject");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
...
ZEND_NAMED_FUNCTION(_wrap_SpObject_ExceptionMethod) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_SpObject, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of SpObject_ExceptionMethod. Expected SWIGTYPE_p_SpObject");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
...
static ZEND_RSRC_DTOR_FUNC(_wrap_destroy_p_SpObject) {
  __wrap_delete_SpObject(rsrc, SWIGTYPE_p_SpObject->name TSRMLS_CC);
}
...
static zend_function_entry director_extend_functions[] = {
 SWIG_ZEND_NAMED_FE(new_spobject,_wrap_new_SpObject,NULL)
 SWIG_ZEND_NAMED_FE(spobject_getfoobar,_wrap_SpObject_getFooBar,NULL)
 SWIG_ZEND_NAMED_FE(spobject_dummy,_wrap_SpObject_dummy,NULL)
 SWIG_ZEND_NAMED_FE(spobject_exceptionmethod,_wrap_SpObject_ExceptionMethod,NULL)
 SWIG_ZEND_NAMED_FE(swig_director_extend_alter_newobject,_wrap_swig_director_extend_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_director_extend_get_newobject,_wrap_swig_director_extend_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry director_extend_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"director_extend",
    director_extend_functions,
    PHP_MINIT(director_extend),
    PHP_MSHUTDOWN(director_extend),
    PHP_RINIT(director_extend),
    PHP_RSHUTDOWN(director_extend),
    PHP_MINFO(director_extend),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &director_extend_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &director_extend_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(director_extend)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(director_extend, director_extend_init_globals, director_extend_destroy_globals);

/* Register resource destructors for pointer types */
le_swig__p_SpObject=zend_register_list_destructors_ex(_wrap_destroy_p_SpObject,NULL,(char *)(SWIGTYPE_p_SpObject->name),module_number);
SWIG_TypeClientData(SWIGTYPE_p_SpObject,&le_swig__p_SpObject);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(director_extend_globals_id);
#endif
    return SUCCESS;
}
