...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(nspace)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(nspace)
ZEND_DECLARE_MODULE_GLOBALS(nspace)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(nspace_globals_id, zend_nspace_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(nspace_globals_id, zend_nspace_globals *, error_code )
#else
#define SWIG_ErrorMsg() (nspace_globals.error_msg)
#define SWIG_ErrorCode() (nspace_globals.error_code)
#endif
...
static void nspace_init_globals(zend_nspace_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void nspace_destroy_globals(zend_nspace_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_nspace_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_nspace_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
static zend_function_entry nspace_functions[] = {
 SWIG_ZEND_NAMED_FE(swig_nspace_alter_newobject,_wrap_swig_nspace_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_nspace_get_newobject,_wrap_swig_nspace_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry nspace_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"nspace",
    nspace_functions,
    PHP_MINIT(nspace),
    PHP_MSHUTDOWN(nspace),
    PHP_RINIT(nspace),
    PHP_RSHUTDOWN(nspace),
    PHP_MINFO(nspace),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &nspace_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &nspace_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(nspace)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(nspace, nspace_init_globals, nspace_destroy_globals);
