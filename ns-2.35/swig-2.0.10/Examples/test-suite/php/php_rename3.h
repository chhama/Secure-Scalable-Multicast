...
#ifndef PHP_RENAME3_H
#define PHP_RENAME3_H

extern zend_module_entry rename3_module_entry;
#define phpext_rename3_ptr &rename3_module_entry

#ifdef PHP_WIN32
# define PHP_RENAME3_API __declspec(dllexport)
#else
# define PHP_RENAME3_API
#endif
