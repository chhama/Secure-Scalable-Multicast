...
#define SWIGTYPE_p_RB swig_types[0]
...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(static_array_member)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(static_array_member)
ZEND_DECLARE_MODULE_GLOBALS(static_array_member)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(static_array_member_globals_id, zend_static_array_member_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(static_array_member_globals_id, zend_static_array_member_globals *, error_code )
#else
#define SWIG_ErrorMsg() (static_array_member_globals.error_msg)
#define SWIG_ErrorCode() (static_array_member_globals.error_code)
#endif
...
static void static_array_member_init_globals(zend_static_array_member_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void static_array_member_destroy_globals(zend_static_array_member_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_static_array_member_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_static_array_member_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
#define SWIG_name  "static_array_member"
#ifdef __cplusplus
extern "C" {
#endif
#include "php.h"
...
#include "php_static_array_member.h"
#ifdef __cplusplus
}
#endif
...
static swig_type_info _swigt__p_RB = {"_p_RB", "RB *", 0, 0, (void*)0, 0};

static swig_type_info *swig_type_initial[] = {
  &_swigt__p_RB,
};

static swig_cast_info _swigc__p_RB[] = {  {&_swigt__p_RB, 0, 0, 0},{0, 0, 0, 0}};
...
/* end header section */
/* vdecl subsection */
static int le_swig__p_RB=0; /* handle for RB */
...
ZEND_NAMED_FUNCTION(_wrap_new_RB) {
  ...
  SWIG_SetPointerZval(return_value, (void *)result, SWIGTYPE_p_RB, 1);
...
static void __wrap_delete_RB(zend_rsrc_list_entry *rsrc, const char *type_name TSRMLS_DC) {
  ...
  arg1 = (RB *)SWIG_ZTS_ConvertResourceData(ptr,type_name,SWIGTYPE_p_RB TSRMLS_CC);
  if (! arg1) zend_error(E_ERROR, "RB resource already free'd");
  delete arg1;
  return;
fail:
  SWIG_FAIL();
...
static ZEND_RSRC_DTOR_FUNC(_wrap_destroy_p_RB) {
  __wrap_delete_RB(rsrc, SWIGTYPE_p_RB->name TSRMLS_CC);
}
/* end wrapper section */
...
static zend_function_entry static_array_member_functions[] = {
 SWIG_ZEND_NAMED_FE(new_rb,_wrap_new_RB,NULL)
 SWIG_ZEND_NAMED_FE(swig_static_array_member_alter_newobject,_wrap_swig_static_array_member_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_static_array_member_get_newobject,_wrap_swig_static_array_member_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry static_array_member_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"static_array_member",
    static_array_member_functions,
    PHP_MINIT(static_array_member),
    PHP_MSHUTDOWN(static_array_member),
    PHP_RINIT(static_array_member),
    PHP_RSHUTDOWN(static_array_member),
    PHP_MINFO(static_array_member),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &static_array_member_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &static_array_member_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(static_array_member)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(static_array_member, static_array_member_init_globals, static_array_member_destroy_globals);

/* Register resource destructors for pointer types */
le_swig__p_RB=zend_register_list_destructors_ex(_wrap_destroy_p_RB,NULL,(char *)(SWIGTYPE_p_RB->name),module_number);
SWIG_TypeClientData(SWIGTYPE_p_RB,&le_swig__p_RB);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(static_array_member_globals_id);
#endif
    return SUCCESS;
}
