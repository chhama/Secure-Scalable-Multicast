...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(catches)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(catches)
ZEND_DECLARE_MODULE_GLOBALS(catches)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(catches_globals_id, zend_catches_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(catches_globals_id, zend_catches_globals *, error_code )
#else
#define SWIG_ErrorMsg() (catches_globals.error_msg)
#define SWIG_ErrorCode() (catches_globals.error_code)
#endif
...
static void catches_init_globals(zend_catches_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void catches_destroy_globals(zend_catches_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_catches_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_catches_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
static swig_type_info _swigt__p_ThreeException = {"_p_ThreeException", "ThreeException *", 0, 0, (void*)0, 0};
...
/* end header section */
/* vdecl subsection */
static int le_swig__p_ThreeException=0; /* handle for ThreeException */
...
ZEND_NAMED_FUNCTION(_wrap_new_ThreeException) {
  ...
  SWIG_SetPointerZval(return_value, (void *)result, SWIGTYPE_p_ThreeException, 1);
...
static void __wrap_delete_ThreeException(zend_rsrc_list_entry *rsrc, const char *type_name TSRMLS_DC) {
  ...
  arg1 = (ThreeException *)SWIG_ZTS_ConvertResourceData(ptr,type_name,SWIGTYPE_p_ThreeException TSRMLS_CC);
  if (! arg1) zend_error(E_ERROR, "ThreeException resource already free'd");
  delete arg1;
  return;
fail:
  SWIG_FAIL();
...
ZEND_NAMED_FUNCTION(_wrap_test_catches) {
  ...
  try {
    ...
    (void)_e;
    zend_throw_exception(NULL, const_cast<char*>("C++ ThreeException const & exception thrown"), 0 TSRMLS_CC);
    return;
...
static ZEND_RSRC_DTOR_FUNC(_wrap_destroy_p_ThreeException) {
  __wrap_delete_ThreeException(rsrc, SWIGTYPE_p_ThreeException->name TSRMLS_CC);
}
/* end wrapper section */
...
static zend_function_entry catches_functions[] = {
 SWIG_ZEND_NAMED_FE(new_threeexception,_wrap_new_ThreeException,NULL)
 SWIG_ZEND_NAMED_FE(test_catches,_wrap_test_catches,NULL)
 SWIG_ZEND_NAMED_FE(test_exception_specification,_wrap_test_exception_specification,NULL)
 SWIG_ZEND_NAMED_FE(test_catches_all,_wrap_test_catches_all,NULL)
 SWIG_ZEND_NAMED_FE(swig_catches_alter_newobject,_wrap_swig_catches_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_catches_get_newobject,_wrap_swig_catches_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry catches_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"catches",
    catches_functions,
    PHP_MINIT(catches),
    PHP_MSHUTDOWN(catches),
    PHP_RINIT(catches),
    PHP_RSHUTDOWN(catches),
    PHP_MINFO(catches),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &catches_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &catches_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(catches)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(catches, catches_init_globals, catches_destroy_globals);

/* Register resource destructors for pointer types */
le_swig__p_ThreeException=zend_register_list_destructors_ex(_wrap_destroy_p_ThreeException,NULL,(char *)(SWIGTYPE_p_ThreeException->name),module_number);
SWIG_TypeClientData(SWIGTYPE_p_ThreeException,&le_swig__p_ThreeException);
