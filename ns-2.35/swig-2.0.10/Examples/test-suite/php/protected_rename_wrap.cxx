...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(protected_rename)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(protected_rename)
ZEND_DECLARE_MODULE_GLOBALS(protected_rename)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(protected_rename_globals_id, zend_protected_rename_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(protected_rename_globals_id, zend_protected_rename_globals *, error_code )
#else
#define SWIG_ErrorMsg() (protected_rename_globals.error_msg)
#define SWIG_ErrorCode() (protected_rename_globals.error_code)
#endif
...
static void protected_rename_init_globals(zend_protected_rename_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void protected_rename_destroy_globals(zend_protected_rename_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_protected_rename_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_protected_rename_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
#define SWIG_name  "protected_rename"
#ifdef __cplusplus
extern "C" {
#endif
#include "php.h"
...
#include "php_protected_rename.h"
#ifdef __cplusplus
}
#endif
...
/* wrapper section */
ZEND_NAMED_FUNCTION(_wrap_Foo_x) {
  Foo *arg1 = (Foo *) 0 ;
  zval **args[1];
  ...
  
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_Foo, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of Foo_x. Expected SWIGTYPE_p_Foo");
    }
  }
...
static zend_function_entry protected_rename_functions[] = {
 SWIG_ZEND_NAMED_FE(foo_x,_wrap_Foo_x,NULL)
 SWIG_ZEND_NAMED_FE(new_foo,_wrap_new_Foo,NULL)
 SWIG_ZEND_NAMED_FE(swig_protected_rename_alter_newobject,_wrap_swig_protected_rename_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_protected_rename_get_newobject,_wrap_swig_protected_rename_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry protected_rename_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"protected_rename",
    protected_rename_functions,
    PHP_MINIT(protected_rename),
    PHP_MSHUTDOWN(protected_rename),
    PHP_RINIT(protected_rename),
    PHP_RSHUTDOWN(protected_rename),
    PHP_MINFO(protected_rename),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &protected_rename_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &protected_rename_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(protected_rename)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(protected_rename, protected_rename_init_globals, protected_rename_destroy_globals);
...
PHP_RINIT_FUNCTION(protected_rename)
{
/* rinit section */
...
PHP_MSHUTDOWN_FUNCTION(protected_rename)
{
/* shutdown section */
#ifdef ZTS
    ts_free_id(protected_rename_globals_id);
#endif
    return SUCCESS;
}

PHP_RSHUTDOWN_FUNCTION(protected_rename)
{
/* rshutdown section */
...
PHP_MINFO_FUNCTION(protected_rename)
{
}
/* end init section */
