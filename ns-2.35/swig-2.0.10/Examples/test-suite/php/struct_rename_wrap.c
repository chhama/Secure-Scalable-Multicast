...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(struct_rename)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(struct_rename)
ZEND_DECLARE_MODULE_GLOBALS(struct_rename)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(struct_rename_globals_id, zend_struct_rename_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(struct_rename_globals_id, zend_struct_rename_globals *, error_code )
#else
#define SWIG_ErrorMsg() (struct_rename_globals.error_msg)
#define SWIG_ErrorCode() (struct_rename_globals.error_code)
#endif
...
static void struct_rename_init_globals(zend_struct_rename_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void struct_rename_destroy_globals(zend_struct_rename_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_struct_rename_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_struct_rename_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
#define SWIG_name  "struct_rename"
#ifdef __cplusplus
extern "C" {
#endif
#include "php.h"
...
/* end header section */
/* vdecl subsection */
static int le_swig__p_Foo=0; /* handle for Bar */
...
ZEND_NAMED_FUNCTION(_wrap_Bar_x_set) {
  ...
  
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_Foo, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of Bar_x_set. Expected SWIGTYPE_p_Foo");
    }
  }
...
ZEND_NAMED_FUNCTION(_wrap_Bar_x_get) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_Foo, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of Bar_x_get. Expected SWIGTYPE_p_Foo");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
  result = (int) ((arg1)->x);
...
static ZEND_RSRC_DTOR_FUNC(_wrap_destroy_p_Foo) {
  __wrap_delete_Bar(rsrc, SWIGTYPE_p_Foo->name TSRMLS_CC);
}
/* end wrapper section */
...
static zend_function_entry struct_rename_functions[] = {
 ...
 SWIG_ZEND_NAMED_FE(swig_struct_rename_alter_newobject,_wrap_swig_struct_rename_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_struct_rename_get_newobject,_wrap_swig_struct_rename_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry struct_rename_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"struct_rename",
    struct_rename_functions,
    PHP_MINIT(struct_rename),
    PHP_MSHUTDOWN(struct_rename),
    PHP_RINIT(struct_rename),
    PHP_RSHUTDOWN(struct_rename),
    PHP_MINFO(struct_rename),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &struct_rename_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &struct_rename_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(struct_rename)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(struct_rename, struct_rename_init_globals, struct_rename_destroy_globals);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(struct_rename_globals_id);
#endif
    return SUCCESS;
}
