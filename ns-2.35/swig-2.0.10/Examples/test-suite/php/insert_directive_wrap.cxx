...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(insert_directive)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(insert_directive)
ZEND_DECLARE_MODULE_GLOBALS(insert_directive)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(insert_directive_globals_id, zend_insert_directive_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(insert_directive_globals_id, zend_insert_directive_globals *, error_code )
#else
#define SWIG_ErrorMsg() (insert_directive_globals.error_msg)
#define SWIG_ErrorCode() (insert_directive_globals.error_code)
#endif
...
static void insert_directive_init_globals(zend_insert_directive_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void insert_directive_destroy_globals(zend_insert_directive_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_insert_directive_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_insert_directive_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
#define SWIG_name  "insert_directive"
#ifdef __cplusplus
extern "C" {
#endif
#include "php.h"
...
#include "php_insert_directive.h"
#ifdef __cplusplus
}
#endif
...
static zend_function_entry insert_directive_functions[] = {
 SWIG_ZEND_NAMED_FE(swig_insert_directive_alter_newobject,_wrap_swig_insert_directive_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_insert_directive_get_newobject,_wrap_swig_insert_directive_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry insert_directive_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"insert_directive",
    insert_directive_functions,
    PHP_MINIT(insert_directive),
    PHP_MSHUTDOWN(insert_directive),
    PHP_RINIT(insert_directive),
    PHP_RSHUTDOWN(insert_directive),
    PHP_MINFO(insert_directive),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &insert_directive_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &insert_directive_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(insert_directive)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(insert_directive, insert_directive_init_globals, insert_directive_destroy_globals);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(insert_directive_globals_id);
#endif
    return SUCCESS;
}
