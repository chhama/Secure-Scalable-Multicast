...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(grouping)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(grouping)
ZEND_DECLARE_MODULE_GLOBALS(grouping)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(grouping_globals_id, zend_grouping_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(grouping_globals_id, zend_grouping_globals *, error_code )
#else
#define SWIG_ErrorMsg() (grouping_globals.error_msg)
#define SWIG_ErrorCode() (grouping_globals.error_code)
#endif
...
static void grouping_init_globals(zend_grouping_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void grouping_destroy_globals(zend_grouping_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_grouping_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_grouping_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
static swig_type_info _swigt__p_f_int__int = {"_p_f_int__int", "int (*)(int)|UnaryOp *", 0, 0, (void*)0, 0};
...
/* end header section */
/* vdecl subsection */
static int le_swig__p_f_int__int=0; /* handle for _p_f_int__int */
...
ZEND_NAMED_FUNCTION(_wrap_do_unary) {
  ...
  {
    if(SWIG_ConvertPtr(*args[1], (void **) &arg2, SWIGTYPE_p_f_int__int, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 2 of do_unary. Expected SWIGTYPE_p_f_int__int");
    }
  }
...
static ZEND_RSRC_DTOR_FUNC(_wrap_destroy_p_f_int__int) {
  /* No destructor for simple type _p_f_int__int */
  efree(rsrc->ptr);
}
...
static zend_function_entry grouping_functions[] = {
 SWIG_ZEND_NAMED_FE(test1,_wrap_test1,NULL)
 SWIG_ZEND_NAMED_FE(test2,_wrap_test2,NULL)
 SWIG_ZEND_NAMED_FE(test3_set,_wrap_test3_set,NULL)
 SWIG_ZEND_NAMED_FE(test3_get,_wrap_test3_get,NULL)
 SWIG_ZEND_NAMED_FE(do_unary,_wrap_do_unary,NULL)
 SWIG_ZEND_NAMED_FE(negate,_wrap_negate,NULL)
 SWIG_ZEND_NAMED_FE(swig_grouping_alter_newobject,_wrap_swig_grouping_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_grouping_get_newobject,_wrap_swig_grouping_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry grouping_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"grouping",
    grouping_functions,
    PHP_MINIT(grouping),
    PHP_MSHUTDOWN(grouping),
    PHP_RINIT(grouping),
    PHP_RSHUTDOWN(grouping),
    PHP_MINFO(grouping),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &grouping_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &grouping_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(grouping)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(grouping, grouping_init_globals, grouping_destroy_globals);

/* Register resource destructors for pointer types */
le_swig__p_f_int__int=zend_register_list_destructors_ex(_wrap_destroy_p_f_int__int,NULL,(char *)(SWIGTYPE_p_f_int__int->name),module_number);
SWIG_TypeClientData(SWIGTYPE_p_f_int__int,&le_swig__p_f_int__int);
...
/* cinit subsection */
{
  zval *z_var;
  MAKE_STD_ZVAL(z_var);
  SWIG_SetPointerZval(z_var, (void*)negate, SWIGTYPE_p_f_int__int, 0);
  zend_constant c;
  c.value = *z_var;
  zval_copy_ctor(&c.value);
  size_t len = sizeof("NEGATE") - 1;
  c.name = zend_strndup("NEGATE", len);
  c.name_len = len+1;
...
/* vinit subsection */
{
  ...
  MAKE_STD_ZVAL(z_var);
  z_var->type = IS_LONG;
  z_var->value.lval = test3;
  zend_hash_add(&EG(symbol_table), (char*)"test3", sizeof("test3"), (void *)&z_var, sizeof(zval *), NULL);
}
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(grouping_globals_id);
#endif
    return SUCCESS;
}
