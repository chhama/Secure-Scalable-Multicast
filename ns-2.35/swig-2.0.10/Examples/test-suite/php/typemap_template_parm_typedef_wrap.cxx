...
#define SWIGTYPE_p_std__listT_unsigned_int_t swig_types[0]
#define SWIGTYPE_p_std__vectorT_unsigned_int_t swig_types[1]
...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(typemap_template_parm_typedef)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(typemap_template_parm_typedef)
ZEND_DECLARE_MODULE_GLOBALS(typemap_template_parm_typedef)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(typemap_template_parm_typedef_globals_id, zend_typemap_template_parm_typedef_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(typemap_template_parm_typedef_globals_id, zend_typemap_template_parm_typedef_globals *, error_code )
#else
#define SWIG_ErrorMsg() (typemap_template_parm_typedef_globals.error_msg)
#define SWIG_ErrorCode() (typemap_template_parm_typedef_globals.error_code)
#endif
...
static void typemap_template_parm_typedef_init_globals(zend_typemap_template_parm_typedef_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void typemap_template_parm_typedef_destroy_globals(zend_typemap_template_parm_typedef_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_typemap_template_parm_typedef_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_typemap_template_parm_typedef_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
#define SWIG_name  "typemap_template_parm_typedef"
#ifdef __cplusplus
extern "C" {
#endif
#include "php.h"
...
#include "php_typemap_template_parm_typedef.h"
#ifdef __cplusplus
}
#endif
...
static swig_type_info _swigt__p_std__listT_unsigned_int_t = {"_p_std__listT_unsigned_int_t", "std::list< unsigned int > *|std::list< jada::uint > *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_std__vectorT_unsigned_int_t = {"_p_std__vectorT_unsigned_int_t", "std::vector< unsigned int > *|std::vector< jada::uint > *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_unsigned_int = {"_p_unsigned_int", "unsigned int *|jada::uint *", 0, 0, (void*)0, 0};
...
/* end header section */
/* vdecl subsection */
static int le_swig__p_std__listT_unsigned_int_t=0; /* handle for _p_std__listT_unsigned_int_t */
static int le_swig__p_std__vectorT_unsigned_int_t=0; /* handle for _p_std__vectorT_unsigned_int_t */
...
static ZEND_RSRC_DTOR_FUNC(_wrap_destroy_p_std__listT_unsigned_int_t) {
  /* No destructor for simple type _p_std__listT_unsigned_int_t */
  efree(rsrc->ptr);
}
static ZEND_RSRC_DTOR_FUNC(_wrap_destroy_p_std__vectorT_unsigned_int_t) {
  /* No destructor for simple type _p_std__vectorT_unsigned_int_t */
  efree(rsrc->ptr);
}
...
static zend_function_entry typemap_template_parm_typedef_functions[] = {
 SWIG_ZEND_NAMED_FE(test_no_typedef,_wrap_test_no_typedef,NULL)
 SWIG_ZEND_NAMED_FE(test_typedef,_wrap_test_typedef,NULL)
 SWIG_ZEND_NAMED_FE(no_typedef_out,_wrap_no_typedef_out,NULL)
 SWIG_ZEND_NAMED_FE(swig_typemap_template_parm_typedef_alter_newobject,_wrap_swig_typemap_template_parm_typedef_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_typemap_template_parm_typedef_get_newobject,_wrap_swig_typemap_template_parm_typedef_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry typemap_template_parm_typedef_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"typemap_template_parm_typedef",
    typemap_template_parm_typedef_functions,
    PHP_MINIT(typemap_template_parm_typedef),
    PHP_MSHUTDOWN(typemap_template_parm_typedef),
    PHP_RINIT(typemap_template_parm_typedef),
    PHP_RSHUTDOWN(typemap_template_parm_typedef),
    PHP_MINFO(typemap_template_parm_typedef),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &typemap_template_parm_typedef_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &typemap_template_parm_typedef_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(typemap_template_parm_typedef)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(typemap_template_parm_typedef, typemap_template_parm_typedef_init_globals, typemap_template_parm_typedef_destroy_globals);

/* Register resource destructors for pointer types */
le_swig__p_std__listT_unsigned_int_t=zend_register_list_destructors_ex(_wrap_destroy_p_std__listT_unsigned_int_t,NULL,(char *)(SWIGTYPE_p_std__listT_unsigned_int_t->name),module_number);
SWIG_TypeClientData(SWIGTYPE_p_std__listT_unsigned_int_t,&le_swig__p_std__listT_unsigned_int_t);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(typemap_template_parm_typedef_globals_id);
#endif
    return SUCCESS;
}
