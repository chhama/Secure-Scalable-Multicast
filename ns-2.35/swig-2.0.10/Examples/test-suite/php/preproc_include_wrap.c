...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(preproc_include)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(preproc_include)
ZEND_DECLARE_MODULE_GLOBALS(preproc_include)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(preproc_include_globals_id, zend_preproc_include_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(preproc_include_globals_id, zend_preproc_include_globals *, error_code )
#else
#define SWIG_ErrorMsg() (preproc_include_globals.error_msg)
#define SWIG_ErrorCode() (preproc_include_globals.error_code)
#endif
...
static void preproc_include_init_globals(zend_preproc_include_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void preproc_include_destroy_globals(zend_preproc_include_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_preproc_include_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_preproc_include_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
static zend_function_entry preproc_include_functions[] = {
 SWIG_ZEND_NAMED_FE(multiply10,_wrap_multiply10,NULL)
 SWIG_ZEND_NAMED_FE(multiply20,_wrap_multiply20,NULL)
 SWIG_ZEND_NAMED_FE(multiply30,_wrap_multiply30,NULL)
 SWIG_ZEND_NAMED_FE(multiply40,_wrap_multiply40,NULL)
 SWIG_ZEND_NAMED_FE(multiply50,_wrap_multiply50,NULL)
 SWIG_ZEND_NAMED_FE(multiply60,_wrap_multiply60,NULL)
 SWIG_ZEND_NAMED_FE(multiply70,_wrap_multiply70,NULL)
 SWIG_ZEND_NAMED_FE(swig_preproc_include_alter_newobject,_wrap_swig_preproc_include_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_preproc_include_get_newobject,_wrap_swig_preproc_include_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry preproc_include_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"preproc_include",
    preproc_include_functions,
    PHP_MINIT(preproc_include),
    PHP_MSHUTDOWN(preproc_include),
    PHP_RINIT(preproc_include),
    PHP_RSHUTDOWN(preproc_include),
    PHP_MINFO(preproc_include),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &preproc_include_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &preproc_include_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(preproc_include)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(preproc_include, preproc_include_init_globals, preproc_include_destroy_globals);
...
/* cinit subsection */
SWIG_STRING_CONSTANT(PREPROC_INCLUDE_C, "preproc_include_c.h");
SWIG_STRING_CONSTANT(INCLUDE_E, "preproc_include_e withspace.h");
SWIG_STRING_CONSTANT(INCLUDE_F, "preproc_include_f withspace.h");
SWIG_LONG_CONSTANT(const1, 1);
SWIG_LONG_CONSTANT(const2, 2);
SWIG_LONG_CONSTANT(const3, 3);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(preproc_include_globals_id);
#endif
    return SUCCESS;
}
