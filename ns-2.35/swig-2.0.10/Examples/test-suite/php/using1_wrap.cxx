...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(using1)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(using1)
ZEND_DECLARE_MODULE_GLOBALS(using1)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(using1_globals_id, zend_using1_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(using1_globals_id, zend_using1_globals *, error_code )
#else
#define SWIG_ErrorMsg() (using1_globals.error_msg)
#define SWIG_ErrorCode() (using1_globals.error_code)
#endif
...
static void using1_init_globals(zend_using1_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void using1_destroy_globals(zend_using1_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_using1_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_using1_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
ZEND_NAMED_FUNCTION(_wrap_spam) {
  ...
  arg1 = (X::Foo::value_type) Z_LVAL_PP(args[0]);
  /*@SWIG@*/;
...
static zend_function_entry using1_functions[] = {
 SWIG_ZEND_NAMED_FE(new__fooimpl,_wrap_new__FooImpl,NULL)
 SWIG_ZEND_NAMED_FE(spam,_wrap_spam,NULL)
 SWIG_ZEND_NAMED_FE(swig_using1_alter_newobject,_wrap_swig_using1_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_using1_get_newobject,_wrap_swig_using1_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry using1_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"using1",
    using1_functions,
    PHP_MINIT(using1),
    PHP_MSHUTDOWN(using1),
    PHP_RINIT(using1),
    PHP_RSHUTDOWN(using1),
    PHP_MINFO(using1),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &using1_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &using1_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(using1)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(using1, using1_init_globals, using1_destroy_globals);
...
PHP_MSHUTDOWN_FUNCTION(using1)
{
/* shutdown section */
#ifdef ZTS
    ts_free_id(using1_globals_id);
#endif
    return SUCCESS;
}

PHP_RSHUTDOWN_FUNCTION(using1)
{
/* rshutdown section */
