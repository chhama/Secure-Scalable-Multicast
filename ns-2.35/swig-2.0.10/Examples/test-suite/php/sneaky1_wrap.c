...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(sneaky1)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(sneaky1)
ZEND_DECLARE_MODULE_GLOBALS(sneaky1)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(sneaky1_globals_id, zend_sneaky1_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(sneaky1_globals_id, zend_sneaky1_globals *, error_code )
#else
#define SWIG_ErrorMsg() (sneaky1_globals.error_msg)
#define SWIG_ErrorCode() (sneaky1_globals.error_code)
#endif
...
static void sneaky1_init_globals(zend_sneaky1_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void sneaky1_destroy_globals(zend_sneaky1_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_sneaky1_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_sneaky1_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
static swig_type_info _swigt__p_f_int_int__int = {"_p_f_int_int__int", "int (*)(int,int)|binop *", 0, 0, (void*)0, 0};
...
static zend_function_entry sneaky1_functions[] = {
 SWIG_ZEND_NAMED_FE(add,_wrap_add,NULL)
 SWIG_ZEND_NAMED_FE(subtract,_wrap_subtract,NULL)
 SWIG_ZEND_NAMED_FE(mul,_wrap_mul,NULL)
 SWIG_ZEND_NAMED_FE(divide,_wrap_divide,NULL)
 SWIG_ZEND_NAMED_FE(swig_sneaky1_alter_newobject,_wrap_swig_sneaky1_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_sneaky1_get_newobject,_wrap_swig_sneaky1_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry sneaky1_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"sneaky1",
    sneaky1_functions,
    PHP_MINIT(sneaky1),
    PHP_MSHUTDOWN(sneaky1),
    PHP_RINIT(sneaky1),
    PHP_RSHUTDOWN(sneaky1),
    PHP_MINFO(sneaky1),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &sneaky1_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &sneaky1_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(sneaky1)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(sneaky1, sneaky1_init_globals, sneaky1_destroy_globals);
