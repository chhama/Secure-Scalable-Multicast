...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(name_cxx)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(name_cxx)
ZEND_DECLARE_MODULE_GLOBALS(name_cxx)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(name_cxx_globals_id, zend_name_cxx_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(name_cxx_globals_id, zend_name_cxx_globals *, error_code )
#else
#define SWIG_ErrorMsg() (name_cxx_globals.error_msg)
#define SWIG_ErrorCode() (name_cxx_globals.error_code)
#endif
...
static void name_cxx_init_globals(zend_name_cxx_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void name_cxx_destroy_globals(zend_name_cxx_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_name_cxx_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_name_cxx_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
/* end header section */
/* vdecl subsection */
static int le_swig__p_A=0; /* handle for AA */
...
static ZEND_RSRC_DTOR_FUNC(_wrap_destroy_p_A) {
  __wrap_delete_AA(rsrc, SWIGTYPE_p_A->name TSRMLS_CC);
}
...
static zend_function_entry name_cxx_functions[] = {
 SWIG_ZEND_NAMED_FE(bar_int,_wrap_bar_int,NULL)
 SWIG_ZEND_NAMED_FE(bar_double,_wrap_bar_double,NULL)
 SWIG_ZEND_NAMED_FE(new_aa,_wrap_new_AA,NULL)
 SWIG_ZEND_NAMED_FE(new_b,_wrap_new_B,NULL)
 SWIG_ZEND_NAMED_FE(swig_name_cxx_alter_newobject,_wrap_swig_name_cxx_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_name_cxx_get_newobject,_wrap_swig_name_cxx_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry name_cxx_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"name_cxx",
    name_cxx_functions,
    PHP_MINIT(name_cxx),
    PHP_MSHUTDOWN(name_cxx),
    PHP_RINIT(name_cxx),
    PHP_RSHUTDOWN(name_cxx),
    PHP_MINFO(name_cxx),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &name_cxx_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &name_cxx_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(name_cxx)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(name_cxx, name_cxx_init_globals, name_cxx_destroy_globals);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(name_cxx_globals_id);
#endif
    return SUCCESS;
}
