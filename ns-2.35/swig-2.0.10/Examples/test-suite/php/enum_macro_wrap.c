...
#define SWIGTYPE_p_Greeks12 swig_types[1]
...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(enum_macro)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(enum_macro)
ZEND_DECLARE_MODULE_GLOBALS(enum_macro)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(enum_macro_globals_id, zend_enum_macro_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(enum_macro_globals_id, zend_enum_macro_globals *, error_code )
#else
#define SWIG_ErrorMsg() (enum_macro_globals.error_msg)
#define SWIG_ErrorCode() (enum_macro_globals.error_code)
#endif
...
static void enum_macro_init_globals(zend_enum_macro_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void enum_macro_destroy_globals(zend_enum_macro_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_enum_macro_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_enum_macro_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
static int le_swig__p_Greeks12=0; /* handle for _p_Greeks12 */
...
static ZEND_RSRC_DTOR_FUNC(_wrap_destroy_p_Greeks12) {
  /* No destructor for simple type _p_Greeks12 */
  efree(rsrc->ptr);
}
/* end wrapper section */
...
static zend_function_entry enum_macro_functions[] = {
 SWIG_ZEND_NAMED_FE(swig_enum_macro_alter_newobject,_wrap_swig_enum_macro_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_enum_macro_get_newobject,_wrap_swig_enum_macro_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry enum_macro_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"enum_macro",
    enum_macro_functions,
    PHP_MINIT(enum_macro),
    PHP_MSHUTDOWN(enum_macro),
    PHP_RINIT(enum_macro),
    PHP_RSHUTDOWN(enum_macro),
    PHP_MINFO(enum_macro),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &enum_macro_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &enum_macro_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(enum_macro)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(enum_macro, enum_macro_init_globals, enum_macro_destroy_globals);
...
le_swig__p_Greeks12=zend_register_list_destructors_ex(_wrap_destroy_p_Greeks12,NULL,(char *)(SWIGTYPE_p_Greeks12->name),module_number);
SWIG_TypeClientData(SWIGTYPE_p_Greeks12,&le_swig__p_Greeks12);
CG(active_class_entry) = NULL;
/* end oinit subsection */

/* cinit subsection */
SWIG_LONG_CONSTANT(alpha1, alpha1);
SWIG_LONG_CONSTANT(beta1, beta1);
SWIG_LONG_CONSTANT(theta1, theta1);
SWIG_LONG_CONSTANT(alpha2, alpha2);
SWIG_LONG_CONSTANT(beta2, beta2);
SWIG_LONG_CONSTANT(theta2, theta2);
SWIG_LONG_CONSTANT(alpha3, alpha3);
SWIG_LONG_CONSTANT(beta3, beta3);
SWIG_LONG_CONSTANT(theta3, theta3);
SWIG_LONG_CONSTANT(alpha4, alpha4);
SWIG_LONG_CONSTANT(beta4, beta4);
SWIG_LONG_CONSTANT(theta4, theta4);
SWIG_LONG_CONSTANT(alpha5, alpha5);
SWIG_LONG_CONSTANT(beta5, beta5);
SWIG_LONG_CONSTANT(alpha6, alpha6);
SWIG_LONG_CONSTANT(beta6, beta6);
SWIG_LONG_CONSTANT(alpha7, alpha7);
SWIG_LONG_CONSTANT(beta7, beta7);
SWIG_LONG_CONSTANT(theta8, theta8);
SWIG_LONG_CONSTANT(theta9, theta9);
SWIG_LONG_CONSTANT(theta10, theta10);
SWIG_LONG_CONSTANT(theta11, theta11);
SWIG_LONG_CONSTANT(theta12, theta12);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(enum_macro_globals_id);
#endif
    return SUCCESS;
}
