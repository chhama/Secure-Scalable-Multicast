...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(char_constant)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(char_constant)
ZEND_DECLARE_MODULE_GLOBALS(char_constant)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(char_constant_globals_id, zend_char_constant_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(char_constant_globals_id, zend_char_constant_globals *, error_code )
#else
#define SWIG_ErrorMsg() (char_constant_globals.error_msg)
#define SWIG_ErrorCode() (char_constant_globals.error_code)
#endif
...
static void char_constant_init_globals(zend_char_constant_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void char_constant_destroy_globals(zend_char_constant_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_char_constant_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_char_constant_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
#define SWIG_name  "char_constant"
#ifdef __cplusplus
extern "C" {
#endif
#include "php.h"
...
static zend_function_entry char_constant_functions[] = {
 SWIG_ZEND_NAMED_FE(ia_get,_wrap_ia_get,NULL)
 SWIG_ZEND_NAMED_FE(ib_get,_wrap_ib_get,NULL)
 SWIG_ZEND_NAMED_FE(swig_char_constant_alter_newobject,_wrap_swig_char_constant_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_char_constant_get_newobject,_wrap_swig_char_constant_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry char_constant_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"char_constant",
    char_constant_functions,
    PHP_MINIT(char_constant),
    PHP_MSHUTDOWN(char_constant),
    PHP_RINIT(char_constant),
    PHP_RSHUTDOWN(char_constant),
    PHP_MINFO(char_constant),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &char_constant_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &char_constant_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(char_constant)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(char_constant, char_constant_init_globals, char_constant_destroy_globals);
...
/* cinit subsection */
SWIG_CHAR_CONSTANT(CHAR_CONSTANT, 'x');
SWIG_STRING_CONSTANT(STRING_CONSTANT, "xyzzy");
SWIG_CHAR_CONSTANT(ESC_CONST, '\1');
SWIG_CHAR_CONSTANT(NULL_CONST, '\0');
SWIG_CHAR_CONSTANT(SPECIALCHAR, '\341');
...
/* vinit subsection */
{
  ...
  z_var->type = IS_LONG;
  z_var->value.lval = ia;
  zend_hash_add(&EG(symbol_table), (char*)"ia", sizeof("ia"), (void *)&z_var, sizeof(zval *), NULL);
}
{
  zval *z_var;
  MAKE_STD_ZVAL(z_var);
  z_var->type = IS_LONG;
  z_var->value.lval = ib;
  zend_hash_add(&EG(symbol_table), (char*)"ib", sizeof("ib"), (void *)&z_var, sizeof(zval *), NULL);
}
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(char_constant_globals_id);
#endif
    return SUCCESS;
}
