...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(template_construct)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(template_construct)
ZEND_DECLARE_MODULE_GLOBALS(template_construct)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(template_construct_globals_id, zend_template_construct_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(template_construct_globals_id, zend_template_construct_globals *, error_code )
#else
#define SWIG_ErrorMsg() (template_construct_globals.error_msg)
#define SWIG_ErrorCode() (template_construct_globals.error_code)
#endif
...
static void template_construct_init_globals(zend_template_construct_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void template_construct_destroy_globals(zend_template_construct_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_template_construct_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_template_construct_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
#define SWIG_name  "template_construct"
#ifdef __cplusplus
extern "C" {
#endif
#include "php.h"
...
#include "php_template_construct.h"
#ifdef __cplusplus
}
#endif
...
static zend_function_entry template_construct_functions[] = {
 SWIG_ZEND_NAMED_FE(new_foo_int,_wrap_new_Foo_int,NULL)
 SWIG_ZEND_NAMED_FE(swig_template_construct_alter_newobject,_wrap_swig_template_construct_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_template_construct_get_newobject,_wrap_swig_template_construct_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry template_construct_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"template_construct",
    template_construct_functions,
    PHP_MINIT(template_construct),
    PHP_MSHUTDOWN(template_construct),
    PHP_RINIT(template_construct),
    PHP_RSHUTDOWN(template_construct),
    PHP_MINFO(template_construct),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &template_construct_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &template_construct_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(template_construct)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(template_construct, template_construct_init_globals, template_construct_destroy_globals);
...
PHP_RINIT_FUNCTION(template_construct)
{
/* rinit section */
...
PHP_MSHUTDOWN_FUNCTION(template_construct)
{
/* shutdown section */
#ifdef ZTS
    ts_free_id(template_construct_globals_id);
#endif
    return SUCCESS;
}

PHP_RSHUTDOWN_FUNCTION(template_construct)
{
/* rshutdown section */
...
PHP_MINFO_FUNCTION(template_construct)
{
}
/* end init section */
