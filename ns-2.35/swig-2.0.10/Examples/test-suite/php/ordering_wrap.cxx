...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(ordering)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(ordering)
ZEND_DECLARE_MODULE_GLOBALS(ordering)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(ordering_globals_id, zend_ordering_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(ordering_globals_id, zend_ordering_globals *, error_code )
#else
#define SWIG_ErrorMsg() (ordering_globals.error_msg)
#define SWIG_ErrorCode() (ordering_globals.error_code)
#endif
...
static void ordering_init_globals(zend_ordering_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void ordering_destroy_globals(zend_ordering_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_ordering_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_ordering_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
ZEND_NAMED_FUNCTION(_wrap_Klass_variable_set) {
  ...
  
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_Klass, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of Klass_variable_set. Expected SWIGTYPE_p_Klass");
    }
  }
...
ZEND_NAMED_FUNCTION(_wrap_Klass_variable_get) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_Klass, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of Klass_variable_get. Expected SWIGTYPE_p_Klass");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
...
static zend_function_entry ordering_functions[] = {
 SWIG_ZEND_NAMED_FE(klass_variable_set,_wrap_Klass_variable_set,NULL)
 SWIG_ZEND_NAMED_FE(klass_variable_get,_wrap_Klass_variable_get,NULL)
 SWIG_ZEND_NAMED_FE(new_klass,_wrap_new_Klass,NULL)
 SWIG_ZEND_NAMED_FE(swig_ordering_alter_newobject,_wrap_swig_ordering_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_ordering_get_newobject,_wrap_swig_ordering_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry ordering_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"ordering",
    ordering_functions,
    PHP_MINIT(ordering),
    PHP_MSHUTDOWN(ordering),
    PHP_RINIT(ordering),
    PHP_RSHUTDOWN(ordering),
    PHP_MINFO(ordering),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &ordering_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &ordering_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(ordering)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(ordering, ordering_init_globals, ordering_destroy_globals);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(ordering_globals_id);
#endif
    return SUCCESS;
}
