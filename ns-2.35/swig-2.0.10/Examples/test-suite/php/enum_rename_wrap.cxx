...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(enum_rename)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(enum_rename)
ZEND_DECLARE_MODULE_GLOBALS(enum_rename)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(enum_rename_globals_id, zend_enum_rename_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(enum_rename_globals_id, zend_enum_rename_globals *, error_code )
#else
#define SWIG_ErrorMsg() (enum_rename_globals.error_msg)
#define SWIG_ErrorCode() (enum_rename_globals.error_code)
#endif
...
static void enum_rename_init_globals(zend_enum_rename_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void enum_rename_destroy_globals(zend_enum_rename_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_enum_rename_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_enum_rename_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
static zend_function_entry enum_rename_functions[] = {
 SWIG_ZEND_NAMED_FE(swig_enum_rename_alter_newobject,_wrap_swig_enum_rename_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_enum_rename_get_newobject,_wrap_swig_enum_rename_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry enum_rename_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"enum_rename",
    enum_rename_functions,
    PHP_MINIT(enum_rename),
    PHP_MSHUTDOWN(enum_rename),
    PHP_RINIT(enum_rename),
    PHP_RSHUTDOWN(enum_rename),
    PHP_MINFO(enum_rename),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &enum_rename_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &enum_rename_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(enum_rename)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(enum_rename, enum_rename_init_globals, enum_rename_destroy_globals);
...
/* cinit subsection */
SWIG_LONG_CONSTANT(M_Jan, M_Jan);
SWIG_LONG_CONSTANT(May, M_May);
SWIG_LONG_CONSTANT(M_Dec, M_Dec);
SWIG_LONG_CONSTANT(S_Can, S_Can);
SWIG_LONG_CONSTANT(S_Must, S_Must);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(enum_rename_globals_id);
#endif
    return SUCCESS;
}
