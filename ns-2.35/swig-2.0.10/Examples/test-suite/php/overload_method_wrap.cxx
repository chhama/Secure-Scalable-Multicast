...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(overload_method)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(overload_method)
ZEND_DECLARE_MODULE_GLOBALS(overload_method)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(overload_method_globals_id, zend_overload_method_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(overload_method_globals_id, zend_overload_method_globals *, error_code )
#else
#define SWIG_ErrorMsg() (overload_method_globals.error_msg)
#define SWIG_ErrorCode() (overload_method_globals.error_code)
#endif
...
static void overload_method_init_globals(zend_overload_method_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void overload_method_destroy_globals(zend_overload_method_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_overload_method_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_overload_method_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
#define SWIG_name  "overload_method"
#ifdef __cplusplus
extern "C" {
#endif
#include "php.h"
...
ZEND_NAMED_FUNCTION(_wrap_Base_overloaded_method__SWIG_0) {
  Base *arg1 = (Base *) 0 ;
  int arg2 ;
  zval **args[2];
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_Base, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of Base_overloaded_method. Expected SWIGTYPE_p_Base");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
...
ZEND_NAMED_FUNCTION(_wrap_Base_overloaded_method__SWIG_1) {
  Base *arg1 = (Base *) 0 ;
  zval **args[1];
  int result;
  ...
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
  result = (int)((Base const *)arg1)->overloaded_method();
  {
    ZVAL_LONG(return_value,result);
  }
  return;
...
ZEND_NAMED_FUNCTION(_wrap_Base_overloaded_method) {
  ...
  if (argc == 1) {
    ...
    if (_v) {
      _wrap_Base_overloaded_method__SWIG_1(INTERNAL_FUNCTION_PARAM_PASSTHRU); return;
    }
  }
  if (argc == 2) {
    int _v;
    ...
    if (_v) {
      ...
      if (_v) {
        _wrap_Base_overloaded_method__SWIG_0(INTERNAL_FUNCTION_PARAM_PASSTHRU); return;
      }
    }
  }
  
  SWIG_ErrorCode() = E_ERROR;
  SWIG_ErrorMsg() = "No matching function for overloaded 'Base_overloaded_method'";
  SWIG_FAIL();
}
...
static zend_function_entry overload_method_functions[] = {
 SWIG_ZEND_NAMED_FE(new_base,_wrap_new_Base,NULL)
 SWIG_ZEND_NAMED_FE(base_method,_wrap_Base_method,NULL)
 SWIG_ZEND_NAMED_FE(base_overloaded_method,_wrap_Base_overloaded_method,NULL)
 SWIG_ZEND_NAMED_FE(swig_overload_method_alter_newobject,_wrap_swig_overload_method_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_overload_method_get_newobject,_wrap_swig_overload_method_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry overload_method_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"overload_method",
    overload_method_functions,
    PHP_MINIT(overload_method),
    PHP_MSHUTDOWN(overload_method),
    PHP_RINIT(overload_method),
    PHP_RSHUTDOWN(overload_method),
    PHP_MINFO(overload_method),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &overload_method_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &overload_method_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(overload_method)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(overload_method, overload_method_init_globals, overload_method_destroy_globals);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(overload_method_globals_id);
#endif
    return SUCCESS;
}
