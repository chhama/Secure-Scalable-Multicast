...
#define SWIGTYPE_p_unsigned_long_long swig_types[2]
#define SWIGTYPE_unsigned_long_long swig_types[3]
...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(long_long)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(long_long)
ZEND_DECLARE_MODULE_GLOBALS(long_long)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(long_long_globals_id, zend_long_long_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(long_long_globals_id, zend_long_long_globals *, error_code )
#else
#define SWIG_ErrorMsg() (long_long_globals.error_msg)
#define SWIG_ErrorCode() (long_long_globals.error_code)
#endif
...
static void long_long_init_globals(zend_long_long_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void long_long_destroy_globals(zend_long_long_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_long_long_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_long_long_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
static zend_function_entry long_long_functions[] = {
 SWIG_ZEND_NAMED_FE(foo1,_wrap_foo1,NULL)
 SWIG_ZEND_NAMED_FE(foo2,_wrap_foo2,NULL)
 SWIG_ZEND_NAMED_FE(foo3,_wrap_foo3,NULL)
 SWIG_ZEND_NAMED_FE(foo4,_wrap_foo4,NULL)
 SWIG_ZEND_NAMED_FE(foo5,_wrap_foo5,NULL)
 SWIG_ZEND_NAMED_FE(foo6,_wrap_foo6,NULL)
 SWIG_ZEND_NAMED_FE(bar1,_wrap_bar1,NULL)
 SWIG_ZEND_NAMED_FE(bar2,_wrap_bar2,NULL)
 SWIG_ZEND_NAMED_FE(bar3,_wrap_bar3,NULL)
 SWIG_ZEND_NAMED_FE(bar4,_wrap_bar4,NULL)
 SWIG_ZEND_NAMED_FE(bar5,_wrap_bar5,NULL)
 SWIG_ZEND_NAMED_FE(bar6,_wrap_bar6,NULL)
 SWIG_ZEND_NAMED_FE(ll_set,_wrap_ll_set,NULL)
 SWIG_ZEND_NAMED_FE(ll_get,_wrap_ll_get,NULL)
 SWIG_ZEND_NAMED_FE(ull_set,_wrap_ull_set,NULL)
 SWIG_ZEND_NAMED_FE(ull_get,_wrap_ull_get,NULL)
 SWIG_ZEND_NAMED_FE(swig_long_long_alter_newobject,_wrap_swig_long_long_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_long_long_get_newobject,_wrap_swig_long_long_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry long_long_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"long_long",
    long_long_functions,
    PHP_MINIT(long_long),
    PHP_MSHUTDOWN(long_long),
    PHP_RINIT(long_long),
    PHP_RSHUTDOWN(long_long),
    PHP_MINFO(long_long),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &long_long_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &long_long_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(long_long)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(long_long, long_long_init_globals, long_long_destroy_globals);
...
/* vinit subsection */
{
  ...
  MAKE_STD_ZVAL(z_var);
  SWIG_SetPointerZval(z_var, (void*)&ll, SWIGTYPE_p_long_long, 0);
  zend_hash_add(&EG(symbol_table), (char*)"ll", sizeof("ll"), (void*)&z_var,
  sizeof(zval *), NULL);
}
{
  zval *z_var;
  ...
  MAKE_STD_ZVAL(z_var);
  SWIG_SetPointerZval(z_var, (void*)&ull, SWIGTYPE_p_unsigned_long_long, 0);
  zend_hash_add(&EG(symbol_table), (char*)"ull", sizeof("ull"), (void*)&z_var,
  sizeof(zval *), NULL);
}
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(long_long_globals_id);
#endif
    return SUCCESS;
}
