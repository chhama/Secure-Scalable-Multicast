...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(add_link)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(add_link)
ZEND_DECLARE_MODULE_GLOBALS(add_link)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(add_link_globals_id, zend_add_link_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(add_link_globals_id, zend_add_link_globals *, error_code )
#else
#define SWIG_ErrorMsg() (add_link_globals.error_msg)
#define SWIG_ErrorCode() (add_link_globals.error_code)
#endif
...
static void add_link_init_globals(zend_add_link_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void add_link_destroy_globals(zend_add_link_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_add_link_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_add_link_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
static zend_function_entry add_link_functions[] = {
 SWIG_ZEND_NAMED_FE(new_foo,_wrap_new_Foo,NULL)
 SWIG_ZEND_NAMED_FE(foo_blah,_wrap_Foo_blah,NULL)
 SWIG_ZEND_NAMED_FE(swig_add_link_alter_newobject,_wrap_swig_add_link_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_add_link_get_newobject,_wrap_swig_add_link_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry add_link_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"add_link",
    add_link_functions,
    PHP_MINIT(add_link),
    PHP_MSHUTDOWN(add_link),
    PHP_RINIT(add_link),
    PHP_RSHUTDOWN(add_link),
    PHP_MINFO(add_link),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &add_link_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &add_link_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(add_link)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(add_link, add_link_init_globals, add_link_destroy_globals);
...
PHP_MSHUTDOWN_FUNCTION(add_link)
{
/* shutdown section */
#ifdef ZTS
    ts_free_id(add_link_globals_id);
#endif
    return SUCCESS;
}

PHP_RSHUTDOWN_FUNCTION(add_link)
{
/* rshutdown section */
