...
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(inherit_globals_id, zend_inherit_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(inherit_globals_id, zend_inherit_globals *, error_code )
#else
#define SWIG_ErrorMsg() (inherit_globals.error_msg)
#define SWIG_ErrorCode() (inherit_globals.error_code)
#endif
...
static void inherit_init_globals(zend_inherit_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void inherit_destroy_globals(zend_inherit_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_inherit_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_inherit_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
static swig_type_info _swigt__p_CDerived = {"_p_CDerived", "CDerived *", 0, 0, (void*)0, 0};
...
/* end header section */
/* vdecl subsection */
static int le_swig__p_CBase=0; /* handle for CBase */
static int le_swig__p_CDerived=0; /* handle for CDerived */
...
ZEND_NAMED_FUNCTION(_wrap_CBase_Foo) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_CBase, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of CBase_Foo. Expected SWIGTYPE_p_CBase");
    }
  }
...
ZEND_NAMED_FUNCTION(_wrap_new_CBase) {
  ...
  SWIG_SetPointerZval(return_value, (void *)result, SWIGTYPE_p_CBase, 1);
...
static void __wrap_delete_CBase(zend_rsrc_list_entry *rsrc, const char *type_name TSRMLS_DC) {
  ...
  arg1 = (CBase *)SWIG_ZTS_ConvertResourceData(ptr,type_name,SWIGTYPE_p_CBase TSRMLS_CC);
  if (! arg1) zend_error(E_ERROR, "CBase resource already free'd");
  delete arg1;
  return;
fail:
  SWIG_FAIL();
...
ZEND_NAMED_FUNCTION(_wrap_new_CDerived) {
  ...
  SWIG_SetPointerZval(return_value, (void *)result, SWIGTYPE_p_CDerived, 1);
...
static void __wrap_delete_CDerived(zend_rsrc_list_entry *rsrc, const char *type_name TSRMLS_DC) {
  ...
  efree(value);
  if (! newobject) return; /* can't delete it! */
  arg1 = (CDerived *)SWIG_ZTS_ConvertResourceData(ptr,type_name,SWIGTYPE_p_CDerived TSRMLS_CC);
  if (! arg1) zend_error(E_ERROR, "CDerived resource already free'd");
  delete arg1;
  return;
fail:
  SWIG_FAIL();
...
static ZEND_RSRC_DTOR_FUNC(_wrap_destroy_p_CBase) {
  __wrap_delete_CBase(rsrc, SWIGTYPE_p_CBase->name TSRMLS_CC);
}
static ZEND_RSRC_DTOR_FUNC(_wrap_destroy_p_CDerived) {
  __wrap_delete_CDerived(rsrc, SWIGTYPE_p_CDerived->name TSRMLS_CC);
}
/* end wrapper section */
...
static zend_function_entry inherit_functions[] = {
 ...
 SWIG_ZEND_NAMED_FE(swig_inherit_alter_newobject,_wrap_swig_inherit_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_inherit_get_newobject,_wrap_swig_inherit_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
zend_module_entry* SWIG_module_entry = &inherit_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &inherit_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(inherit)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(inherit, inherit_init_globals, inherit_destroy_globals);

/* Register resource destructors for pointer types */
le_swig__p_CBase=zend_register_list_destructors_ex(_wrap_destroy_p_CBase,NULL,(char *)(SWIGTYPE_p_CBase->name),module_number);
SWIG_TypeClientData(SWIGTYPE_p_CBase,&le_swig__p_CBase);
le_swig__p_CDerived=zend_register_list_destructors_ex(_wrap_destroy_p_CDerived,NULL,(char *)(SWIGTYPE_p_CDerived->name),module_number);
SWIG_TypeClientData(SWIGTYPE_p_CDerived,&le_swig__p_CDerived);
