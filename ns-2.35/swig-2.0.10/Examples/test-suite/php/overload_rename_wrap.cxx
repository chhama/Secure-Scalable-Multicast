...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(overload_rename)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(overload_rename)
ZEND_DECLARE_MODULE_GLOBALS(overload_rename)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(overload_rename_globals_id, zend_overload_rename_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(overload_rename_globals_id, zend_overload_rename_globals *, error_code )
#else
#define SWIG_ErrorMsg() (overload_rename_globals.error_msg)
#define SWIG_ErrorCode() (overload_rename_globals.error_code)
#endif
...
static void overload_rename_init_globals(zend_overload_rename_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void overload_rename_destroy_globals(zend_overload_rename_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_overload_rename_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_overload_rename_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
#define SWIG_name  "overload_rename"
#ifdef __cplusplus
extern "C" {
#endif
#include "php.h"
...
static zend_function_entry overload_rename_functions[] = {
 SWIG_ZEND_NAMED_FE(new_foo,_wrap_new_Foo,NULL)
 SWIG_ZEND_NAMED_FE(new_foo_int,_wrap_new_Foo_int,NULL)
 SWIG_ZEND_NAMED_FE(swig_overload_rename_alter_newobject,_wrap_swig_overload_rename_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_overload_rename_get_newobject,_wrap_swig_overload_rename_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry overload_rename_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"overload_rename",
    overload_rename_functions,
    PHP_MINIT(overload_rename),
    PHP_MSHUTDOWN(overload_rename),
    PHP_RINIT(overload_rename),
    PHP_RSHUTDOWN(overload_rename),
    PHP_MINFO(overload_rename),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &overload_rename_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &overload_rename_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(overload_rename)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(overload_rename, overload_rename_init_globals, overload_rename_destroy_globals);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(overload_rename_globals_id);
#endif
    return SUCCESS;
}
