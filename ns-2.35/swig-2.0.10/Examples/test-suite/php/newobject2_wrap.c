...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(newobject2)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(newobject2)
ZEND_DECLARE_MODULE_GLOBALS(newobject2)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(newobject2_globals_id, zend_newobject2_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(newobject2_globals_id, zend_newobject2_globals *, error_code )
#else
#define SWIG_ErrorMsg() (newobject2_globals.error_msg)
#define SWIG_ErrorCode() (newobject2_globals.error_code)
#endif
...
static void newobject2_init_globals(zend_newobject2_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void newobject2_destroy_globals(zend_newobject2_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_newobject2_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_newobject2_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
ZEND_NAMED_FUNCTION(_wrap_do_stuff) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_Foo, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of do_stuff. Expected SWIGTYPE_p_Foo");
    }
  }
  do_stuff(arg1);
...
static zend_function_entry newobject2_functions[] = {
 ...
 SWIG_ZEND_NAMED_FE(makefoo,_wrap_makeFoo,NULL)
 SWIG_ZEND_NAMED_FE(foocount,_wrap_fooCount,NULL)
 SWIG_ZEND_NAMED_FE(do_stuff,_wrap_do_stuff,NULL)
 SWIG_ZEND_NAMED_FE(swig_newobject2_alter_newobject,_wrap_swig_newobject2_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_newobject2_get_newobject,_wrap_swig_newobject2_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry newobject2_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"newobject2",
    newobject2_functions,
    PHP_MINIT(newobject2),
    PHP_MSHUTDOWN(newobject2),
    PHP_RINIT(newobject2),
    PHP_RSHUTDOWN(newobject2),
    PHP_MINFO(newobject2),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &newobject2_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &newobject2_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(newobject2)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(newobject2, newobject2_init_globals, newobject2_destroy_globals);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(newobject2_globals_id);
#endif
    return SUCCESS;
}
