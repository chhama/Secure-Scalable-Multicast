...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(director_thread)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(director_thread)
ZEND_DECLARE_MODULE_GLOBALS(director_thread)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(director_thread_globals_id, zend_director_thread_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(director_thread_globals_id, zend_director_thread_globals *, error_code )
#else
#define SWIG_ErrorMsg() (director_thread_globals.error_msg)
#define SWIG_ErrorCode() (director_thread_globals.error_code)
#endif
...
static void director_thread_init_globals(zend_director_thread_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void director_thread_destroy_globals(zend_director_thread_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_director_thread_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_director_thread_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
#define SWIG_name  "director_thread"
#ifdef __cplusplus
extern "C" {
#endif
#include "php.h"
...
void SwigDirector_Foo::do_foo() {
  ...
  ZVAL_STRINGL(&funcname, (char *)"do_foo", 6, 0);
  if (!swig_self) {
...
/* wrapper section */
ZEND_NAMED_FUNCTION(_wrap_MilliSecondSleep) {
  int arg1 ;
  zval **args[1];
...
ZEND_NAMED_FUNCTION(_wrap_Foo_stop) {
  Foo *arg1 = (Foo *) 0 ;
  zval **args[1];
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_Foo, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of Foo_stop. Expected SWIGTYPE_p_Foo");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
  (arg1)->stop();
...
ZEND_NAMED_FUNCTION(_wrap_Foo_run) {
  Foo *arg1 = (Foo *) 0 ;
  zval **args[1];
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_Foo, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of Foo_run. Expected SWIGTYPE_p_Foo");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
  (arg1)->run();
...
ZEND_NAMED_FUNCTION(_wrap_Foo_do_foo) {
  Foo *arg1 = (Foo *) 0 ;
  zval **args[1];
  ...
  upcall = !director->swig_is_overridden_method((char *)"Foo", (char *)"do_foo");
  SWIG_ResetError();
  if(ZEND_NUM_ARGS() != 1 || zend_get_parameters_array_ex(1, args) != SUCCESS) {
    WRONG_PARAM_COUNT;
  }
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_Foo, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of Foo_do_foo. Expected SWIGTYPE_p_Foo");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
  if (upcall) {
...
static zend_function_entry director_thread_functions[] = {
 SWIG_ZEND_NAMED_FE(millisecondsleep,_wrap_MilliSecondSleep,NULL)
 ...
 SWIG_ZEND_NAMED_FE(foo_stop,_wrap_Foo_stop,NULL)
 SWIG_ZEND_NAMED_FE(foo_run,_wrap_Foo_run,NULL)
 SWIG_ZEND_NAMED_FE(foo_do_foo,_wrap_Foo_do_foo,NULL)
 SWIG_ZEND_NAMED_FE(swig_director_thread_alter_newobject,_wrap_swig_director_thread_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_director_thread_get_newobject,_wrap_swig_director_thread_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry director_thread_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"director_thread",
    director_thread_functions,
    PHP_MINIT(director_thread),
    PHP_MSHUTDOWN(director_thread),
    PHP_RINIT(director_thread),
    PHP_RSHUTDOWN(director_thread),
    PHP_MINFO(director_thread),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &director_thread_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &director_thread_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(director_thread)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(director_thread, director_thread_init_globals, director_thread_destroy_globals);
...
PHP_RINIT_FUNCTION(director_thread)
{
/* rinit section */
...
PHP_MSHUTDOWN_FUNCTION(director_thread)
{
/* shutdown section */
#ifdef ZTS
    ts_free_id(director_thread_globals_id);
#endif
    return SUCCESS;
}

PHP_RSHUTDOWN_FUNCTION(director_thread)
{
/* rshutdown section */
...
PHP_MINFO_FUNCTION(director_thread)
{
}
/* end init section */
