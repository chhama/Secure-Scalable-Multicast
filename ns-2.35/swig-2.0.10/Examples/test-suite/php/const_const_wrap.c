...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(const_const)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(const_const)
ZEND_DECLARE_MODULE_GLOBALS(const_const)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(const_const_globals_id, zend_const_const_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(const_const_globals_id, zend_const_const_globals *, error_code )
#else
#define SWIG_ErrorMsg() (const_const_globals.error_msg)
#define SWIG_ErrorCode() (const_const_globals.error_code)
#endif
...
static void const_const_init_globals(zend_const_const_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void const_const_destroy_globals(zend_const_const_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_const_const_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_const_const_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
static zend_function_entry const_const_functions[] = {
 SWIG_ZEND_NAMED_FE(foo,_wrap_foo,NULL)
 SWIG_ZEND_NAMED_FE(swig_const_const_alter_newobject,_wrap_swig_const_const_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_const_const_get_newobject,_wrap_swig_const_const_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry const_const_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"const_const",
    const_const_functions,
    PHP_MINIT(const_const),
    PHP_MSHUTDOWN(const_const),
    PHP_RINIT(const_const),
    PHP_RSHUTDOWN(const_const),
    PHP_MINFO(const_const),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &const_const_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &const_const_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(const_const)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(const_const, const_const_init_globals, const_const_destroy_globals);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(const_const_globals_id);
#endif
    return SUCCESS;
}
