...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(extern_c)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(extern_c)
ZEND_DECLARE_MODULE_GLOBALS(extern_c)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(extern_c_globals_id, zend_extern_c_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(extern_c_globals_id, zend_extern_c_globals *, error_code )
#else
#define SWIG_ErrorMsg() (extern_c_globals.error_msg)
#define SWIG_ErrorCode() (extern_c_globals.error_code)
#endif
...
static void extern_c_init_globals(zend_extern_c_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void extern_c_destroy_globals(zend_extern_c_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_extern_c_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_extern_c_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
static swig_type_info _swigt__p_f_int__void = {"_p_f_int__void", "void (*)(int)|Function1 *|Function2 *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_int = {"_p_int", "int *|Integer1 *|Integer2 *", 0, 0, (void*)0, 0};
...
static zend_function_entry extern_c_functions[] = {
 SWIG_ZEND_NAMED_FE(realfunction,_wrap_RealFunction,NULL)
 SWIG_ZEND_NAMED_FE(swig_extern_c_alter_newobject,_wrap_swig_extern_c_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_extern_c_get_newobject,_wrap_swig_extern_c_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry extern_c_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"extern_c",
    extern_c_functions,
    PHP_MINIT(extern_c),
    PHP_MSHUTDOWN(extern_c),
    PHP_RINIT(extern_c),
    PHP_RSHUTDOWN(extern_c),
    PHP_MINFO(extern_c),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &extern_c_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &extern_c_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(extern_c)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(extern_c, extern_c_init_globals, extern_c_destroy_globals);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(extern_c_globals_id);
#endif
    return SUCCESS;
}
