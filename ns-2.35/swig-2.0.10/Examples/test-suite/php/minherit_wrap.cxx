...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(minherit)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(minherit)
ZEND_DECLARE_MODULE_GLOBALS(minherit)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(minherit_globals_id, zend_minherit_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(minherit_globals_id, zend_minherit_globals *, error_code )
#else
#define SWIG_ErrorMsg() (minherit_globals.error_msg)
#define SWIG_ErrorCode() (minherit_globals.error_code)
#endif
...
static void minherit_init_globals(zend_minherit_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void minherit_destroy_globals(zend_minherit_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_minherit_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_minherit_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
static zend_function_entry minherit_functions[] = {
 ...
 SWIG_ZEND_NAMED_FE(swig_minherit_alter_newobject,_wrap_swig_minherit_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_minherit_get_newobject,_wrap_swig_minherit_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry minherit_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"minherit",
    minherit_functions,
    PHP_MINIT(minherit),
    PHP_MSHUTDOWN(minherit),
    PHP_RINIT(minherit),
    PHP_RSHUTDOWN(minherit),
    PHP_MINFO(minherit),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &minherit_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &minherit_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(minherit)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(minherit, minherit_init_globals, minherit_destroy_globals);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(minherit_globals_id);
#endif
    return SUCCESS;
}
