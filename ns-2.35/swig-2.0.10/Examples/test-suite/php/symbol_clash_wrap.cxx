...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(symbol_clash)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(symbol_clash)
ZEND_DECLARE_MODULE_GLOBALS(symbol_clash)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(symbol_clash_globals_id, zend_symbol_clash_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(symbol_clash_globals_id, zend_symbol_clash_globals *, error_code )
#else
#define SWIG_ErrorMsg() (symbol_clash_globals.error_msg)
#define SWIG_ErrorCode() (symbol_clash_globals.error_code)
#endif
...
static void symbol_clash_init_globals(zend_symbol_clash_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void symbol_clash_destroy_globals(zend_symbol_clash_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_symbol_clash_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_symbol_clash_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
static zend_function_entry symbol_clash_functions[] = {
 SWIG_ZEND_NAMED_FE(swig_symbol_clash_alter_newobject,_wrap_swig_symbol_clash_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_symbol_clash_get_newobject,_wrap_swig_symbol_clash_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry symbol_clash_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"symbol_clash",
    symbol_clash_functions,
    PHP_MINIT(symbol_clash),
    PHP_MSHUTDOWN(symbol_clash),
    PHP_RINIT(symbol_clash),
    PHP_RSHUTDOWN(symbol_clash),
    PHP_MINFO(symbol_clash),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &symbol_clash_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &symbol_clash_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(symbol_clash)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(symbol_clash, symbol_clash_init_globals, symbol_clash_destroy_globals);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(symbol_clash_globals_id);
#endif
    return SUCCESS;
}
