...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(import_stl_a)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(import_stl_a)
ZEND_DECLARE_MODULE_GLOBALS(import_stl_a)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(import_stl_a_globals_id, zend_import_stl_a_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(import_stl_a_globals_id, zend_import_stl_a_globals *, error_code )
#else
#define SWIG_ErrorMsg() (import_stl_a_globals.error_msg)
#define SWIG_ErrorCode() (import_stl_a_globals.error_code)
#endif
...
static void import_stl_a_init_globals(zend_import_stl_a_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void import_stl_a_destroy_globals(zend_import_stl_a_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_import_stl_a_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_import_stl_a_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
static zend_function_entry import_stl_a_functions[] = {
 ...
 SWIG_ZEND_NAMED_FE(swig_import_stl_a_alter_newobject,_wrap_swig_import_stl_a_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_import_stl_a_get_newobject,_wrap_swig_import_stl_a_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry import_stl_a_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"import_stl_a",
    import_stl_a_functions,
    PHP_MINIT(import_stl_a),
    PHP_MSHUTDOWN(import_stl_a),
    PHP_RINIT(import_stl_a),
    PHP_RSHUTDOWN(import_stl_a),
    PHP_MINFO(import_stl_a),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &import_stl_a_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &import_stl_a_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(import_stl_a)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(import_stl_a, import_stl_a_init_globals, import_stl_a_destroy_globals);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(import_stl_a_globals_id);
#endif
    return SUCCESS;
}
