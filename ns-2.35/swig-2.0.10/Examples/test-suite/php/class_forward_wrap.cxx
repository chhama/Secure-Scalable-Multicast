...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(class_forward)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(class_forward)
ZEND_DECLARE_MODULE_GLOBALS(class_forward)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(class_forward_globals_id, zend_class_forward_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(class_forward_globals_id, zend_class_forward_globals *, error_code )
#else
#define SWIG_ErrorMsg() (class_forward_globals.error_msg)
#define SWIG_ErrorCode() (class_forward_globals.error_code)
#endif
...
static void class_forward_init_globals(zend_class_forward_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void class_forward_destroy_globals(zend_class_forward_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_class_forward_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_class_forward_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
#define SWIG_name  "class_forward"
#ifdef __cplusplus
extern "C" {
#endif
#include "php.h"
...
static zend_function_entry class_forward_functions[] = {
 SWIG_ZEND_NAMED_FE(new_a,_wrap_new_A,NULL)
 SWIG_ZEND_NAMED_FE(new_c,_wrap_new_C,NULL)
 SWIG_ZEND_NAMED_FE(swig_class_forward_alter_newobject,_wrap_swig_class_forward_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_class_forward_get_newobject,_wrap_swig_class_forward_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry class_forward_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"class_forward",
    class_forward_functions,
    PHP_MINIT(class_forward),
    PHP_MSHUTDOWN(class_forward),
    PHP_RINIT(class_forward),
    PHP_RSHUTDOWN(class_forward),
    PHP_MINFO(class_forward),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &class_forward_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &class_forward_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(class_forward)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(class_forward, class_forward_init_globals, class_forward_destroy_globals);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(class_forward_globals_id);
#endif
    return SUCCESS;
}
