...
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(threads_globals_id, zend_threads_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(threads_globals_id, zend_threads_globals *, error_code )
#else
#define SWIG_ErrorMsg() (threads_globals.error_msg)
#define SWIG_ErrorCode() (threads_globals.error_code)
#endif
...
static void threads_init_globals(zend_threads_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void threads_destroy_globals(zend_threads_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_threads_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_threads_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
static swig_type_info _swigt__p_Kerfuffle = {"_p_Kerfuffle", "Kerfuffle *", 0, 0, (void*)0, 0};
...
/* end header section */
/* vdecl subsection */
static int le_swig__p_Kerfuffle=0; /* handle for Kerfuffle */
...
ZEND_NAMED_FUNCTION(_wrap_Kerfuffle_StdString) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_Kerfuffle, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of Kerfuffle_StdString. Expected SWIGTYPE_p_Kerfuffle");
    }
  }
...
ZEND_NAMED_FUNCTION(_wrap_Kerfuffle_CharString) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_Kerfuffle, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of Kerfuffle_CharString. Expected SWIGTYPE_p_Kerfuffle");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
...
ZEND_NAMED_FUNCTION(_wrap_new_Kerfuffle) {
  ...
  SWIG_SetPointerZval(return_value, (void *)result, SWIGTYPE_p_Kerfuffle, 1);
...
static void __wrap_delete_Kerfuffle(zend_rsrc_list_entry *rsrc, const char *type_name TSRMLS_DC) {
  ...
  arg1 = (Kerfuffle *)SWIG_ZTS_ConvertResourceData(ptr,type_name,SWIGTYPE_p_Kerfuffle TSRMLS_CC);
  if (! arg1) zend_error(E_ERROR, "Kerfuffle resource already free'd");
  delete arg1;
  return;
fail:
  SWIG_FAIL();
...
static ZEND_RSRC_DTOR_FUNC(_wrap_destroy_p_Kerfuffle) {
  __wrap_delete_Kerfuffle(rsrc, SWIGTYPE_p_Kerfuffle->name TSRMLS_CC);
}
/* end wrapper section */
...
static zend_function_entry threads_functions[] = {
 SWIG_ZEND_NAMED_FE(kerfuffle_stdstring,_wrap_Kerfuffle_StdString,NULL)
 SWIG_ZEND_NAMED_FE(kerfuffle_charstring,_wrap_Kerfuffle_CharString,NULL)
 SWIG_ZEND_NAMED_FE(new_kerfuffle,_wrap_new_Kerfuffle,NULL)
 SWIG_ZEND_NAMED_FE(swig_threads_alter_newobject,_wrap_swig_threads_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_threads_get_newobject,_wrap_swig_threads_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
zend_module_entry threads_module_entry = {
    ...
    PHP_RINIT(threads),
    PHP_RSHUTDOWN(threads),
    PHP_MINFO(threads),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &threads_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &threads_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(threads)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(threads, threads_init_globals, threads_destroy_globals);

/* Register resource destructors for pointer types */
le_swig__p_Kerfuffle=zend_register_list_destructors_ex(_wrap_destroy_p_Kerfuffle,NULL,(char *)(SWIGTYPE_p_Kerfuffle->name),module_number);
SWIG_TypeClientData(SWIGTYPE_p_Kerfuffle,&le_swig__p_Kerfuffle);
