...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(namespace_enum)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(namespace_enum)
ZEND_DECLARE_MODULE_GLOBALS(namespace_enum)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(namespace_enum_globals_id, zend_namespace_enum_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(namespace_enum_globals_id, zend_namespace_enum_globals *, error_code )
#else
#define SWIG_ErrorMsg() (namespace_enum_globals.error_msg)
#define SWIG_ErrorCode() (namespace_enum_globals.error_code)
#endif
...
static void namespace_enum_init_globals(zend_namespace_enum_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void namespace_enum_destroy_globals(zend_namespace_enum_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_namespace_enum_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_namespace_enum_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
#define SWIG_name  "namespace_enum"
#ifdef __cplusplus
extern "C" {
#endif
#include "php.h"
...
static zend_function_entry namespace_enum_functions[] = {
 SWIG_ZEND_NAMED_FE(new_bar,_wrap_new_Bar,NULL)
 SWIG_ZEND_NAMED_FE(swig_namespace_enum_alter_newobject,_wrap_swig_namespace_enum_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_namespace_enum_get_newobject,_wrap_swig_namespace_enum_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry namespace_enum_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"namespace_enum",
    namespace_enum_functions,
    PHP_MINIT(namespace_enum),
    PHP_MSHUTDOWN(namespace_enum),
    PHP_RINIT(namespace_enum),
    PHP_RSHUTDOWN(namespace_enum),
    PHP_MINFO(namespace_enum),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &namespace_enum_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &namespace_enum_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(namespace_enum)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(namespace_enum, namespace_enum_init_globals, namespace_enum_destroy_globals);
...
/* cinit subsection */
SWIG_LONG_CONSTANT(LAGER, Foo::LAGER);
SWIG_LONG_CONSTANT(STOUT, Foo::STOUT);
SWIG_LONG_CONSTANT(ALE, Foo::ALE);
SWIG_LONG_CONSTANT(Bar_SLOW, Foo::Bar::SLOW);
SWIG_LONG_CONSTANT(Bar_FAST, Foo::Bar::FAST);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(namespace_enum_globals_id);
#endif
    return SUCCESS;
}
