...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(typemap_ns_using)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(typemap_ns_using)
ZEND_DECLARE_MODULE_GLOBALS(typemap_ns_using)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(typemap_ns_using_globals_id, zend_typemap_ns_using_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(typemap_ns_using_globals_id, zend_typemap_ns_using_globals *, error_code )
#else
#define SWIG_ErrorMsg() (typemap_ns_using_globals.error_msg)
#define SWIG_ErrorCode() (typemap_ns_using_globals.error_code)
#endif
...
static void typemap_ns_using_init_globals(zend_typemap_ns_using_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void typemap_ns_using_destroy_globals(zend_typemap_ns_using_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_typemap_ns_using_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_typemap_ns_using_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
#define SWIG_name  "typemap_ns_using"
#ifdef __cplusplus
extern "C" {
#endif
#include "php.h"
...
#include "php_typemap_ns_using.h"
#ifdef __cplusplus
}
#endif
...
static swig_type_info _swigt__p_X___FooImpl = {"_p_X___FooImpl", "X::_FooImpl *|X::Foo *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_int = {"_p_int", "int *|X::Integer *", 0, 0, (void*)0, 0};
...
static int le_swig__p_X___FooImpl=0; /* handle for _FooImpl */
...
ZEND_NAMED_FUNCTION(_wrap_new__FooImpl) {
  ...
  SWIG_SetPointerZval(return_value, (void *)result, SWIGTYPE_p_X___FooImpl, 1);
...
static void __wrap_delete__FooImpl(zend_rsrc_list_entry *rsrc, const char *type_name TSRMLS_DC) {
  swig_object_wrapper *value=(swig_object_wrapper *) rsrc->ptr ;
  void *ptr=value->ptr ;
  int newobject=value->newobject ;
  X::_FooImpl *arg1 = (X::_FooImpl *) 0 ;
  
  efree(value);
  if (! newobject) return; /* can't delete it! */
  arg1 = (X::_FooImpl *)SWIG_ZTS_ConvertResourceData(ptr,type_name,SWIGTYPE_p_X___FooImpl TSRMLS_CC);
  if (! arg1) zend_error(E_ERROR, "X::_FooImpl resource already free'd");
  delete arg1;
  return;
fail:
  SWIG_FAIL();
...
ZEND_NAMED_FUNCTION(_wrap_spam) {
  ...
  arg1 = (Foo::value_type) Z_LVAL_PP(args[0]);
  /*@SWIG@*/;
...
static ZEND_RSRC_DTOR_FUNC(_wrap_destroy_p_X___FooImpl) {
  __wrap_delete__FooImpl(rsrc, SWIGTYPE_p_X___FooImpl->name TSRMLS_CC);
}
/* end wrapper section */
...
static zend_function_entry typemap_ns_using_functions[] = {
 SWIG_ZEND_NAMED_FE(new__fooimpl,_wrap_new__FooImpl,NULL)
 SWIG_ZEND_NAMED_FE(spam,_wrap_spam,NULL)
 SWIG_ZEND_NAMED_FE(swig_typemap_ns_using_alter_newobject,_wrap_swig_typemap_ns_using_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_typemap_ns_using_get_newobject,_wrap_swig_typemap_ns_using_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry typemap_ns_using_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"typemap_ns_using",
    typemap_ns_using_functions,
    PHP_MINIT(typemap_ns_using),
    PHP_MSHUTDOWN(typemap_ns_using),
    PHP_RINIT(typemap_ns_using),
    PHP_RSHUTDOWN(typemap_ns_using),
    PHP_MINFO(typemap_ns_using),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &typemap_ns_using_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &typemap_ns_using_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(typemap_ns_using)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(typemap_ns_using, typemap_ns_using_init_globals, typemap_ns_using_destroy_globals);
...
le_swig__p_X___FooImpl=zend_register_list_destructors_ex(_wrap_destroy_p_X___FooImpl,NULL,(char *)(SWIGTYPE_p_X___FooImpl->name),module_number);
SWIG_TypeClientData(SWIGTYPE_p_X___FooImpl,&le_swig__p_X___FooImpl);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(typemap_ns_using_globals_id);
#endif
    return SUCCESS;
}
