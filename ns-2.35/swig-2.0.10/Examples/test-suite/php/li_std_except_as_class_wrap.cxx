...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(li_std_except_as_class)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(li_std_except_as_class)
ZEND_DECLARE_MODULE_GLOBALS(li_std_except_as_class)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(li_std_except_as_class_globals_id, zend_li_std_except_as_class_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(li_std_except_as_class_globals_id, zend_li_std_except_as_class_globals *, error_code )
#else
#define SWIG_ErrorMsg() (li_std_except_as_class_globals.error_msg)
#define SWIG_ErrorCode() (li_std_except_as_class_globals.error_code)
#endif
...
static void li_std_except_as_class_init_globals(zend_li_std_except_as_class_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void li_std_except_as_class_destroy_globals(zend_li_std_except_as_class_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_li_std_except_as_class_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_li_std_except_as_class_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
#include "php_li_std_except_as_class.h"
#ifdef __cplusplus
}
#endif
...
static zend_function_entry li_std_except_as_class_functions[] = {
 SWIG_ZEND_NAMED_FE(test_domain_error,_wrap_test_domain_error,NULL)
 SWIG_ZEND_NAMED_FE(swig_li_std_except_as_class_alter_newobject,_wrap_swig_li_std_except_as_class_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_li_std_except_as_class_get_newobject,_wrap_swig_li_std_except_as_class_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry li_std_except_as_class_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"li_std_except_as_class",
    li_std_except_as_class_functions,
    PHP_MINIT(li_std_except_as_class),
    PHP_MSHUTDOWN(li_std_except_as_class),
    PHP_RINIT(li_std_except_as_class),
    PHP_RSHUTDOWN(li_std_except_as_class),
    PHP_MINFO(li_std_except_as_class),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &li_std_except_as_class_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &li_std_except_as_class_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(li_std_except_as_class)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(li_std_except_as_class, li_std_except_as_class_init_globals, li_std_except_as_class_destroy_globals);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(li_std_except_as_class_globals_id);
#endif
    return SUCCESS;
}
