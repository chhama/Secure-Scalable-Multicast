...
#define SWIGTYPE_p_samename swig_types[0]
...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(samename)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(samename)
ZEND_DECLARE_MODULE_GLOBALS(samename)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(samename_globals_id, zend_samename_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(samename_globals_id, zend_samename_globals *, error_code )
#else
#define SWIG_ErrorMsg() (samename_globals.error_msg)
#define SWIG_ErrorCode() (samename_globals.error_code)
#endif
...
static void samename_init_globals(zend_samename_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void samename_destroy_globals(zend_samename_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_samename_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_samename_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
static swig_type_info _swigt__p_samename = {"_p_samename", "samename *", 0, 0, (void*)0, 0};

static swig_type_info *swig_type_initial[] = {
  &_swigt__p_samename,
};

static swig_cast_info _swigc__p_samename[] = {  {&_swigt__p_samename, 0, 0, 0},{0, 0, 0, 0}};
...
/* end header section */
/* vdecl subsection */
static int le_swig__p_samename=0; /* handle for samename */
/* end vdecl subsection */
/* wrapper section */
ZEND_NAMED_FUNCTION(_wrap_samename_do_something) {
  samename *arg1 = (samename *) 0 ;
  zval **args[1];
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_samename, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of samename_do_something. Expected SWIGTYPE_p_samename");
    }
  }
...
ZEND_NAMED_FUNCTION(_wrap_new_samename) {
  samename *result = 0 ;
  ...
  SWIG_SetPointerZval(return_value, (void *)result, SWIGTYPE_p_samename, 1);
...
static void __wrap_delete_samename(zend_rsrc_list_entry *rsrc, const char *type_name TSRMLS_DC) {
  ...
  arg1 = (samename *)SWIG_ZTS_ConvertResourceData(ptr,type_name,SWIGTYPE_p_samename TSRMLS_CC);
  if (! arg1) zend_error(E_ERROR, "samename resource already free'd");
  delete arg1;
  return;
fail:
  SWIG_FAIL();
...
static ZEND_RSRC_DTOR_FUNC(_wrap_destroy_p_samename) {
  __wrap_delete_samename(rsrc, SWIGTYPE_p_samename->name TSRMLS_CC);
}
/* end wrapper section */
...
static zend_function_entry samename_functions[] = {
 SWIG_ZEND_NAMED_FE(samename_do_something,_wrap_samename_do_something,NULL)
 SWIG_ZEND_NAMED_FE(new_samename,_wrap_new_samename,NULL)
 SWIG_ZEND_NAMED_FE(swig_samename_alter_newobject,_wrap_swig_samename_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_samename_get_newobject,_wrap_swig_samename_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry samename_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"samename",
    samename_functions,
    PHP_MINIT(samename),
    PHP_MSHUTDOWN(samename),
    PHP_RINIT(samename),
    PHP_RSHUTDOWN(samename),
    PHP_MINFO(samename),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &samename_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &samename_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(samename)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(samename, samename_init_globals, samename_destroy_globals);

/* Register resource destructors for pointer types */
le_swig__p_samename=zend_register_list_destructors_ex(_wrap_destroy_p_samename,NULL,(char *)(SWIGTYPE_p_samename->name),module_number);
SWIG_TypeClientData(SWIGTYPE_p_samename,&le_swig__p_samename);
...
PHP_MSHUTDOWN_FUNCTION(samename)
{
/* shutdown section */
#ifdef ZTS
    ts_free_id(samename_globals_id);
#endif
    return SUCCESS;
}

PHP_RSHUTDOWN_FUNCTION(samename)
{
/* rshutdown section */
