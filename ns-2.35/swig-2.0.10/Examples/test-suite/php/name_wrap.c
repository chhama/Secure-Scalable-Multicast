...
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(name_globals_id, zend_name_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(name_globals_id, zend_name_globals *, error_code )
#else
#define SWIG_ErrorMsg() (name_globals.error_msg)
#define SWIG_ErrorCode() (name_globals.error_code)
#endif
...
static void name_init_globals(zend_name_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void name_destroy_globals(zend_name_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_name_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_name_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
static zend_function_entry name_functions[] = {
 SWIG_ZEND_NAMED_FE(foo_2,_wrap_foo_2,NULL)
 SWIG_ZEND_NAMED_FE(bar_2_set,_wrap_bar_2_set,NULL)
 SWIG_ZEND_NAMED_FE(bar_2_get,_wrap_bar_2_get,NULL)
 SWIG_ZEND_NAMED_FE(swig_name_alter_newobject,_wrap_swig_name_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_name_get_newobject,_wrap_swig_name_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry name_module_entry = {
...
zend_module_entry* SWIG_module_entry = &name_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &name_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(name)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(name, name_init_globals, name_destroy_globals);
...
/* vinit subsection */
{
  ...
  MAKE_STD_ZVAL(z_var);
  z_var->type = IS_LONG;
  z_var->value.lval = bar_1;
  zend_hash_add(&EG(symbol_table), (char*)"bar_1", sizeof("bar_1"), (void *)&z_var, sizeof(zval *), NULL);
}
