...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(pointer_reference)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(pointer_reference)
ZEND_DECLARE_MODULE_GLOBALS(pointer_reference)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(pointer_reference_globals_id, zend_pointer_reference_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(pointer_reference_globals_id, zend_pointer_reference_globals *, error_code )
#else
#define SWIG_ErrorMsg() (pointer_reference_globals.error_msg)
#define SWIG_ErrorCode() (pointer_reference_globals.error_code)
#endif
...
static void pointer_reference_init_globals(zend_pointer_reference_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void pointer_reference_destroy_globals(zend_pointer_reference_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_pointer_reference_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_pointer_reference_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
#include "php_pointer_reference.h"
#ifdef __cplusplus
}
#endif
...
ZEND_NAMED_FUNCTION(_wrap_foo) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_p_int, 0) < 0 || arg1 == NULL) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of foo. Expected SWIGTYPE_p_p_int");
    }
  }
  foo(*arg1);
...
ZEND_NAMED_FUNCTION(_wrap_Struct_value_set) {
  ...
  
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_Struct, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of Struct_value_set. Expected SWIGTYPE_p_Struct");
    }
  }
...
ZEND_NAMED_FUNCTION(_wrap_Struct_value_get) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_Struct, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of Struct_value_get. Expected SWIGTYPE_p_Struct");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
...
ZEND_NAMED_FUNCTION(_wrap_Struct_instance_set) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_Struct, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of Struct_instance_set. Expected SWIGTYPE_p_Struct");
    }
  }
...
ZEND_NAMED_FUNCTION(_wrap_Struct_pInstance_set) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_Struct, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of Struct_pInstance_set. Expected SWIGTYPE_p_Struct");
    }
  }
...
ZEND_NAMED_FUNCTION(_wrap_set) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &temp1, SWIGTYPE_p_Struct, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of set. Expected SWIGTYPE_p_Struct");
    }
    arg1 = (Struct **)&temp1;
  }
...
ZEND_NAMED_FUNCTION(_wrap_overloading__SWIG_0) {
  int arg1 ;
  zval **args[1];
  int result;
...
ZEND_NAMED_FUNCTION(_wrap_overloading__SWIG_1) {
  Struct **arg1 = 0 ;
  Struct *temp1 ;
  zval **args[1];
  int result;
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &temp1, SWIGTYPE_p_Struct, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of overloading. Expected SWIGTYPE_p_Struct");
    }
    arg1 = (Struct **)&temp1;
  }
...
ZEND_NAMED_FUNCTION(_wrap_overloading) {
  ...
  if (argc == 1) {
    ...
    {
      void *tmp;
      _v = (SWIG_ConvertPtr(*argv[0], (void**)&tmp, SWIGTYPE_p_Struct, 0) >= 0);
    }
    if (_v) {
      _wrap_overloading__SWIG_1(INTERNAL_FUNCTION_PARAM_PASSTHRU); return;
    }
  }
  if (argc == 1) {
    int _v;
    ...
    if (_v) {
      _wrap_overloading__SWIG_0(INTERNAL_FUNCTION_PARAM_PASSTHRU); return;
    }
  }
  
  SWIG_ErrorCode() = E_ERROR;
  SWIG_ErrorMsg() = "No matching function for overloaded 'overloading'";
  SWIG_FAIL();
}
...
static zend_function_entry pointer_reference_functions[] = {
 SWIG_ZEND_NAMED_FE(foo,_wrap_foo,NULL)
 SWIG_ZEND_NAMED_FE(struct_value_set,_wrap_Struct_value_set,NULL)
 SWIG_ZEND_NAMED_FE(struct_value_get,_wrap_Struct_value_get,NULL)
 SWIG_ZEND_NAMED_FE(new_struct,_wrap_new_Struct,NULL)
 SWIG_ZEND_NAMED_FE(struct_instance_set,_wrap_Struct_instance_set,NULL)
 SWIG_ZEND_NAMED_FE(struct_instance_get,_wrap_Struct_instance_get,NULL)
 SWIG_ZEND_NAMED_FE(struct_pinstance_set,_wrap_Struct_pInstance_set,NULL)
 SWIG_ZEND_NAMED_FE(struct_pinstance_get,_wrap_Struct_pInstance_get,NULL)
 SWIG_ZEND_NAMED_FE(set,_wrap_set,NULL)
 SWIG_ZEND_NAMED_FE(get,_wrap_get,NULL)
 SWIG_ZEND_NAMED_FE(overloading,_wrap_overloading,NULL)
 SWIG_ZEND_NAMED_FE(swig_pointer_reference_alter_newobject,_wrap_swig_pointer_reference_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_pointer_reference_get_newobject,_wrap_swig_pointer_reference_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry pointer_reference_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"pointer_reference",
    pointer_reference_functions,
    PHP_MINIT(pointer_reference),
    PHP_MSHUTDOWN(pointer_reference),
    PHP_RINIT(pointer_reference),
    PHP_RSHUTDOWN(pointer_reference),
    PHP_MINFO(pointer_reference),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &pointer_reference_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &pointer_reference_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(pointer_reference)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(pointer_reference, pointer_reference_init_globals, pointer_reference_destroy_globals);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(pointer_reference_globals_id);
#endif
    return SUCCESS;
}
