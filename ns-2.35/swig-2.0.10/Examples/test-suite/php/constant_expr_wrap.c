...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(constant_expr)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(constant_expr)
ZEND_DECLARE_MODULE_GLOBALS(constant_expr)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(constant_expr_globals_id, zend_constant_expr_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(constant_expr_globals_id, zend_constant_expr_globals *, error_code )
#else
#define SWIG_ErrorMsg() (constant_expr_globals.error_msg)
#define SWIG_ErrorCode() (constant_expr_globals.error_code)
#endif
...
static void constant_expr_init_globals(zend_constant_expr_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void constant_expr_destroy_globals(zend_constant_expr_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_constant_expr_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_constant_expr_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
#define SWIG_name  "constant_expr"
#ifdef __cplusplus
extern "C" {
#endif
#include "php.h"
...
ZEND_NAMED_FUNCTION(_wrap_d_array_set) {
  ...
  
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_double, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of d_array_set. Expected SWIGTYPE_p_double");
    }
  }
  {
    size_t ii;
...
static zend_function_entry constant_expr_functions[] = {
 SWIG_ZEND_NAMED_FE(x_get,_wrap_X_get,NULL)
 SWIG_ZEND_NAMED_FE(d_array_set,_wrap_d_array_set,NULL)
 SWIG_ZEND_NAMED_FE(d_array_get,_wrap_d_array_get,NULL)
 SWIG_ZEND_NAMED_FE(swig_constant_expr_alter_newobject,_wrap_swig_constant_expr_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_constant_expr_get_newobject,_wrap_swig_constant_expr_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry constant_expr_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"constant_expr",
    constant_expr_functions,
    PHP_MINIT(constant_expr),
    PHP_MSHUTDOWN(constant_expr),
    PHP_RINIT(constant_expr),
    PHP_RSHUTDOWN(constant_expr),
    PHP_MINFO(constant_expr),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &constant_expr_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &constant_expr_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(constant_expr)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(constant_expr, constant_expr_init_globals, constant_expr_destroy_globals);
...
}
{
  zval *z_var;
  MAKE_STD_ZVAL(z_var);
  SWIG_SetPointerZval(z_var, (void*)d_array, SWIGTYPE_p_double, 0);
  zend_hash_add(&EG(symbol_table), (char*)"d_array", sizeof("d_array"), (void *)&z_var,
  sizeof(zval *), NULL);
}
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(constant_expr_globals_id);
#endif
    return SUCCESS;
}
