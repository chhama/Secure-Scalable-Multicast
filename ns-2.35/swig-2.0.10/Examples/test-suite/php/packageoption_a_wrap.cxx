...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(packageoption_a)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(packageoption_a)
ZEND_DECLARE_MODULE_GLOBALS(packageoption_a)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(packageoption_a_globals_id, zend_packageoption_a_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(packageoption_a_globals_id, zend_packageoption_a_globals *, error_code )
#else
#define SWIG_ErrorMsg() (packageoption_a_globals.error_msg)
#define SWIG_ErrorCode() (packageoption_a_globals.error_code)
#endif
...
static void packageoption_a_init_globals(zend_packageoption_a_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void packageoption_a_destroy_globals(zend_packageoption_a_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_packageoption_a_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_packageoption_a_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
#define SWIG_name  "packageoption_a"
#ifdef __cplusplus
extern "C" {
#endif
#include "php.h"
...
ZEND_NAMED_FUNCTION(_wrap_A_testInt) {
  ...
  
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_A, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of A_testInt. Expected SWIGTYPE_p_A");
    }
  }
...
ZEND_NAMED_FUNCTION(_wrap_Base_vmethod) {
  ...
  
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_Base, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of Base_vmethod. Expected SWIGTYPE_p_Base");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
...
ZEND_NAMED_FUNCTION(_wrap_Base_basemethod) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_Base, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of Base_basemethod. Expected SWIGTYPE_p_Base");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
...
static zend_function_entry packageoption_a_functions[] = {
 SWIG_ZEND_NAMED_FE(a_testint,_wrap_A_testInt,NULL)
 SWIG_ZEND_NAMED_FE(new_a,_wrap_new_A,NULL)
 SWIG_ZEND_NAMED_FE(base_vmethod,_wrap_Base_vmethod,NULL)
 SWIG_ZEND_NAMED_FE(base_basemethod,_wrap_Base_basemethod,NULL)
 SWIG_ZEND_NAMED_FE(new_base,_wrap_new_Base,NULL)
 SWIG_ZEND_NAMED_FE(swig_packageoption_a_alter_newobject,_wrap_swig_packageoption_a_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_packageoption_a_get_newobject,_wrap_swig_packageoption_a_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry packageoption_a_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"packageoption_a",
    packageoption_a_functions,
    PHP_MINIT(packageoption_a),
    PHP_MSHUTDOWN(packageoption_a),
    PHP_RINIT(packageoption_a),
    PHP_RSHUTDOWN(packageoption_a),
    PHP_MINFO(packageoption_a),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &packageoption_a_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &packageoption_a_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(packageoption_a)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(packageoption_a, packageoption_a_init_globals, packageoption_a_destroy_globals);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(packageoption_a_globals_id);
#endif
    return SUCCESS;
}
