...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(director_finalizer)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(director_finalizer)
ZEND_DECLARE_MODULE_GLOBALS(director_finalizer)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(director_finalizer_globals_id, zend_director_finalizer_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(director_finalizer_globals_id, zend_director_finalizer_globals *, error_code )
#else
#define SWIG_ErrorMsg() (director_finalizer_globals.error_msg)
#define SWIG_ErrorCode() (director_finalizer_globals.error_code)
#endif
...
static void director_finalizer_init_globals(zend_director_finalizer_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void director_finalizer_destroy_globals(zend_director_finalizer_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_director_finalizer_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_director_finalizer_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
#define SWIG_name  "director_finalizer"
#ifdef __cplusplus
extern "C" {
#endif
#include "php.h"
...
#include "php_director_finalizer.h"
#ifdef __cplusplus
}
#endif
...
void SwigDirector_Foo::orStatus(int x) {
  ...
  ZVAL_STRINGL(&funcname, (char *)"orStatus", 8, 0);
  if (!swig_self) {
...
ZEND_NAMED_FUNCTION(_wrap_Foo_orStatus) {
  Foo *arg1 = (Foo *) 0 ;
  int arg2 ;
  zval **args[2];
  ...
  upcall = !director->swig_is_overridden_method((char *)"Foo", (char *)"orStatus");
  SWIG_ResetError();
  if(ZEND_NUM_ARGS() != 2 || zend_get_parameters_array_ex(2, args) != SUCCESS) {
    WRONG_PARAM_COUNT;
  }
  
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_Foo, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of Foo_orStatus. Expected SWIGTYPE_p_Foo");
    }
  }
...
ZEND_NAMED_FUNCTION(_wrap_deleteFoo) {
  Foo *arg1 = (Foo *) 0 ;
  zval **args[1];
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_Foo, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of deleteFoo. Expected SWIGTYPE_p_Foo");
    }
  }
  deleteFoo(arg1);
...
ZEND_NAMED_FUNCTION(_wrap_getStatus) {
  int result;
...
ZEND_NAMED_FUNCTION(_wrap_resetStatus) {
  SWIG_ResetError();
  if(ZEND_NUM_ARGS() != 0) {
    WRONG_PARAM_COUNT;
  }
...
static zend_function_entry director_finalizer_functions[] = {
 SWIG_ZEND_NAMED_FE(foo_orstatus,_wrap_Foo_orStatus,NULL)
 SWIG_ZEND_NAMED_FE(new_foo,_wrap_new_Foo,NULL)
 SWIG_ZEND_NAMED_FE(deletefoo,_wrap_deleteFoo,NULL)
 SWIG_ZEND_NAMED_FE(getstatus,_wrap_getStatus,NULL)
 SWIG_ZEND_NAMED_FE(launder,_wrap_launder,NULL)
 SWIG_ZEND_NAMED_FE(resetstatus,_wrap_resetStatus,NULL)
 SWIG_ZEND_NAMED_FE(swig_director_finalizer_alter_newobject,_wrap_swig_director_finalizer_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_director_finalizer_get_newobject,_wrap_swig_director_finalizer_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry director_finalizer_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"director_finalizer",
    director_finalizer_functions,
    PHP_MINIT(director_finalizer),
    PHP_MSHUTDOWN(director_finalizer),
    PHP_RINIT(director_finalizer),
    PHP_RSHUTDOWN(director_finalizer),
    PHP_MINFO(director_finalizer),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &director_finalizer_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &director_finalizer_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(director_finalizer)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(director_finalizer, director_finalizer_init_globals, director_finalizer_destroy_globals);
...
PHP_RINIT_FUNCTION(director_finalizer)
{
/* rinit section */
...
PHP_MSHUTDOWN_FUNCTION(director_finalizer)
{
/* shutdown section */
#ifdef ZTS
    ts_free_id(director_finalizer_globals_id);
#endif
    return SUCCESS;
}

PHP_RSHUTDOWN_FUNCTION(director_finalizer)
{
/* rshutdown section */
...
PHP_MINFO_FUNCTION(director_finalizer)
{
}
/* end init section */
