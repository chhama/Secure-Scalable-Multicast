...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(director_constructor)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(director_constructor)
ZEND_DECLARE_MODULE_GLOBALS(director_constructor)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(director_constructor_globals_id, zend_director_constructor_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(director_constructor_globals_id, zend_director_constructor_globals *, error_code )
#else
#define SWIG_ErrorMsg() (director_constructor_globals.error_msg)
#define SWIG_ErrorCode() (director_constructor_globals.error_code)
#endif
...
static void director_constructor_init_globals(zend_director_constructor_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void director_constructor_destroy_globals(zend_director_constructor_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_director_constructor_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_director_constructor_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
#define SWIG_name  "director_constructor"
#ifdef __cplusplus
extern "C" {
#endif
#include "php.h"
...
#include "php_director_constructor.h"
#ifdef __cplusplus
}
#endif
...
int SwigDirector_Foo::getit() {
  ...
  ZVAL_STRINGL(&funcname, (char *)"getit", 5, 0);
  if (!swig_self) {
...
void SwigDirector_Foo::doubleit() {
  ...
  zval *result, funcname;
  MAKE_STD_ZVAL(result);
  ZVAL_STRINGL(&funcname, (char *)"doubleit", 8, 0);
  if (!swig_self) {
    SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
  }
...
int SwigDirector_Foo::test() {
  ...
  zval *result, funcname;
  MAKE_STD_ZVAL(result);
  ZVAL_STRINGL(&funcname, (char *)"test", 4, 0);
  if (!swig_self) {
    SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
  }
...
ZEND_NAMED_FUNCTION(_wrap_Foo_do_test) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_Foo, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of Foo_do_test. Expected SWIGTYPE_p_Foo");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
...
ZEND_NAMED_FUNCTION(_wrap_Foo_getit) {
  ...
  upcall = !director->swig_is_overridden_method((char *)"Foo", (char *)"getit");
  SWIG_ResetError();
  if(ZEND_NUM_ARGS() != 1 || zend_get_parameters_array_ex(1, args) != SUCCESS) {
    WRONG_PARAM_COUNT;
  }
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_Foo, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of Foo_getit. Expected SWIGTYPE_p_Foo");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
  if (upcall) {
...
ZEND_NAMED_FUNCTION(_wrap_Foo_doubleit) {
  ...
  director = dynamic_cast<Swig::Director*>(arg1);
  upcall = !director->swig_is_overridden_method((char *)"Foo", (char *)"doubleit");
  SWIG_ResetError();
  if(ZEND_NUM_ARGS() != 1 || zend_get_parameters_array_ex(1, args) != SUCCESS) {
    WRONG_PARAM_COUNT;
  }
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_Foo, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of Foo_doubleit. Expected SWIGTYPE_p_Foo");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
  if (upcall) {
...
ZEND_NAMED_FUNCTION(_wrap_Foo_test) {
  ...
  director = dynamic_cast<Swig::Director*>(arg1);
  upcall = !director->swig_is_overridden_method((char *)"Foo", (char *)"test");
  SWIG_ResetError();
  if(ZEND_NUM_ARGS() != 1 || zend_get_parameters_array_ex(1, args) != SUCCESS) {
    WRONG_PARAM_COUNT;
  }
  ...
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
  if (upcall) {
    Swig::DirectorPureVirtualException::raise("Foo::test" TSRMLS_CC);
  } else {
...
static zend_function_entry director_constructor_functions[] = {
 ...
 SWIG_ZEND_NAMED_FE(foo_do_test,_wrap_Foo_do_test,NULL)
 SWIG_ZEND_NAMED_FE(foo_getit,_wrap_Foo_getit,NULL)
 SWIG_ZEND_NAMED_FE(foo_doubleit,_wrap_Foo_doubleit,NULL)
 SWIG_ZEND_NAMED_FE(foo_test,_wrap_Foo_test,NULL)
 SWIG_ZEND_NAMED_FE(swig_director_constructor_alter_newobject,_wrap_swig_director_constructor_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_director_constructor_get_newobject,_wrap_swig_director_constructor_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry director_constructor_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"director_constructor",
    director_constructor_functions,
    PHP_MINIT(director_constructor),
    PHP_MSHUTDOWN(director_constructor),
    PHP_RINIT(director_constructor),
    PHP_RSHUTDOWN(director_constructor),
    PHP_MINFO(director_constructor),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &director_constructor_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &director_constructor_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(director_constructor)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(director_constructor, director_constructor_init_globals, director_constructor_destroy_globals);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(director_constructor_globals_id);
#endif
    return SUCCESS;
}
