...
#define SWIGTYPE_p_Class1 swig_types[0]
...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(typemap_directorout)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(typemap_directorout)
ZEND_DECLARE_MODULE_GLOBALS(typemap_directorout)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(typemap_directorout_globals_id, zend_typemap_directorout_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(typemap_directorout_globals_id, zend_typemap_directorout_globals *, error_code )
#else
#define SWIG_ErrorMsg() (typemap_directorout_globals.error_msg)
#define SWIG_ErrorCode() (typemap_directorout_globals.error_code)
#endif
...
static void typemap_directorout_init_globals(zend_typemap_directorout_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void typemap_directorout_destroy_globals(zend_typemap_directorout_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_typemap_directorout_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_typemap_directorout_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
#define SWIG_name  "typemap_directorout"
#ifdef __cplusplus
extern "C" {
#endif
#include "php.h"
...
#include "php_typemap_directorout.h"
#ifdef __cplusplus
}
#endif
...
static swig_type_info _swigt__p_Class1 = {"_p_Class1", "Class1 *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_int = {"_p_int", "int *|MyType *", 0, 0, (void*)0, 0};
...
static swig_cast_info _swigc__p_Class1[] = {  {&_swigt__p_Class1, 0, 0, 0},{0, 0, 0, 0}};
...
SwigDirector_Class1::SwigDirector_Class1(zval *self TSRMLS_DC): Class1(), Swig::Director(self TSRMLS_CC) {
...
MyType &SwigDirector_Class1::foo1() {
  ...
  ZVAL_STRINGL(&funcname, (char *)"foo1", 4, 0);
  if (!swig_self) {
  ...
  /* special start */ /*&result = 0;*/ /* special end */ 
  FREE_ZVAL(result);
  return (MyType &) *c_result;
fail:
  SWIG_FAIL();
}
...
MyType &SwigDirector_Class1::foo2(int parm1) {
  ...
  zval *result, funcname;
  MAKE_STD_ZVAL(result);
  ZVAL_STRINGL(&funcname, (char *)"foo2", 4, 0);
  if (!swig_self) {
    SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
  }
...
/* vdecl subsection */
static int le_swig__p_Class1=0; /* handle for Class1 */
...
ZEND_NAMED_FUNCTION(_wrap_new_Class1) {
  ...
  if ( arg0->type == IS_NULL ) {
    /* not subclassed */
    result = (Class1 *)new Class1();
  } else {
    result = (Class1 *)new SwigDirector_Class1(arg0 TSRMLS_CC);
  }
  
  
  SWIG_SetPointerZval(return_value, (void *)result, SWIGTYPE_p_Class1, 1);
...
ZEND_NAMED_FUNCTION(_wrap_Class1_foo1) {
  ...
  upcall = !director->swig_is_overridden_method((char *)"Class1", (char *)"foo1");
  SWIG_ResetError();
  if(ZEND_NUM_ARGS() != 1 || zend_get_parameters_array_ex(1, args) != SUCCESS) {
    WRONG_PARAM_COUNT;
  }
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_Class1, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of Class1_foo1. Expected SWIGTYPE_p_Class1");
    }
  }
...
ZEND_NAMED_FUNCTION(_wrap_Class1_foo2__SWIG_0) {
  Class1 *arg1 = (Class1 *) 0 ;
  int arg2 ;
  zval **args[2];
  Swig::Director *director = 0;
  ...
  director = dynamic_cast<Swig::Director*>(arg1);
  upcall = !director->swig_is_overridden_method((char *)"Class1", (char *)"foo2");
  SWIG_ResetError();
  if(ZEND_NUM_ARGS() != 2 || zend_get_parameters_array_ex(2, args) != SUCCESS) {
    WRONG_PARAM_COUNT;
  }
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_Class1, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of Class1_foo2. Expected SWIGTYPE_p_Class1");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
...
ZEND_NAMED_FUNCTION(_wrap_Class1_foo2__SWIG_1) {
  Class1 *arg1 = (Class1 *) 0 ;
  zval **args[1];
  Swig::Director *director = 0;
  bool upcall = false;
...
ZEND_NAMED_FUNCTION(_wrap_Class1_foo2) {
  ...
  if (argc == 1) {
    ...
    {
      void *tmp;
      _v = (SWIG_ConvertPtr(*argv[0], (void**)&tmp, SWIGTYPE_p_Class1, 0) >= 0);
    }
    if (_v) {
      _wrap_Class1_foo2__SWIG_1(INTERNAL_FUNCTION_PARAM_PASSTHRU); return;
    }
  }
  if (argc == 2) {
    int _v;
    ...
    if (_v) {
      ...
      if (_v) {
        _wrap_Class1_foo2__SWIG_0(INTERNAL_FUNCTION_PARAM_PASSTHRU); return;
      }
    }
  }
  
  SWIG_ErrorCode() = E_ERROR;
  SWIG_ErrorMsg() = "No matching function for overloaded 'Class1_foo2'";
  SWIG_FAIL();
}
...
static void __wrap_delete_Class1(zend_rsrc_list_entry *rsrc, const char *type_name TSRMLS_DC) {
  ...
  arg1 = (Class1 *)SWIG_ZTS_ConvertResourceData(ptr,type_name,SWIGTYPE_p_Class1 TSRMLS_CC);
  if (! arg1) zend_error(E_ERROR, "Class1 resource already free'd");
  delete arg1;
  return;
fail:
  SWIG_FAIL();
...
static ZEND_RSRC_DTOR_FUNC(_wrap_destroy_p_Class1) {
  __wrap_delete_Class1(rsrc, SWIGTYPE_p_Class1->name TSRMLS_CC);
}
...
static zend_function_entry typemap_directorout_functions[] = {
 SWIG_ZEND_NAMED_FE(new_class1,_wrap_new_Class1,NULL)
 SWIG_ZEND_NAMED_FE(class1_foo1,_wrap_Class1_foo1,NULL)
 SWIG_ZEND_NAMED_FE(class1_foo2,_wrap_Class1_foo2,NULL)
 SWIG_ZEND_NAMED_FE(swig_typemap_directorout_alter_newobject,_wrap_swig_typemap_directorout_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_typemap_directorout_get_newobject,_wrap_swig_typemap_directorout_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry typemap_directorout_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"typemap_directorout",
    typemap_directorout_functions,
    PHP_MINIT(typemap_directorout),
    PHP_MSHUTDOWN(typemap_directorout),
    PHP_RINIT(typemap_directorout),
    PHP_RSHUTDOWN(typemap_directorout),
    PHP_MINFO(typemap_directorout),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &typemap_directorout_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &typemap_directorout_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(typemap_directorout)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(typemap_directorout, typemap_directorout_init_globals, typemap_directorout_destroy_globals);

/* Register resource destructors for pointer types */
le_swig__p_Class1=zend_register_list_destructors_ex(_wrap_destroy_p_Class1,NULL,(char *)(SWIGTYPE_p_Class1->name),module_number);
SWIG_TypeClientData(SWIGTYPE_p_Class1,&le_swig__p_Class1);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(typemap_directorout_globals_id);
#endif
    return SUCCESS;
}
