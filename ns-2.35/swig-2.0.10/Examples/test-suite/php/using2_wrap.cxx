...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(using2)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(using2)
ZEND_DECLARE_MODULE_GLOBALS(using2)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(using2_globals_id, zend_using2_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(using2_globals_id, zend_using2_globals *, error_code )
#else
#define SWIG_ErrorMsg() (using2_globals.error_msg)
#define SWIG_ErrorCode() (using2_globals.error_code)
#endif
...
static void using2_init_globals(zend_using2_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void using2_destroy_globals(zend_using2_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_using2_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_using2_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
static zend_function_entry using2_functions[] = {
 SWIG_ZEND_NAMED_FE(new__fooimpl,_wrap_new__FooImpl,NULL)
 SWIG_ZEND_NAMED_FE(spam,_wrap_spam,NULL)
 SWIG_ZEND_NAMED_FE(swig_using2_alter_newobject,_wrap_swig_using2_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_using2_get_newobject,_wrap_swig_using2_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry using2_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"using2",
    using2_functions,
    PHP_MINIT(using2),
    PHP_MSHUTDOWN(using2),
    PHP_RINIT(using2),
    PHP_RSHUTDOWN(using2),
    PHP_MINFO(using2),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &using2_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &using2_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(using2)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(using2, using2_init_globals, using2_destroy_globals);
