...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(li_constraints)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(li_constraints)
ZEND_DECLARE_MODULE_GLOBALS(li_constraints)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(li_constraints_globals_id, zend_li_constraints_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(li_constraints_globals_id, zend_li_constraints_globals *, error_code )
#else
#define SWIG_ErrorMsg() (li_constraints_globals.error_msg)
#define SWIG_ErrorCode() (li_constraints_globals.error_code)
#endif
...
static void li_constraints_init_globals(zend_li_constraints_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void li_constraints_destroy_globals(zend_li_constraints_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_li_constraints_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_li_constraints_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
#define SWIG_name  "li_constraints"
#ifdef __cplusplus
extern "C" {
#endif
#include "php.h"
...
ZEND_NAMED_FUNCTION(_wrap_test_nonnull) {
  ...
  
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, 0, 0) < 0) {
      ...
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of test_nonnull. Expected SWIGTYPE_p_p_void");
    }
  }
  {
    if (!arg1) {
...
static zend_function_entry li_constraints_functions[] = {
 SWIG_ZEND_NAMED_FE(test_nonnegative,_wrap_test_nonnegative,NULL)
 SWIG_ZEND_NAMED_FE(test_nonpositive,_wrap_test_nonpositive,NULL)
 SWIG_ZEND_NAMED_FE(test_positive,_wrap_test_positive,NULL)
 SWIG_ZEND_NAMED_FE(test_negative,_wrap_test_negative,NULL)
 SWIG_ZEND_NAMED_FE(test_nonzero,_wrap_test_nonzero,NULL)
 SWIG_ZEND_NAMED_FE(test_nonnull,_wrap_test_nonnull,NULL)
 SWIG_ZEND_NAMED_FE(swig_li_constraints_alter_newobject,_wrap_swig_li_constraints_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_li_constraints_get_newobject,_wrap_swig_li_constraints_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry li_constraints_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"li_constraints",
    li_constraints_functions,
    PHP_MINIT(li_constraints),
    PHP_MSHUTDOWN(li_constraints),
    PHP_RINIT(li_constraints),
    PHP_RSHUTDOWN(li_constraints),
    PHP_MINFO(li_constraints),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &li_constraints_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &li_constraints_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(li_constraints)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(li_constraints, li_constraints_init_globals, li_constraints_destroy_globals);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(li_constraints_globals_id);
#endif
    return SUCCESS;
}
