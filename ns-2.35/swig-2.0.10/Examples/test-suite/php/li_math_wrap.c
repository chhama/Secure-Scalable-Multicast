...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(li_math)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(li_math)
ZEND_DECLARE_MODULE_GLOBALS(li_math)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(li_math_globals_id, zend_li_math_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(li_math_globals_id, zend_li_math_globals *, error_code )
#else
#define SWIG_ErrorMsg() (li_math_globals.error_msg)
#define SWIG_ErrorCode() (li_math_globals.error_code)
#endif
...
static void li_math_init_globals(zend_li_math_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void li_math_destroy_globals(zend_li_math_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_li_math_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_li_math_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
static zend_function_entry li_math_functions[] = {
 SWIG_ZEND_NAMED_FE(c_cos,_wrap_c_cos,NULL)
 SWIG_ZEND_NAMED_FE(c_sin,_wrap_c_sin,NULL)
 SWIG_ZEND_NAMED_FE(c_tan,_wrap_c_tan,NULL)
 SWIG_ZEND_NAMED_FE(c_acos,_wrap_c_acos,NULL)
 SWIG_ZEND_NAMED_FE(c_asin,_wrap_c_asin,NULL)
 SWIG_ZEND_NAMED_FE(c_atan,_wrap_c_atan,NULL)
 SWIG_ZEND_NAMED_FE(c_atan2,_wrap_c_atan2,NULL)
 SWIG_ZEND_NAMED_FE(c_cosh,_wrap_c_cosh,NULL)
 SWIG_ZEND_NAMED_FE(c_sinh,_wrap_c_sinh,NULL)
 SWIG_ZEND_NAMED_FE(c_tanh,_wrap_c_tanh,NULL)
 SWIG_ZEND_NAMED_FE(c_exp,_wrap_c_exp,NULL)
 SWIG_ZEND_NAMED_FE(c_log,_wrap_c_log,NULL)
 SWIG_ZEND_NAMED_FE(c_log10,_wrap_c_log10,NULL)
 SWIG_ZEND_NAMED_FE(c_pow,_wrap_c_pow,NULL)
 SWIG_ZEND_NAMED_FE(c_sqrt,_wrap_c_sqrt,NULL)
 SWIG_ZEND_NAMED_FE(fabs,_wrap_fabs,NULL)
 SWIG_ZEND_NAMED_FE(c_ceil,_wrap_c_ceil,NULL)
 SWIG_ZEND_NAMED_FE(c_floor,_wrap_c_floor,NULL)
 SWIG_ZEND_NAMED_FE(c_fmod,_wrap_c_fmod,NULL)
 SWIG_ZEND_NAMED_FE(swig_li_math_alter_newobject,_wrap_swig_li_math_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_li_math_get_newobject,_wrap_swig_li_math_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry li_math_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"li_math",
    li_math_functions,
    PHP_MINIT(li_math),
    PHP_MSHUTDOWN(li_math),
    PHP_RINIT(li_math),
    PHP_RSHUTDOWN(li_math),
    PHP_MINFO(li_math),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &li_math_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &li_math_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(li_math)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(li_math, li_math_init_globals, li_math_destroy_globals);
...
/* cinit subsection */
SWIG_DOUBLE_CONSTANT(M_E, 2.7182818284590452354);
SWIG_DOUBLE_CONSTANT(M_LOG2E, 1.4426950408889634074);
SWIG_DOUBLE_CONSTANT(M_LOG10E, 0.43429448190325182765);
SWIG_DOUBLE_CONSTANT(M_LN2, 0.69314718055994530942);
SWIG_DOUBLE_CONSTANT(M_LN10, 2.30258509299404568402);
SWIG_DOUBLE_CONSTANT(M_PI, 3.14159265358979323846);
SWIG_DOUBLE_CONSTANT(M_PI_2, 1.57079632679489661923);
SWIG_DOUBLE_CONSTANT(M_PI_4, 0.78539816339744830962);
SWIG_DOUBLE_CONSTANT(M_1_PI, 0.31830988618379067154);
SWIG_DOUBLE_CONSTANT(M_2_PI, 0.63661977236758134308);
SWIG_DOUBLE_CONSTANT(M_2_SQRTPI, 1.12837916709551257390);
SWIG_DOUBLE_CONSTANT(M_SQRT2, 1.41421356237309504880);
SWIG_DOUBLE_CONSTANT(M_SQRT1_2, 0.70710678118654752440);
