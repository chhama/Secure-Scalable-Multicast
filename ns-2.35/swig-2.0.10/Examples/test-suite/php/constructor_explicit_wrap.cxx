...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(constructor_explicit)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(constructor_explicit)
ZEND_DECLARE_MODULE_GLOBALS(constructor_explicit)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(constructor_explicit_globals_id, zend_constructor_explicit_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(constructor_explicit_globals_id, zend_constructor_explicit_globals *, error_code )
#else
#define SWIG_ErrorMsg() (constructor_explicit_globals.error_msg)
#define SWIG_ErrorCode() (constructor_explicit_globals.error_code)
#endif
...
static void constructor_explicit_init_globals(zend_constructor_explicit_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void constructor_explicit_destroy_globals(zend_constructor_explicit_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_constructor_explicit_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_constructor_explicit_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
#define SWIG_name  "constructor_explicit"
#ifdef __cplusplus
extern "C" {
#endif
#include "php.h"
...
#include "php_constructor_explicit.h"
#ifdef __cplusplus
}
#endif
...
static zend_function_entry constructor_explicit_functions[] = {
 SWIG_ZEND_NAMED_FE(new_foo,_wrap_new_Foo,NULL)
 SWIG_ZEND_NAMED_FE(test,_wrap_test,NULL)
 SWIG_ZEND_NAMED_FE(swig_constructor_explicit_alter_newobject,_wrap_swig_constructor_explicit_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_constructor_explicit_get_newobject,_wrap_swig_constructor_explicit_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry constructor_explicit_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"constructor_explicit",
    constructor_explicit_functions,
    PHP_MINIT(constructor_explicit),
    PHP_MSHUTDOWN(constructor_explicit),
    PHP_RINIT(constructor_explicit),
    PHP_RSHUTDOWN(constructor_explicit),
    PHP_MINFO(constructor_explicit),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &constructor_explicit_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &constructor_explicit_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(constructor_explicit)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(constructor_explicit, constructor_explicit_init_globals, constructor_explicit_destroy_globals);
...
PHP_RINIT_FUNCTION(constructor_explicit)
{
/* rinit section */
...
PHP_MSHUTDOWN_FUNCTION(constructor_explicit)
{
/* shutdown section */
#ifdef ZTS
    ts_free_id(constructor_explicit_globals_id);
#endif
    return SUCCESS;
}

PHP_RSHUTDOWN_FUNCTION(constructor_explicit)
{
/* rshutdown section */
...
PHP_MINFO_FUNCTION(constructor_explicit)
{
}
/* end init section */
