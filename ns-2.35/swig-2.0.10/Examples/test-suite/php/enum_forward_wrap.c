...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(enum_forward)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(enum_forward)
ZEND_DECLARE_MODULE_GLOBALS(enum_forward)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(enum_forward_globals_id, zend_enum_forward_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(enum_forward_globals_id, zend_enum_forward_globals *, error_code )
#else
#define SWIG_ErrorMsg() (enum_forward_globals.error_msg)
#define SWIG_ErrorCode() (enum_forward_globals.error_code)
#endif
...
static void enum_forward_init_globals(zend_enum_forward_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void enum_forward_destroy_globals(zend_enum_forward_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_enum_forward_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_enum_forward_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
ZEND_NAMED_FUNCTION(_wrap_test_function1) {
  ...
  arg1 = (enum ForwardEnum1) Z_LVAL_PP(args[0]);
  /*@SWIG@*/;
...
ZEND_NAMED_FUNCTION(_wrap_test_function2) {
  ...
  /*@SWIG:/home/chhama/Dropbox/mtp/o-ns-allinone-2.35.1/ns-2.35/swig-2.0.10/Lib/php/utils.i,7,CONVERT_INT_IN@*/
  convert_to_long_ex(args[0]);
  arg1 = (enum ForwardEnum2) Z_LVAL_PP(args[0]);
  /*@SWIG@*/;
...
ZEND_NAMED_FUNCTION(_wrap_test_function3) {
  ...
  /*@SWIG:/home/chhama/Dropbox/mtp/o-ns-allinone-2.35.1/ns-2.35/swig-2.0.10/Lib/php/utils.i,7,CONVERT_INT_IN@*/
  convert_to_long_ex(args[0]);
  arg1 = (enum ForwardEnum3) Z_LVAL_PP(args[0]);
  /*@SWIG@*/;
...
static zend_function_entry enum_forward_functions[] = {
 SWIG_ZEND_NAMED_FE(get_enum1,_wrap_get_enum1,NULL)
 SWIG_ZEND_NAMED_FE(test_function1,_wrap_test_function1,NULL)
 SWIG_ZEND_NAMED_FE(get_enum2,_wrap_get_enum2,NULL)
 SWIG_ZEND_NAMED_FE(test_function2,_wrap_test_function2,NULL)
 SWIG_ZEND_NAMED_FE(get_enum3,_wrap_get_enum3,NULL)
 SWIG_ZEND_NAMED_FE(test_function3,_wrap_test_function3,NULL)
 SWIG_ZEND_NAMED_FE(swig_enum_forward_alter_newobject,_wrap_swig_enum_forward_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_enum_forward_get_newobject,_wrap_swig_enum_forward_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry enum_forward_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"enum_forward",
    enum_forward_functions,
    PHP_MINIT(enum_forward),
    PHP_MSHUTDOWN(enum_forward),
    PHP_RINIT(enum_forward),
    PHP_RSHUTDOWN(enum_forward),
    PHP_MINFO(enum_forward),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &enum_forward_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &enum_forward_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(enum_forward)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(enum_forward, enum_forward_init_globals, enum_forward_destroy_globals);
...
/* cinit subsection */
SWIG_LONG_CONSTANT(EEE, EEE);
SWIG_LONG_CONSTANT(FFF, FFF);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(enum_forward_globals_id);
#endif
    return SUCCESS;
}
