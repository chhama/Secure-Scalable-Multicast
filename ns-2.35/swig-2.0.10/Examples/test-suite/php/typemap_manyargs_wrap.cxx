...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(typemap_manyargs)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(typemap_manyargs)
ZEND_DECLARE_MODULE_GLOBALS(typemap_manyargs)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(typemap_manyargs_globals_id, zend_typemap_manyargs_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(typemap_manyargs_globals_id, zend_typemap_manyargs_globals *, error_code )
#else
#define SWIG_ErrorMsg() (typemap_manyargs_globals.error_msg)
#define SWIG_ErrorCode() (typemap_manyargs_globals.error_code)
#endif
...
static void typemap_manyargs_init_globals(zend_typemap_manyargs_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void typemap_manyargs_destroy_globals(zend_typemap_manyargs_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_typemap_manyargs_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_typemap_manyargs_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
#define SWIG_name  "typemap_manyargs"
#ifdef __cplusplus
extern "C" {
#endif
#include "php.h"
...
#include "php_typemap_manyargs.h"
#ifdef __cplusplus
}
#endif
...
ZEND_NAMED_FUNCTION(_wrap_my_c_function) {
  ...
  {
    arg2 = &temp12;      // the code generate for this is arg2 = &temp12;
    arg3 = &temp22;      // the code generate for this is arg3 = &temp22;
    arg4 = &temp32;      // and so on...
    arg5 = &temp42;
    arg6 = &temp52;
    arg7 = &temp62;
    arg8 = &temp72;
    arg9 = &temp82;
    arg10 = &temp92;
    arg11 = &temp102;   // the code generated for this was arg20 = &temp102; and arg20 does not exist.
...
static zend_function_entry typemap_manyargs_functions[] = {
 SWIG_ZEND_NAMED_FE(my_c_function,_wrap_my_c_function,NULL)
 SWIG_ZEND_NAMED_FE(swig_typemap_manyargs_alter_newobject,_wrap_swig_typemap_manyargs_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_typemap_manyargs_get_newobject,_wrap_swig_typemap_manyargs_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry typemap_manyargs_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"typemap_manyargs",
    typemap_manyargs_functions,
    PHP_MINIT(typemap_manyargs),
    PHP_MSHUTDOWN(typemap_manyargs),
    PHP_RINIT(typemap_manyargs),
    PHP_RSHUTDOWN(typemap_manyargs),
    PHP_MINFO(typemap_manyargs),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &typemap_manyargs_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &typemap_manyargs_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(typemap_manyargs)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(typemap_manyargs, typemap_manyargs_init_globals, typemap_manyargs_destroy_globals);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(typemap_manyargs_globals_id);
#endif
    return SUCCESS;
}
