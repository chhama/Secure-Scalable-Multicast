...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(packageoption_b)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(packageoption_b)
ZEND_DECLARE_MODULE_GLOBALS(packageoption_b)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(packageoption_b_globals_id, zend_packageoption_b_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(packageoption_b_globals_id, zend_packageoption_b_globals *, error_code )
#else
#define SWIG_ErrorMsg() (packageoption_b_globals.error_msg)
#define SWIG_ErrorCode() (packageoption_b_globals.error_code)
#endif
...
static void packageoption_b_init_globals(zend_packageoption_b_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void packageoption_b_destroy_globals(zend_packageoption_b_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_packageoption_b_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_packageoption_b_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
#define SWIG_name  "packageoption_b"
#ifdef __cplusplus
extern "C" {
#endif
#include "php.h"
...
/* wrapper section */
ZEND_NAMED_FUNCTION(_wrap_B_testInt) {
  B *arg1 = (B *) 0 ;
  zval **args[1];
  int result;
  ...
  
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_B, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of B_testInt. Expected SWIGTYPE_p_B");
    }
  }
...
static zend_function_entry packageoption_b_functions[] = {
 SWIG_ZEND_NAMED_FE(b_testint,_wrap_B_testInt,NULL)
 SWIG_ZEND_NAMED_FE(new_b,_wrap_new_B,NULL)
 SWIG_ZEND_NAMED_FE(swig_packageoption_b_alter_newobject,_wrap_swig_packageoption_b_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_packageoption_b_get_newobject,_wrap_swig_packageoption_b_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry packageoption_b_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"packageoption_b",
    packageoption_b_functions,
    PHP_MINIT(packageoption_b),
    PHP_MSHUTDOWN(packageoption_b),
    PHP_RINIT(packageoption_b),
    PHP_RSHUTDOWN(packageoption_b),
    PHP_MINFO(packageoption_b),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &packageoption_b_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &packageoption_b_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(packageoption_b)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(packageoption_b, packageoption_b_init_globals, packageoption_b_destroy_globals);
...
PHP_RINIT_FUNCTION(packageoption_b)
{
/* rinit section */
...
PHP_MSHUTDOWN_FUNCTION(packageoption_b)
{
/* shutdown section */
#ifdef ZTS
    ts_free_id(packageoption_b_globals_id);
#endif
    return SUCCESS;
}

PHP_RSHUTDOWN_FUNCTION(packageoption_b)
{
/* rshutdown section */
...
PHP_MINFO_FUNCTION(packageoption_b)
{
}
/* end init section */
