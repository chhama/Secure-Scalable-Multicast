...
#define SWIGTYPE_p_s1 swig_types[1]
...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(nested_comment)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(nested_comment)
ZEND_DECLARE_MODULE_GLOBALS(nested_comment)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(nested_comment_globals_id, zend_nested_comment_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(nested_comment_globals_id, zend_nested_comment_globals *, error_code )
#else
#define SWIG_ErrorMsg() (nested_comment_globals.error_msg)
#define SWIG_ErrorCode() (nested_comment_globals.error_code)
#endif
...
static void nested_comment_init_globals(zend_nested_comment_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void nested_comment_destroy_globals(zend_nested_comment_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_nested_comment_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_nested_comment_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
#define SWIG_name  "nested_comment"
#ifdef __cplusplus
extern "C" {
#endif
#include "php.h"
...
/* end header section */
/* vdecl subsection */
static int le_swig__p_s1=0; /* handle for s2 */
...
ZEND_NAMED_FUNCTION(_wrap_new_s2) {
  ...
  SWIG_SetPointerZval(return_value, (void *)result, SWIGTYPE_p_s1, 1);
...
static void __wrap_delete_s2(zend_rsrc_list_entry *rsrc, const char *type_name TSRMLS_DC) {
  ...
  arg1 = (s1 *)SWIG_ZTS_ConvertResourceData(ptr,type_name,SWIGTYPE_p_s1 TSRMLS_CC);
  if (! arg1) zend_error(E_ERROR, "s1 resource already free'd");
  delete arg1;
  return;
fail:
  SWIG_FAIL();
...
static ZEND_RSRC_DTOR_FUNC(_wrap_destroy_p_s1) {
  __wrap_delete_s2(rsrc, SWIGTYPE_p_s1->name TSRMLS_CC);
}
...
static zend_function_entry nested_comment_functions[] = {
 SWIG_ZEND_NAMED_FE(new_s2,_wrap_new_s2,NULL)
 SWIG_ZEND_NAMED_FE(new_a,_wrap_new_a,NULL)
 SWIG_ZEND_NAMED_FE(swig_nested_comment_alter_newobject,_wrap_swig_nested_comment_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_nested_comment_get_newobject,_wrap_swig_nested_comment_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry nested_comment_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"nested_comment",
    nested_comment_functions,
    PHP_MINIT(nested_comment),
    PHP_MSHUTDOWN(nested_comment),
    PHP_RINIT(nested_comment),
    PHP_RSHUTDOWN(nested_comment),
    PHP_MINFO(nested_comment),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &nested_comment_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &nested_comment_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(nested_comment)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(nested_comment, nested_comment_init_globals, nested_comment_destroy_globals);

/* Register resource destructors for pointer types */
le_swig__p_s1=zend_register_list_destructors_ex(_wrap_destroy_p_s1,NULL,(char *)(SWIGTYPE_p_s1->name),module_number);
SWIG_TypeClientData(SWIGTYPE_p_s1,&le_swig__p_s1);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(nested_comment_globals_id);
#endif
    return SUCCESS;
}
