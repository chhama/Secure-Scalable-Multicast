...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(newobject1)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(newobject1)
ZEND_DECLARE_MODULE_GLOBALS(newobject1)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(newobject1_globals_id, zend_newobject1_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(newobject1_globals_id, zend_newobject1_globals *, error_code )
#else
#define SWIG_ErrorMsg() (newobject1_globals.error_msg)
#define SWIG_ErrorCode() (newobject1_globals.error_code)
#endif
...
static void newobject1_init_globals(zend_newobject1_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void newobject1_destroy_globals(zend_newobject1_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_newobject1_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_newobject1_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
ZEND_NAMED_FUNCTION(_wrap_Foo_makeMore) {
  ...
  
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_Foo, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of Foo_makeMore. Expected SWIGTYPE_p_Foo");
    }
  }
...
static zend_function_entry newobject1_functions[] = {
 SWIG_ZEND_NAMED_FE(foo_makefoo,_wrap_Foo_makeFoo,NULL)
 SWIG_ZEND_NAMED_FE(foo_makemore,_wrap_Foo_makeMore,NULL)
 SWIG_ZEND_NAMED_FE(foo_foocount,_wrap_Foo_fooCount,NULL)
 SWIG_ZEND_NAMED_FE(swig_newobject1_alter_newobject,_wrap_swig_newobject1_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_newobject1_get_newobject,_wrap_swig_newobject1_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry newobject1_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"newobject1",
    newobject1_functions,
    PHP_MINIT(newobject1),
    PHP_MSHUTDOWN(newobject1),
    PHP_RINIT(newobject1),
    PHP_RSHUTDOWN(newobject1),
    PHP_MINFO(newobject1),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &newobject1_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &newobject1_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(newobject1)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(newobject1, newobject1_init_globals, newobject1_destroy_globals);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(newobject1_globals_id);
#endif
    return SUCCESS;
}
