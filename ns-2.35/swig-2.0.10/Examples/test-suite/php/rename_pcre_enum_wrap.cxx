...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(rename_pcre_enum)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(rename_pcre_enum)
ZEND_DECLARE_MODULE_GLOBALS(rename_pcre_enum)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(rename_pcre_enum_globals_id, zend_rename_pcre_enum_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(rename_pcre_enum_globals_id, zend_rename_pcre_enum_globals *, error_code )
#else
#define SWIG_ErrorMsg() (rename_pcre_enum_globals.error_msg)
#define SWIG_ErrorCode() (rename_pcre_enum_globals.error_code)
#endif
...
static void rename_pcre_enum_init_globals(zend_rename_pcre_enum_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void rename_pcre_enum_destroy_globals(zend_rename_pcre_enum_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_rename_pcre_enum_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_rename_pcre_enum_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
#define SWIG_name  "rename_pcre_enum"
#ifdef __cplusplus
extern "C" {
#endif
#include "php.h"
...
#include "php_rename_pcre_enum.h"
#ifdef __cplusplus
}
#endif
...
static zend_function_entry rename_pcre_enum_functions[] = {
 SWIG_ZEND_NAMED_FE(swig_rename_pcre_enum_alter_newobject,_wrap_swig_rename_pcre_enum_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_rename_pcre_enum_get_newobject,_wrap_swig_rename_pcre_enum_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry rename_pcre_enum_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"rename_pcre_enum",
    rename_pcre_enum_functions,
    PHP_MINIT(rename_pcre_enum),
    PHP_MSHUTDOWN(rename_pcre_enum),
    PHP_RINIT(rename_pcre_enum),
    PHP_RSHUTDOWN(rename_pcre_enum),
    PHP_MINFO(rename_pcre_enum),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &rename_pcre_enum_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &rename_pcre_enum_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(rename_pcre_enum)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(rename_pcre_enum, rename_pcre_enum_init_globals, rename_pcre_enum_destroy_globals);
...
/* cinit subsection */
SWIG_LONG_CONSTANT(First, Foo_First);
SWIG_LONG_CONSTANT(Second, Foo_Second);
SWIG_LONG_CONSTANT(MinMax, BoundaryCondition_MinMax);
SWIG_LONG_CONSTANT(MaxMin, BoundaryCondition_MaxMin);
SWIG_LONG_CONSTANT(MaxMax, BoundaryCondition_MaxMax);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(rename_pcre_enum_globals_id);
#endif
    return SUCCESS;
}
