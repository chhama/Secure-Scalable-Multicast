...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(char_binary)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(char_binary)
ZEND_DECLARE_MODULE_GLOBALS(char_binary)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(char_binary_globals_id, zend_char_binary_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(char_binary_globals_id, zend_char_binary_globals *, error_code )
#else
#define SWIG_ErrorMsg() (char_binary_globals.error_msg)
#define SWIG_ErrorCode() (char_binary_globals.error_code)
#endif
...
static void char_binary_init_globals(zend_char_binary_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void char_binary_destroy_globals(zend_char_binary_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_char_binary_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_char_binary_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
static int le_swig__p_a_5__char=0; /* handle for _p_a_5__char */
...
ZEND_NAMED_FUNCTION(_wrap_Test_strlen) {
  ...
  
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_Test, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of Test_strlen. Expected SWIGTYPE_p_Test");
    }
  }
...
ZEND_NAMED_FUNCTION(_wrap_delete_pchar) {
  ...
  
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_char, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of delete_pchar. Expected SWIGTYPE_p_char");
    }
  }
  delete_pchar(arg1);
...
ZEND_NAMED_FUNCTION(_wrap_pchar_getitem) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_char, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of pchar_getitem. Expected SWIGTYPE_p_char");
    }
  }
...
ZEND_NAMED_FUNCTION(_wrap_pchar_setitem) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_char, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of pchar_setitem. Expected SWIGTYPE_p_char");
    }
  }
...
static ZEND_RSRC_DTOR_FUNC(_wrap_destroy_p_a_5__char) {
  /* No destructor for simple type _p_a_5__char */
  efree(rsrc->ptr);
}
/* end wrapper section */
...
static zend_function_entry char_binary_functions[] = {
 SWIG_ZEND_NAMED_FE(test_strlen,_wrap_Test_strlen,NULL)
 SWIG_ZEND_NAMED_FE(new_test,_wrap_new_Test,NULL)
 SWIG_ZEND_NAMED_FE(var_namet_set,_wrap_var_namet_set,NULL)
 SWIG_ZEND_NAMED_FE(var_namet_get,_wrap_var_namet_get,NULL)
 SWIG_ZEND_NAMED_FE(var_pchar_set,_wrap_var_pchar_set,NULL)
 SWIG_ZEND_NAMED_FE(var_pchar_get,_wrap_var_pchar_get,NULL)
 SWIG_ZEND_NAMED_FE(new_pchar,_wrap_new_pchar,NULL)
 SWIG_ZEND_NAMED_FE(delete_pchar,_wrap_delete_pchar,NULL)
 SWIG_ZEND_NAMED_FE(pchar_getitem,_wrap_pchar_getitem,NULL)
 SWIG_ZEND_NAMED_FE(pchar_setitem,_wrap_pchar_setitem,NULL)
 SWIG_ZEND_NAMED_FE(swig_char_binary_alter_newobject,_wrap_swig_char_binary_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_char_binary_get_newobject,_wrap_swig_char_binary_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry char_binary_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"char_binary",
    char_binary_functions,
    PHP_MINIT(char_binary),
    PHP_MSHUTDOWN(char_binary),
    PHP_RINIT(char_binary),
    PHP_RSHUTDOWN(char_binary),
    PHP_MINFO(char_binary),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &char_binary_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &char_binary_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(char_binary)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(char_binary, char_binary_init_globals, char_binary_destroy_globals);
...
le_swig__p_a_5__char=zend_register_list_destructors_ex(_wrap_destroy_p_a_5__char,NULL,(char *)(SWIGTYPE_p_a_5__char->name),module_number);
SWIG_TypeClientData(SWIGTYPE_p_a_5__char,&le_swig__p_a_5__char);
...
/* vinit subsection */
{
  ...
  if (var_namet) {
    /* varinit char [ANY] */
    ZVAL_STRINGL(z_var,(char*)var_namet, 5, 1);
  }
  zend_hash_add(&EG(symbol_table), (char*)"var_namet", sizeof("var_namet"), (void*)&z_var, sizeof(zval *), NULL);
}
{
  zval *z_var;
  MAKE_STD_ZVAL(z_var);
  z_var->type = IS_STRING;
  if(var_pchar) {
      z_var->value.str.val = estrdup(var_pchar);
      z_var->value.str.len = strlen(var_pchar);
  } else {
      z_var->value.str.val = 0;
      z_var->value.str.len = 0;
  }
  zend_hash_add(&EG(symbol_table), (char*)"var_pchar", sizeof("var_pchar"), (void *)&z_var, sizeof(zval *), NULL);
}
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(char_binary_globals_id);
#endif
    return SUCCESS;
}
