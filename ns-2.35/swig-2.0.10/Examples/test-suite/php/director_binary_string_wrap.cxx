...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(director_binary_string)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(director_binary_string)
ZEND_DECLARE_MODULE_GLOBALS(director_binary_string)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(director_binary_string_globals_id, zend_director_binary_string_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(director_binary_string_globals_id, zend_director_binary_string_globals *, error_code )
#else
#define SWIG_ErrorMsg() (director_binary_string_globals.error_msg)
#define SWIG_ErrorCode() (director_binary_string_globals.error_code)
#endif
...
static void director_binary_string_init_globals(zend_director_binary_string_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void director_binary_string_destroy_globals(zend_director_binary_string_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_director_binary_string_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_director_binary_string_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
#define SWIG_name  "director_binary_string"
#ifdef __cplusplus
extern "C" {
#endif
#include "php.h"
...
#include "php_director_binary_string.h"
#ifdef __cplusplus
}
#endif
...
SwigDirector_Callback::SwigDirector_Callback(zval *self TSRMLS_DC): Callback(), Swig::Director(self TSRMLS_CC) {
...
void SwigDirector_Callback::run(char *dataBufferAA, int sizeAA, char *dataBufferBB, int sizeBB) {
  TSRMLS_FETCH_FROM_CTX(swig_zts_ctx);
  zval *args[4];
  zval *result, funcname;
  MAKE_STD_ZVAL(result);
  ZVAL_STRINGL(&funcname, (char *)"run", 3, 0);
  if (!swig_self) {
  ...
  INIT_ZVAL(obj0);
  {
    if(!dataBufferAA) {
      ...
      ZVAL_STRING(&obj0, (char *)dataBufferAA, 1);
    }
  }
  zval obj1;
  args[1] = &obj1;
  ...
  INIT_ZVAL(obj2);
  {
    if(!dataBufferBB) {
      ...
      ZVAL_STRING(&obj2, (char *)dataBufferBB, 1);
    }
  }
  zval obj3;
  args[3] = &obj3;
...
static int le_swig__p_Callback=0; /* handle for Callback */
static int le_swig__p_Caller=0; /* handle for Caller */
/* end vdecl subsection */
/* wrapper section */
/* This function is designed to be called by the zend list destructors */
/* to typecast and do the actual destruction */
static void __wrap_delete_Callback(zend_rsrc_list_entry *rsrc, const char *type_name TSRMLS_DC) {
  ...
  arg1 = (Callback *)SWIG_ZTS_ConvertResourceData(ptr,type_name,SWIGTYPE_p_Callback TSRMLS_CC);
  if (! arg1) zend_error(E_ERROR, "Callback resource already free'd");
  delete arg1;
  return;
fail:
  SWIG_FAIL();
...
ZEND_NAMED_FUNCTION(_wrap_Callback_run) {
  ...
  upcall = !director->swig_is_overridden_method((char *)"Callback", (char *)"run");
  SWIG_ResetError();
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_Callback, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of Callback_run. Expected SWIGTYPE_p_Callback");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
  {
    ...
    arg3 = (int) Z_STRLEN_PP(args[1]);
  }
  {
    convert_to_string_ex(args[2]);
    arg4 = (char *) Z_STRVAL_PP(args[2]);
    arg5 = (int) Z_STRLEN_PP(args[2]);
  }
  if (upcall) {
    (arg1)->Callback::run(arg2,arg3,arg4,arg5);
  } else {
...
ZEND_NAMED_FUNCTION(_wrap_new_Callback) {
  ...
  if ( arg0->type == IS_NULL ) {
    ...
    result = (Callback *)new SwigDirector_Callback(arg0 TSRMLS_CC);
  }
  
  
  SWIG_SetPointerZval(return_value, (void *)result, SWIGTYPE_p_Callback, 1);
...
ZEND_NAMED_FUNCTION(_wrap_Caller_setCallback) {
  ...
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
  {
    if(SWIG_ConvertPtr(*args[1], (void **) &arg2, SWIGTYPE_p_Callback, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 2 of Caller_setCallback. Expected SWIGTYPE_p_Callback");
    }
  }
...
ZEND_NAMED_FUNCTION(_wrap_Caller_call_null) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_Caller, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of Caller_call_null. Expected SWIGTYPE_p_Caller");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
  (arg1)->call_null();
...
static ZEND_RSRC_DTOR_FUNC(_wrap_destroy_p_Callback) {
  __wrap_delete_Callback(rsrc, SWIGTYPE_p_Callback->name TSRMLS_CC);
}
...
static zend_function_entry director_binary_string_functions[] = {
 SWIG_ZEND_NAMED_FE(callback_run,_wrap_Callback_run,NULL)
 SWIG_ZEND_NAMED_FE(new_callback,_wrap_new_Callback,NULL)
 ...
 SWIG_ZEND_NAMED_FE(caller_call_null,_wrap_Caller_call_null,NULL)
 SWIG_ZEND_NAMED_FE(swig_director_binary_string_alter_newobject,_wrap_swig_director_binary_string_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_director_binary_string_get_newobject,_wrap_swig_director_binary_string_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry director_binary_string_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"director_binary_string",
    director_binary_string_functions,
    PHP_MINIT(director_binary_string),
    PHP_MSHUTDOWN(director_binary_string),
    PHP_RINIT(director_binary_string),
    PHP_RSHUTDOWN(director_binary_string),
    PHP_MINFO(director_binary_string),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &director_binary_string_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &director_binary_string_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(director_binary_string)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(director_binary_string, director_binary_string_init_globals, director_binary_string_destroy_globals);
...
le_swig__p_Callback=zend_register_list_destructors_ex(_wrap_destroy_p_Callback,NULL,(char *)(SWIGTYPE_p_Callback->name),module_number);
SWIG_TypeClientData(SWIGTYPE_p_Callback,&le_swig__p_Callback);
...
/* cinit subsection */
SWIG_LONG_CONSTANT(BUFFER_SIZE_AA, 8);
SWIG_LONG_CONSTANT(BUFFER_SIZE_BB, 5);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(director_binary_string_globals_id);
#endif
    return SUCCESS;
}
