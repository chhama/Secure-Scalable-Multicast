...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(lextype)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(lextype)
ZEND_DECLARE_MODULE_GLOBALS(lextype)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(lextype_globals_id, zend_lextype_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(lextype_globals_id, zend_lextype_globals *, error_code )
#else
#define SWIG_ErrorMsg() (lextype_globals.error_msg)
#define SWIG_ErrorCode() (lextype_globals.error_code)
#endif
...
static void lextype_init_globals(zend_lextype_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void lextype_destroy_globals(zend_lextype_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_lextype_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_lextype_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
static swig_type_info _swigt__p_void = {"_p_void", "Giraffe|void *", 0, 0, (void*)0, 0};
  ...
  
  {
    ...
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_p_void, 0) < 0) {
      ...
      if (!((*args[0])->type==IS_NULL && PZVAL_IS_REF(*args[0]))) {
        ...
        SWIG_PHP_Error(E_ERROR, "Type error in argument $arg of drink.");
      }
    }
    force1=0;
    if (arg1==NULL) {
      ptr1=(Giraffe) calloc(1,sizeof(Giraffe));
...
static zend_function_entry lextype_functions[] = {
 SWIG_ZEND_NAMED_FE(eat,_wrap_eat,NULL)
 SWIG_ZEND_NAMED_FE(drink,_wrap_drink,NULL)
 SWIG_ZEND_NAMED_FE(mate,_wrap_mate,NULL)
 SWIG_ZEND_NAMED_FE(swig_lextype_alter_newobject,_wrap_swig_lextype_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_lextype_get_newobject,_wrap_swig_lextype_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry lextype_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"lextype",
    lextype_functions,
    PHP_MINIT(lextype),
    PHP_MSHUTDOWN(lextype),
    PHP_RINIT(lextype),
    PHP_RSHUTDOWN(lextype),
    PHP_MINFO(lextype),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &lextype_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &lextype_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(lextype)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(lextype, lextype_init_globals, lextype_destroy_globals);
...
/* cinit subsection */
SWIG_LONG_CONSTANT(HEIGHT_Giraffe, 100);
SWIG_LONG_CONSTANT(WIDTH_Giraffe, 5);
