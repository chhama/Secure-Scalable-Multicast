...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(director_string)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(director_string)
ZEND_DECLARE_MODULE_GLOBALS(director_string)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(director_string_globals_id, zend_director_string_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(director_string_globals_id, zend_director_string_globals *, error_code )
#else
#define SWIG_ErrorMsg() (director_string_globals.error_msg)
#define SWIG_ErrorCode() (director_string_globals.error_code)
#endif
...
static void director_string_init_globals(zend_director_string_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void director_string_destroy_globals(zend_director_string_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_director_string_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_director_string_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
#define SWIG_name  "director_string"
#ifdef __cplusplus
extern "C" {
#endif
#include "php.h"
...
SwigDirector_A::SwigDirector_A(zval *self, std::string const &first TSRMLS_DC): A(first), Swig::Director(self TSRMLS_CC) {
...
std::string const &SwigDirector_A::get_first() const {
  ...
  ZVAL_STRINGL(&funcname, (char *)"get_first", 9, 0);
  if (!swig_self) {
  ...
  temp = new std::string(Z_STRVAL_PP(&result), Z_STRLEN_PP(&result));
...
std::string const &SwigDirector_A::get(int n) const {
  ...
  zval *result, funcname;
  MAKE_STD_ZVAL(result);
  ZVAL_STRINGL(&funcname, (char *)"get", 3, 0);
  if (!swig_self) {
    SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
  }
...
std::string const &SwigDirector_A::call_get_first() const {
  ...
  zval *result, funcname;
  MAKE_STD_ZVAL(result);
  ZVAL_STRINGL(&funcname, (char *)"call_get_first", 14, 0);
  if (!swig_self) {
    SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
  }
...
std::string const &SwigDirector_A::call_get(int n) const {
  ...
  zval *result, funcname;
  MAKE_STD_ZVAL(result);
  ZVAL_STRINGL(&funcname, (char *)"call_get", 8, 0);
  if (!swig_self) {
    SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
  }
...
int SwigDirector_A::string_length(std::string const &s) const {
  ...
  zval *result, funcname;
  MAKE_STD_ZVAL(result);
  ZVAL_STRINGL(&funcname, (char *)"string_length", 13, 0);
  if (!swig_self) {
    SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
  }
...
void SwigDirector_A::process_text(char const *text) {
  ...
  zval *result, funcname;
  MAKE_STD_ZVAL(result);
  ZVAL_STRINGL(&funcname, (char *)"process_text", 12, 0);
  if (!swig_self) {
    SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
  }
...
ZEND_NAMED_FUNCTION(_wrap_new_A) {
  ...
  temp1.assign(Z_STRVAL_PP(args[1]), Z_STRLEN_PP(args[1]));
  arg1 = &temp1;
  ...
  if ( arg0->type == IS_NULL ) {
    ...
    result = (A *)new SwigDirector_A(arg0, (std::string const &)*arg1 TSRMLS_CC);
  }
...
ZEND_NAMED_FUNCTION(_wrap_A_get_first) {
  ...
  upcall = !director->swig_is_overridden_method((char *)"A", (char *)"get_first");
  SWIG_ResetError();
  if(ZEND_NUM_ARGS() != 1 || zend_get_parameters_array_ex(1, args) != SUCCESS) {
    WRONG_PARAM_COUNT;
  }
  
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_A, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of A_get_first. Expected SWIGTYPE_p_A");
    }
  }
...
ZEND_NAMED_FUNCTION(_wrap_A_get) {
  ...
  director = dynamic_cast<Swig::Director*>(arg1);
  upcall = !director->swig_is_overridden_method((char *)"A", (char *)"get");
  SWIG_ResetError();
  if(ZEND_NUM_ARGS() != 2 || zend_get_parameters_array_ex(2, args) != SUCCESS) {
    WRONG_PARAM_COUNT;
  }
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_A, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of A_get. Expected SWIGTYPE_p_A");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
...
ZEND_NAMED_FUNCTION(_wrap_A_call_get_first) {
  ...
  director = dynamic_cast<Swig::Director*>(arg1);
  upcall = !director->swig_is_overridden_method((char *)"A", (char *)"call_get_first");
  SWIG_ResetError();
  if(ZEND_NUM_ARGS() != 1 || zend_get_parameters_array_ex(1, args) != SUCCESS) {
    WRONG_PARAM_COUNT;
  }
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_A, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of A_call_get_first. Expected SWIGTYPE_p_A");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
  if (upcall) {
...
ZEND_NAMED_FUNCTION(_wrap_A_call_get) {
  ...
  director = dynamic_cast<Swig::Director*>(arg1);
  upcall = !director->swig_is_overridden_method((char *)"A", (char *)"call_get");
  SWIG_ResetError();
  if(ZEND_NUM_ARGS() != 2 || zend_get_parameters_array_ex(2, args) != SUCCESS) {
    WRONG_PARAM_COUNT;
  }
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_A, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of A_call_get. Expected SWIGTYPE_p_A");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
...
ZEND_NAMED_FUNCTION(_wrap_A_string_length) {
  ...
  director = dynamic_cast<Swig::Director*>(arg1);
  upcall = !director->swig_is_overridden_method((char *)"A", (char *)"string_length");
  SWIG_ResetError();
  if(ZEND_NUM_ARGS() != 2 || zend_get_parameters_array_ex(2, args) != SUCCESS) {
    WRONG_PARAM_COUNT;
  }
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_A, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of A_string_length. Expected SWIGTYPE_p_A");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
...
ZEND_NAMED_FUNCTION(_wrap_A_m_strings_set) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_A, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of A_m_strings_set. Expected SWIGTYPE_p_A");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
  {
    if(SWIG_ConvertPtr(*args[1], (void **) &arg2, SWIGTYPE_p_std__vectorT_std__string_t, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 2 of A_m_strings_set. Expected SWIGTYPE_p_std__vectorT_std__string_t");
    }
  }
...
ZEND_NAMED_FUNCTION(_wrap_A_m_strings_get) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_A, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of A_m_strings_get. Expected SWIGTYPE_p_A");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
...
ZEND_NAMED_FUNCTION(_wrap_A_process_text) {
  ...
  director = dynamic_cast<Swig::Director*>(arg1);
  upcall = !director->swig_is_overridden_method((char *)"A", (char *)"process_text");
  SWIG_ResetError();
  if(ZEND_NUM_ARGS() != 2 || zend_get_parameters_array_ex(2, args) != SUCCESS) {
    WRONG_PARAM_COUNT;
  }
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_A, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of A_process_text. Expected SWIGTYPE_p_A");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
...
ZEND_NAMED_FUNCTION(_wrap_A_call_process_func) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_A, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of A_call_process_func. Expected SWIGTYPE_p_A");
    }
  }
  if(!arg1) SWIG_PHP_Error(E_ERROR, "this pointer is NULL");
...
static zend_function_entry director_string_functions[] = {
 SWIG_ZEND_NAMED_FE(new_a,_wrap_new_A,NULL)
 SWIG_ZEND_NAMED_FE(a_get_first,_wrap_A_get_first,NULL)
 SWIG_ZEND_NAMED_FE(a_get,_wrap_A_get,NULL)
 SWIG_ZEND_NAMED_FE(a_call_get_first,_wrap_A_call_get_first,NULL)
 SWIG_ZEND_NAMED_FE(a_call_get,_wrap_A_call_get,NULL)
 SWIG_ZEND_NAMED_FE(a_string_length,_wrap_A_string_length,NULL)
 SWIG_ZEND_NAMED_FE(a_m_strings_set,_wrap_A_m_strings_set,NULL)
 SWIG_ZEND_NAMED_FE(a_m_strings_get,_wrap_A_m_strings_get,NULL)
 SWIG_ZEND_NAMED_FE(a_process_text,_wrap_A_process_text,NULL)
 SWIG_ZEND_NAMED_FE(a_call_process_func,_wrap_A_call_process_func,NULL)
 ...
 SWIG_ZEND_NAMED_FE(swig_director_string_alter_newobject,_wrap_swig_director_string_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_director_string_get_newobject,_wrap_swig_director_string_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry director_string_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"director_string",
    director_string_functions,
    PHP_MINIT(director_string),
    PHP_MSHUTDOWN(director_string),
    PHP_RINIT(director_string),
    PHP_RSHUTDOWN(director_string),
    PHP_MINFO(director_string),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &director_string_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &director_string_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(director_string)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(director_string, director_string_init_globals, director_string_destroy_globals);
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(director_string_globals_id);
#endif
    return SUCCESS;
}
