...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(li_cmalloc)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(li_cmalloc)
ZEND_DECLARE_MODULE_GLOBALS(li_cmalloc)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(li_cmalloc_globals_id, zend_li_cmalloc_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(li_cmalloc_globals_id, zend_li_cmalloc_globals *, error_code )
#else
#define SWIG_ErrorMsg() (li_cmalloc_globals.error_msg)
#define SWIG_ErrorCode() (li_cmalloc_globals.error_code)
#endif
...
static void li_cmalloc_init_globals(zend_li_cmalloc_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void li_cmalloc_destroy_globals(zend_li_cmalloc_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_li_cmalloc_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_li_cmalloc_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
ZEND_NAMED_FUNCTION(_wrap_realloc_int) {
  ...
  
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_int, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of realloc_int. Expected SWIGTYPE_p_int");
    }
  }
...
ZEND_NAMED_FUNCTION(_wrap_free_int) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_int, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of free_int. Expected SWIGTYPE_p_int");
    }
  }
  free(arg1);
...
ZEND_NAMED_FUNCTION(_wrap_realloc_double) {
  ...
  
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_double, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of realloc_double. Expected SWIGTYPE_p_double");
    }
  }
...
ZEND_NAMED_FUNCTION(_wrap_free_double) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_double, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of free_double. Expected SWIGTYPE_p_double");
    }
  }
  free(arg1);
...
ZEND_NAMED_FUNCTION(_wrap_realloc_void) {
  ...
  
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, 0, 0) < 0) {
      ...
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of realloc_void. Expected SWIGTYPE_p_p_void");
    }
  }
...
ZEND_NAMED_FUNCTION(_wrap_realloc_intp) {
  ...
  
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_p_int, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of realloc_intp. Expected SWIGTYPE_p_p_int");
    }
  }
...
ZEND_NAMED_FUNCTION(_wrap_free_intp) {
  ...
  {
    if(SWIG_ConvertPtr(*args[0], (void **) &arg1, SWIGTYPE_p_p_int, 0) < 0) {
      SWIG_PHP_Error(E_ERROR, "Type error in argument 1 of free_intp. Expected SWIGTYPE_p_p_int");
    }
  }
  free(arg1);
...
static zend_function_entry li_cmalloc_functions[] = {
 SWIG_ZEND_NAMED_FE(malloc_int,_wrap_malloc_int,NULL)
 SWIG_ZEND_NAMED_FE(calloc_int,_wrap_calloc_int,NULL)
 SWIG_ZEND_NAMED_FE(realloc_int,_wrap_realloc_int,NULL)
 SWIG_ZEND_NAMED_FE(free_int,_wrap_free_int,NULL)
 SWIG_ZEND_NAMED_FE(malloc_double,_wrap_malloc_double,NULL)
 SWIG_ZEND_NAMED_FE(calloc_double,_wrap_calloc_double,NULL)
 SWIG_ZEND_NAMED_FE(realloc_double,_wrap_realloc_double,NULL)
 SWIG_ZEND_NAMED_FE(free_double,_wrap_free_double,NULL)
 SWIG_ZEND_NAMED_FE(malloc_void,_wrap_malloc_void,NULL)
 SWIG_ZEND_NAMED_FE(calloc_void,_wrap_calloc_void,NULL)
 SWIG_ZEND_NAMED_FE(realloc_void,_wrap_realloc_void,NULL)
 SWIG_ZEND_NAMED_FE(free_void,_wrap_free_void,NULL)
 SWIG_ZEND_NAMED_FE(malloc_intp,_wrap_malloc_intp,NULL)
 SWIG_ZEND_NAMED_FE(calloc_intp,_wrap_calloc_intp,NULL)
 SWIG_ZEND_NAMED_FE(realloc_intp,_wrap_realloc_intp,NULL)
 SWIG_ZEND_NAMED_FE(free_intp,_wrap_free_intp,NULL)
 SWIG_ZEND_NAMED_FE(swig_li_cmalloc_alter_newobject,_wrap_swig_li_cmalloc_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_li_cmalloc_get_newobject,_wrap_swig_li_cmalloc_get_newobject,NULL)
{NULL, NULL, NULL}
};
...
#endif
zend_module_entry li_cmalloc_module_entry = {
    STANDARD_MODULE_HEADER,
    (char*)"li_cmalloc",
    li_cmalloc_functions,
    PHP_MINIT(li_cmalloc),
    PHP_MSHUTDOWN(li_cmalloc),
    PHP_RINIT(li_cmalloc),
    PHP_RSHUTDOWN(li_cmalloc),
    PHP_MINFO(li_cmalloc),
    NO_VERSION_YET,
    STANDARD_MODULE_PROPERTIES
};
zend_module_entry* SWIG_module_entry = &li_cmalloc_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &li_cmalloc_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(li_cmalloc)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* oinit subsection */
ZEND_INIT_MODULE_GLOBALS(li_cmalloc, li_cmalloc_init_globals, li_cmalloc_destroy_globals);
...
/* cinit subsection */
SWIG_LONG_CONSTANT(sizeof_int, sizeof(int));
SWIG_LONG_CONSTANT(sizeof_double, sizeof(double));
SWIG_LONG_CONSTANT(sizeof_intp, sizeof(int *));
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(li_cmalloc_globals_id);
#endif
    return SUCCESS;
}
