...
#define SWIG_init    boot_foo

#define SWIG_name   "fooc::boot_foo"
#define SWIG_prefix "fooc::"
...
#ifdef PERL_OBJECT
#define MAGIC_CLASS _wrap_foo_var::
class _wrap_foo_var : public CPerlObj {
public:
#else
#define MAGIC_CLASS
#endif
...
XS(_wrap_Foo_toBase) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: Foo_toBase(self);");
    }
    res1 = SWIG_ConvertPtr(ST(0), &argp1,SWIGTYPE_p_Foo, 0 |  0 );
    if (!SWIG_IsOK(res1)) {
...
XS(_wrap_Foo_fromBase) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: Foo_fromBase(b);");
    }
...
static swig_type_info _swigt__p_Foo = {"_p_Foo", "Foo *", 0, 0, (void*)"foo::Foo", 0};
...
{"fooc::new_Foo", _wrap_new_Foo},
{"fooc::delete_Foo", _wrap_delete_Foo},
{"fooc::Foo_A", _wrap_Foo_A},
{"fooc::Foo_B", _wrap_Foo_B},
{"fooc::Foo_toBase", _wrap_Foo_toBase},
{"fooc::Foo_fromBase", _wrap_Foo_fromBase},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
...
XS(SWIG_init) {
  ...
  SWIG_TypeClientData(SWIGTYPE_p_Foo, (void*) "foo::Foo");
  ST(0) = &PL_sv_yes;
  XSRETURN(1);
}
