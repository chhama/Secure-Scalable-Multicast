...
XS(_wrap_add) {
  {
    ...
    if ((items < 3) || (items > 3)) {
      SWIG_croak("Usage: add(x,y,result);");
    }
...
{"examplec::add", _wrap_add},
{"examplec::new_intp", _wrap_new_intp},
{"examplec::copy_intp", _wrap_copy_intp},
{"examplec::delete_intp", _wrap_delete_intp},
{"examplec::intp_assign", _wrap_intp_assign},
{"examplec::intp_value", _wrap_intp_value},
{"examplec::subtract", _wrap_subtract},
{"examplec::divide", _wrap_divide},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
