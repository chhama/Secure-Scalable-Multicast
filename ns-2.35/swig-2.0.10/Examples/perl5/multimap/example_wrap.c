...
XS(_wrap_gcdmain) {
  {
    ...
    arg2 = 0;
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: gcdmain(argc,argv);");
    }
    {
      AV *tempav;
      SV **tv;
...
XS(_wrap_count) {
  {
    ...
    if ((items < 2) || (items > 2)) {
      SWIG_croak("Usage: count(bytes,len,c);");
    }
    {
      STRLEN temp;
      arg1 = (char *) SvPV(ST(0), temp);
      arg2 = (int) temp;
    }
...
XS(_wrap_capitalize) {
  {
    ...
    if ((items < 1) || (items > 1)) {
      SWIG_croak("Usage: capitalize(str,len);");
    }
    {
      STRLEN templen;
      char *temp;
      temp = (char *) SvPV(ST(0),templen);
      arg2 = (int) templen;
    ...
    ST(argvi) = sv_newmortal();
    {
      ...
      ST(argvi) = sv_newmortal();
      sv_setpvn((SV*)ST(argvi++),arg1,arg2);
      free(arg1);
    }
...
{"examplec::gcd", _wrap_gcd},
{"examplec::gcdmain", _wrap_gcdmain},
{"examplec::count", _wrap_count},
{"examplec::capitalize", _wrap_capitalize},
{"examplec::circle", _wrap_circle},
{0,0}
};
/* -----------------------------------------------------------------------------
 * Type initialization:
